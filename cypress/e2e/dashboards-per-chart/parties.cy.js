/**
 * Per-chart Cypress spec for the parties dashboard.
 *
...
const CFG = DASHBOARDS.find((d) => d.slug === 'parties');
if (!CFG) throw new Error('Missing DASHBOARDS entry for slug "parties"');
