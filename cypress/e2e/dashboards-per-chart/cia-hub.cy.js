/**
 * Per-chart Cypress spec for the cia-hub dashboard.
 *
...
const CFG = DASHBOARDS.find((d) => d.slug === 'cia-hub');
if (!CFG) throw new Error('Missing DASHBOARDS entry for slug "cia-hub"');
