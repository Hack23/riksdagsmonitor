/**
 * Per-chart Cypress spec for the committees dashboard.
 *
...
const CFG = DASHBOARDS.find((d) => d.slug === 'committees');
if (!CFG) throw new Error('Missing DASHBOARDS entry for slug "committees"');
