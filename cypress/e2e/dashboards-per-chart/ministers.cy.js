/**
 * Per-chart Cypress spec for the ministers dashboard.
 *
...
const CFG = DASHBOARDS.find((d) => d.slug === 'ministers');
if (!CFG) throw new Error('Missing DASHBOARDS entry for slug "ministers"');
