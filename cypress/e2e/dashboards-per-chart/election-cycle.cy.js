/**
 * Per-chart Cypress spec for the election-cycle dashboard.
 *
...
const CFG = DASHBOARDS.find((d) => d.slug === 'election-cycle');
if (!CFG) throw new Error('Missing DASHBOARDS entry for slug "election-cycle"');
