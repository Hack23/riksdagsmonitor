/**
 * Per-chart Cypress spec for the pre-election dashboard.
 *
...
const CFG = DASHBOARDS.find((d) => d.slug === 'pre-election');
if (!CFG) throw new Error('Missing DASHBOARDS entry for slug "pre-election"');
