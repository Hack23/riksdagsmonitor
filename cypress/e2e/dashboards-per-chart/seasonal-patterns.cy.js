/**
 * Per-chart Cypress spec for the seasonal-patterns dashboard.
 *
...
const CFG = DASHBOARDS.find((d) => d.slug === 'seasonal-patterns');
if (!CFG) throw new Error('Missing DASHBOARDS entry for slug "seasonal-patterns"');
