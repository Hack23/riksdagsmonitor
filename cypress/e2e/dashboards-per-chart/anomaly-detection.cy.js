/**
 * Per-chart Cypress spec for the anomaly-detection dashboard.
 *
...
const CFG = DASHBOARDS.find((d) => d.slug === 'anomaly-detection');
if (!CFG) throw new Error('Missing DASHBOARDS entry for slug "anomaly-detection"');
