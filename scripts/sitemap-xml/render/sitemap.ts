...
<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9"
  ...
  // ── Specialised political-intelligence dashboards (one URL per dashboard
  // per language, with a full hreflang alternates chain).  These pages live
  // under /dashboards/ and are generated by scripts/build-dashboard-pages.py.
