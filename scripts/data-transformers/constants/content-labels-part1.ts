...
export const CONTENT_LABELS_PART1: Partial<Record<string, ContentLabelSet>> = {
  en: {
    ...
    readFullInterpellation: 'View interpellation',
    partyInterpellationsFiled: (party: string, n: number): string => `${party}: ${n} interpellation${n > 1 ? 's' : ''} filed`,
  ...
  sv: {
    ...
    readFullInterpellation: 'Visa interpellationen',
    partyInterpellationsFiled: (party: string, n: number): string => `${party}: ${n} interpellation${n > 1 ? 'er' : ''} inlämnade`,
  ...
  da: {
    ...
    readFullInterpellation: 'Se interpellationen',
    partyInterpellationsFiled: (party: string, n: number): string => `${party}: ${n} interpellation${n > 1 ? 'er' : ''} indgivet`,
  ...
  no: {
    ...
    readFullInterpellation: 'Se interpellasjonen',
    partyInterpellationsFiled: (party: string, n: number): string => `${party}: ${n} interpellasjon${n > 1 ? 'er' : ''} innsendt`,
    ...
    readFullInterpellation: 'Näytä välikysymys',
    partyInterpellationsFiled: (party: string, n: number): string => `${party}: ${n} välikysymys${n > 1 ? 'tä' : ''} jätetty`,
  ...
  de: {
    ...
    readFullInterpellation: 'Interpellation anzeigen',
    partyInterpellationsFiled: (party: string, n: number): string => `${party}: ${n} Interpellation${n > 1 ? 'en' : ''} eingereicht`,
  ...
  fr: {
    ...
    readFullInterpellation: "Voir l'interpellation",
    partyInterpellationsFiled: (party: string, n: number): string => `${party} : ${n} interpellation${n > 1 ? 's' : ''} déposée${n > 1 ? 's' : ''}`,
