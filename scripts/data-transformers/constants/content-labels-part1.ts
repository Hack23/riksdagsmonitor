...
export const CONTENT_LABELS_PART1: Partial<Record<string, ContentLabelSet>> = {
  en: {
    ...
    unknownMinister: 'Unknown minister',
    ...
    policySignificanceGeneric: 'Requires committee review and chamber debate before any decision is taken.',
  ...
  sv: {
    ...
    unknownMinister: 'Okänd minister',
    ministerInterpellationCount: (minister: string, n: number): string => `${minister} — ${n} interpellation${n !== 1 ? 'er' : ''}`,
  ...
  da: {
    ...
    unknownMinister: 'Ukendt minister',
    ministerInterpellationCount: (minister: string, n: number): string => `${minister} — ${n} interpellation${n !== 1 ? 'er' : ''}`,
  ...
  no: {
    ...
    unknownMinister: 'Ukjent minister',
    ministerInterpellationCount: (minister: string, n: number): string => `${minister} — ${n} interpellasjon${n !== 1 ? 'er' : ''}`,
    ...
    unknownMinister: 'Tuntematon ministeri',
    ministerInterpellationCount: (minister: string, n: number): string => `${minister} — ${n} välikysymys${n !== 1 ? 'tä' : ''}`,
  ...
  de: {
    ...
    unknownMinister: 'Unbekannter Minister',
    ministerInterpellationCount: (minister: string, n: number): string => `${minister} — ${n} Interpellation${n !== 1 ? 'en' : ''}`,
  ...
  fr: {
    ...
    unknownMinister: 'Ministre inconnu',
    ministerInterpellationCount: (minister: string, n: number): string => `${minister} — ${n} interpellation${n !== 1 ? 's' : ''}`,
