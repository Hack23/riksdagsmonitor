...
,
    ...
    interpellationDefault: 'Interpelación parlamentaria que exige rendición de cuentas gubernamental.',
...
,
    ...
    interpellationsBreakdown: (n: number): string => `Oppositieleden hebben ${n} interpellaties ingediend om ministeriële verantwoording te eisen.`,
...
,
    ...
    interpellationDefault: 'استجواب برلماني يطالب بالمساءلة الحكومية.',
    interpellationsBreakdown: (n: number): string => `قدم نواب المعارضة ${n} استجواباً يطالبون فيه بمساءلة الوزراء.`,
    ...
    partyInterpellationsFiled: (party: string, n: number): string => `${party}: ${n} استجواب مقدم`,
...
,
    ...
    interpellationDefault: 'אינטרפלציה פרלמנטרית הדורשת אחריותיות ממשלתית.',
    ...
    readFullInterpellation: 'קרא את האינטרפלציה המלאה',
    ...
    partyInterpellationsFiled: (party: string, n: number): string => `${party}: ${n} אינטרפלציות הוגשו`,
...
,
    ...
    interpellationDefault: '政府の説明責任を求める議会質問主意書。',
    interpellationsBreakdown: (n: number): string => `野党議員が${n}件の質問主意書を提出し、大臣の説明責任を求めています。`,
    debateDynamics: '討論の動態と説明責任',
    ministerAccountability: '宛先',
    accountabilityAnalysis: '説明責任分析',
    readFullInterpellation: '質問主意書全文を読む',
...
,
    ...
    interpellationDefault: '정부의 책임을 요구하는 의회 대정부질문.',
    interpellationsBreakdown: (n: number): string => `야당 의원들이 장관의 책임을 요구하는 ${n}개의 대정부 질의를 제출했습니다.`,
    debateDynamics: '토론 역학 및 책임성',
    ministerAccountability: '수신자',
    accountabilityAnalysis: '책임성 분석',
    readFullInterpellation: '전체 대정부 질의 읽기',
    ...
    partyInterpellationsFiled: (party: string, n: number): string => `${party}: ${n}건의 대정부 질의 제출`,
...
,
    noInterpellations: '目前没有质询可用。',
    interpellationDefault: '要求政府问责的议会质询。',
    interpellationsBreakdown: (n: number): string => `反对党议员提交了${n}项质询，要求追究部长责任。`,
