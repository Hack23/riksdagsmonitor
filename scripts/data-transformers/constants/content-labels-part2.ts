...
,
    ...
    ministerAccountabilityContext: (n: number): string => `${n} ministers worden geconfronteerd met parlementaire interpellaties in deze periode, wat de controlepriorititeiten van de oppositie benadrukt.`,
    targetMinister: 'Doelminister',
    interpellationBy: 'Ingediend door',
    questioner: 'Vraagsteller',
    oppositionOversight: 'Analysse van oppositioneel toezicht',
