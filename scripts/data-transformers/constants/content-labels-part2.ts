...
export const CONTENT_LABELS_PART2: Partial<Record<string, ContentLabelSet>> = {
  es: {
    ...
    unknownMinister: 'Ministro desconocido',
    ministerInterpellationCount: (minister: string, n: number): string => `${minister} — ${n} interpelación${n !== 1 ? 'es' : ''}`,
  ...
  nl: {
    ...
    unknownMinister: 'Onbekende minister',
    ministerInterpellationCount: (minister: string, n: number): string => `${minister} — ${n} interpellatie${n !== 1 ? 's' : ''}`,
  ...
  ar: {
    ...
    unknownMinister: 'وزير غير معروف',
    ministerInterpellationCount: (minister: string, n: number): string => `${minister} — ${n} استجواب${n !== 1 ? 'ات' : ''}`,
  ...
  he: {
    ...
    unknownMinister: 'שר לא ידוע',
    ministerInterpellationCount: (minister: string, n: number): string => `${minister} — ${n} אינטרפלצי${n !== 1 ? 'ות' : 'ה'}`,
  ...
  ja: {
    ...
    unknownMinister: '不明な大臣',
    ministerInterpellationCount: (minister: string, n: number): string => `${minister} — ${n}件の質問主意書`,
  ...
  ko: {
    ...
    unknownMinister: '알 수 없는 장관',
    ministerInterpellationCount: (minister: string, n: number): string => `${minister} — ${n}건의 대정부질문`,
  ...
  zh: {
    ...
    unknownMinister: '未知部长',
    ministerInterpellationCount: (minister: string, n: number): string => `${minister} — ${n}项质询`,
