 ...
 */
function getTitles(lang: Language, _eventCount: number): TitleSet {
  const titles: Record<Language, TitleSet> = {
    en: {
      title: `Month Ahead: Parliamentary Outlook`,
      subtitle: `Month Ahead — AI-generated political intelligence from Sweden's Riksdag`
    },
    sv: {
      title: `Månaden framåt: Parlamentarisk utblick`,
      subtitle: `Månaden framåt — AI-genererad politisk analys från Sveriges riksdag`
    },
    da: {
      title: `Måneden forude: Parlamentarisk udsigt`,
      subtitle: `Måneden forude — AI-genereret politisk analyse fra det svenske parlament`
    },
    no: {
      title: `Måneden fremover: Parlamentarisk utsikt`,
      subtitle: `Måneden fremover — AI-generert politisk analyse fra det svenske parlamentet`
    },
    fi: {
      title: `Kuukausi eteenpäin: Parlamentaarinen näkymä`,
      subtitle: `Kuukausi eteenpäin — tekoälytuotettu poliittinen analyysi Ruotsin valtiopäiviltä`
    },
    de: {
      title: `Monatsausblick: Parlamentarische Vorschau`,
      subtitle: `Monatsausblick — KI-generierte politische Analyse aus dem schwedischen Parlament`
    },
    fr: {
      title: `Mois à venir : Perspective parlementaire`,
      subtitle: `Mois à venir — analyse politique générée par IA du Parlement suédois`
    },
    es: {
      title: `Mes adelante: Perspectiva parlamentaria`,
      subtitle: `Mes adelante — análisis político generado por IA del Parlamento sueco`
    },
    nl: {
      title: `Maand vooruit: Parlementair vooruitzicht`,
      subtitle: `Maand vooruit — AI-gegenereerde politieke analyse uit het Zweedse parlement`
    },
    ar: {
      title: `الشهر القادم: التوقعات البرلمانية`,
      subtitle: `الشهر القادم — تحليل سياسي بالذكاء الاصطناعي من البرلمان السويدي`
    },
    he: {
      title: `החודש הקרוב: תחזית פרלמנטרית`,
      subtitle: `החודש הקרוב — ניתוח פוליטי שנוצר על ידי בינה מלאכותית מהפרלמנט השוודי`
    },
    ja: {
      title: `月間展望：議会見通し`,
      subtitle: `月間展望 — スウェーデン議会のAI生成政治分析`
    },
    ko: {
      title: `월간 전망: 의회 전망`,
      subtitle: `월간 전망 — 스웨덴 의회의 AI 생성 정치 분석`
    },
    zh: {
      title: `月度展望：议会前瞻`,
      subtitle: `月度展望 — 瑞典议会的AI生成政治分析`
    }
  };
