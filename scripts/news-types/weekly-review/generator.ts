...
function getTitles(lang: Language, _documentCount: number): TitleSet {
  const titles: Record<Language, TitleSet> = {
    en: {
      ...
      subtitle: `Weekly Review — AI-generated political intelligence from Sweden's Riksdag`
    },
    sv: {
      title: `Veckans sammanfattning: Riksdagen i retrospektiv`,
      subtitle: `Veckans sammanfattning — AI-genererad politisk analys från Sveriges riksdag`
    },
    da: {
    ...
    no: {
      ...
      subtitle: `Ukentlig gjennomgang — AI-generert politisk analyse fra det svenske parlamentet`
    },
    fi: {
      title: `Viikkokatsaus: Eduskunta jälkikäteen`,
      subtitle: `Viikkokatsaus — tekoälytuotettu poliittinen analyysi Ruotsin valtiopäiviltä`
    },
    de: {
      title: `Wochenrückblick: Parlament in Rückschau`,
      subtitle: `Wochenrückblick — KI-generierte politische Analyse aus dem schwedischen Parlament`
    },
    fr: {
      title: `Revue hebdomadaire : Le Parlement en rétrospective`,
      subtitle: `Revue hebdomadaire — analyse politique générée par IA du Parlement suédois`
    },
    es: {
      title: `Revisión semanal: El Parlamento en retrospectiva`,
      subtitle: `Revisión semanal — análisis político generado por IA del Parlamento sueco`
    },
    nl: {
      title: `Wekelijkse terugblik: Parlement in retrospectief`,
      subtitle: `Wekelijkse terugblik — AI-gegenereerde politieke analyse uit het Zweedse parlement`
    },
    ar: {
      title: `المراجعة الأسبوعية: البرلمان في استعراض`,
      subtitle: `المراجعة الأسبوعية — تحليل سياسي بالذكاء الاصطناعي من البرلمان السويدي`
    },
    he: {
      title: `סקירה שבועית: הפרלמנט בראי`,
      subtitle: `סקירה שבועית — ניתוח פוליטי שנוצר על ידי בינה מלאכותית מהפרלמנט השוודי`
    },
    ja: {
      title: `週間レビュー：議会の振り返り`,
      subtitle: `週間レビュー — スウェーデン議会のAI生成政治分析`
    },
    ko: {
      title: `주간 리뷰: 의회 회고`,
      subtitle: `주간 리뷰 — 스웨덴 의회의 AI 생성 정치 분석`
    },
    zh: {
      title: `每周回顾：议会回顾`,
      subtitle: `每周回顾 — 瑞典议会的AI生成政治分析`
    }
  };
