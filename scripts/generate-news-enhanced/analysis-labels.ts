/**
 * @module generate-news-enhanced/analysis-labels
 * @description Localised label constants and interpolation helpers used by the
 * AI analysis pipeline. Contains all 14-language phrase maps for legislative
 * signals, SWOT quadrants, strategic implications, and key takeaway templates.
 *
 * @license Apache-2.0
 * @author Hack23 AB
 */
...
export type Lang14 = Record<Language, string>;

export function L14(en: string, sv: string, da: string, no: string, fi: string,
...
export function pickLang(map: Lang14, lang: Language): string {
...
export function plural(n: number, lang: Language): string {
...
export function betVerbForm(n: number, lang: Language): string {
...
export function motVerbForm(n: number, lang: Language): string {
...
export const SCRUTINY_SIGNAL: Lang14 = L14(
...
export const EU_ALIGNMENT_SIGNAL: Lang14 = L14(
...
export const GOV_STRENGTH_LABELS: Record<string, Lang14> = {
  propositions: L14(
...
export const OPP_STRENGTH_LABELS: Record<string, Lang14> = {
  committee: L14(
...
export const EU_OPPORTUNITY: Lang14 = L14(
...
export const GOV_WEAKNESS_IMPL: Lang14 = L14(
...
export const GOV_THREAT_EXEC: Lang14 = L14(
...
export const OPP_WEAKNESS_INFO: Lang14 = L14(
...
export const OPP_OPPORTUNITY_CONSENSUS: Lang14 = L14(
...
export const OPP_THREAT_MAJORITY: Lang14 = L14(
...
export const PRIVATE_STRENGTH_DOMAIN: Lang14 = L14(
...
export const PRIVATE_WEAKNESS_COMPLIANCE: Lang14 = L14(
...
export const PRIVATE_OPPORTUNITY_INVESTMENT: Lang14 = L14(
...
export const PRIVATE_THREAT_UNCERTAINTY: Lang14 = L14(
...
export const STRATEGIC_IMPL_TEMPLATES: Record<string, Lang14> = {
  legislative: L14(
...
export const SIGNAL_GOVT_AGENDA: Lang14 = L14(
...
export const SIGNAL_PARL_SCRUTINY: Lang14 = L14(
...
export const SIGNAL_BALANCED: Lang14 = L14(
...
export const SIGNAL_PRESS: Lang14 = L14(
...
export const SIGNAL_EXTERNAL: Lang14 = L14(
...
export const TYPE_DESC_PRESS: Lang14 = L14(
...
export const TYPE_DESC_EXTERNAL: Lang14 = L14(
...
export const TYPE_DESC_REGULATORY: Lang14 = L14(
...
export const SIGNAL_SNAPSHOT: Lang14 = L14(
...
export const TAKEAWAY_EU: Lang14 = L14(
...
export const TAKEAWAY_ENRICHED: Lang14 = L14(
...
export const TAKEAWAY_COALITION_STRESS: Lang14 = L14(
