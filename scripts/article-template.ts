 ...
 * @license Apache-2.0
 */
export { generateArticleHTML, generateEventCalendar, generateWatchSection, generateArticleLanguageSwitcher, generateSiteFooter, fixHtmlNesting, stripSwedishBoilerplate, default } from './article-template/index.js';
