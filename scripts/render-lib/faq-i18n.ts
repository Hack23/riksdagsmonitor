...
export const FAQ_I18N: Record<Language, FAQCatalogues> = {
  en: {
    sitemap: [
      ...
      { question: 'How do I switch languages?', answer: 'Use the language switcher in the header or the flag links at the bottom of every section. Each of the 14 supported languages has its own sitemap_${lang}.html with `hreflang` annotations.' },
      ...
      { question: 'Are the article sources auditable?', answer: 'Yes. Every article links to the underlying analysis artifacts on GitHub (analysis/daily/${date}/${stream}/) so any reader can audit the OSINT chain end-to-end.' },
    ],
    politicalIntelligence: [
      ...
      { question: 'How are the analyses generated?', answer: 'Each analysis follows the AI-FIRST principle: a Claude-Opus / Sonnet agent produces a first-pass analysis and then re-reads the entire output to refine every section. Minimum two complete iterations are required before publishing.' },
    ...
    newsIndex: [
      { question: 'How are these articles generated?', answer: 'Each article is produced by an agentic workflow that runs the AI-FIRST pipeline against analysis artifacts published under analysis/daily/${date}/. The full prompt contract lives in .github/prompts/.' },
      ...
      { question: 'Are the sources verifiable?', answer: 'Yes. Every article links to its underlying analysis artifacts on GitHub (analysis/daily/${date}/${stream}/) and cites Riksdag/Regering/Myndigheter primary sources with stable IDs.' },
    ],
  },
  ...
  sv: {
    sitemap: [
      ...
      { question: 'Hur byter jag språk?', answer: 'Använd språkväljaren i sidhuvudet eller flagglänkarna längst ned i varje sektion. Var och en av de 14 språken har en egen sitemap_${lang}.html med hreflang-attribut.' },
      ...
      { question: 'Går artiklarnas källor att granska?', answer: 'Ja. Varje artikel länkar till de underliggande analys-artefakterna på GitHub (analysis/daily/${datum}/${stream}/) så vem som helst kan granska OSINT-kedjan från början till slut.' },
    ],
    politicalIntelligence: [
      ...
      { question: 'Hur produceras analyserna?', answer: 'Varje analys följer AI-FIRST-principen: en Claude-Opus/Sonnet-agent gör en första analys och läser sedan om hela produkten för att förfina varje avsnitt. Minst två kompletta iterationer krävs före publicering.' },
    ...
    newsIndex: [
      { question: 'Hur skapas dessa artiklar?', answer: 'Varje artikel produceras av ett agentiskt arbetsflöde som kör AI-FIRST-pipen mot analys-artefakter under analysis/daily/${datum}/. Det fullständiga promptkontraktet finns i .github/prompts/.' },
      ...
      { question: 'Är källorna verifierbara?', answer: 'Ja. Varje artikel länkar till sina analys-artefakter på GitHub (analysis/daily/${datum}/${stream}/) och citerar primärkällor från riksdag, regering och myndigheter med stabila ID:n.' },
    ],
  },
  ...
  da: {
    sitemap: [
      ...
      { question: 'Hvordan skifter jeg sprog?', answer: 'Brug sprogvælgeren i sidehovedet eller flaglinkene nederst i hver sektion. Hvert af de 14 understøttede sprog har sin egen sitemap_${lang}.html med hreflang-annoteringer.' },
      ...
      { question: 'Kan artiklernes kilder kontrolleres?', answer: 'Ja. Hver artikel linker til de underliggende analyseartefakter på GitHub (analysis/daily/${dato}/${stream}/) så enhver læser kan revidere OSINT-kæden ende-til-ende.' },
    ],
    politicalIntelligence: [
      ...
      { question: 'Hvordan genereres analyserne?', answer: 'Hver analyse følger AI-FIRST-princippet: en Claude-Opus/Sonnet-agent producerer en første analyse og genlæser derefter hele outputtet for at forfine hvert afsnit. Mindst to fulde iterationer kræves før publicering.' },
    ...
    newsIndex: [
      { question: 'Hvordan genereres disse artikler?', answer: 'Hver artikel produceres af et agentbaseret workflow som kører AI-FIRST-pipen mod analyseartefakter under analysis/daily/${dato}/. Den fulde promptkontrakt ligger i .github/prompts/.' },
      ...
      { question: 'Er kilderne verificerbare?', answer: 'Ja. Hver artikel linker til sine analyseartefakter på GitHub (analysis/daily/${dato}/${stream}/) og citerer primære kilder fra Rigsdag, Regering og myndigheder med stabile ID-er.' },
    ],
  },
  ...
  no: {
    sitemap: [
      ...
      { question: 'Kan artikkelkildene revideres?', answer: 'Ja. Hver artikkel lenker til de underliggende analyseartefaktene på GitHub (analysis/daily/${dato}/${stream}/) slik at enhver leser kan revidere OSINT-kjeden ende-til-ende.' },
    ],
    politicalIntelligence: [
      ...
      { question: 'Hvordan produseres analysene?', answer: 'Hver analyse følger AI-FIRST-prinsippet: en Claude-Opus/Sonnet-agent produserer en første analyse og leser deretter hele resultatet for å forbedre hvert avsnitt. Minst to fulle iterasjoner kreves.' },
    ...
    newsIndex: [
      { question: 'Hvordan genereres disse artiklene?', answer: 'Hver artikkel produseres av en agentbasert arbeidsflyt som kjører AI-FIRST-piplinen mot analyseartefakter under analysis/daily/${dato}/. Den fulle promptkontrakten ligger i .github/prompts/.' },
      ...
      { question: 'Er kildene verifiserbare?', answer: 'Ja. Hver artikkel lenker til sine analyseartefakter på GitHub (analysis/daily/${dato}/${stream}/) og siterer primærkilder fra Riksdag, Regjering og myndigheter med stabile ID-er.' },
    ],
  },
    ...
    sitemap: [
      ...
      { question: 'Kuinka vaihdan kieltä?', answer: 'Käytä otsikon kielenvalitsinta tai kunkin osion alalaidan lippulinkkejä. Jokaisella 14 tuetusta kielestä on oma sitemap_${lang}.html-sivu hreflang-merkinnöin.' },
      ...
      { question: 'Voiko artikkelien lähteet tarkistaa?', answer: 'Kyllä. Jokainen artikkeli linkittää taustalla oleviin analyysiartefakteihin GitHubissa (analysis/daily/${pvm}/${stream}/), joten kuka tahansa lukija voi tarkistaa OSINT-ketjun.' },
    ],
    politicalIntelligence: [
      ...
      { question: 'Miten analyysit tuotetaan?', answer: 'Jokainen analyysi noudattaa AI-FIRST-periaatetta: Claude-Opus/Sonnet-agentti tuottaa ensimmäisen analyysin ja lukee koko tuloksen uudelleen jalostaakseen jokaista osaa. Vähintään kaksi täyttä iteraatiota vaaditaan.' },
    ...
    newsIndex: [
      { question: 'Miten artikkelit syntyvät?', answer: 'Jokainen artikkeli tuotetaan agenttipohjaisella työnkululla, joka ajaa AI-FIRST-putken analyysiartefakteja vastaan polusta analysis/daily/${pvm}/. Promptisopimus on .github/prompts/-kansiossa.' },
      ...
      { question: 'Ovatko lähteet todennettavissa?', answer: 'Kyllä. Jokainen artikkeli linkittää analyysiartefakteihinsa GitHubissa (analysis/daily/${pvm}/${stream}/) ja viittaa Valtiopäivien, hallituksen ja viranomaisten ensisijaisiin lähteisiin.' },
    ],
  },
  ...
  de: {
    sitemap: [
      ...
      { question: 'Wie wechsle ich die Sprache?', answer: 'Nutzen Sie den Sprachwechsler im Header oder die Flaggen-Links am Ende jeder Sektion. Jede der 14 unterstützten Sprachen hat ihre eigene sitemap_${lang}.html mit hreflang-Annotationen.' },
      ...
      { question: 'Sind die Artikelquellen prüfbar?', answer: 'Ja. Jeder Artikel verlinkt auf die zugrundeliegenden Analyse-Artefakte auf GitHub (analysis/daily/${datum}/${stream}/), sodass jeder Leser die OSINT-Kette nachvollziehen kann.' },
    ],
    politicalIntelligence: [
      ...
      { question: 'Wie werden die Analysen erstellt?', answer: 'Jede Analyse folgt dem AI-FIRST-Prinzip: ein Claude-Opus/Sonnet-Agent erstellt eine erste Fassung und liest dann das gesamte Ergebnis erneut, um jeden Abschnitt zu verfeinern. Mindestens zwei vollständige Iterationen sind erforderlich.' },
    ...
    newsIndex: [
      { question: 'Wie entstehen diese Artikel?', answer: 'Jeder Artikel wird von einem agentischen Workflow erzeugt, der die AI-FIRST-Pipeline gegen Analyse-Artefakte unter analysis/daily/${datum}/ ausführt. Der vollständige Prompt-Vertrag liegt in .github/prompts/.' },
      ...
      { question: 'Sind die Quellen verifizierbar?', answer: 'Ja. Jeder Artikel verlinkt auf seine Analyse-Artefakte auf GitHub (analysis/daily/${datum}/${stream}/) und zitiert Primärquellen von Riksdag, Regering und Behörden mit stabilen IDs.' },
    ],
  },
  ...
  fr: {
    sitemap: [
      ...
      { question: 'Comment changer de langue ?', answer: 'Utilisez le sélecteur de langue dans l\'en-tête ou les liens drapeaux au bas de chaque section. Chacune des 14 langues prises en charge possède son propre sitemap_${lang}.html avec annotations hreflang.' },
      ...
      { question: 'Les sources des articles sont-elles vérifiables ?', answer: 'Oui. Chaque article renvoie aux artefacts d\'analyse sous-jacents sur GitHub (analysis/daily/${date}/${stream}/), permettant à tout lecteur d\'auditer la chaîne OSINT de bout en bout.' },
    ],
    politicalIntelligence: [
      ...
      { question: 'Comment sont produites les analyses ?', answer: 'Chaque analyse suit le principe AI-FIRST : un agent Claude-Opus/Sonnet produit une première analyse puis relit l\'intégralité du résultat pour affiner chaque section. Deux itérations complètes minimum sont requises.' },
    ...
    newsIndex: [
      { question: 'Comment ces articles sont-ils générés ?', answer: 'Chaque article est produit par un workflow agentique qui exécute le pipeline AI-FIRST sur les artefacts d\'analyse publiés sous analysis/daily/${date}/. Le contrat de prompt complet est dans .github/prompts/.' },
      ...
      { question: 'Les sources sont-elles vérifiables ?', answer: 'Oui. Chaque article renvoie à ses artefacts d\'analyse sur GitHub (analysis/daily/${date}/${stream}/) et cite les sources primaires du Riksdag, de la Regering et des agences avec des ID stables.' },
    ],
  },
  ...
  es: {
    sitemap: [
      ...
      { question: '¿Cómo cambio de idioma?', answer: 'Use el selector de idioma de la cabecera o los enlaces con bandera al pie de cada sección. Cada uno de los 14 idiomas soportados tiene su propio sitemap_${lang}.html con anotaciones hreflang.' },
      ...
      { question: '¿Son auditables las fuentes de los artículos?', answer: 'Sí. Cada artículo enlaza a los artefactos de análisis subyacentes en GitHub (analysis/daily/${fecha}/${stream}/), permitiendo a cualquier lector auditar la cadena OSINT de extremo a extremo.' },
    ],
    politicalIntelligence: [
      ...
      { question: '¿Cómo se generan los análisis?', answer: 'Cada análisis sigue el principio AI-FIRST: un agente Claude-Opus/Sonnet produce un primer análisis y luego relee toda la salida para refinar cada sección. Se requieren al menos dos iteraciones completas.' },
    ...
    newsIndex: [
      { question: '¿Cómo se generan estos artículos?', answer: 'Cada artículo es producido por un flujo de trabajo agéntico que ejecuta la canalización AI-FIRST contra los artefactos de análisis publicados en analysis/daily/${fecha}/. El contrato completo de prompts está en .github/prompts/.' },
      ...
      { question: '¿Son verificables las fuentes?', answer: 'Sí. Cada artículo enlaza a sus artefactos de análisis en GitHub (analysis/daily/${fecha}/${stream}/) y cita fuentes primarias del Riksdag, la Regering y agencias con identificadores estables.' },
    ],
  },
  ...
  nl: {
    sitemap: [
      ...
      { question: 'Hoe wissel ik van taal?', answer: 'Gebruik de taalkiezer in de header of de vlaglinks onderaan elke sectie. Elk van de 14 ondersteunde talen heeft zijn eigen sitemap_${lang}.html met hreflang-annotaties.' },
      ...
      { question: 'Zijn de bronnen van artikelen controleerbaar?', answer: 'Ja. Elk artikel linkt naar de onderliggende analyse-artefacten op GitHub (analysis/daily/${datum}/${stream}/), zodat elke lezer de OSINT-keten kan controleren.' },
    ],
    politicalIntelligence: [
      ...
      { question: 'Hoe worden de analyses gemaakt?', answer: 'Elke analyse volgt het AI-FIRST-principe: een Claude-Opus/Sonnet-agent maakt een eerste analyse en leest vervolgens de hele output opnieuw om elke sectie te verfijnen. Minimaal twee complete iteraties zijn vereist.' },
    ...
    newsIndex: [
      { question: 'Hoe worden deze artikelen gegenereerd?', answer: 'Elk artikel wordt geproduceerd door een agentische workflow die de AI-FIRST-pijplijn uitvoert tegen analyse-artefacten onder analysis/daily/${datum}/. Het volledige promptcontract staat in .github/prompts/.' },
      ...
      { question: 'Zijn de bronnen verifieerbaar?', answer: 'Ja. Elk artikel linkt naar zijn analyse-artefacten op GitHub (analysis/daily/${datum}/${stream}/) en citeert primaire bronnen van Riksdag, Regering en agentschappen met stabiele ID\'s.' },
    ],
  },
  ...
  ar: {
    sitemap: [
      ...
      { question: 'كيف أغير اللغة؟', answer: 'استخدم محدد اللغة في الرأس أو روابط الأعلام في أسفل كل قسم. كل من اللغات الـ14 المدعومة لها sitemap_${lang}.html خاص بها مع تعليقات hreflang.' },
      ...
      { question: 'هل مصادر المقالات قابلة للتدقيق؟', answer: 'نعم. كل مقال يرتبط بمصنوعات التحليل الأساسية على GitHub (analysis/daily/${التاريخ}/${stream}/) مما يسمح لأي قارئ بتدقيق سلسلة OSINT.' },
    ],
    politicalIntelligence: [
      ...
      { question: 'كيف يتم إنشاء التحليلات؟', answer: 'يتبع كل تحليل مبدأ AI-FIRST: ينتج وكيل Claude-Opus/Sonnet تحليلًا أوليًا ثم يعيد قراءة الناتج بالكامل لتحسين كل قسم. مطلوب تكراران كاملان على الأقل.' },
    ...
    newsIndex: [
      { question: 'كيف تُنشأ هذه المقالات؟', answer: 'يُنتج كل مقال بواسطة سير عمل وكيل يدير خط أنابيب AI-FIRST مقابل مصنوعات التحليل المنشورة تحت analysis/daily/${التاريخ}/. عقد المطالبة الكامل في .github/prompts/.' },
      ...
      { question: 'هل المصادر قابلة للتحقق؟', answer: 'نعم. كل مقال يرتبط بمصنوعات التحليل على GitHub (analysis/daily/${التاريخ}/${stream}/) ويستشهد بمصادر أولية من البرلمان والحكومة والوكالات بمعرفات مستقرة.' },
    ],
  },
  ...
  he: {
    sitemap: [
      ...
      { question: 'כיצד אחליף שפה?', answer: 'השתמשו בבורר השפה בכותרת או בקישורי הדגלים בתחתית כל מקטע. לכל אחת מ-14 השפות הנתמכות יש sitemap_${lang}.html משלה עם אנוטציות hreflang.' },
      ...
      { question: 'האם מקורות המאמרים ניתנים לאימות?', answer: 'כן. כל מאמר מקשר למוצרי הניתוח הבסיסיים ב-GitHub (analysis/daily/${תאריך}/${stream}/) כך שכל קורא יכול לבדוק את שרשרת OSINT.' },
    ],
    politicalIntelligence: [
      ...
      { question: 'כיצד מופקים הניתוחים?', answer: 'כל ניתוח עוקב אחר עקרון AI-FIRST: סוכן Claude-Opus/Sonnet מפיק ניתוח ראשוני ולאחר מכן קורא מחדש את כל הפלט כדי לחדד כל סעיף. נדרשות לפחות שתי איטרציות מלאות.' },
    ...
    newsIndex: [
      { question: 'כיצד נוצרים המאמרים האלה?', answer: 'כל מאמר מופק על ידי תהליך סוכן המריץ את צינור ה-AI-FIRST כנגד פריטי הניתוח שפורסמו תחת analysis/daily/${תאריך}/. חוזה הנחיה מלא ב-.github/prompts/.' },
      ...
      { question: 'האם המקורות ניתנים לאימות?', answer: 'כן. כל מאמר מקשר למוצרי הניתוח שלו ב-GitHub (analysis/daily/${תאריך}/${stream}/) ומצטט מקורות ראשוניים מהפרלמנט, הממשלה והסוכנויות עם מזהים יציבים.' },
    ],
  },
  ...
  ja: {
    sitemap: [
      ...
      { question: '言語の切り替え方は？', answer: 'ヘッダーの言語切替または各セクション下部の国旗リンクを使用してください。サポートされている14言語それぞれに、hreflang注釈付きのsitemap_${lang}.htmlがあります。' },
      ...
      { question: '記事の出典は監査可能ですか？', answer: 'はい。各記事はGitHub上の基となる分析アーティファクト（analysis/daily/${日付}/${stream}/）にリンクしており、誰でもOSINTチェーンを最初から最後まで監査できます。' },
    ],
    politicalIntelligence: [
      { question: '政治インテリジェンスとは？', answer: '政治インテリジェンスとは、議会および政府活動に関する公開ソース情報を体系的に収集、分析、報告することで、ここではスウェーデン議会と政府に適用されています。' },
      { question: '分析はどのように生成されますか？', answer: '各分析はAI-FIRST原則に従います。Claude-Opus/Sonnetエージェントが初稿を作成し、その後出力全体を再読して各セクションを洗練します。最低2回の完全な反復が必要です。' },
    ...
    newsIndex: [
      { question: 'これらの記事はどのように生成されますか？', answer: '各記事は、analysis/daily/${日付}/配下の分析アーティファクトに対してAI-FIRSTパイプラインを実行するエージェントワークフローによって生成されます。完全なプロンプト契約は.github/prompts/にあります。' },
      ...
      { question: '出典は検証可能ですか？', answer: 'はい。各記事はGitHub上の分析アーティファクト（analysis/daily/${日付}/${stream}/）にリンクし、議会、政府、機関の一次資料を安定したIDで引用しています。' },
    ],
  },
  ...
  ko: {
    sitemap: [
      ...
      { question: '언어를 어떻게 변경하나요?', answer: '헤더의 언어 선택기 또는 각 섹션 하단의 국기 링크를 사용하세요. 지원되는 14개 언어 각각에 hreflang 주석이 포함된 sitemap_${lang}.html이 있습니다.' },
      ...
      { question: '기사의 출처는 감사 가능한가요?', answer: '예. 각 기사는 GitHub의 기본 분석 아티팩트(analysis/daily/${날짜}/${stream}/)에 연결되어 있어 모든 독자가 OSINT 체인을 처음부터 끝까지 감사할 수 있습니다.' },
    ],
    politicalIntelligence: [
      { question: '정치 정보란 무엇인가요?', answer: '정치 정보란 의회 및 정부 활동에 관한 공개 소스 정보의 체계적 수집, 분석, 보고이며, 여기서는 스웨덴 의회 및 정부에 적용됩니다.' },
      { question: '분석은 어떻게 생성되나요?', answer: '각 분석은 AI-FIRST 원칙을 따릅니다. Claude-Opus/Sonnet 에이전트가 첫 번째 분석을 생성한 다음 전체 출력을 다시 읽어 각 섹션을 다듬습니다. 최소 두 번의 완전한 반복이 필요합니다.' },
    ...
    newsIndex: [
      { question: '이 기사들은 어떻게 생성되나요?', answer: '각 기사는 analysis/daily/${날짜}/ 아래에 게시된 분석 아티팩트에 대해 AI-FIRST 파이프라인을 실행하는 에이전트 워크플로에 의해 생성됩니다. 전체 프롬프트 계약은 .github/prompts/에 있습니다.' },
      ...
      { question: '출처는 검증 가능한가요?', answer: '예. 각 기사는 GitHub의 분석 아티팩트(analysis/daily/${날짜}/${stream}/)에 연결되며 의회, 정부, 기관의 1차 출처를 안정적인 ID로 인용합니다.' },
    ],
  },
  ...
  zh: {
    sitemap: [
      ...
      { question: '如何切换语言？', answer: '使用头部的语言选择器或每个部分底部的国旗链接。支持的14种语言中每一种都有自己的 sitemap_${lang}.html，带有 hreflang 注释。' },
      { question: '在哪里可以找到 XML 站点地图？', answer: '机器可读的 XML 站点地图位于 /sitemap.xml，爬虫指令位于 /robots.txt。两者都从上方"附加资源"部分链接。' },
      { question: '文章来源可审计吗？', answer: '是的。每篇文章都链接到 GitHub 上的底层分析产物（analysis/daily/${日期}/${stream}/），使任何读者都能端到端审计 OSINT 链。' },
    ],
    politicalIntelligence: [
      { question: '什么是政治情报？', answer: '政治情报是对议会和政府活动的公开来源信息进行系统收集、分析和报告 — 此处应用于瑞典议会和政府。' },
      { question: '如何生成分析？', answer: '每项分析遵循 AI-FIRST 原则：Claude-Opus/Sonnet 代理生成初次分析，然后重新阅读整个输出以完善每个部分。至少需要两次完整迭代。' },
    ...
    newsIndex: [
      { question: '这些文章是如何生成的？', answer: '每篇文章由代理工作流生成，该工作流针对 analysis/daily/${日期}/ 下发布的分析产物运行 AI-FIRST 管道。完整的提示合约位于 .github/prompts/。' },
      ...
      { question: '来源可验证吗？', answer: '是的。每篇文章都链接到 GitHub 上的分析产物（analysis/daily/${日期}/${stream}/），并以稳定的 ID 引用议会、政府和机构的主要来源。' },
    ],
  },
};
