...
// ---------------------------------------------------------------------------
// Language configuration (14 languages – verbatim i18n)
// ---------------------------------------------------------------------------
...
const AVAILABLE_IN_TRANSLATIONS: Record<string, string> = {
 ...
 */
function generateLanguageBadge(lang: string, isRTL: boolean = false): string {
 ...
 */
function generateLanguageSwitcherNav(currentLang: string): string {
 ...
 */
function generateAvailableLanguages(languages: string[], currentLang: string): string {
 ...
 */
function parseArticleMetadata(filePath: string): NewsArticleMetadata | null {
  try {
 ...
 */
function normalizeDateString(dateStr: string | null): string {
 ...
 */
function extractFromFilename(fileName: string): string {
 ...
 */
function classifyArticleType(content: string, fileName: string): ArticleTypeValue {
 ...
 */
function scanNewsArticles(): Record<string, NewsArticleMetadata[]> {
 ...
 */
function buildSlugToLanguagesMap(articlesByLang: Record<string, NewsArticleMetadata[]>): Record<string, string[]> {
 ...
 */
function getAllArticlesWithLanguageInfo(articlesByLang: Record<string, NewsArticleMetadata[]>): NewsArticleMetadata[] {
 ...
 */
function generateRTLStyles(isRTL: boolean | undefined): string {
  if (!isRTL) return '';
 ...
 */
function generateLanguageNotice(langKey: string): string {
 ...
 */
function generateAllIndexes(): GenerationResult {
