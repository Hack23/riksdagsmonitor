...
export const LANGUAGES: Record<LanguageCode, LanguageConfig> = {
  en: {
    ...
    i18n: { noArticles: 'No articles available', search: 'Search:', searchPlaceholder: 'Search articles...', loadMore: 'Load more articles', showing: 'Showing {shown} of {total} articles', totalArticles: 'Total articles: {total}' },
  ...
  sv: {
    ...
    i18n: { noArticles: 'Inga artiklar tillgängliga', search: 'Sök:', searchPlaceholder: 'Sök artiklar...', loadMore: 'Ladda fler artiklar', showing: 'Visar {shown} av {total} artiklar', totalArticles: 'Totalt antal artiklar: {total}' },
  ...
  da: {
    ...
    i18n: { noArticles: 'Ingen artikler tilgængelige', search: 'Søg:', searchPlaceholder: 'Søg artikler...', loadMore: 'Indlæs flere artikler', showing: 'Viser {shown} af {total} artikler', totalArticles: 'Samlet antal artikler: {total}' },
  ...
  no: {
    ...
    i18n: { noArticles: 'Ingen artikler tilgjengelige', search: 'Søk:', searchPlaceholder: 'Søk artikler...', loadMore: 'Last flere artikler', showing: 'Viser {shown} av {total} artikler', totalArticles: 'Totalt antall artikler: {total}' },
    ...
    i18n: { noArticles: 'Ei artikkeleita saatavilla', search: 'Haku:', searchPlaceholder: 'Hae artikkeleita...', loadMore: 'Lataa lisää artikkeleita', showing: 'Näytetään {shown} / {total} artikkelia', totalArticles: 'Artikkeleita yhteensä: {total}' },
  ...
  de: {
    ...
    i18n: { noArticles: 'Keine Artikel verfügbar', search: 'Suche:', searchPlaceholder: 'Artikel suchen...', loadMore: 'Mehr Artikel laden', showing: 'Zeige {shown} von {total} Artikeln', totalArticles: 'Artikel insgesamt: {total}' },
  ...
  fr: {
    ...
    i18n: { noArticles: 'Aucun article disponible', search: 'Recherche :', searchPlaceholder: 'Rechercher des articles...', loadMore: 'Charger plus d\'articles', showing: 'Affichage de {shown} sur {total} articles', totalArticles: 'Total des articles : {total}' },
  ...
  es: {
    ...
    i18n: { noArticles: 'No hay artículos disponibles', search: 'Buscar:', searchPlaceholder: 'Buscar artículos...', loadMore: 'Cargar más artículos', showing: 'Mostrando {shown} de {total} artículos', totalArticles: 'Total de artículos: {total}' },
  ...
  nl: {
    ...
    i18n: { noArticles: 'Geen artikelen beschikbaar', search: 'Zoeken:', searchPlaceholder: 'Artikelen zoeken...', loadMore: 'Meer artikelen laden', showing: 'Toon {shown} van {total} artikelen', totalArticles: 'Totaal aantal artikelen: {total}' },
  ...
  ar: {
    ...
    i18n: { noArticles: 'لا توجد مقالات متاحة', search: 'بحث:', searchPlaceholder: 'ابحث في المقالات...', loadMore: 'تحميل المزيد من المقالات', showing: 'عرض {shown} من {total} مقالات', totalArticles: 'إجمالي المقالات: {total}' },
  ...
  he: {
    ...
    i18n: { noArticles: 'אין מאמרים זמינים', search: 'חיפוש:', searchPlaceholder: 'חפש מאמרים...', loadMore: 'טען עוד מאמרים', showing: 'מציג {shown} מתוך {total} מאמרים', totalArticles: 'סך כל המאמרים: {total}' },
  ...
  ja: {
    ...
    i18n: { noArticles: '記事がありません', search: '検索：', searchPlaceholder: '記事を検索...', loadMore: 'さらに記事を読み込む', showing: '{shown} / {total} 件の記事', totalArticles: '記事総数：{total}' },
  ...
  ko: {
    ...
    i18n: { noArticles: '기사가 없습니다', search: '검색:', searchPlaceholder: '기사 검색...', loadMore: '더 많은 기사 불러오기', showing: '{shown} / {total} 개 기사', totalArticles: '전체 기사 수: {total}' },
  ...
  zh: {
    ...
    i18n: { noArticles: '没有可用的文章', search: '搜索：', searchPlaceholder: '搜索文章...', loadMore: '加载更多文章', showing: '显示 {shown} / {total} 篇文章', totalArticles: '文章总数：{total}' },
