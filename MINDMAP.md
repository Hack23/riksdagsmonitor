...
> - Mindmaps expanded to explicitly enumerate the **15 CIA data subsystems** (anomaly, coalition, committee, distribution, election, election-cycle, ministry, parties, party, percentile, politician, pre-election, risk, seasonal, voting), **14 agentic news workflows**, **24 Copilot agents**, **93 skills**, **8 MCP servers**, **14 languages**, and the **dual distribution model** (static site + `riksdagsmonitor` npm package with SLSA provenance).
> - Added mindmap branch for toolchain: Node.js ≥26, TypeScript 6.0.3, Vite 8.0.10, Vitest 4.1.5, ESLint 10.2.1, Cypress 15.14.0, Playwright 1.59.1, typedoc 0.28.19.
