...
> - Documented schema governance scripts under `scripts/`: `sync-cia-schemas`, `validate-against-cia-schemas`, `check-cia-schema-updates`, `generate-types-from-cia-schemas` (all Node 26 native TypeScript modules).
