...
### Aggregation & prospective workflows (Tier-C, 23-artifact contract; long-horizon variants add `cycle-trajectory.md` for the cycle workflow)
...
| 11 | [`news-election-cycle.md`](news-election-cycle.md) | _generated by `gh aw compile`_ | `workflow_dispatch` (cron `0 9 13 3,9 *` declared but disabled until runtime measured) | Full 4-year mandate; current Tidö + next post-2026 cycle; 24-artifact contract incl. `cycle-trajectory.md`; × 2.5 |
