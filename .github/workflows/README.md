...
| 9 | [`news-quarter-ahead.md`](news-quarter-ahead.md) | _generated by `gh aw compile`_ | 1st + 15th of month 09:00 UTC | 90-day parliamentary-season + Riksbank/SCB calendar; long-horizon-forecasting × 1.7 |
| 10 | [`news-year-ahead.md`](news-year-ahead.md) | _generated by `gh aw compile`_ | 5 Jan + 5 Jul 09:00 UTC | 365-day annual outlook anchored in IMF WEO Apr/Oct vintage; PESTLE blocking; × 2.0 |
| 11 | [`news-election-cycle.md`](news-election-cycle.md) | _generated by `gh aw compile`_ | `workflow_dispatch` (cron `0 9 13 3,9 *` declared but disabled until runtime measured) | Full 4-year mandate; current Tidö + next post-2026 cycle; 28-artifact contract (23 + 5 blocking supplementary via LH-4 + LH-5); × 2.5 |
