...
| **Total** | **50** | Verify with `ls .github/workflows/ | wc -l` (excludes this `README.md`) |
...
### Aggregation & prospective workflows (Tier-C, 23-artifact baseline; year-ahead adds pestle-analysis.md = 24; election-cycle adds 5 supplementary = 28)
...
| 10 | [`news-year-ahead.md`](news-year-ahead.md) | [`news-year-ahead.lock.yml`](news-year-ahead.lock.yml) | 5 Jan + 5 Jul 09:00 UTC | 365-day annual outlook anchored in IMF WEO Apr/Oct vintage; PESTLE blocking; × 2.0 |
