...
2. If you get **"unknown tool"** or **"0 tools registered"** errors, this means the MCP server is still initializing after a Render.com cold start. Wait 45s and retry. After 3 consecutive failures, run MCP gateway diagnostics:
```bash
