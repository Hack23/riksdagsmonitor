...
|----------|-------|-------------|-------------------|
| **[Architecture](ARCHITECTURE.md)** | 🏛️ Architecture | C4 model showing system structure | [View Source](https://github.com/Hack23/riksdagsmonitor/blob/main/ARCHITECTURE.md) |
| **[Workflows](WORKFLOWS.md)** | 🔧 DevOps | CI/CD automation processes | [View Source](https://github.com/Hack23/riksdagsmonitor/blob/main/WORKFLOWS.md) |
| **[Threat Model](THREAT_MODEL.md)** | 🛡️ Security | State transition risk assessment | [View Source](https://github.com/Hack23/riksdagsmonitor/blob/main/THREAT_MODEL.md) |
| **[State Diagrams](STATEDIAGRAM.md)** | 🔄 Behavior | System state transitions (this doc) | [View Source](https://github.com/Hack23/riksdagsmonitor/blob/main/STATEDIAGRAM.md) |
...
- [ISO/IEC 25010:2011](https://iso25000.com/index.php/en/iso-25000-standards/iso-25010) - Software quality
