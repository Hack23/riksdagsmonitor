# Riksdagsmonitor News Articles

This directory contains analytical journalism articles about Swedish parliamentary activity.
...
All articles in this directory follow:

- **Journalism Ethics**: Accuracy, balance, fairness, transparency
- **Editorial Standards**: The Economist style guide, AP/Reuters conventions
...
- **YAML Front Matter** (HTML comment) - Metadata for automation
- **Semantic HTML5** - Proper document structure (header, article, section, footer)
- **Meta Tags** - SEO optimization (description, keywords)
- **Hreflang Links** - Cross-language navigation
- **Source Citations** - Footer with all references
