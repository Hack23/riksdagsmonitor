 ...
 */
// Party mention extraction moved to shared module: scripts/party-variants.js
// This prevents duplication between tests and validation script
...
describe('Multi-Language Quality Tests', () => {
  ...
  it('should have consistent structure across languages', () => {
    ...
    if (structures.length >= 2) {
      ...
      const allConsistent = structures.every(s => s.hasSections === firstHasSections);
