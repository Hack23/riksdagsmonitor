 ...
 *
 * NOTE: When using vi.mock() in the same test file, inline the mock data
 * instead of importing from this fixture to avoid Vite module resolution
 * conflicts in vmThreads pool.
 *
 * @author Hack23 AB
 * @license Apache-2.0
 */
...
/** Sample raw documents covering all major types: bet, prop, mot, ip, fr */
export const sampleDocuments: RawDocument[] = [
  ...
  { dok_id: 'H9011', titel: 'Proposition om stärkt nationell säkerhet', title: 'Proposition on strengthened national security', doktyp: 'prop', datum: '2026-03-14', organ: 'FöU' },
  ...
  { dok_id: 'H9023456', titel: 'Motion om klimatanpassning', title: 'Motion on climate adaptation', doktyp: 'mot', datum: '2026-03-12', parti: 'MP', intressent_namn: 'Maria Grönberg' },
  { dok_id: 'H9034567', titel: 'Interpellation om sjukvårdens resurser', title: 'Interpellation on healthcare resources', doktyp: 'ip', datum: '2026-03-11', parti: 'V', intressent_namn: 'Erik Lindström', mottagare: 'Socialministern' },
  { dok_id: 'H9045678', titel: 'Skriftlig fråga om infrastrukturinvesteringar', title: 'Written question on infrastructure investments', doktyp: 'fr', datum: '2026-03-10', parti: 'S', intressent_namn: 'Anna Johansson' },
  { dok_id: 'H9012', titel: 'Proposition om ny skollag', title: 'Proposition on new education act', doktyp: 'prop', datum: '2026-03-09', organ: 'UbU' },
  { dok_id: 'H9056789', titel: 'Motion om försvarsbudgeten', title: 'Motion on the defense budget', doktyp: 'mot', datum: '2026-03-08', parti: 'M', intressent_namn: 'Lars Svensson' },
  { dok_id: 'H901FöU5', titel: 'Betänkande om cybersäkerhet', title: 'Committee report on cybersecurity', doktyp: 'bet', organ: 'FöU', datum: '2026-03-07' },
  { dok_id: 'H9067890', titel: 'Motion om energipolitik och grön omställning', title: 'Motion on energy policy and green transition', doktyp: 'mot', datum: '2026-03-06', parti: 'C', intressent_namn: 'Karin Lindqvist' },
  ...
  { dok_id: 'H901FiU12', titel: 'Betänkande om finanspolitiska ramverket', title: 'Committee report on fiscal policy framework', doktyp: 'bet', organ: 'FiU', datum: '2026-03-04' },
];
