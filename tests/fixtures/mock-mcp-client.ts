...
export const sampleDocuments: RawDocument[] = [
  ...
  { dok_id: 'H901Ju22', titel: 'Betänkande om digitalisering', title: 'Committee report on digitalization', doktyp: 'bet', organ: 'JuU', datum: '2026-03-13' },
  ...
  { dok_id: 'H9012', titel: 'Proposition om skollag', title: 'Proposition on education act', doktyp: 'prop', datum: '2026-03-09', organ: 'UbU' },
  ...
  { dok_id: 'H901FiU12', titel: 'Betänkande om finanspolitik', title: 'Committee report on fiscal policy', doktyp: 'bet', organ: 'FiU', datum: '2026-03-04' },
];
