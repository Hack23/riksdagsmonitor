...
describe('party-variants', () => {
  ...
  describe('PARTY_VARIANTS', () => {
    it('should have all 8 Swedish parliamentary parties', () => {
      const expectedParties: string[] = ['S', 'M', 'SD', 'V', 'MP', 'C', 'L', 'KD'];
      const actualParties: string[] = Object.keys(PARTY_VARIANTS);
  ...
  describe('extractPartyMentions', () => {
    describe('Single party detection', () => {
      it('should detect Socialdemokraterna by full name', () => {
        ...
        const parties: Set<PartyCode> = extractPartyMentions(html);
    ...
    describe('Edge cases', () => {
      it('should return empty Set for empty string', () => {
        const parties: Set<PartyCode> = extractPartyMentions('');
      ...
      it('should return empty Set for null input', () => {
        const parties: Set<PartyCode> = extractPartyMentions(null);
      ...
      it('should return empty Set for undefined input', () => {
        const parties: Set<PartyCode> = extractPartyMentions(undefined);
    ...
    describe('Returns Set', () => {
      ...
      it('should return canonical codes not variants', () => {
        ...
        expect(parties.has('S')).toBe(true);
        expect(parties.has('Socialdemokraterna' as PartyCode)).toBe(false);
      });

      it('should be iterable', () => {
        const html = '<p>S, M och SD röstade för.</p>';
        const parties: Set<PartyCode> = extractPartyMentions(html);
        const partyArray: PartyCode[] = Array.from(parties);
