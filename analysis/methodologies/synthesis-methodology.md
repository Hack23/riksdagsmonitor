...
| Field | Value |
|-------|-------|
| **Purpose** | Family A — step-by-step production of the 9 always-on core synthesis artifacts (executive brief, synthesis, significance, classification, SWOT, risk, threat, stakeholder). |
| **Inputs** | Per-document analyses (Family E); `cross-reference-map.md`; `data-download-manifest.md`; classification outputs |
| **Outputs** | `executive-brief.md`, `synthesis-summary.md`, `significance-scoring.md`, `classification-results.md`, `swot-analysis.md`, `risk-assessment.md`, `threat-analysis.md`, `stakeholder-perspectives.md`, folder `README.md` |
...
- [ ] DIW 6-dimension weighting applied to every significance-scoring entry
- [ ] Executive-brief BLUF + 3 Decisions sections present (Check 7)
...
> _(synthesis lede)_ "FiU committee report `H901FiU1` (2026-04-22, 17 sponsors led by Edin (S)) reroutes SEK 6.1 bn from defence to climate. SD–M–KD bloc loses on punkt 5.3 (vote 173–176). Cui bono: opposition coalition wins fiscal narrative; cost: tightens FöU appropriation gap. WEP: **highly likely** Riksdag passes (3-source consensus, [B2])."

### 🔴 Anti-exemplar (failure mode — never ship this)

> _(failure mode)_ "The Riksdag debated the budget. Several parties spoke. The opposition raised concerns. The vote was close." — no `dok_id`, no MPs, no vote count, no WEP, banned-phrase "raised concerns".

### 🔗 Cross-links

- **Template(s)**: `analysis/templates/intelligence-assessment.md`, `analysis/templates/executive-brief.md`
