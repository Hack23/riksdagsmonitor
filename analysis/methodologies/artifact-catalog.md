...
| 21 | `media-framing-analysis.md` | [`electoral-domain-methodology.md`](electoral-domain-methodology.md#-part-5--media-framing--influence-operations-analysis-media-framing-analysismd) | [`media-framing-analysis.md`](../templates/media-framing-analysis.md) | 200 | frame graph + laundering chain + lifecycle xychart | external press (OSINT) + EUvsDisinfo + DISARM TTPs + Nordicom |
