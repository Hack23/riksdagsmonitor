...
> | Slot | Value |
> |------|-------|
> | **Owning methodology** | [`per-artifact-methodologies.md`](../methodologies/per-artifact-methodologies.md#workflow-audit) |
> | **Owning gate check** | Supplementary (Tier-C mandatory) — see [`05-analysis-gate.md`](../../.github/prompts/05-analysis-gate.md) |
> | **Required inputs** | 7-module prompt pipeline run record |
...
> | **Reader Intelligence Guide** | row generated from `workflow-audit.md` (see [`scripts/render-lib/aggregator/reader-guide.ts`](../../scripts/render-lib/aggregator/reader-guide.ts)) |
