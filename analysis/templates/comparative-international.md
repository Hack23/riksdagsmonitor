...
> | Slot | Value |
> |------|-------|
> | **Owning methodology** | [`per-artifact-methodologies.md`](../methodologies/per-artifact-methodologies.md#comparative-international) |
> | **Owning gate check** | Check 7 (Family C — ≥ 2 peer-country rows) — see [`05-analysis-gate.md`](../../.github/prompts/05-analysis-gate.md) |
> | **Required inputs** | World Bank / IMF / SCB; sibling synthesis-summary.md |
> | **Horizon band** | mixed (per [`scripts/horizon-context.ts`](../../scripts/horizon-context.ts)) |
> | **Output family** | Family C — Strategic Extensions |
> | **Aggregation order** | 18 of 30 in canonical order (see [`scripts/render-lib/aggregator/order.ts`](../../scripts/render-lib/aggregator/order.ts)) |
> | **Reader Intelligence Guide** | row generated from `comparative-international.md` (see [`scripts/render-lib/aggregator/reader-guide.ts`](../../scripts/render-lib/aggregator/reader-guide.ts)) |
...
| **Admiralty Floor** | **IMF** WEO/FM/IFS/BOP/GFS_COFOG/DOTS/PCPS/MFS_IR/ER (economic context) and OECD statistics require **[A1]**; World Bank governance / environment / social residue requires **[A1]**; country-specific policy documents require **[B2]** |
...
> World Bank supplies the governance, environment, and social context here. Economic rows above use IMF. Add a Statskontoret row/table when the Swedish measure depends on agency capacity, administrative burden or public-sector efficiency.
