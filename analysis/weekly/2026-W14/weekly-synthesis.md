...
```mermaid
flowchart TD
    subgraph "Committee Reports — 2026-03-30"
        MJU30["📋 MJU30<br/>Climate Targets 2030<br/>Significance: 5/10"]
        KU38["📋 KU38<br/>Parliamentary Process<br/>Significance: 5/10"]
    end
    
    subgraph "Policy Domains"
        ENV["🌍 Environmental &<br/>Climate Policy"]
        EU["🇪🇺 EU Regulatory<br/>Alignment"]
        PARL["🏛️ Parliamentary<br/>Reform"]
        CONST["📜 Constitutional<br/>Governance"]
    end
