...
graph TD
    subgraph "🟢 STRENGTHS"
        S1["Parliamentary majority<br/>with SD support"]
        S2["Policy momentum:<br/>6 new propositions last week"]
        S3["NATO commitment<br/>(Finland deployment)"]
    end

    subgraph "🔴 WEAKNESSES"
        W1["4-front opposition<br/>attack on April 15"]
        W2["Healthcare rejection<br/>motion (HD024081)"]
        W3["Reliance on SD<br/>for migration votes"]
    end

    subgraph "🔵 OPPORTUNITIES"
        O1["Spring budget<br/>local distribution"]
        O2["Cyber security<br/>leadership narrative"]
        O3["Welfare fraud<br/>crackdown agenda"]
    end

    subgraph "🟠 THREATS"
        T1["S multi-front strategy<br/>could shift media narrative"]
        T2["Healthcare + migration<br/>are top voter concerns"]
        T3["Municipal capacity<br/>for reform implementation"]
    end
