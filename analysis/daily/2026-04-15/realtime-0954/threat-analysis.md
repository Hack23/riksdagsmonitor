...
```mermaid
graph TD
    subgraph "Political Threat Vectors — April 15"
        T0["Threat Environment<br/>🟡 MEDIUM"] --> T1["Narrative Attack<br/>S Multi-Front Strategy"]
        T0 --> T2["Policy Resistance<br/>Healthcare Rejection"]
        T0 --> T3["Migration Contestation<br/>Reception + Settlement"]
    end

    T1 --> T1a["4 motions<br/>4 committees<br/>4 policy areas"]
