...
```mermaid
graph TD
    A["HD024078<br/>S Motion: Crime Victim Law"] --> B{"Sensitivity"}
    B -->|"🟢 PUBLIC"| C["Criminal Justice Policy<br/>Victim Rights Framework"]
    A --> D{"Domain"}
    D --> E["Justice (JUS)<br/>+ Social Welfare"]
    A --> F{"Urgency"}
    F -->|"🔵 ELEVATED"| G["CU Processing<br/>Active Session"]
