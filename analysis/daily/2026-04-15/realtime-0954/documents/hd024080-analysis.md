...
```mermaid
graph TD
    A["HD024080<br/>S Motion: Reception Act"] --> B{"Sensitivity"}
    B -->|"🟡 SENSITIVE"| C["Migration Policy<br/>Public vs. Private Operation"]
    A --> D{"Domain"}
    D --> E["Migration (MIG)<br/>+ Welfare Delivery"]
    A --> F{"Urgency"}
    F -->|"🔵 ELEVATED"| G["Committee Processing<br/>SfU — Active Session"]
