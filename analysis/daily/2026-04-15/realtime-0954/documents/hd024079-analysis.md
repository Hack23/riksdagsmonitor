...
```mermaid
graph TD
    A["HD024079<br/>S Motion: Settlement Law"] --> B{"Sensitivity"}
    B -->|"🟡 SENSITIVE"| C["Immigration/Integration<br/>Housing Rights"]
    A --> D{"Domain"}
    D --> E["Migration (MIG)<br/>+ Labour Market<br/>+ Housing (HOU)"]
    A --> F{"Urgency"}
