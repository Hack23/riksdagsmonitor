...
```mermaid
graph TD
    A["HD024081<br/>S Motion: REJECT Healthcare Reform"] --> B{"Sensitivity"}
    B -->|"🟡 SENSITIVE"| C["Healthcare Policy<br/>Municipal Competence"]
    A --> D{"Domain"}
    D --> E["Healthcare (HEA)<br/>+ Municipal Governance"]
    A --> F{"Urgency"}
