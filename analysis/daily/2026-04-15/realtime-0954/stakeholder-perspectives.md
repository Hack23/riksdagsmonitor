...
```mermaid
graph TD
    subgraph "Stakeholder Impact — April 15"
        S1["🏛️ Government Coalition<br/>Impact: HIGH<br/>Defensive posture"]
        S2["🔴 Opposition (S)<br/>Impact: HIGH<br/>Offensive strategy"]
        S3["👥 Citizens<br/>Impact: HIGH<br/>Healthcare + Migration"]
        S4["🏢 Municipalities<br/>Impact: HIGH<br/>Implementation burden"]
        S5["🌍 International/EU<br/>Impact: MEDIUM<br/>Migration scrutiny"]
        S6["⚖️ Judiciary<br/>Impact: LOW<br/>Constitutional process"]
        S7["📰 Media<br/>Impact: MEDIUM<br/>Multi-story day"]
