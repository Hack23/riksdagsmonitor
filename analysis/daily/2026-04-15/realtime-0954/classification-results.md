...
```mermaid
graph TD
    subgraph "Policy Domain Classification"
        M1["HD024080<br/>Migration"] -->|"SfU"| D1["🟡 SENSITIVE<br/>Asylum Housing"]
        M2["HD024078<br/>Justice"] -->|"CU"| D2["🟢 PUBLIC<br/>Crime Victims"]
        M3["HD024079<br/>Integration"] -->|"AU"| D3["🟡 SENSITIVE<br/>Settlement Law"]
