...
```mermaid
graph LR
    A["Prop 215: Settlement Law"] --> B["S Motion 4079"]
    B --> C["Yrkande 1: Anti-evasion Criteria"]
    B --> D["Yrkande 2: Weight Previous Intake"]
    B --> E["Yrkande 3: Reject § 8"]
    
    C --> F["Target: Affluent Municipalities"]
