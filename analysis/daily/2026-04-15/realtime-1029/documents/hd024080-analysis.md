...
```mermaid
graph TD
    A["Prop 229: New Reception Law"] --> B["S Motion 4080"]
    B --> C["Yrkande 1: No Privatization"]
    B --> D["Yrkande 2: Vulnerable Area Opt-out"]
    B --> E["Yrkande 3: Municipal Accountability"]
    
    C --> F["Public-Only Asylum Housing"]
    D --> G["Segregation Protection"]
    E --> H["Political Responsibility"]
    
    subgraph "Migration Policy Diptych"
        B
