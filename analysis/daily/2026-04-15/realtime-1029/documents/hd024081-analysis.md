...
```mermaid
graph TD
    A["Prop 216: Municipal Doctor Hiring"] --> B["S Motion 4081: Full Rejection"]
    
    C["Remiss Responses"] -->|Majority Negative| B
    
    B --> D["Risk: Unclear Medical Responsibility"]
    B --> E["Risk: Parallel Healthcare Structures"]
    B --> F["Risk: Unequal Resource Distribution"]
    B --> G["Risk: Patient Choice Uncertainty"]
    
    D --> H["SoU Committee Decision"]
    E --> H
    F --> H
    G --> H
