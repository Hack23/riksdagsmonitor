...
```mermaid
graph LR
    subgraph "Significance Tiers"
        HIGH["HIGH ≥7<br>None today"]
        MEDIUM["MEDIUM 4-6<br>4 documents"]
        LOW["LOW ≤3<br>None scored"]
    end
    
    MEDIUM --> D1["HD024081: 6/10"]
    MEDIUM --> D2["HD024079: 6/10"]
