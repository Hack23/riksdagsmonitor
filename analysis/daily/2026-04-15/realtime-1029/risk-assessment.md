...
```mermaid
graph TD
    subgraph "Risk Level Assessment"
        R1["Coalition Stability<br>🟢 LOW (15/100)"]
        R2["Policy Implementation<br>🟡 MEDIUM (40/100)"]
        R3["Electoral Risk<br>🟡 MEDIUM (45/100)"]
        R4["Institutional Risk<br>🟢 LOW (10/100)"]
    end
    
    R1 --> D1["Government majority holds<br>in all 4 target committees"]
    R2 --> D2["Healthcare prop proceeds<br>against remiss majority"]
