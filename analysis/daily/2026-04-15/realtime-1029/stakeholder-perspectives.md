...
```mermaid
graph TD
    S["S: Coordinated Opposition"] -->|Challenges| GOV["Government Coalition"]
    SD["SD: Oversight Questions"] -->|Probes| GOV
    HC["Healthcare Professionals"] -->|Support| S
    MUN["Municipalities"] -->|May Support| S
