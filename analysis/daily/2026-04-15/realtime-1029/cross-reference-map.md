...
```mermaid
graph TD
    subgraph "S Legislative Offensive (April 15)"
        M78["HD024078<br>Crime Victims<br>JuU"]
        M79["HD024079<br>Settlement Law<br>CU"]
        M80["HD024080<br>Asylum Reception<br>SfU"]
        M81["HD024081<br>Healthcare Reform<br>SoU"]
    end
    
    subgraph "Government Propositions (Targets)"
        P1["Prop 203<br>Crime Victims"]
        P2["Prop 204<br>Settlement Act"]
        P3["Prop 200<br>Reception Act"]
        P4["Prop 216<br>Healthcare"]
    end
    
    subgraph "SD Oversight Campaign"
        Q1["HD12684<br>Syrian Returns"]
        Q2["HD12692<br>Reserve Police"]
        Q3["HD12693<br>Lobby Register"]
    end
    
    M78 -->|"accept-and-extend"| P1
    M79 -->|"partial reject §8"| P2
    M80 -->|"full reject private"| P3
    M81 -->|"full reject + remiss"| P4
    
    M79 -.->|"migration diptych"| M80
