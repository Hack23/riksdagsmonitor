...
graph LR
    subgraph "Threat Actors"
        A1["S (Opposition)"]
        A2["SD (Coalition Support)"]
    end
    
    subgraph "Threat Vectors"
        V1["Legislative Challenges"]
        V2["Parliamentary Oversight"]
        V3["Narrative Competition"]
    end
    
    subgraph "Targets"
        T1["Government Policy Agenda"]
        T2["Coalition Credibility"]
        T3["Electoral Support"]
    end
