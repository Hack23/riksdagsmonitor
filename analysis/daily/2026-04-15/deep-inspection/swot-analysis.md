...
> ⚠️ **No SWOT entries generated**: The automated data pipeline found 4 documents but could not extract SWOT contributions from metadata alone. Deep SWOT analysis requires AI-driven per-document analysis following `analysis/methodologies/political-swot-framework.md`.
