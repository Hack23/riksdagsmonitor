...
> ⚠️ **No threat indicators extracted**: The automated data pipeline found 4 documents but could not identify specific threat indicators from metadata alone. Deep threat analysis requires AI-driven per-document analysis following `analysis/methodologies/political-threat-framework.md`.
