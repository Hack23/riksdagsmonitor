# Data Download Manifest — 2026-04-15
...
Downloaded **20** documents (session-wide) from 1 MCP data sources.

After date filtering to **2026-04-15**: **8** documents selected for analysis.
