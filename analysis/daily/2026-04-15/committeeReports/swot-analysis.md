...
graph TD
    subgraph Strengths["✅ Strengths"]
        S1["EU compliance cluster<br/>TU21, TU22"]
        S2["Crime agenda coherence<br/>TU17, SfU22"]
        S3["Digital modernization<br/>TU21 e-ID"]
    end
    subgraph Weaknesses["⚠️ Weaknesses"]
        W1["Immigration rights tension<br/>SfU22"]
        W2["Industry compliance costs<br/>TU17, TU22"]
    end
    subgraph Opportunities["🔵 Opportunities"]
        O1["Digital leadership position<br/>TU21 EUDI"]
        O2["Pre-election positioning<br/>June decisions"]
    end
    subgraph Threats["🔴 Threats"]
        T1["ECHR challenge<br/>SfU22"]
        T2["Implementation delays<br/>TU21 e-ID"]
    end
    S1 --> O1
    S2 --> T1
    W1 --> T1
