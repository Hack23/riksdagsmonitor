...
graph TD
    ...
    subgraph "🔴 Weaknesses"
        style W fill:#B71C1C,color:#FFFFFF
    ...
    subgraph "🟡 Opportunities"
        style O fill:#FFD54F,color:#000000
    ...
    subgraph "🔵 Threats"
        style T fill:#0D47A1,color:#FFFFFF
        ...
        T4["SD coalition friction if<br/>interpellations intensify"]
    end
```
