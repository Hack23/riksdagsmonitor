...
```mermaid
graph TD
    subgraph "📊 Risk Matrix — Month Ahead Legislative Pipeline"
        direction TB
        subgraph "🔴 High Risk (L×I ≥ 10)"
            style HR fill:#d00000,color:#FFFFFF
            R1["Energy relief insufficient<br/>L:3 × I:4 = 12"]
            R2["Healthcare crisis escalation<br/>L:3 × I:4 = 12"]
