...
graph TD
    subgraph "💪 Strengths"
        STR1["S1: Coordinated fiscal offensive<br/>6 props from Finansdepartementet<br/>dok_id: HD03100, HD0399, HD03236"]
        STR2["S2: Legislative pipeline clearing<br/>20 committee reports processing<br/>404 opposition motions addressed"]
        STR3["S3: NATO integration milestone<br/>Swedish forces to Finland<br/>dok_id: HD03220"]
        STR4["S4: Direct voter relief<br/>Fuel tax cuts + energy support<br/>dok_id: HD03236"]
    end
    subgraph "⚠️ Weaknesses"
        W1["W1: Climate-fiscal contradiction<br/>Fuel tax cut vs MJU30 targets<br/>Risk score: 15/25"]
        W2["W2: Internal coalition friction<br/>SD interpellations target M+KD<br/>dok_id: HD10429, HD10430"]
        W3["W3: Healthcare vacuum<br/>348 health motions rejected,<br/>no new proposals (SoU16+SoU17)"]
        W4["W4: Defence personnel gap<br/>98 motions rejected, NATO<br/>force structure unmet (FöU8)"]
    end
    subgraph "🎯 Opportunities"
        O1["O1: Autumn budget framing<br/>VP sets economic platform<br/>for Election 2026 campaign"]
        O2["O2: Cross-party Sida reform<br/>C+V+MP form rare bloc<br/>mot. 4070-4072"]
        O3["O3: Regional engagement<br/>PM Skåne, Minister Värmland<br/>Pre-election voter contact"]
        O4["O4: Criminal justice results<br/>Double gang penalties + civil<br/>servant liability (HD03218+HD03217)"]
    end
    subgraph "🚨 Threats"
        T1["T1: Opposition rejects fiscal<br/>framework in FiU committee<br/>Risk L:4×I:4=16"]
        T2["T2: GDP forecast deviation<br/>Global uncertainty, ESB credibility<br/>Risk L:3×I:5=15"]
        T3["T3: Election bribe framing<br/>S/V label fuel cuts as<br/>pre-election bribery L:4×I:3=12"]
        T4["T4: EU Green Deal tension<br/>Fuel tax cut vs climate<br/>commitments L:4×I:3=12"]
    end
    style STR1 fill:#4CAF50,color:#FFFFFF
    style STR2 fill:#4CAF50,color:#FFFFFF
    style STR3 fill:#4CAF50,color:#FFFFFF
    style STR4 fill:#4CAF50,color:#FFFFFF
    style W1 fill:#FFC107,color:#000000
    style W2 fill:#FFC107,color:#000000
    style W3 fill:#FFC107,color:#000000
    style W4 fill:#FFC107,color:#000000
    style O1 fill:#1565C0,color:#FFFFFF
    style O2 fill:#1565C0,color:#FFFFFF
    style O3 fill:#1565C0,color:#FFFFFF
    style O4 fill:#1565C0,color:#FFFFFF
