...
```mermaid
graph TD
    subgraph "📊 Daily Political Intelligence Dashboard — Evening 2026-04-13"
        direction TB
        subgraph "🔒 Sensitivity Distribution"
            ...
            S3["🟢 PUBLIC: 16 documents<br/>Routine, procedural"]
        end
        subgraph "⚡ Risk Level"
            R1["🔴 HIGH: Spring Budget package<br/>Climate-fiscal tension"]
            R2["🟠 MEDIUM-HIGH: Security-migration<br/>404 motions rejected"]
            R3["🟡 MEDIUM: Coalition dynamics<br/>SD interpellations"]
        end
        subgraph "📈 Top Significance"
            SIG1["🔴 10/10: Vårproposition HD03100"]
            SIG2["🔴 9/10: Extra budget HD03236"]
            SIG3["🔴 9/10: Vårändringsbudget HD0399"]
            SIG4["🟠 8/10: Gang crime HD03218"]
            SIG5["🟠 40/50: Migration SfU16"]
        end
        subgraph "🗳️ Election 2026"
            E1["📊 Government: Pre-election<br/>fiscal offensive launched"]
            E2["📊 Opposition: MP leads<br/>multi-front challenge"]
