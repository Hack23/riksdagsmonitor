...
```mermaid
flowchart TD
    ROOT["Democratic Accountability"] --> A["Fiscal Oversight"]
    ROOT --> B["Criminal Justice Proportionality"]
    ROOT --> C["Environmental Commitments"]
    
    A --> A1["✅ Annual Report Published<br/>(HD03101)"]
    A --> A2["✅ Tax Expenditures Disclosed<br/>(HD0398)"]
    A --> A3["✅ Audit Response Filed<br/>(HD03241)"]
    
    B --> B1["⚠️ Double Penalties Proportionality<br/>(HD03218)"]
    B --> B2["⚠️ Civil Servant Liability Scope<br/>(HD03217)"]
