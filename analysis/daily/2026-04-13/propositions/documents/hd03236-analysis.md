...
```mermaid
flowchart TD
    A["Extra Ändringsbudget HD03236"] --> B["Fuel Tax Cut"]
    A --> C["Electricity Price Support"]
    A --> D["Gas Price Support"]
    B --> E["🟢 Voter Relief<br/>Direct household impact"]
    B --> F["🔴 Climate Critics<br/>Contradicts green transition"]
    C --> G["🟢 Energy Affordability<br/>Addresses cost-of-living"]
    C --> H["🔴 Fiscal Cost<br/>Increases budget deficit"]
