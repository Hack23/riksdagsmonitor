...
```mermaid
flowchart LR
    A["Prop 2025/26:218<br/>Double Penalties"] --> B["🟢 Gang Crime Deterrent"]
    A --> C["🟡 Legal Proportionality Debate"]
    A --> D["🟢 Voter Safety Signal"]
    B --> E["SD/M Core Priority"]
    C --> F["V/MP/C Legal Critique"]
