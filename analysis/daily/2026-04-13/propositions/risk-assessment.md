...
```mermaid
quadrantChart
    title Political Risk Matrix — Spring 2026 Propositions
    x-axis "Low Impact" --> "High Impact"
    y-axis "Low Likelihood" --> "High Likelihood"
    "Climate backlash (HD03236)": [0.6, 0.9]
    "GDP forecast miss (HD03100)": [0.8, 0.6]
    "SD blocks spending (HD0399)": [0.7, 0.55]
    "Prison capacity gap (HD03218)": [0.65, 0.5]
    "Election bribe framing": [0.5, 0.75]
    "EU fiscal scrutiny": [0.5, 0.3]
    "NATO cost escalation (HD03220)": [0.55, 0.35]
    "Union opposition (HD03217)": [0.4, 0.6]
```
...
```mermaid
flowchart TD
    A["Global Economic Shock"] --> B["GDP Forecast Miss<br/>Score: 12"]
    B --> C["Vårproposition Credibility Loss"]
    B --> D["Revenue Shortfall"]
    D --> E["Supplementary Budget<br/>Insufficient"]
    C --> F["Opposition Economic<br/>Alternative Gains Traction"]
    
    G["Energy Price Spike"] --> H["Fuel Tax Cut<br/>Insufficient Relief"]
    G --> I["Extra Budget Costs<br/>Balloon"]
