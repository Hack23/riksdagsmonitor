...
```mermaid
graph LR
    A["mot. 2025/26:4015"] --> B{Sensitivity}
    B -->|"🟡 SENSITIVE"| D["Market Regulation / Public Sector"]
    A --> G{Domain}
    G --> H["Competition Policy / Municipal Services"]
    A --> I{Urgency}
    I -->|"🔵 ELEVATED"| L["Active proposition in NU"]
