...
```mermaid
graph LR
    A["mot. 2025/26:4075"] --> B{Sensitivity}
    B -->|"🟡 SENSITIVE"| D["Public Health Policy"]
    A --> G{Domain}
    G --> H["Social Policy / Alcohol Regulation"]
    A --> I{Urgency}
    I -->|"🔵 ELEVATED"| L["Active proposition — committee consideration imminent"]
