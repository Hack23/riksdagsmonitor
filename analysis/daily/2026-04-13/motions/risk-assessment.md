...
```mermaid
graph TD
    R1["R1: Coalition Split<br>on Alcohol Policy<br>L:2 × I:3 = 6"] --> CAT1["MODERATE"]
    R2["R2: Municipal Service<br>Erosion via Competition Law<br>L:3 × I:4 = 12"] --> CAT2["HIGH"]
    R3["R3: Education Quality<br>Decline via Outsourcing<br>L:3 × I:4 = 12"] --> CAT2
