...
graph TB
    subgraph "Democratic Function Threats"
        T1["🟠 Rule of Law<br>Foreign imprisonment<br>Youth investigation expansion"] 
        T2["🟡 Separation of Powers<br>Municipal autonomy<br>Rapid deregulation"] 
        T3["🟢 Transparency<br>Sida audit follow-up"] 
    end
