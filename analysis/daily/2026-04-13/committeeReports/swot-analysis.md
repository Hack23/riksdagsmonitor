...
graph TD
    subgraph Strengths
        S1["S1: Security consensus UU6"]
        S2["S2: Tido migration framework SfU16"]
    end
    subgraph Weaknesses
        W1["W1: Migration divisiveness SfU16"]
        W2["W2: Defence personnel gaps FoU8"]
    end
    subgraph Opportunities
        O1["O1: NATO cooperation UU6+FoU8"]
        O3["O3: Green rail transition TU15"]
    end
    subgraph Threats
