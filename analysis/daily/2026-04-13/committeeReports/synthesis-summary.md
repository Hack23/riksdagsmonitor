...
```mermaid
graph TD
    subgraph Security[🔒 Security and Defence]
        UU6["UU6: Security Policy<br/>51 motions rejected"]
        FoU8["FöU8: Defence Personnel<br/>98 motions rejected"]
        FoU12["FöU12: Civilian Protection<br/>Government proposal"]
        FoU11["FöU11: Maritime Oil Spill<br/>Riksrevisionen audit"]
    end
    subgraph Migration[🚪 Migration Enforcement]
        SfU16["SfU16: Migration<br/>157 motions rejected"]
        SfU31["SfU31: Detention Framework"]
        SfU32["SfU32: Returns Enforcement"]
        SfU36["SfU36: Conduct Requirements"]
    end
    subgraph Climate[🌿 Energy and Climate]
        NU18["NU18: Renewables Permitting"]
        MJU30["MJU30: Climate Goals"]
    end
    subgraph Healthcare[🏥 Healthcare]
        SoU16["SoU16: Healthcare Org<br/>176 motions"]
        SoU17["SoU17: Healthcare Priorities<br/>172 motions"]
    end
