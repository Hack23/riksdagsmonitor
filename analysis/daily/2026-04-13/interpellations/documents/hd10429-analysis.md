...
```mermaid
graph TD
    subgraph "HD10429 Constitutional Challenge Chain"
        A["Quran burnings 2023"] --> B["International pressure<br/>incl. authoritarian states"]
        B --> C["Government investigates<br/>demo restrictions (summer 2023)"]
        C --> D["Prop 2025/26:133<br/>Assembly security bill"]
        D --> E["SD's Farivar questions<br/>constitutional impact"]
        E --> F["Written question<br/>(Feb 2026)"]
        F --> G["Unsatisfactory response<br/>(March 4)"]
        G --> H["Escalation to<br/>interpellation HD10429"]
        H --> I{"Strömmer responds<br/>by 2026-04-27?"}
        I -->|"Clear guarantees"| J["Constitutional concerns addressed"]
        I -->|"Evasive/vague"| K["Constitutional crisis potential"]
    end
