...
```mermaid
graph TD
    subgraph "🔴 Political Threat Taxonomy — 2026-04-13 Evening"
        direction TB
        subgraph AC["🏛️ Accountability (AC)"]
            AC1["AC-1: SD coalition accountability push<br/>HD10429 targets M on free speech<br/>HD10430 targets KD on hate speech<br/>Severity: 3/5"]
            AC2["AC-2: Mass motion rejection<br/>404 motions in one day<br/>Democratic participation questioned<br/>Severity: 2/5"]
        end
        subgraph NI["⚖️ Normative Integrity (NI)"]
            NI1["NI-1: Climate commitment dilution<br/>MJU30 reframes targets<br/>EU alignment vs national ambition<br/>Severity: 3/5"]
            NI2["NI-2: Free speech vs hate speech tension<br/>HD10429 — Prop 133 debate<br/>Constitutional rights at stake<br/>Severity: 3/5"]
        end
        subgraph FP["📋 Fiscal Prudence (FP)"]
            FP1["FP-1: Pre-election fiscal expansion<br/>HD03236 unfunded tax cut<br/>Budget discipline risk<br/>Severity: 2/5"]
        end
        subgraph DS["🛡️ Defence/Security (DS)"]
