...
```mermaid
graph TD
    subgraph "📊 Second-Pass Evening Dashboard — 2026-04-13"
        direction TB
        subgraph "🔒 Sensitivity Distribution"
            S1["🔴 RESTRICTED: 3 documents<br/>Fiscal framework, NATO deployment"]
            S2["🟡 SENSITIVE: 42 documents<br/>Legislation, committee reports"]
            S3["🟢 PUBLIC: 16 documents<br/>Routine, procedural, regional visits"]
        end
        subgraph "⚡ Risk Escalation Tracker"
            R1["🔴 HIGH: Climate-fiscal contradiction<br/>HD03236 vs MJU30 — L:4 × I:4 = 16"]
            R2["🟠 MEDIUM-HIGH: Coalition tension<br/>SD interpellations due Apr 24-27"]
            R3["🟡 MEDIUM: Opposition coordination<br/>S-MP-C-V pre-election blocs forming"]
        end
        subgraph "📈 Chamber Activity Update"
            CA1["🔵 NU17: Electricity market debate<br/>MP vs M — Lakso v Skalberg Karlsson"]
            CA2["🔵 Government: Carlson in Värmland<br/>Regional pre-election tour continues"]
            CA3["🟡 Upcoming: SD interpellation responses<br/>Strömmer + Forssmed due Apr 24-27"]
        end
        subgraph "🗳️ Election 2026 — Updated"
            E1["🔴 Government fiscal offensive<br/>6 propositions = campaign platform"]
            E2["🟠 Opposition bloc formation<br/>S-MP + C-V-MP cross-party alliances"]
