...
```mermaid
graph TD
    subgraph "🔄 SWOT — Swedish Political Landscape 2026-04-13 Evening"
        direction TB
        subgraph S["💪 Strengths (Government)"]
            S1["Coordinated fiscal package<br/>6 propositions in one day<br/>dok: HD03100, HD0399, HD03236"]
            S2["Legislative pipeline clearing<br/>20 committee reports processed<br/>404 motions handled"]
            S3["Regional engagement active<br/>Carlson Värmland + PM Skåne"]
        end
        subgraph W["⚠️ Weaknesses (Government)"]
            W1["Climate-fiscal contradiction<br/>HD03236 fuel cuts vs MJU30 targets<br/>Risk: L4×I4=16"]
            W2["Defence personnel gap<br/>FöU8 rejects 98 motions<br/>NATO readiness at risk"]
            W3["Healthcare impasse<br/>SoU16+SoU17 reject 348 motions<br/>No new solutions offered"]
        end
        subgraph O["🎯 Opportunities (Opposition)"]
            O1["Cross-party bloc formation<br/>S-MP competition + C-V-MP Sida<br/>mot. 4015+4057, 4070-4072"]
            O2["Climate narrative ammunition<br/>Fuel cuts vs milestones<br/>HD03236 vs MJU30"]
            O3["Energy debate platform<br/>NU17 electricity market<br/>Voter cost-of-living concern"]
        end
        subgraph T["🔴 Threats (System)"]
            T1["SD coalition stress testing<br/>HD10429 + HD10430<br/>Due Apr 24-27"]
            T2["Democratic deficit critique<br/>404 motions rejected<br/>Opposition narrative building"]
