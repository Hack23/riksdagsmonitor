...
```mermaid
flowchart TD
    subgraph "Opposition Motion Distribution — 2026-04-07"
        A["50 Motions Filed"] --> B{By Policy Domain}
        B --> C["Education (UbU)<br/>6 motions — 5 propositions"]
        B --> D["Housing & Civil Law (CU)<br/>3 motions"]
        B --> E["Food Safety (MJU)<br/>1 motion"]
        B --> F["Environment (MJU)<br/>Hydropower re-examination"]
        B --> G["Other domains<br/>~39 motions"]
    end
    C --> H["Prop. 187: Flexible rental market"]
    C --> I["Prop. 197: Equivalent grading"]
    C --> J["Prop. 191–195: School reform package"]
    D --> K["Prop. 202: EU Habitats Directive exemption"]
    D --> L["Prop. 224: Simplified procedures"]
