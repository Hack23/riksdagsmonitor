...
```mermaid
graph TD
    subgraph "👥 Stakeholder Perspectives — 2026-04-07"
        CIT["Citizens<br>Moderate impact"]
        GOV["Government Coalition<br>M, KD, L + SD support"]
        OPP["Opposition<br>MP active, S quiet"]
        BIZ["Business/Industry<br>Export control impact"]
