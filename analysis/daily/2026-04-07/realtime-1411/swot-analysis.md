...
```mermaid
graph TD
    subgraph "💼 Political SWOT — 2026-04-07"
        subgraph "✅ Strengths"
            S1["S1: Active legislative<br>agenda across policy areas"]
            S2["S2: Government sets<br>policy direction"]
        end
        subgraph "⚠️ Weaknesses"
            W1["W1: SD pressure on<br>integration policy"]
            W2["W2: Coalition tension<br>on religious institutions"]
        end
        subgraph "🌟 Opportunities"
            O1["O1: Cross-party<br>preparedness support"]
            O2["O2: NATO alignment<br>via export control"]
        end
        subgraph "🚨 Threats"
            T1["T1: Mosque debate<br>could escalate"]
            T2["T2: SD hardening<br>ahead of budget"]
        end
    end
    style S1 fill:#4CAF50,stroke:#2E7D32,color:#FFFFFF
    style S2 fill:#4CAF50,stroke:#2E7D32,color:#FFFFFF
    style W1 fill:#FFC107,stroke:#F57C00,color:#000000
    style W2 fill:#FFC107,stroke:#F57C00,color:#000000
