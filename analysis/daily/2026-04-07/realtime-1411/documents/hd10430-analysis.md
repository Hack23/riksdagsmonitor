...
```mermaid
graph TD
    subgraph "👥 HD10430 Stakeholder Impact"
        SD_P["SD (Jomshof)<br>Pressuring coalition"]
        KD_M["KD (Forssmed)<br>Must respond"]
        MUSLIM["Muslim communities<br>Directly affected"]
        MEDIA["Media<br>Expressen investigation"]
    end
    SD_P --> KD_M
    MEDIA --> SD_P
    KD_M --> MUSLIM
