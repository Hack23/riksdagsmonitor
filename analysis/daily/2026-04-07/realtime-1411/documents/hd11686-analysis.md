...
```mermaid
graph TD
    subgraph "👥 HD11686 Stakeholder Impact"
        SD_S["SD (Söder)<br>University governance"]
        L_M["L (Edholm)<br>Must defend autonomy"]
        UNIV["Universities<br>Institutional independence"]
        ACAD["Academic community<br>Freedom concern"]
    end
    SD_S --> L_M
    L_M --> UNIV
    UNIV --> ACAD
