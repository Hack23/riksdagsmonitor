...
```mermaid
graph TD
    subgraph "👥 HD03114 Stakeholder Impact"
        GOV_E["Government<br>Export transparency"]
        DEF["Defense industry<br>Export framework"]
        NATO_A["NATO/EU<br>Alignment signal"]
        CIVIL_S["Civil society<br>Arms control oversight"]
    end
    GOV_E --> DEF
    GOV_E --> NATO_A
    CIVIL_S --> GOV_E
