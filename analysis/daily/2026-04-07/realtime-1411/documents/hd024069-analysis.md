...
```mermaid
graph TD
    subgraph "👥 HD024069 Stakeholder Impact"
        MP_A["MP (Nohrén)<br>Pushing faster action"]
        GOV["Government<br>Prop 2025/26:205"]
        AGR["Agriculture sector<br>Stockpile requirements"]
        CIT["Citizens<br>Food security"]
    end
    MP_A --> GOV
    GOV --> AGR
    GOV --> CIT
