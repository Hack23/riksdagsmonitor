...
```mermaid
graph TD
    subgraph "👥 HD024068 Stakeholder Impact"
        MP["MP (Nohrén)<br>Animal welfare"]
        GOV["Government<br>Prop 2025/26:211"]
        HUNT["Hunting community<br>Supports simplification"]
        ENV["Environmental orgs<br>Support MP position"]
    end
    MP --> GOV
    GOV --> HUNT
    MP --> ENV
    ...
    style HUNT fill:#FFC107,stroke:#F57C00,color:#000000
