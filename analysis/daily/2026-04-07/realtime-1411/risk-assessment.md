...
```mermaid
graph TD
    subgraph "⚠️ Political Risk Matrix — 2026-04-07"
        subgraph "Likelihood → Impact"
            R1["R1: Coalition friction<br>on integration<br>L=2 × I=3 = 6"]
            R2["R2: SD budget<br>negotiation hardening<br>L=2 × I=4 = 8"]
            R3["R3: Food security<br>preparedness gap<br>L=1 × I=2 = 2"]
