...
```mermaid
graph TD
    subgraph "SWOT Analysis — 2026-04-07"
        subgraph "Internal Factors"
            S["💪 Strengths<br/>Democratic oversight<br/>Constitutional tradition<br/>NATO integration"]
            W["⚠️ Weaknesses<br/>Coalition tension<br/>Export policy balance<br/>Limited question leverage"]
        end
        subgraph "External Factors"
            O["🎯 Opportunities<br/>Defense modernization<br/>Policy clarity<br/>International cooperation"]
            T["🔴 Threats<br/>Arms diversion risk<br/>Free speech challenge<br/>EU policy divergence"]
        end
    end
