...
graph TD
    subgraph "📊 Daily Political Intelligence Dashboard"
        ...
        subgraph "🔒 Sensitivity"
            CLS["Sensitivity<br/>SENSITIVE<br/>Defense export policy + constitutional rights"]
        end
        subgraph "⚖️ Risk"
            RSK["Overall Risk<br/>MEDIUM<br/>Top: RSK-001 Arms diversion risk"]
        end
        subgraph "🎭 Threat"
            THR["Threat Level<br/>MODERATE<br/>Top Category: AC (Accountability Challenge)"]
        end
        subgraph "📈 Significance"
            SIG["Top Significance<br/>7/10<br/>Priority Article"]
        end
    end
...
```mermaid
graph LR
    subgraph "Cross-Document Patterns"
        P1["SD Parliamentary Activism<br/>3 of 4 documents from SD"]
        P2["Defense & Foreign Policy Cluster<br/>HD03114 + HD11685"]
        P3["Coalition Tension Signals<br/>HD10429 challenges M minister"]
    end

    P1 --> C1["SD testing coalition boundaries"]
