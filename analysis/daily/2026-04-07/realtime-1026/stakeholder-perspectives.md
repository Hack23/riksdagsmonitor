...
```mermaid
graph TD
    subgraph "Stakeholder Impact — 2026-04-07"
        CIT["👤 Citizens<br/>MEDIUM impact<br/>Arms export transparency"]
        GOV["🏛️ Government Coalition<br/>HIGH impact<br/>Defense policy + coalition test"]
        OPP["⚔️ Opposition<br/>MEDIUM impact<br/>V/MP critical of arms exports"]
        BUS["💼 Business/Industry<br/>HIGH impact<br/>Defense sector benefits"]
        INT["🌍 International/EU<br/>HIGH impact<br/>NATO integration"]
        CIV["🏘️ Civil Society<br/>MEDIUM impact<br/>Peace orgs + press freedom"]
        JUD["⚖️ Judiciary<br/>MEDIUM impact<br/>Constitutional free speech"]
