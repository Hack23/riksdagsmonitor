...
```mermaid
graph LR
    A["HD03114<br/>Strategic Export Controls"] --> B{Sensitivity}
    B -->|"🟡 SENSITIVE"| C["Defense/Security Policy<br/>NATO implications"]
    
    A --> G{Domain}
    G --> H["Defense & Security"]
    G --> I["Foreign Policy"]
    G --> J["Trade & Industry"]
...
```mermaid
graph TD
    subgraph "Risk Matrix — HD03114"
        R1["RSK-001<br/>Arms diversion to conflict zones<br/>L:3 × I:4 = 12"]
        R2["RSK-002<br/>Coalition divergence on export policy<br/>L:2 × I:3 = 6"]
