...
```mermaid
graph TD
    subgraph "Political Threat Taxonomy — 2026-04-07"
        AC["AC: Accountability Challenge<br/>Free speech interpellation<br/>HD10429"]
        NI["NI: National Interest<br/>Arms export oversight<br/>HD03114"]
        DP["DP: Democratic Process<br/>SD testing coalition boundaries<br/>HD10429, HD11684, HD11685"]
    end

    AC --> S1["Severity: MODERATE<br/>Constitutional debate within normal parameters"]
