...
graph LR
    subgraph "Risk Heat Map"
        R1["🔴 MJU30 Climate<br>L:3 × I:5 = 15"]
        R2["🟡 CU18 Housing<br>L:4 × I:3 = 12"]
        R3["🟡 NU17 Energy<br>L:3 × I:4 = 12"]
        R4["🟡 SoU16/17 Health<br>L:3 × I:3 = 9"]
    ...
    style R6 fill:#00d9ff,color:#0a0e27
```
