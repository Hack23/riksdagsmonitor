...
```mermaid
flowchart TD
    subgraph "Committee Report Pipeline — 2025/26"
        A[20 Committee Reports] --> B{By Committee}
        B --> C["JuU (Justice): JuU15, JuU16"]
        B --> D["FöU (Defence): FöU11, FöU12"]
        B --> E["SoU (Health): SoU16, SoU17, SoU18"]
        B --> F["MJU (Environment): MJU18, MJU30"]
        B --> G["AU (Labour): AU11, AU12"]
        B --> H["KU (Constitution): KU31, KU38"]
        B --> I["CU (Civil Law): CU17, CU18"]
        B --> J["UU (Foreign Affairs): UU6"]
        B --> K["SfU (Social Insurance): SfU18"]
        B --> L["KrU (Culture): KrU10"]
        B --> M["TU (Transport): TU14"]
