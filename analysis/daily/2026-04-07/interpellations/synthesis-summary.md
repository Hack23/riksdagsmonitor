...
```mermaid
pie title Interpellations by Target Minister
    "Carlson (KD) - Infrastructure" : 8
    "Svantesson (M) - Finance" : 3
    "Other Ministers" : 4
```
...
```mermaid
flowchart LR
    S["Social Democrats (S)<br/>13 interpellations"] --> C1["Carlson KD<br/>8 questions"]
    S --> C2["Svantesson M<br/>2 questions"]
    ...
    style C2 fill:#52bdec,color:#000000
```
