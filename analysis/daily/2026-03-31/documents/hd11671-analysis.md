...
```mermaid
graph LR
    A[HD11671<br/>Fråga 671] --> B{Worker Safety}
    B --> C[Asbestos Exposure]
    B --> D[Regulatory Oversight]
    A --> E{Opposition Pressure}
    E --> F[S Worker Rights Narrative]
    A --> G{Government Vulnerability}
    G --> H[Arbetsmiljöverket Failure]
    G --> I[L Minister Responsibility]
    ...
    style I fill:#fd7e14,stroke:#333,color:#000
```
