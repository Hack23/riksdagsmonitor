...
```mermaid
graph LR
    A["HD01UU6<br/>Säkerhetspolitik"] --> B{Security Domain}
    B --> C["NATO Integration"]
    B --> D["Defense Spending"]
    B --> E["Threat Assessment"]
    A --> F{Parliamentary Consensus}
    F --> G["Cross-Party Core"]
    F --> H["Expenditure Fault Lines"]
    A --> I{Strategic Impact}
