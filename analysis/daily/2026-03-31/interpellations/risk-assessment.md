...
```mermaid
graph TD
    subgraph "⚖️ Aggregate Risk Matrix — 2026-03-31 Interpellations"
        R1["🟡 Coalition Stability<br/>Avg: L:2 × I:2.5 = 5"]
        R2["🔴 Policy Implementation<br/>Avg: L:4.5 × I:3 = 13.5"]
        R3["🟠 Budget / Fiscal<br/>Avg: L:3.5 × I:2.5 = 9"]
        R4["🟡 Electoral Impact<br/>Avg: L:3 × I:3 = 9"]
        R5["🟡 Democratic Process<br/>Avg: L:2 × I:2 = 4"]
