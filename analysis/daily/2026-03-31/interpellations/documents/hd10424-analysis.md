...
```mermaid
graph LR
    A["HD10424<br/>Flyglinjen Torsby/Hagfors–Arlanda"] --> B{Sensitivity}
    B -->|"🟡 SENSITIVE"| D["Regional accessibility<br/>& emergency preparedness"]

    A --> G{Domain}
    G --> H["Transport (TRA)<br/>+ Defence (DEF)"]
...
```mermaid
graph TD
    subgraph "⚖️ Political Risk Matrix — HD10424"
