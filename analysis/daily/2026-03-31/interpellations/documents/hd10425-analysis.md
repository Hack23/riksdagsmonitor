...
```mermaid
graph LR
    A["HD10425<br/>Infrastructure costs<br/>for defence establishments"] --> B{Sensitivity}
    B -->|"🟡 SENSITIVE"| D["Defence infrastructure<br/>& inter-agency coordination"]

    A --> G{Domain}
    G --> H["Defence (DEF)<br/>+ Transport (TRA)<br/>+ Municipal Gov (GOV)"]

    A --> I{Urgency}
    I -->|"🟠 URGENT"| K["Active base construction<br/>Response by 2026-04-21"]
...
```mermaid
graph TD
    subgraph "⚖️ Political Risk Matrix — HD10425"
        R1["🟡 Coalition Stability<br/>L:2 × I:3 = 6"]
        R2["🔴 Policy Implementation<br/>L:5 × I:3 = 15"]
        R3["🟠 Budget / Fiscal<br/>L:4 × I:3 = 12"]
