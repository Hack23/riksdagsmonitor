...
```mermaid
graph TD
    subgraph "💼 SWOT Analysis — 2026-03-31 Propositions"
        subgraph "✅ Strengths"
            S1["S1: 3/4 propositions from<br/>single ministry — coordinated<br/>justice reform agenda"]
            S2["S2: Coalition voting alignment<br/>KD-M 88.5%, L-M 87.9%"]
            S3["S3: Clear committee routing<br/>SfU, CU, AU assigned"]
        end
        subgraph "⚠️ Weaknesses"
            W1["W1: Migration proposals require<br/>SD support — dependency risk"]
            W2["W2: Narrow thematic focus<br/>may neglect other priorities"]
        end
        subgraph "🔵 Opportunities"
            O1["O1: Consumer credit reform<br/>HD03223 — broad support"]
            O2["O2: Victim compensation reform<br/>HD03222 — cross-party appeal"]
            O3["O3: Migration reform momentum<br/>from 2 coordinated proposals"]
        end
        subgraph "🔴 Threats"
            T1["T1: Opposition S,V,MP will<br/>challenge migration propositions"]
