...
graph TD
    ...
    T3[🟠 T-03: Democratic Accountability Gap<br/>MJU20 — Riksrevisionen ignored<br/>Severity: MEDIUM-HIGH]
    T4[🟡 T-04: Social Safety Risks<br/>TU16 driving deregulation<br/>Severity: MEDIUM]
    T5[🔵 T-05: Geopolitical Exposure<br/>UFöU3 NATO Finland<br/>Severity: HIGH with EXTERNAL driver]

    T1 --> ECHR[ECHR Art. 5 Liberty]
    T2 --> PARIS[Paris Agreement obligations]
    T3 --> PARL[Parliamentary oversight weakness]
    T4 --> SAFETY[Traffic safety statistics]
    T5 --> RUSSIA[Russian escalation dynamics]
```
