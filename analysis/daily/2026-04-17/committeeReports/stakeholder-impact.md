...
graph TD
    ...
    GOV -->|SUPPORT| UFöU3[UFöU3 NATO Finland]
    OPP[🔴 Opposition<br/>S-V-MP] -->|RESERVE x9| MJU19[MJU19 Waste Reform]
    OPP -->|RESERVE| MJU20[MJU20 Climate]
    OPP -->|CHALLENGE| SfU_PKG
    CIT[👥 Citizens] -->|BENEFIT| FiU48
    CIT -->|BENEFIT| SfU20_perm[SfU20 Parental Leave]
    CIT -->|CONCERNED| SfU_PKG
    BIZ[🏢 Business] -->|BENEFIT| SkU23[SkU23 EV Tax Perm.]
    BIZ -->|COMPLIANCE COST| MJU19
    CSO[🤝 Civil Society] -->|RESIST| SfU_PKG
    INT[🌍 EU/International] -->|MONITOR| FiU48
    INT -->|SCRUTINISE| SfU_PKG
    JUD[⚖️ Judiciary] -->|REVIEW| SfU31[SfU31 Detention]
    MED[📰 Media] -->|COVERS| FiU48
    MED -->|POLARISED| SfU_PKG
```
