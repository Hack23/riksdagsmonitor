...
graph LR
    ...
    A --> UFöU3[⚔️ UFöU3<br/>NATO Finland<br/>Forward Presence]
    A --> MJU19[♻️ MJU19<br/>Waste Law Reform<br/>9 Reservations]
    A --> MJU20[🌡️ MJU20<br/>Climate Governance<br/>Riksrevisionen]
    
    FiU48 --> ELECTION[🗳️ Election 2026<br/>Signals]
    SfU_BLOC --> ELECTION
    UFöU3 --> NATO_POLICY[NATO Integration]
    MJU19 --> EU_COMPLIANCE[EU Green Law]
    MJU20 --> CLIMATE_CRED[Climate Credibility]
```
