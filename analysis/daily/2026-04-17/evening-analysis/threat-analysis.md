...
```mermaid
graph TD
    ROOT["⚠️ Parliamentary Threat Landscape<br/>2026-04-17"] --> T1["🔴 Institutional Failure"]
    ROOT --> T2["⚖️ Constitutional Risks"]
    ROOT --> T3["🌍 EU Compliance Risks"]
    ROOT --> T4["💰 Economic/Fiscal Risks"]
    ROOT --> T5["🏘️ Social Cohesion Risks"]
    ROOT --> T6["🗳️ Democratic Legitimacy Risks"]

    T1 --> T1A["Q719: Skatteverket demanding\ntax from trafficking victims\nSeverity: 5/5"]
    T1 --> T1B["CU42: Poor state oversight\nof estate administration\nSeverity: 2/5"]

    T2 --> T2A["KU33: Restricting public access\nto seized digital materials\nSeverity: 4/5"]
    T2 --> T2B["KU32: Constitutional amendment\nfor media accessibility — procedural\nSeverity: 1/5"]

    T3 --> T3A["IP437: Wage Transparency\nDirective implementation lag\nSeverity: 3/5"]
    T3 --> T3B["KU32 EU Accessibility Act\nconstitutional compliance\nSeverity: 2/5"]

    T4 --> T4A["HD024098: Fuel tax cuts\nin extra budget — climate cost\nSeverity: 4/5"]
    T4 --> T4B["Q719: State revenue\nvs victim protection\nSeverity: 5/5"]

    T5 --> T5A["IP438: Women's shelter\nclosures — NGO sector pressure\nSeverity: 4/5"]
    T5 --> T5B["Q718: State retreat\nfrom SE Skåne periphery\nSeverity: 3/5"]
