...
```mermaid
graph TD
    EXT["Extra Budget\nprop. 2025/26:236\n(fuel tax + energy)"] --> MP["HD024098\nMP Motion:\nReject fuel tax cut\nJanine Alm Ericson (MP)"]
    
    GOV_GUARD["Government proposition\n(guardianship reform)"] --> CU22["HD01CU22\nCU22 Betänkande:\nGuardianship trustee reform"]
    GOV_DEED["Government proposition\n(property deed identity)"] --> CU27["HD01CU27\nCU27 Betänkande:\nProperty deed ID + housing coop"]
    GOV_REG["Government proposition\n(housing coop register)"] --> CU28["HD01CU28\nCU28 Betänkande:\nNew housing coop register"]
    
    RIKSREV["Riksrevisionens rapport\n(estate management)"] --> CU42["HD01CU42\nCU42 Betänkande:\nEstate mgmt audit response"]
    
    EU_ACCESS["EU Accessibility Act\n(2019/882)"] --> KU32["HD01KU32\nKU32 Betänkande:\nMedia accessibility (vilande)"]
    
    SEIZURE_PROP["Government proposition\n(KU33 seizure secrecy)"] --> KU33["HD01KU33\nKU33 Betänkande:\nSeized document privacy"]
    
    WAGE_DIR["EU Wage Transparency\nDirective 2023/970"] --> IP437["HD10437\nIP437 Interpellation:\nSofia Amloh (S) → Larsson (L)"]
    
    SHELTER_FUND["Municipal procurement\nreform / shelter funding"] --> IP438["HD10438\nIP438 Interpellation:\nSofia Amloh (S) → Larsson (L)"]
    
    STATE_SKANE["State service\nwithdrawal policy"] --> Q718["HD11718\nQ718 Question:\nMagnusson (S) → Slottner (KD)"]
    
    TRAFFIC_CASE["Västernorrland\ntrafficking case"] --> Q719["HD11719\nQ719 Question:\nStrandhäll (S) → Svantesson (M)"]
...
timeline
    ...
    section Evening
        Votes likely on committee reports
        MP motion HD024098 before Finance Committee
```
