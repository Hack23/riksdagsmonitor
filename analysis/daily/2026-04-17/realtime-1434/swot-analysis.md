...
graph TD
    ...
    style S3N fill:#28a745,color:#fff
    style S4N fill:#28a745,color:#fff
    style W1N fill:#fd7e14,color:#fff
    style W2N fill:#fd7e14,color:#fff
    style W3N fill:#fd7e14,color:#fff
    style W4N fill:#fd7e14,color:#fff
    style O1N fill:#0d6efd,color:#fff
    style O2N fill:#0d6efd,color:#fff
    style O3N fill:#0d6efd,color:#fff
    style T1N fill:#dc3545,color:#fff
    style T2N fill:#dc3545,color:#fff
    style T3N fill:#dc3545,color:#fff
    style T4N fill:#dc3545,color:#fff
    style T5N fill:#dc3545,color:#fff
```
