...
```mermaid
graph TD
    A[Government: M+KD+L+SD\nProp 235+228+236 advancing] --> B{Opposition response}
    B --> C[V: Total rejections\nmot 4090,4091,4092\nMax opposition]
    B --> D[C: Constructive amendments\nmot 4093,4094,4095\nCentrist positioning]
    B --> E[MP: Selective acceptance\nmot 4096,4097\nPrincipled opposition]
    C --> F[Risk: Marginalisation]
