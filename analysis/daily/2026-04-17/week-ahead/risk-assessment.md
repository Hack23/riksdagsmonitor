...
quadrantChart
    ...
    "EU fisheries compliance failure": [0.25, 0.55]
    "April 23 committee overload": [0.40, 0.30]
    "Wallström hearing political theatre": [0.70, 0.40]
    "Shelter closure media storm": [0.75, 0.65]
```
