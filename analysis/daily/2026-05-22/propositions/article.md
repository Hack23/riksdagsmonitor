...
keywords: "Propositions, English, May 22, 2026 update, Riksdagsmonitor, Swedish Parliament, Riksdag, political intelligence, OSINT, Swedish politics, democratic transparency, Sweden Abolishes Permanent Residence Expands, Sweden, Abolishes, Permanent, Residence, Expands, Security, Deportation, Pre-Election, Legislative, Reckoning, Busch, government, submitted"
date: 2026-05-22
subfolder: propositions
slug: 2026-05-22-propositions
source_folder: analysis/daily/2026-05-22/propositions
generated_at: 2026-05-22T13:53:54.813Z
language: en
layout: article
---
## Executive Brief
...
```mermaid
graph TB
  subgraph Migration["🔴 Migration Architecture (5 props, DIW×1.5)"]
    HD03262["HD03262\nResidence Abolition\nDIW:132"]
    HD03267["HD03267\nSecurity Threats\nDIW:136.5"]
    HD03265["HD03265\nDetention\nDIW:124.5"]
    HD03263["HD03263\nDeportation\nDIW:108"]
  ...
  subgraph Digital["🟠 Digital State (2 props)"]
    HD03250["HD03250\nState e-ID\nDIW:84"]
    HD03261["HD03261\nSkatteverket\nDIW:118.5"]
  end
  subgraph Defence["🔵 Defence (1 prop)"]
    HD03254["HD03254\nMilitary Coop\nDIW:117"]
  end
  subgraph Governance["🟡 Governance (2 props)"]
    HD03258["HD03258\nTransparency\nDIW:74"]
    HD03251["HD03251\nMental Health\nDIW:58"]
  end

  Migration --> ELECTION["2026-09-13\nElection\nSD-M-KD-L positioning"]
  Digital --> ELECTION
  Defence --> ELECTION
  Governance --> ELECTION

  style Migration fill:#3a0000,color:#ffaaaa
  style Digital fill:#1a2200,color:#ccffaa
  style Defence fill:#001a3a,color:#aaccff
  style Governance fill:#2a2200,color:#ffffaa
  style ELECTION fill:#1a1a1a,color:#ffffff
```
...
gantt
  ...
  section T+72h
    C first comment (PIR-6) :done, 2026-05-25, 1d
    UNHCR statement :done, 2026-05-24, 1d
    SD response (PIR-5) :done, 2026-05-24, 1d
  section T+7d
    SfU scheduling :crit, 2026-05-29, 1d
    Lagrådet remiss decision :crit, 2026-05-29, 1d
  section T+30d
    C formal SfU position (PIR-6) :crit, 2026-06-15, 1d
    Lagrådet opinion (PIR-1) :crit, 2026-06-15, 1d
    SD acceptance of amendment (PIR-5) :crit, 2026-06-20, 1d
    IMY response (PIR-3) :2026-07-01, 1d
    KU scheduling (PIR-7) :2026-06-10, 1d
  section T+90d+
    Summer recess begins :milestone, 2026-06-25, 0d
    SfU plenary vote :crit, 2026-07-15, 1d
    Autumn session fallback :2026-08-20, 1d
    Sweden election :milestone, 2026-09-13, 0d
```
...
mindmap
  root((SWOT\n2026-05-22))
    Strengths
      Cluster coherence
      Fiscal capacity
      SD alignment secured
    Weaknesses
      Migrationsverket capacity gap
      Digg project delivery risk
      Lagrådet HD03267 exposure
    Opportunities
      Denmark precedent HD03262
      eIDAS 2.0 HD03250
      NATO HD03254 timing
    Threats
      C fracture HD03262
      ECHR Art.3 HD03267
      IMY enforcement HD03261
```
...
```mermaid
timeline
  title Swedish Migration Policy Trajectory
  1954 : Passport freedom for Nordic citizens
  1967 : Labour market migration peaks
  1989 : Aliens Act — rights codification (S government)
  1994 : EU membership — free movement for EEA
  2001 : Temporary protection directive (Bosnia precedent)
  2015 : Refugee crisis — 163,000 applications
  2016 : Temporary limits — Prop 2015/16:174
  2021 : Denmark paradigmeskift — Nordic precedent
  2022 : Stricter conditions — Prop 2021/22:134
  2026 : Abolition of permanent residence + security fast-track (HD03262-HD03267)
```
...
```mermaid
timeline
  title Swedish Migration Legislative Chain 2015–2026
  2015 : Prop 2015/16:174 Temporary Measures (EU refugee crisis)
  2016 : Utlänningslag amendments — quota system
  2019 : Prop 2018/19:128 Extension temporary measures
  2021 : Prop 2021/22:6 New migration regime (permanent temporary shift)
  2022 : Prop 2021/22:134 Stricter conditions
  2024 : Prop 2023/24:89 Further tightening
  2025 : Prop 2024/25:71 Court efficiency
  2026 : HD03262 Abolition permanent residence + HD03263-HD03267 full enforcement cluster
```
