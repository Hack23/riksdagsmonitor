...
graph TD
    subgraph "📊 Daily Political Intelligence Dashboard"
        ...
        subgraph "🔒 Sensitivity"
            CLS["Sensitivity<br/>SENSITIVE<br/>Defense & Justice legislation"]
        end
        subgraph "⚖️ Risk"
            RSK["Overall Risk<br/>MEDIUM-HIGH<br/>Top: RSK-001 Prison capacity crisis L×I=16"]
        end
        subgraph "🎭 Threat"
            THR["Threat Level<br/>MODERATE<br/>Top Category: LI — Legislative Implementation"]
        end
        subgraph "📈 Significance"
            SIG["Top Significance<br/>7.0/10<br/>Priority — Analysis Only"]
        end
    end

    subgraph "🎯 Editorial Decision"
        DEC{Article Decision}
        DEC -->|"Sunday — no live events"| MON["📋 Analysis Only"]
    end
    ...
    style SIG fill:#1565C0,stroke:#424242,stroke-width:2px,color:#FFFFFF
...
graph LR
    subgraph "🏛️ Government Coalition Assessment"
        GS["✅ Strengths<br/>8 entries<br/>Dominant: Tidö Agreement delivery on crime & defense"]
        GW["⚠️ Weaknesses<br/>6 entries<br/>Critical: Prison capacity gap & ECHR risk"]
        GO["🚀 Opportunities<br/>5 entries<br/>Top: Election positioning on security agenda"]
        GT["🔴 Threats<br/>6 entries<br/>Top: Implementation gaps undermine credibility"]
    end
