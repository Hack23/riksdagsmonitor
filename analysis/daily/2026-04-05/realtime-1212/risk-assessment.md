...
```mermaid
graph TD
    subgraph "⚖️ Political Risk Matrix — April 2026"
        direction TB
        subgraph "HIGH Impact"
            R1["🔴 RSK-001<br/>Prison Capacity Crisis<br/>L=4 I=4 Score=16"]
            R3["🟠 RSK-003<br/>Cyber Threat Escalation<br/>L=3 I=5 Score=15"]
        end
        subgraph "MEDIUM Impact"
            R2["🟠 RSK-002<br/>ECHR Challenge<br/>L=3 I=4 Score=12"]
            R5["🟡 RSK-005<br/>Implementation Gap<br/>L=3 I=4 Score=12"]
            R4["🟡 RSK-004<br/>Defense Funding Gap<br/>L=2 I=4 Score=8"]
        end
    end
