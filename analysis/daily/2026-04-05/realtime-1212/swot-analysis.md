...
```mermaid
graph TD
    subgraph "📊 Political SWOT Landscape — Week 14"
        direction TB
        subgraph "✅ Strengths"
            S1N["💪 S1: 4 props in one day"]
            S2N["💪 S2: SD alignment solid"]
        end
        subgraph "⚠️ Weaknesses"
            W1N["⚡ W1: Prison capacity crisis"]
            W2N["⚡ W2: ECHR risk"]
        end
        subgraph "🚀 Opportunities"
            O1N["🌟 O1: Election positioning"]
            O2N["🌟 O2: NATO cooperation"]
        end
        subgraph "🔴 Threats"
            T1N["☁️ T1: Implementation gap"]
            T2N["☁️ T2: Geo escalation"]
        end
    end
