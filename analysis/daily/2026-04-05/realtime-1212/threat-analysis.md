...
```mermaid
graph TD
    subgraph "🎭 Political Threat Landscape — April 2026"
        direction TB
        LI["📋 Legislative Implementation<br/>MODERATE<br/>Prison and enforcement capacity gaps"]
        AC["🔒 Accountability<br/>LOW<br/>Standard committee review process"]
        TR["🌐 Transnational<br/>MODERATE<br/>Cyber threats and ECHR challenges"]
        DP["🏛️ Democratic Process<br/>LOW<br/>Cross-party consensus on defense"]
    end
