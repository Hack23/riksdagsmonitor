...
```mermaid
graph TD
    subgraph "👥 Stakeholder Impact — Security and Justice Package"
        direction TB
        CIT["🏘️ Citizens<br/>Impact: HIGH<br/>Direction: Mixed"]
        GOV["🏛️ Government<br/>Impact: HIGH<br/>Direction: Positive"]
        OPP["🗳️ Opposition<br/>Impact: MEDIUM<br/>Direction: Negative"]
        BIZ["🏭 Business<br/>Impact: MEDIUM<br/>Direction: Positive"]
        CIV["🤝 Civil Society<br/>Impact: HIGH<br/>Direction: Negative"]
        INT["🌍 International<br/>Impact: HIGH<br/>Direction: Mixed"]
        JUD["⚖️ Judiciary<br/>Impact: HIGH<br/>Direction: Mixed"]
        MED["📺 Media<br/>Impact: HIGH<br/>Direction: Amplifying"]
    end

    GOV -->|"delivers to"| CIT
    OPP -->|"critiques for"| CIT
