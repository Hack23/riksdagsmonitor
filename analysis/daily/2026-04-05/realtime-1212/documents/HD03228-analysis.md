...
```mermaid
graph TD
    subgraph "📊 HD03228 — Arms Export Regulation SWOT"
        direction TB
        subgraph "✅ Strengths"
            S1N["💪 S1: NATO alignment"]
            S2N["💪 S2: Cross-party majority"]
        end
        subgraph "⚠️ Weaknesses"
            W1N["⚡ W1: Export loosening risk"]
            W2N["⚡ W2: Policy tradition break"]
        end
        subgraph "🚀 Opportunities"
            O1N["🌟 O1: Industry revenues"]
            O2N["🌟 O2: NATO partnership"]
        end
        subgraph "🔴 Threats"
            T1N["☁️ T1: Polarization"]
            T2N["☁️ T2: End-use scrutiny"]
        end
    end
