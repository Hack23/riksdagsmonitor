...
keywords: "JuU10, JuU31, CU24, SoU25, JuU, CU, SoU, Malmer Stenergard, Christophe Sahabo, Three Socialdemokraterna MPs, Johanna Haraldsson, Labour Minister Britz, IF Metall, Anna Wallentheim, Education Minister Mohamsson, Olle Thorell, Foreign Minister Malmer Stenergard, SD s Josef Fransson, Energy Minister Busch, Riksdagsmonitor, Swedish Parliament, Riksdag, political intelligence, OSINT"
date: 2026-04-26
subfolder: motions
slug: 2026-04-26-motions
source_folder: analysis/daily/2026-04-26/motions
generated_at: 2026-05-24T17:19:39.188Z
language: en
layout: article
---
## Executive Brief
...
```mermaid
graph TD
    A["Riksdag 2026-04-24<br/>Opposition Parliamentary Activity"] --> B["Cluster A: L-ministeriet\nAnsvarsutkrävande"]
    A --> C["Cluster B: Konsulärt skydd\nBurundi"]
    A --> D["Cluster C: Energinarrativ\nSD vs Windeurope/SVT"]
    A --> E["Lagstiftning: JuU10/JuU31/CU24/SoU25"]
    
    B --> F["Systemfel: Arbetsförmedlingen\n+ Kriminalvård/utbildning"]
    C --> G["MR-trovärdighet\n(Sahabo/Burundi)"]
    D --> H["Koalitionsspänning\nKD/SD energi"]
    E --> I["Ny vapenlag, polisreform,\nbyggprocess, äldrevård"]
...
```mermaid
graph LR
    A["KJ-2: Barnrätt KRITISK\n(Almost certain)"] --> B["PIR-3: Lagstiftning\ntidslinje"]
    C["KJ-1: S strategi\n(Likely)"] --> D["PIR-5: Interpellation\neskalering"]
    E["KJ-5: Myndighets-\ndeflektering (Likely)"] --> F["PIR-1: Svar\n2026-05-06"]
...
```mermaid
graph LR
    A["DIW Ranking<br/>2026-04-24"] --> B["#1 HD11749<br/>8.5 — Barnrätt\nin kriminalvård"]
    A --> C["#2 HD11747<br/>8.2 — Lönestöd\nfarlig arbetsmiljö"]
    A --> D["#3 HD10448<br/>7.8 — Vindkraft\ndesinformation"]
    A --> E["#4 HD11748<br/>7.2 — Sahabo\nBurundi"]
    A --> F["#5-8 Betänkanden\n5.2–6.8"]
...
```mermaid
graph LR
    A["CU24 — Effektiv och säker byggprocess"] --> B["Riksdagen behandlar"]
    style A fill:#1565C0,color:#FFFFFF
...
```mermaid
graph LR
    A["Prop. En ny vapenlag"] --> B["JuU10 — Betänkande"]
    B --> C["Riksdag: Ja"]
    B --> D["Oppositionsreservationer\n(semi-auto jaktgevär)"]
...
```mermaid
graph TD
    A["Polisreformen 2015"] --> B["Riksrevisionens granskning 2025"]
    B --> C["Slutsats: Otillräcklig effektivitet"]
    C --> D["Regeringen: ny styrning\nmed fokus på mål"]
    D --> E["JuU31 — Betänkande: skrivelse godkänd"]
...
```mermaid
graph LR
    A["SoU25 — Äldre och anhörigvård"] --> B["Riksdagen behandlar"]
    style A fill:#1565C0,color:#FFFFFF
    style B fill:#4CAF50,color:#FFFFFF
```
...
```mermaid
graph TD
    A["HD10448 — Interpellation SD/Fransson"] --> B["Windeurope rapport 2026-04-21"]
    B --> C["SVT/SR rapporterar: 'rysk desinformation'"]
    C --> D["Fransson: kritik = desinformation?"]
    D --> E["Ebba Busch tvingas svara"]
    E --> F1["Försvarar rapport → legitimerar narrativ"]
    E --> F2["Distanserar sig → EU-friktion"]
...
```mermaid
graph LR
    A["HD11747 — S/Haraldsson fråga"] --> B["Skåneföretag med lönebidrag"]
    B --> C["Formalin utan skydd\n(Arbetsmiljöverket bekräftar)"]
    C --> D["IF Metall larmar upprepade ggr"]
    D --> E["Arbetsförmedlingen fortsätter placeringar"]
    E --> F["Fråga till Britz/L"]
    
    style A fill:#E53935,color:#FFFFFF
    style B fill:#FF9800,color:#FFFFFF
    style C fill:#F44336,color:#FFFFFF
    style D fill:#FF9800,color:#FFFFFF
...
```mermaid
graph TD
    A["HD11748 — S/Thorell fråga"] --> B["Christophe Sahabo\n(svensk medborgare)"]
    B --> C["Frihetsberövad i Burundi"]
    C --> D["Burundi: negativ\npolitisk utveckling (Freedom House)"]
    D --> E["Fråga till Malmer Stenergard/M"]
    E --> F["Svarsdatum 2026-05-06"]
...
```mermaid
graph TD
    A["HD11749 — S/Wallentheim fråga"] --> B["Regeringen: barn 13+ i Kriminalvården"]
    B --> C["Ny skolform planeras\n(ingen lagstiftning ännu)"]
    C --> D["Institutet för mänskliga rättigheter:\nbristande rättsliga förutsättningar"]
    D --> E["Wallentheim → Mohamsson/L"]
    E --> F["Vilka garantier för\nlikvärdig utbildning?"]
...
```mermaid
graph TD
    A["349 riksdagsmandat"] --> B["Regering + stöd:\n176 mandat\n(M+KD+L+SD)"]
    A --> C["Opposition:\n173 mandat\n(S+C+V+MP)"]
    B --> D["Majoritet: 3 mandat\n— tunn marginal"]
    C --> E["Behöver +2 mandat\nför majoritet"]
...
```mermaid
graph LR
    A["Väljarsegment 2026"] --> B["Funktionsnedsatta/\nfackliga (S-konsolidering)"]
    A --> C["Föräldrar/utbildning\n(tvärsektoriellt)"]
    A --> D["Landsbygd/energi\n(SD-konsolidering)"]
    A --> E["MR-engagerade\n(S/MP)"]
