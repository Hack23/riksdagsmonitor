...
```mermaid
%%{init: {'theme': 'dark', 'themeVariables': {'primaryColor': '#00d9ff', 'edgeLabelBackground': '#0a0e27', 'tertiaryColor': '#1a1e3d'}}}%%
flowchart TD
