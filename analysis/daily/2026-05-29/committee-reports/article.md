...
generated_at: 2026-05-29T19:05:10.237Z
language: en
layout: article
---
## What Happened
...
```mermaid
flowchart TD
  B[Committee batch 2026-05-28] --> C1[High controversy]
  B --> C2[Consensus]
  B --> C3[Constitutional]
  C1 --> NU20[HD01NU20 wind 10 res]
  C1 --> UbU23[HD01UbU23 curricula 11 res]
  C3 --> JuU35[HD01JuU35 sentences abroad 3 res]
  C2 --> MJU27[HD01MJU27 food fraud]
  C2 --> TU17[HD01TU17 telecom fraud]
  C2 --> TU18[HD01TU18 interoperability]
  C2 --> CU44[HD01CU44 EU subsidiarity]
  style C1 fill:#ff006e,color:#fff
  style C3 fill:#ffbe0b,color:#000
  style C2 fill:#00d9ff,color:#000
```
...
mindmap
  root((Committee batch 2026-05-29))
    High controversy
      HD01NU20 wind power
        10 reservations
        Energy wedge
        Veto bottleneck unresolved
      HD01UbU23 curricula
        11 reservations
        Knowledge-school identity
        Reversal risk post-2026
    Constitutional
      HD01JuU35 sentences abroad
        Qualified majority RF 10
        Needs S support
        Estonia capacity
    Consensus
      HD01MJU27 food fraud
      HD01TU17 telecom fraud
      HD01TU18 interoperability
      HD01CU44 EU subsidiarity
    Cross-cutting
      Votes pending
      EU integration thread
...
```mermaid
flowchart TD
  BATCH[7 committee reports] --> SPLIT{Controversy level}
  SPLIT -->|HIGH| FLAG[HD01NU20 HD01UbU23]
  SPLIT -->|MEDIUM constitutional| JUST[HD01JuU35]
  SPLIT -->|LOW| CONS[HD01MJU27 HD01TU17 HD01TU18 HD01CU44]
  FLAG --> KJ1[KJ-1 HIGH passage + salience]
  JUST --> KJ2[KJ-2 MEDIUM qualified majority]
  CONS --> KJ3[KJ-3 HIGH passage]
  KJ1 --> PIR1[PIR votes]
  KJ2 --> PIR2[PIR majority]
  KJ3 --> KJ4[KJ-4 MEDIUM implementation]
  style FLAG fill:#ff006e,color:#fff
  style JUST fill:#ffbe0b,color:#000
  style CONS fill:#00d9ff,color:#000
  style KJ1 fill:#1a1e3d,color:#fff
```
...
```mermaid
graph TB
  GOV[Tidö government M KD L] --> SD[SD support party]
  GOV --> AGENCIES[Public agencies]
  OPP[Opposition bloc] --> S[Socialdemokraterna]
  OPP --> V[Vänsterpartiet]
  OPP --> C[Centerpartiet]
  OPP --> MP[Miljöpartiet]
  AGENCIES --> KRIM[Kriminalvården HD01JuU35]
  AGENCIES --> SKOL[Skolverket HD01UbU23]
  AGENCIES --> LIVS[Livsmedelsverket HD01MJU27]
  AGENCIES --> PTS[PTS HD01TU17]
  AGENCIES --> DIGG[DIGG HD01TU18]
  GOV --> NU20[HD01NU20 wind]
  GOV --> UbU23[HD01UbU23 curricula]
  OPP --> NU20
  OPP --> UbU23
  style GOV fill:#00d9ff,color:#000
  style OPP fill:#ff006e,color:#fff
  style SD fill:#ffbe0b,color:#000
  style AGENCIES fill:#1a1e3d,color:#fff
```
...
```mermaid
graph TB
  ELEC[Swedish electorate] --> RURAL[Rural / landowner]
  ELEC --> PARENTS[Parents / teachers]
  ELEC --> SECVOTE[Security-focused]
  ELEC --> GREEN[Climate-first]
  ELEC --> CIVLIB[Civil-liberties]
  ELEC --> CONSUM[Consumers]
  RURAL --> NU[HD01NU20 wind]
  PARENTS --> UBU[HD01UbU23 curricula]
  SECVOTE --> JU[HD01JuU35 sentences abroad]
  GREEN --> NU
  CIVLIB --> JU
  CONSUM --> MJ[HD01MJU27 / HD01TU17]
  style ELEC fill:#1a1e3d,color:#fff
  style NU fill:#ffbe0b,color:#000
  style UBU fill:#ff006e,color:#fff
  style JU fill:#00d9ff,color:#000
```
...
gantt
  ...
  section T+72h
  Recorded chamber votes posted        :2026-05-29, 3d
  Party reactions to vote outcomes     :2026-05-30, 2d
  section T+7d
  Media volume on flagships            :2026-05-30, 7d
  S position confirmed on HD01JuU35    :2026-06-01, 5d
  section T+30d
  Skolverket rollout signals           :2026-06-05, 25d
  Wind payout mechanism detail         :2026-06-10, 20d
  section T+90d
  DIGG interoperability onboarding     :2026-06-15, 75d
  EU peer subsidiarity responses       :2026-06-20, 70d
```
...
```mermaid
flowchart TD
  R[349 seats majority 175] --> G[Government + SD support 176]
  R --> O[Opposition 173]
  G --> M[M 68]
  G --> SD[SD 73 support]
  G --> KD[KD 19]
...
%%{init: {'theme':'base','themeVariables':{'primaryColor':'#1a1e3d','primaryTextColor':'#e0e0e0','lineColor':'#00d9ff'}}}%%
quadrantChart
  title Government legislative position (HD01NU20 / HD01UbU23 / HD01JuU35)
  x-axis Low political risk --> High political risk
  y-axis Low strategic value --> High strategic value
  quadrant-1 Invest and campaign
  quadrant-2 Defend and frame
  quadrant-3 Maintain quietly
  quadrant-4 Monitor and de-risk
  "HD01NU20 wind": [0.75, 0.80]
  "HD01UbU23 curricula": [0.82, 0.78]
  "HD01JuU35 sentences": [0.65, 0.60]
  "HD01TU17 telecom": [0.30, 0.45]
  "HD01TU18 interop": [0.35, 0.40]
  "HD01MJU27 food": [0.20, 0.35]
  "HD01CU44 EU": [0.25, 0.30]
```
...
%%{init: {'theme':'base','themeVariables':{'primaryColor':'#1a1e3d','primaryTextColor':'#e0e0e0','lineColor':'#00d9ff'}}}%%
timeline
  title Precedents for the 2026-05-29 batch
  2009 : Wind-power planning reform : streamlined permitting debate (HD01NU20 lineage)
  2011 : Curriculum reform Lgr11 : prior major curricula overhaul (HD01UbU23 lineage)
  2018 : EU GDPR enters force : data-protection baseline (HD01TU18 lineage)
  2022 : Denmark Kosovo cell-rental deal : sentences-abroad precedent (HD01JuU35 lineage)
  2022 : lag 2022:482 telecom rules : statute now amended (HD01TU17 lineage)
  2024 : EU Interoperable Europe Act : basis for prop. 2025/26:244 (HD01TU18 lineage)
  2026 : This batch : seven committee reports
```
...
```mermaid
graph LR
  SE[Sweden batch] --> NU[HD01NU20 wind benefit]
  SE --> JU[HD01JuU35 sentences abroad]
  SE --> TU[HD01TU18 interoperability]
  NU --> DK1[DK local bonus]
  NU --> NO1[NO municipal tax]
  JU --> DK2[DK Kosovo cell rental]
  TU --> EU[EU Interoperable Europe Act]
  TU --> NO2[NO Altinn platform]
  style SE fill:#00d9ff,color:#000
  style EU fill:#ffbe0b,color:#000
  style DK2 fill:#ff006e,color:#fff
```
...
```mermaid
flowchart TD
  LAW[Legislation passed] --> CAP{Agency capacity adequate?}
  CAP -->|Yes| DELIVER[On-time delivery]
  CAP -->|No| RISK[Delivery risk / delay]
  RISK --> SKOL[Skolverket training load HD01UbU23]
  RISK --> KRIM[Kriminalvården transfer logistics HD01JuU35]
  RISK --> DIGG[DIGG onboarding scale HD01TU18]
  style DELIVER fill:#00d9ff,color:#000
  style RISK fill:#ff006e,color:#fff
  style DIGG fill:#ffbe0b,color:#000
```
...
```mermaid
graph LR
  NU[HD01NU20 wind] --> F1[Govt frame: local benefit delivered]
  NU --> F2[Opp frame: too little too late]
  UBU[HD01UbU23 curricula] --> F3[Govt frame: knowledge & standards]
  UBU --> F4[Opp frame: politicised disruption]
  JU[HD01JuU35 sentences abroad] --> F5[Govt frame: capacity & order]
  JU --> F6[Opp flank: rights & constitution]
  TU[HD01TU18 interoperability] --> F7[Frame: competent digital state]
  style F1 fill:#00d9ff,color:#000
  style F2 fill:#ff006e,color:#fff
  style F3 fill:#00d9ff,color:#000
  style F4 fill:#ff006e,color:#fff
  style F5 fill:#00d9ff,color:#000
  style F6 fill:#ffbe0b,color:#000
```
...
```mermaid
flowchart TD
  EV[Evidence set] --> H1[H1 Bifurcated baseline]
  EV --> H2[H2 Sleeper interoperability]
  EV --> H3[H3 Constitutional primacy]
  EV --> H4[H4 Null housekeeping]
  H1 --> R1[Most consistent overall]
  H2 --> R2[Cannot be rejected - watch HD01TU18]
  H3 --> R3[Over-claims drama, passage likely]
  H4 --> R4[Rejected - reservations + election]
  style H1 fill:#00d9ff,color:#000
  style H2 fill:#ffbe0b,color:#000
  style H3 fill:#ffbe0b,color:#000
  style H4 fill:#ff006e,color:#fff
```
...
```mermaid
graph LR
  NU20[HD01NU20 wind] --> ENERGY[Energy & permitting policy]
  UbU23[HD01UbU23 curricula] --> SKOLLAG[Skollagen / Skolverket]
  JuU35[HD01JuU35 sentences abroad] --> RF10[RF 10 kap qualified majority]
  JuU35 --> KRIM[Kriminalvården]
  MJU27[HD01MJU27 food fraud] --> LIVS[Livsmedelsverket / EU food law]
  TU17[HD01TU17 telecom fraud] --> LAG2022[lag 2022:482 / PTS]
  TU18[HD01TU18 interoperability] --> PROP244[prop. 2025/26:244]
  TU18 --> DIGG[DIGG / EU IEA]
  CU44[HD01CU44 EU Inc.] --> EUCO[EU company law]
  style NU20 fill:#ff006e,color:#fff
  style UbU23 fill:#ff006e,color:#fff
  style JuU35 fill:#ffbe0b,color:#000
  style TU18 fill:#00d9ff,color:#000
  style CU44 fill:#00d9ff,color:#000
```
