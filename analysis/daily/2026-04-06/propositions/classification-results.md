...
Classified **4** parliamentary documents by sensitivity, impact, urgency, and domain.
...
1. **Stärkt medicinsk kompetens i kommunal hälso- och sjukvård** (dok_id: HD03216) — Significance: 0/10
2. **Ett modernt och anpassat regelverk för krigsmateriel** (dok_id: HD03228) — Significance: 0/10
3. **Skärpta regler om utvisning på grund av brott** (dok_id: HD03235) — Significance: 0/10
4. **Lagändringar för ett stärkt nationellt cybersäkerhetscenter** (dok_id: HD03214) — Significance: 0/10
