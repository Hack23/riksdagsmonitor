...
graph TD
    subgraph "📊 Daily Political Intelligence Dashboard"
        ...
        subgraph "🔒 Sensitivity"
            CLS["Sensitivity<br/>SENSITIVE<br/>Defense + Justice dominant"]
        end
        subgraph "⚖️ Risk"
            RSK["Overall Risk<br/>MEDIUM<br/>Top: Policy Implementation (12)"]
        end
        subgraph "🎭 Threat"
            THR["Threat Level<br/>LOW<br/>No active democratic threats"]
        end
        subgraph "📈 Significance"
            SIG["Top Significance<br/>5/10<br/>Monitor — Analysis Only"]
        end
    end
...
graph LR
    subgraph "🏛️ Government Coalition Assessment"
        GS["✅ Strengths<br/>3 entries<br/>Dominant: Defense/security credibility"]
        GW["⚠️ Weaknesses<br/>4 entries<br/>Critical: Prison capacity implementation"]
        GO["🚀 Opportunities<br/>2 entries<br/>Top: Civil defense public support"]
        GT["🔴 Threats<br/>3 entries<br/>Top: Correctional system overload"]
    end
