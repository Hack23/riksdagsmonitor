...
graph TD
    subgraph "🟢 STRENGTHS"
        S1["Coalition cohesion<br/>4 major props Apr 1<br/>KD-M alignment 88.5%"]
        S2["Security agenda clarity<br/>HD03214 + HD01FöU12 + HD03228<br/>coordinated defense package"]
        S3["Legislative productivity<br/>10 committee reports<br/>Mar 31–Apr 2"]
    end
    subgraph "🔴 WEAKNESSES"
        W1["Metadata-only analysis<br/>Pipeline scored 0/10<br/>Full-text unavailable"]
        W2["No chamber votes<br/>Apr 1-6 period<br/>Committee phase only"]
        W3["Immigration policy risk<br/>HD03215 + HD03229<br/>Potential V/MP opposition"]
    end
    subgraph "🔵 OPPORTUNITIES"
        O1["Post-NATO defense modernization<br/>Cybersecurity + war materiel<br/>Bipartisan support likely"]
        O2["Education cross-party space<br/>S + C + MP filing motions<br/>Compromise potential"]
        O3["Healthcare reform momentum<br/>HD03216 municipal competence<br/>Broad stakeholder support"]
    end
    subgraph "🟡 THREATS"
        T1["Opposition motion blitz<br/>15+ S motions Apr 1<br/>Systematic challenge"]
