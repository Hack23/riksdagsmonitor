...
```mermaid
graph LR
    subgraph "Parliamentary Activity — Week of March 31 – April 6"
        A["🔵 Propositions<br/>4 new (Apr 1)"] --> B["🟢 Committee Reports<br/>10 new (Mar 31–Apr 2)"]
...
```mermaid
pie title "Legislative Activity by Policy Domain (Mar 31–Apr 6)"
    "Security & Defense" : 4
    "Criminal Justice" : 5
    "Healthcare & Social" : 4
    "Education" : 6
