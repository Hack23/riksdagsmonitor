...
```mermaid
flowchart LR
    subgraph Government["🟢 Government Coalition"]
        M["M - Moderaterna"]
    ...
    FöU12["FöU12: Shelter Law\n6 reservations"]
    JuU15["JuU15: Criminal Justice\n8 reservations"]
    UU6["UU6: Security Policy\n13 reservations"]
    Government -->|"Approves"| FöU12
    Government -->|"Rejects 76 motions"| JuU15
    Government -->|"Rejects 59 motions"| UU6
    S -->|"Res. 1, 6"| FöU12
    V -->|"Res. 1, 2"| FöU12
    C -->|"Res. 3, 5"| FöU12
    MP -->|"Res. 4"| FöU12
    ...
    style Government fill:#2d5a27,color:#fff
    style Opposition fill:#8b1a1a,color:#fff
    style FöU12 fill:#1a3a5c,color:#fff
    style JuU15 fill:#5c1a1a,color:#fff
    style UU6 fill:#3a1a5c,color:#fff
```
