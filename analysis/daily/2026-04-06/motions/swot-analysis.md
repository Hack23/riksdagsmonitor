...
graph TD
    ...
    style UbU fill:#2196F3,color:white
    style CU fill:#FF9800,color:white
    style FiU fill:#9C27B0,color:white
    
    S[S: 10 motions] --> UbU[UbU: 15 total]
    S --> CU[CU: 8 total]
    C[C: 12 motions] --> UbU
    C --> FiU[FiU: 5 total]
    MP[MP: 18 motions] --> UbU
    MP --> CU
    V[V: 3 motions] --> SfU[SfU: 2 total]
```
