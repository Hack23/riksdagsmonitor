...
```mermaid
graph LR
    A["HD01FöU12<br/>Civilian Protection"] --> B{Sensitivity}
    B -->|"🟡 SENSITIVE"| D["Defense Policy<br/>National Security"]

    A --> G{Domain}
    G --> H["Defense & Civil Preparedness"]

    A --> I{Urgency}
    I -->|"🟠 URGENT"| K["Legislative action<br/>pending chamber vote"]
