...
graph TD
    subgraph "📊 Daily Political Intelligence Dashboard"
        ...
        subgraph "🔒 Sensitivity"
            CLS["Sensitivity: SENSITIVE<br/>Defense & foreign policy documents"]
        end
        subgraph "⚖️ Risk"
            RSK["Overall Risk: LOW<br/>Coalition risk 4/100<br/>Top: RSK-1 Prison overcrowding"]
        end
        subgraph "🎭 Threat"
            THR["Threat Level: LOW<br/>No active threats detected<br/>Monitoring: opposition coordination"]
        end
        subgraph "📈 Significance"
            SIG["Top Significance: 7/10<br/>HD01FöU12 Civilian Protection<br/>Monitor / Analysis Only"]
        end
    end

    subgraph "🎯 Editorial Decision"
        DEC{Article Decision}
        DEC -->|"Easter Monday"| MON["📋 Analysis Only"]
    end
