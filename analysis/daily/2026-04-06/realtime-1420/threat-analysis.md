...
graph TD
    subgraph "🎭 Political Threat Taxonomy — 2026-04-06"
        NI["Narrative Integrity<br/>Severity: 2/5 Minor"]
        LI["Legislative Integrity<br/>Severity: 1/5 Negligible"]
        AC["Accountability<br/>Severity: 2/5 Minor"]
        TR["Transparency<br/>Severity: 1/5 Negligible"]
        DP["Democratic Process<br/>Severity: 1/5 Negligible"]
...
```mermaid
graph TD
    ROOT["Goal: Undermine government<br/>foreign policy credibility"]
    ROOT --> A["Systematic parliamentary<br/>questions to FM Stenergard"]
    ROOT --> B["Media amplification of<br/>unanswered questions"]

    A --> A1["HD11679: Arms control<br/>commitment questioned"]
    A --> A2["HD11680: Israel human<br/>rights stance challenged"]
    A --> A3["HD11683: Syria minorities<br/>response demanded"]
