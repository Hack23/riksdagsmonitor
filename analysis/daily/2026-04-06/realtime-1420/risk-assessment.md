...
```mermaid
graph TD
    subgraph "⚖️ Political Risk Landscape — L × I"
        R1["RSK-1: Prison overcrowding<br/>L:3 × I:4 = 12"]
        R2["RSK-2: Shelter implementation delays<br/>L:3 × I:3 = 9"]
        R3["RSK-3: Foreign policy pressure<br/>L:2 × I:3 = 6"]
        R4["RSK-4: Norra Kärr mining controversy<br/>L:2 × I:3 = 6"]
...
```mermaid
graph TD
    A["Trigger: Prison population exceeds capacity<br/>(HD01JuU15 context)"] --> B["Overcrowding incidents<br/>reported in media"]
    B --> C["Opposition amplifies issue<br/>(S Res. 5: expansion scrutiny)"]
    C --> D{"Government response?"}
    D -->|"Emergency funding"| E["Budget pressure<br/>Score: 8"]
