...
```mermaid
graph TD
    subgraph "💼 SWOT Quadrant Map — Government Coalition"
        subgraph "✅ Strengths"
            S1["S1: Unified defense legislation"]
            S2["S2: SD criminal justice alignment"]
            S3["S3: Multi-front defense modernization"]
        end
        subgraph "⚠️ Weaknesses"
            W1["W1: Shelter feasibility gaps"]
            W2["W2: Accessibility concerns"]
            W3["W3: Prison overcrowding"]
        end
        subgraph "🌟 Opportunities"
            O1["O1: NATO coordination"]
            O2["O2: Cross-party defense consensus"]
        end
        subgraph "🔴 Threats"
            T1["T1: 4-party opposition alignment"]
            T2["T2: S foreign policy offensive"]
        end
    end
