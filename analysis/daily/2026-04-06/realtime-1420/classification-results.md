...
```mermaid
graph TD
    subgraph "🏷️ Document Classification — 2026-04-06"
        subgraph "By Sensitivity"
            SEN["🟡 SENSITIVE: 5 docs<br/>🟢 PUBLIC: 4 docs"]
        end
        subgraph "By Type"
            TYP["Committee Reports: 2<br/>Interpellation: 1<br/>Written Questions: 6"]
        end
        subgraph "By Domain"
            DOM["Defense: 2 docs<br/>Justice: 2 docs<br/>Foreign Policy: 3 docs<br/>Environment: 2 docs"]
        end
    end
