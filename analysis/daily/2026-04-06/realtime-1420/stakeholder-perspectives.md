...
```mermaid
graph TD
    subgraph "👥 Stakeholder Impact Matrix — 2026-04-06"
        CIT["🏛️ Citizens<br/>Impact: MODERATE<br/>Enhanced civil protection"]
        GOV["🏢 Government Coalition<br/>Impact: POSITIVE<br/>Legislative wins"]
        OPP["⚔️ Opposition Bloc<br/>Impact: ACTIVE<br/>Building narratives"]
        BIZ["💼 Business/Industry<br/>Impact: MIXED<br/>New obligations + contracts"]
        CIV["🤝 Civil Society<br/>Impact: MODERATE<br/>Accessibility concerns"]
        INT["🌍 International/EU<br/>Impact: POSITIVE<br/>NATO alignment"]
        JUD["⚖️ Judiciary/Constitutional<br/>Impact: ROUTINE<br/>Standard processing"]
