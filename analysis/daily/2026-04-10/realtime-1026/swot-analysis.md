...
```mermaid
graph TD
    subgraph Political SWOT Landscape 2026-04-10
        direction TB
        subgraph Strengths Internal Positive
            S1N[S1: SD-M foreign policy alignment]
            S2N[S2: Criminal justice reform delivery]
        end
        subgraph Weaknesses Internal Negative
            W1N[W1: Climate policy delay]
            W2N[W2: AF reform accessibility]
        end
        subgraph Opportunities External Positive
            O1N[O1: Spring budget debate platform]
            O2N[O2: WHA Taiwan solidarity]
        end
        subgraph Threats External Negative
            T1N[T1: S election campaign buildup]
            T2N[T2: C climate credibility challenge]
        end
    end
