...
```mermaid
graph TD
    subgraph Stakeholder Impact Overview
        DOC[6 Written Questions 2026-04-10]
    end

    subgraph Political Actors
        GOV[Government Coalition LOW - 4 ministers questioned]
        OPP[Opposition LOW POSITIVE - S C building narratives]
    end

    subgraph Society and Economy
        CIT[Citizens LOW - AF and Gotland concerns]
        ECO[Economic NONE - No fiscal implications]
    end

    subgraph External and Media
        INT[International LOW - Taiwan WHA CIS]
        MED[Media LOW - Routine questions]
    end
    ...
    style ECO fill:#9E9E9E,color:#FFFFFF
