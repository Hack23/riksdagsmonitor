...
```mermaid
quadrantChart
    title Government Position on Strategic Export Control
    x-axis "Weak Position" --> "Strong Position"
    y-axis "Low Urgency" --> "High Urgency"
    "NATO alignment": [0.8, 0.7]
    "Transparency reporting": [0.7, 0.5]
    "Opposition scrutiny": [0.4, 0.6]
    "Dual-use tech controls": [0.5, 0.8]
    "Defence industry growth": [0.75, 0.65]
```
...
```mermaid
graph LR
    subgraph "Risk Matrix — Skr. 2025/26:114"
        direction TB
        A["🔵 Coalition Stability<br/>Risk: LOW (2/5)<br/>Impact: LOW (2/5)"] --> B["Cross-party consensus<br/>on defence policy"]
