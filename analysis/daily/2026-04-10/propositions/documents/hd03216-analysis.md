...
```mermaid
graph LR
    A["Prop. 2025/26:216<br/>HD03216"] --> B{Sensitivity}
    B -->|"🟢 PUBLIC"| E["Standard Parliamentary<br/>Welfare policy reform"]
    
    A --> G{Domain}
    G --> H["Health & Welfare"]
    G --> H2["Municipal Governance"]
...
```mermaid
quadrantChart
    title Government Position on Municipal Healthcare (Prop. 2025/26:216)
    x-axis "Weak Position" --> "Strong Position"
    y-axis "Low Urgency" --> "High Urgency"
    "COVID-19 response": [0.35, 0.65]
    "Eldercare reform promise": [0.6, 0.7]
    "Municipal autonomy tension": [0.4, 0.5]
    "Healthcare workforce": [0.3, 0.8]
    "Patient safety improvement": [0.7, 0.6]
```
...
```mermaid
graph TD
    subgraph "Risk Matrix — Prop. 2025/26:216"
        R1["🟡 Funding Adequacy<br/>Risk: MEDIUM (3/5)<br/>Impact: HIGH (4/5)"] --> M1["Unfunded mandates risk<br/>municipal non-compliance"]
