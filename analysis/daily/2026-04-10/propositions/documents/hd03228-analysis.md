...
```mermaid
graph LR
    A["Prop. 2025/26:228<br/>HD03228"] --> B{Sensitivity}
    B -->|"🟡 SENSITIVE"| D["Policy Delivery Risk<br/>Arms export controversy potential"]
    
    A --> G{Domain}
    G --> H["Defence & Security"]
    G --> H2["Foreign Trade Policy"]
    G --> H3["International Law"]
...
```mermaid
quadrantChart
    title Government Position on Arms Regulations (Prop. 2025/26:228)
    x-axis "Weak Position" --> "Strong Position"
    y-axis "Low Urgency" --> "High Urgency"
    "NATO alignment": [0.8, 0.85]
    "Defence industry support": [0.75, 0.7]
    "Human rights scrutiny": [0.35, 0.75]
    "Parliamentary majority": [0.7, 0.5]
    "Cross-ref HD03114": [0.6, 0.6]
    "Public opinion risk": [0.3, 0.65]
```
...
```mermaid
graph TD
    subgraph "Risk Matrix — Prop. 2025/26:228"
        R1["🟡 Human Rights Controversy<br/>Risk: MEDIUM (3/5)<br/>Impact: HIGH (4/5)"] --> M1["Specific export destination<br/>debates could dominate coverage"]
