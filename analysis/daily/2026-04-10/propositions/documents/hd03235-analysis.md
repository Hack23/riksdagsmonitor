...
```mermaid
graph LR
    A["Prop. 2025/26:235<br/>HD03235"] --> B{Sensitivity}
    B -->|"🟡 SENSITIVE"| D["Policy Delivery Risk<br/>Human rights implications<br/>Potential ECHR tension"]
    
    A --> G{Domain}
    G --> H["Migration & Integration"]
    G --> H2["Criminal Justice"]
    G --> H3["Human Rights"]
...
```mermaid
quadrantChart
    title Government Position on Deportation Rules (Prop. 2025/26:235)
    x-axis "Weak Position" --> "Strong Position"
    y-axis "Low Urgency" --> "High Urgency"
    "SD voter delivery": [0.85, 0.9]
    "Public support for tough stance": [0.75, 0.8]
    "ECHR compatibility": [0.3, 0.85]
    "S vote dilemma": [0.6, 0.75]
    "Implementation capacity": [0.4, 0.7]
    "Human rights criticism": [0.25, 0.8]
    "Election positioning": [0.8, 0.9]
```
...
```mermaid
graph TD
    subgraph "Risk Matrix — Prop. 2025/26:235"
        R1["🔴 ECHR Compatibility<br/>Risk: HIGH (4/5)<br/>Impact: HIGH (4/5)"] --> M1["Lowered thresholds may<br/>violate Art. 8 ECHR"]
        R2["🟡 Enforcement Gap<br/>Risk: MEDIUM (3/5)<br/>Impact: HIGH (4/5)"] --> M2["Legislation without<br/>enforcement capacity"]
