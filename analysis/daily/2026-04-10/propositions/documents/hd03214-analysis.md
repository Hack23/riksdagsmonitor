...
```mermaid
graph LR
    A["Prop. 2025/26:214<br/>HD03214"] --> B{Sensitivity}
    B -->|"🟡 SENSITIVE"| D["Policy Delivery Risk<br/>National security implications"]
    
    A --> G{Domain}
    G --> H["Defence & Cybersecurity"]
    G --> H2["Digital Infrastructure"]
...
```mermaid
quadrantChart
    title Government Position on Cybersecurity Centre (Prop. 2025/26:214)
    x-axis "Weak Position" --> "Strong Position"
    y-axis "Low Urgency" --> "High Urgency"
    "NATO cyber cooperation": [0.85, 0.75]
    "NIS2 compliance": [0.7, 0.85]
    "Cross-agency authority": [0.65, 0.7]
    "Opposition consensus": [0.75, 0.4]
    "Budget allocation": [0.5, 0.6]
    "Implementation timeline": [0.4, 0.8]
```
...
```mermaid
graph TD
    subgraph "Risk Matrix — Prop. 2025/26:214"
        R1["🟢 Coalition Stability<br/>Risk: LOW (2/5)<br/>Impact: LOW (1/5)"] --> M1["Strong cross-party<br/>consensus on cyber defence"]
