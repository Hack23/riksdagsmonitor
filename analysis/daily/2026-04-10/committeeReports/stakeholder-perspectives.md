...
```mermaid
graph TD
    subgraph "High Impact Stakeholders"
        A["Citizens"] --> A1["Security + Migration"]
        B["Govt Coalition"] --> B1["Security + Migration"]
        C["Opposition"] --> C1["Migration primary"]
        D["International/EU"] --> D1["Security + Migration + Defence"]
    end
    subgraph "Medium Impact"
        E["Business"] --> E1["Transport + Rural"]
        F["Civil Society"] --> F1["Migration + Rural"]
        G["Media"] --> G1["Migration + Security"]
    end
