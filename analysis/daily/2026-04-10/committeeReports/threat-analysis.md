...
```mermaid
graph TD
    A["Threat Landscape April 2026"] --> B["TH1: Coalition Stability"]
    A --> C["TH2: Democratic Legitimacy"]
    A --> D["TH3: Institutional Capacity"]
    A --> E["TH4: Social Cohesion"]
    B --> B1["SD-M divergence on NATO"]
