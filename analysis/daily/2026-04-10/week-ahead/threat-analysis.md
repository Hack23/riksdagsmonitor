...
flowchart TD
    A[Week Start: Vårpropositionen] -->|Fiscal data exposed| B{Budget Defense}
    B -->|Strong| C[Coalition Narrative Control]
    B -->|Weak| D[Opposition Ammunition]
    D --> E[KU Hearing Escalation Tue]
    E -->|Strömmer pressed| F[Judicial Independence Crisis Frame]
    E -->|Contained| G[Normal Committee Week]
    C --> G
    F --> H[PM QT Defensive Position Thu]
    G --> I[PM QT Neutral Position Thu]
