...
```mermaid
graph TD
    subgraph "Political Risk Matrix — Opposition Motions"
        direction TB
        subgraph "HIGH Impact"
            R1["R1: Sida audit accountability\nL:3 x I:4 = 12"]
            R2["R2: Youth crime civil liberties\nL:2 x I:4 = 8"]
        end
        subgraph "MEDIUM Impact"
            R3["R3: Housing policy fragmentation\nL:3 x I:3 = 9"]
            R4["R4: Welfare reform opposition\nL:2 x I:3 = 6"]
            R5["R5: SD policy independence\nL:1 x I:3 = 3"]
        end
        subgraph "LOW Impact"
