...
```mermaid
graph LR
    A["mot. 2025/26:4032"] --> B{Sensitivity}
    B -->|"🟡 SENSITIVE"| C["Welfare Reform Effectiveness"]
    A --> D{Domain}
    D --> E["Social Welfare / Evidence-Based Policy"]
    A --> F{Urgency}
    F -->|"🔵 ELEVATED"| G["SoU committee consideration"]
