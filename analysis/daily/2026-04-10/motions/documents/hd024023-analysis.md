...
```mermaid
graph LR
    A["mot. 2025/26:4023"] --> B{Sensitivity}
    B -->|"🟠 HIGH"| C["Education Funding — Election Issue"]
    A --> D{Domain}
    D --> E["Education / Municipal Finance"]
    A --> F{Urgency}
    F -->|"🔵 ELEVATED"| G["UbU committee — budget implications"]
