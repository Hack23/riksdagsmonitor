...
```mermaid
graph LR
    A["mot. 2025/26:4037"] --> B{Sensitivity}
    B -->|"🟡 SENSITIVE"| C["Copyright Policy — Coalition Split"]
    A --> D{Domain}
    D --> E["IP / Copyright Abolition"]
    A --> F{Urgency}
    F -->|"🔵 ELEVATED"| G["NU committee consideration within weeks"]
