...
```mermaid
graph LR
    A["mot. 2025/26:4014"] --> B{Sensitivity}
    B -->|"🟠 HIGH"| C["Anti-Corruption / Organised Crime"]
    A --> D{Domain}
    D --> E["Public Procurement Policy"]
    A --> F{Urgency}
    F -->|"🔴 HIGH"| G["FiU committee — security implications"]
    ...
    style G fill:#EF5350,stroke:#424242,color:#000000
```
