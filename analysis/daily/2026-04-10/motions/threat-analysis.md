...
```mermaid
graph TD
    subgraph "Democratic Function Threat Categories"
        T1["🔴 Civil Liberties<br/>Youth crime prop. 227: V+MP oppose<br/>Foreign prisons prop. 185: MP rejects"]
        T2["🟡 Policy Accountability<br/>Sida audit skr. 226: C+V+MP challenge<br/>Welfare reform prop. 207: S+C critique"]
        T3["🟢 Legislative Process<br/>13 props challenged across 8 committees<br/>5 cross-party opposition clusters"]
        T4["🔵 Institutional Trust<br/>4.7B SEK Sida accountability gap<br/>Procurement integrity concerns"]
