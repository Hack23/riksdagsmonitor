...
**Generated**: 2026-04-10 07:13 UTC
**Data Sources**: get_motioner
...
> ⚠️ **No threat indicators extracted**: The automated data pipeline found 2 documents but could not identify specific threat indicators from metadata alone. Deep threat analysis requires AI-driven per-document analysis following `analysis/methodologies/political-threat-framework.md`.
...
1. No threat indicators could be derived from document metadata alone — AI analysis required.
