...
```mermaid
graph TD
    subgraph "SWOT Quadrant — Opposition Motions 2026-04-10"
        direction TB
        subgraph "Strengths"
            S1["S1: MP broad-spectrum activity 7 motions"]
            S2["S2: Cross-party Sida audit coordination C+V+MP"]
            S3["S3: S-C welfare policy convergence"]
        end
        subgraph "Weaknesses"
            W1["W1: No formal opposition coordination"]
            W2["W2: SD only 1 motion limited engagement"]
            W3["W3: Metadata-only analysis limited depth"]
        end
        subgraph "Opportunities"
            O1["O1: Sida 4.7B SEK accountability issue"]
            O2["O2: Youth crime civil liberties debate"]
            O3["O3: Housing affordability cross-party potential"]
        end
        subgraph "Threats"
            T1["T1: Government majority on prop. 227"]
            T2["T2: Motion overload dilutes opposition impact"]
