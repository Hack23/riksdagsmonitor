...
graph TD
    subgraph "Stakeholder Impact Matrix"
        CIT["👥 Citizens"]
        GOV["🏛️ Government Coalition"]
        OPP["⚔️ Opposition Bloc"]
        BIZ["💼 Business/Industry"]
        CIV["🤝 Civil Society"]
        INT["🌍 International/EU"]
        JUD["⚖️ Judiciary/Constitutional"]
        MED["📰 Media/Public Opinion"]
    end
    CIT -->|"Housing consumer protection"| H["prop. 188, 212"]
    CIT -->|"Welfare activity requirements"| W["prop. 207"]
    CIT -->|"Education funding"| E["prop. 196"]
    GOV -->|"Legislative agenda pressure"| L["13 propositions challenged"]
    OPP -->|"Coordinated challenges"| CC["5 cross-party clusters"]
