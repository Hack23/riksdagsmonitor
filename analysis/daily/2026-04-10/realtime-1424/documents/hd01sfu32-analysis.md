...
```mermaid
graph LR
    A["HD01SfU32"] --> B{{Sensitivity}}
    B -->|SENSITIVE| D["Deportation Operations"]
    A --> G{{Domain}}
...
```mermaid
quadrantChart
    title Political Impact — HD01SfU32 Return Operations
    ...
    "Deportation efficiency gains": [0.2, 0.8]
    "Tido Agreement delivery": [0.15, 0.85]
    "Human rights critique": [0.75, 0.65]
    "Operational capacity risk": [0.3, 0.25]
```
...
```mermaid
graph TD
    subgraph "Political Risk Matrix — HD01SfU32"
        R1["Coalition Stability L:2 x I:2 = 4"]
        R2["Policy Implementation L:4 x I:3 = 12"]
        R3["Budget Fiscal L:3 x I:2 = 6"]
        R4["Electoral Impact L:3 x I:3 = 9"]
        R5["Democratic Process L:2 x I:2 = 4"]
    end
...
```mermaid
graph LR
    subgraph "Political Threat Taxonomy — HD01SfU32"
        NI["Narrative Integrity Sev:2"]
        LI["Legislative Integrity Sev:1"]
        AC["Accountability Sev:3"]
        TR["Transparency Sev:2"]
...
```mermaid
graph TD
    subgraph "Impact — HD01SfU32"
        DOC["Deportation Enforcement"]
    end
    subgraph "Political"
        GOV["Government Impact: HIGH"]
        OPP["Opposition Impact: MEDIUM"]
    end
    subgraph "Society"
        CIT["Citizens/Migrants Impact: HIGH"]
        ECO["Economic Impact: MEDIUM"]
    end
    subgraph "External"
        INT["International Impact: MEDIUM"]
        MED["Media Impact: HIGH"]
    end
    DOC --> GOV
    DOC --> OPP
    DOC --> CIT
