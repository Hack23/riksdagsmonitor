...
```mermaid
graph LR
    A["HD01SfU31"] --> B{{Sensitivity}}
    B -->|SENSITIVE| D["Migration Detention Policy"]
    A --> G{{Domain}}
    G --> H["Migration MIG / Justice JUS"]
    A --> I{{Urgency}}
...
```mermaid
quadrantChart
    title Political Impact — HD01SfU31 Detention Framework
    ...
    "Migration enforcement delivery": [0.25, 0.75]
    "SD support consolidation": [0.2, 0.8]
    "Human rights critique opportunity": [0.7, 0.6]
    "EU compliance concerns": [0.4, 0.3]
```
...
```mermaid
graph TD
    subgraph "Political Risk Matrix — HD01SfU31"
        R1["Coalition Stability L:2 x I:2 = 4"]
        R2["Policy Implementation L:3 x I:3 = 9"]
        R3["Budget Fiscal L:2 x I:2 = 4"]
        R4["Electoral Impact L:3 x I:2 = 6"]
        R5["Democratic Process L:2 x I:3 = 6"]
    end
...
```mermaid
graph TD
    subgraph "Document Impact — HD01SfU31"
        DOC["Detention Framework"]
    end
    subgraph "Political Actors"
        GOV["Government Coalition Impact: HIGH"]
        OPP["Opposition Impact: MEDIUM"]
    end
    subgraph "Society"
        CIT["Citizens/Migrants Impact: HIGH"]
        ECO["Economic Actors Impact: LOW"]
    end
    subgraph "External"
        INT["International/EU Impact: MEDIUM"]
        MED["Media Impact: MEDIUM"]
    end
    DOC --> GOV
    DOC --> OPP
    DOC --> CIT
