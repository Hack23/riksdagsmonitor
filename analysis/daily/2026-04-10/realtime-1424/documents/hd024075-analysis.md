...
```mermaid
graph LR
    A["HD024075"] --> B{{Sensitivity}}
    B -->|PUBLIC| E["Standard Legislative"]
    A --> G{{Domain}}
...
```mermaid
graph TD
    subgraph "Political Risk Matrix — HD024075"
        R1["Coalition Stability L:1 x I:1 = 1"]
        R2["Policy Implementation L:1 x I:1 = 1"]
        R3["Budget Fiscal L:1 x I:1 = 1"]
        R4["Electoral Impact L:2 x I:1 = 2"]
        R5["Democratic Process L:1 x I:1 = 1"]
    end
    subgraph "Risk Tiers"
        TL["LOW Score 1-4"]
    end
