...
```mermaid
graph LR
    A["HD11702"] --> B{{Sensitivity}}
    B -->|PUBLIC| E["Standard Parliamentary Question"]
    A --> G{{Domain}}
...
```mermaid
graph TD
    subgraph "Political Risk Matrix — HD11702"
        R1["Coalition Stability L:2 x I:2 = 4"]
        R2["Policy Implementation L:3 x I:2 = 6"]
        R3["Budget Fiscal L:1 x I:1 = 1"]
        R4["Electoral Impact L:2 x I:2 = 4"]
        R5["Democratic Process L:1 x I:1 = 1"]
        R6["External International L:2 x I:2 = 4"]
    end
    subgraph "Risk Tiers"
        TM["MEDIUM 5-9"]
        TL["LOW 1-4"]
