...
```mermaid
graph LR
    A["HD01SfU36"] --> B{{Sensitivity}}
    B -->|SENSITIVE| D["Immigration Character Requirements"]
    A --> G{{Domain}}
...
```mermaid
quadrantChart
    title Political Impact — HD01SfU36 Character Requirements
    ...
    "SD demand delivered": [0.15, 0.85]
    "Tido credibility": [0.2, 0.75]
    "Discrimination concerns": [0.7, 0.55]
    "Administrative burden": [0.35, 0.25]
```
...
```mermaid
graph TD
    subgraph "Political Risk Matrix — HD01SfU36"
        R1["Coalition Stability L:1 x I:2 = 2"]
        R2["Policy Implementation L:3 x I:3 = 9"]
        R3["Budget Fiscal L:2 x I:1 = 2"]
...
```mermaid
graph LR
    subgraph "Political Threat Taxonomy — HD01SfU36"
...
```mermaid
graph TD
    subgraph "Impact — HD01SfU36"
        DOC["Character Requirements"]
    end
    subgraph "Political"
    ...
    subgraph "Society"
        CIT["Citizens/Applicants Impact: HIGH"]
        ECO["Economic Impact: LOW"]
    end
    subgraph "External"
