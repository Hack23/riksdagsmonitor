...
```mermaid
graph TD
    subgraph "Migration Policy Cluster Impact"
        DOC["SfU Triple Report"]
    end
    subgraph "Political"
    ...
    subgraph "Economy and Society"
        BIZ["Business Impact: MEDIUM"]
        CIV["Civil Society Impact: HIGH"]
    end
    subgraph "External"
        INT["International Impact: MEDIUM"]
        JUD["Judiciary Impact: MEDIUM"]
