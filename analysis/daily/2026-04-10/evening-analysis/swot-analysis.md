...
```mermaid
graph TD
    subgraph "Government Coalition SWOT — 2026-04-10 Evening"
        direction TB
        subgraph "✅ STRENGTHS"
            S1["5 propositions tabled<br/>Broad legislative momentum"]
            S2["Tidö Agreement delivery<br/>Migration + security + crime"]
            S3["Cross-party cybersecurity consensus<br/>HD03214"]
            S4["SfU triple migration lock<br/>SfU31 + SfU32 + SfU36"]
        end
        subgraph "⚠️ WEAKNESSES"
            W1["ECHR vulnerability on HD03235<br/>Deportation threshold"]
            W2["Enforcement capacity gap<br/>Migrationsverket overload"]
            W3["Climate policy delay<br/>HD11702 MP pressure on L"]
            W4["Sida 4.7B SEK gap<br/>Cross-party opposition"]
        end
        subgraph "🚀 OPPORTUNITIES"
            O1["Election 2026 positioning<br/>Security + migration narrative"]
            O2["NATO cooperation deepening<br/>Cyber + arms modernisation"]
            O3["Healthcare reform credit<br/>Counters S welfare ownership"]
        end
        subgraph "🔴 THREATS"
            T1["ECHR ruling risk<br/>L:4 × I:4 = 16/25"]
            T2["KU hearings next week<br/>Ministerial accountability"]
            T3["S-C welfare alignment<br/>Alternative majority risk"]
            T4["International criticism<br/>UNHCR + CoE"]
        end
    end
