...
```mermaid
graph TD
    subgraph "Risk Heat Map — April 10 2026 Evening"
        direction TB
        subgraph "🔴 HIGH (≥15)"
            R1["ECHR Deportation<br/>HD03235<br/>L:4 × I:4 = 16"]
        end
        subgraph "🟡 MEDIUM (9-14)"
            R2["Migration Enforcement Capacity<br/>SfU31/32/36<br/>L:4 × I:3 = 12"]
            R3["Arms Export Controversy<br/>HD03228<br/>L:3 × I:4 = 12"]
            R4["Cybersecurity Timeline<br/>HD03214<br/>L:3 × I:4 = 12"]
            R5["Healthcare Mandates<br/>HD03216<br/>L:3 × I:4 = 12"]
            R6["Sida Accountability<br/>skr. 226<br/>L:3 × I:3 = 9"]
        end
        subgraph "🟢 LOW (≤8)"
            R7["S Vote Dilemma<br/>HD03235<br/>L:3 × I:3 = 9"]
            R8["International Criticism<br/>HD03235<br/>L:4 × I:2 = 8"]
            R9["Coalition Stability<br/>All<br/>L:1 × I:5 = 5"]
        end
    end
    ...
    style R9 fill:#28a745,color:#fff
```
