...
```mermaid
graph TD
    subgraph "📊 Evening Political Intelligence Dashboard — 2026-04-10"
        direction TB
        subgraph "🔒 Sensitivity"
            CLS["Sensitivity: 🟡 SENSITIVE<br/>Migration + Defence + Arms Trade"]
        end
        subgraph "⚖️ Risk"
            RSK["Overall Risk: 🟡 MEDIUM<br/>Top: ECHR deportation risk L:4×I:4=16/25"]
        end
        subgraph "🎭 Threat"
            THR["Threat Level: 🟠 MODERATE-HIGH<br/>Power Balance elevated by enforcement expansion"]
        end
        subgraph "📈 Significance"
            SIG["Top Significance: 9/10<br/>Prop. 2025/26:235 Deportation Reform"]
        end
    end
...
```mermaid
graph TD
    subgraph "Coalition Government SWOT — Day Summary"
        direction TB
        subgraph "✅ Strengths"
            S1["Legislative momentum<br/>5 propositions + 6 committee reports"]
            S2["Tidö delivery<br/>Migration + security commitments"]
            S3["Cross-party consensus<br/>Cybersecurity, NATO integration"]
        end
        subgraph "⚠️ Weaknesses"
            W1["ECHR vulnerability<br/>Deportation rules HD03235"]
            W2["Implementation gaps<br/>Migrationsverket capacity"]
            W3["Climate policy delay<br/>MP pressure on L minister"]
        end
        subgraph "🚀 Opportunities"
            O1["Election positioning<br/>Tough-on-crime + security narrative"]
            O2["NATO cooperation<br/>Cyber + arms trade modernisation"]
        end
        subgraph "🔴 Threats"
            T1["ECHR adverse ruling<br/>L:4 × I:4 = 16/25"]
            T2["Opposition coordination<br/>Sida audit cross-party challenge"]
            T3["KU hearings next week<br/>Ministerial accountability"]
        end
    end
