...
```mermaid
graph TD
    subgraph "Stakeholder Impact Radar — 2026-04-10"
        direction TB
        CIT["👤 Citizens<br/>Impact: MEDIUM-HIGH<br/>Migration + healthcare + security"]
        GOV["🏛️ Government Coalition<br/>Impact: HIGH<br/>Legislative delivery mode"]
        OPP["⚔️ Opposition Bloc<br/>Impact: HIGH<br/>Broad offensive + KU prep"]
        BIZ["💼 Business/Industry<br/>Impact: MEDIUM<br/>Arms + cyber + procurement"]
        CIV["🤝 Civil Society<br/>Impact: MEDIUM-HIGH<br/>Rights concerns on deportation"]
        INT["🌍 International/EU<br/>Impact: MEDIUM<br/>NATO alignment + ECHR tension"]
        JUD["⚖️ Judiciary/Constitutional<br/>Impact: HIGH<br/>Lagrådet + JO election"]
