...
```mermaid
graph TD
    subgraph "Significance Dimensions — Evening 2026-04-10"
        direction LR
        POL["Political Impact<br/>8/10"]
        LEG["Legislative Consequence<br/>9/10"]
        PUB["Public Interest<br/>8/10"]
        INT["International Relevance<br/>7/10"]
