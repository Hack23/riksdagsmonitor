...
```mermaid
graph LR
    A[HD03228] --> B{Sensitivity}
    B -->|"🟡 SENSITIVE"| D[Defense Trade & NATO Alignment]

    A --> G{Domain}
    G --> H["Foreign Affairs & Defence (FOR/DEF)"]

    A --> I{Urgency}
    I -->|"🟠 URGENT"| K[Major policy shift — referred to UU committee]
...
```mermaid
quadrantChart
    title Political Impact — War Materiel Framework
    ...
    "NATO alignment strengthens M position": [0.2, 0.8]
    "Arms export scrutiny risk": [0.3, 0.2]
    "V/MP opposition to arms liberalization": [0.8, 0.6]
    "S cautious support for NATO adaptation": [0.6, 0.55]
```
...
graph TD
    subgraph "⚖️ Political Risk Matrix"
        ...
        R2["🟡 Policy Implementation<br/>L:2 × I:3 = 6"]
        R3["🟢 Budget / Fiscal<br/>L:1 × I:2 = 2"]
        R4["🟡 Electoral Impact<br/>L:3 × I:3 = 9"]
        R5["🟢 Democratic Process<br/>L:2 × I:2 = 4"]
        R6["🟠 External / International<br/>L:3 × I:4 = 12"]
    end
