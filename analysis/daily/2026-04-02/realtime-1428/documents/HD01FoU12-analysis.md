...
```mermaid
graph LR
    A[HD01FöU12] --> B{Sensitivity}
    B -->|"🟡 SENSITIVE"| D[National Security Policy]

    A --> G{Domain}
    G --> H["Defence & Civil Protection (DEF)"]
...
```mermaid
quadrantChart
    title Political Impact — Civilian Protection Report
    ...
    "FöU12 strengthens defense posture": [0.25, 0.75]
    "Funding gaps expose weakness": [0.35, 0.25]
    "Opposition demands more spending": [0.75, 0.65]
    "Cross-party defense consensus": [0.5, 0.8]
```
...
graph TD
    subgraph "⚖️ Political Risk Matrix — Likelihood × Impact"
        R1["🟡 Coalition Stability<br/>L:2 × I:2 = 4"]
        R2["🟠 Policy Implementation<br/>L:3 × I:4 = 12"]
        R3["🟡 Budget / Fiscal<br/>L:3 × I:3 = 9"]
        R4["🟢 Electoral Impact<br/>L:2 × I:2 = 4"]
        R5["🟢 Democratic Process<br/>L:1 × I:2 = 2"]
        R6["🟠 External / International<br/>L:4 × I:3 = 12"]
    end
...
graph TD
    subgraph "📄 Document Impact Assessment"
        DOC["📄 HD01FöU12<br/>Civilian Protection"]
    end

    subgraph "🏛️ Political Actors"
        GOV["🏛️ Government Coalition<br/>M + KD + L (+ SD)<br/>POSITIVE: defense leadership"]
        OPP["⚖️ Opposition<br/>S, V, MP, C<br/>MIXED: support defense but seek more funding"]
    end

    subgraph "👥 Society & Economy"
        CIT["👥 Citizens<br/>HIGH impact: shelter access, evacuation plans"]
        ECO["💰 Economic Actors<br/>MEDIUM: defense industry growth, municipal costs"]
    end

    subgraph "🌍 External & Media"
        INT["🌍 International<br/>HIGH: NATO interoperability, Nordic cooperation"]
        MED["📰 Media<br/>HIGH: Hormuz crisis amplifies news value"]
    end
