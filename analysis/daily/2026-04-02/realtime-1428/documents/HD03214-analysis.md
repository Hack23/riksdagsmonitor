...
```mermaid
graph LR
    A[HD03214] --> B{Sensitivity}
    B -->|"🟡 SENSITIVE"| D[National Cybersecurity Infrastructure]

    A --> G{Domain}
    G --> H["Defence & Digital Security (DEF/DIG)"]

    A --> I{Urgency}
    I -->|"🟠 URGENT"| K[Critical infrastructure protection — referred to FöU]
...
```mermaid
quadrantChart
    title Political Impact — Cybersecurity Center
    ...
    "Addresses critical capability gap": [0.2, 0.85]
    "Inter-agency coordination complexity": [0.3, 0.25]
    "Opposition demands transparency": [0.75, 0.6]
    "Bipartisan cyber defense support": [0.5, 0.75]
```
...
graph TD
    subgraph "⚖️ Political Risk Matrix"
        ...
        R2["🟡 Policy Implementation<br/>L:3 × I:3 = 9"]
        R3["🟡 Budget / Fiscal<br/>L:2 × I:3 = 6"]
        R4["🟢 Electoral Impact<br/>L:1 × I:2 = 2"]
