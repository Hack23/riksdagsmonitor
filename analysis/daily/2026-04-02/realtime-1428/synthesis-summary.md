...
graph TD
    subgraph "📊 Daily Political Intelligence Dashboard"
        ...
        subgraph "🔒 Sensitivity"
            CLS["Sensitivity<br/>SENSITIVE<br/>Defense & Energy Security"]
        end
        subgraph "⚖️ Risk"
            RSK["Overall Risk<br/>HIGH<br/>Top: Oil crisis L:5×I:5=25"]
        end
        subgraph "🎭 Threat"
            THR["Threat Level<br/>MODERATE<br/>Top: Transparency (TR)"]
        end
        subgraph "📈 Significance"
            SIG["Top Significance<br/>9/10<br/>Breaking Article"]
        end
    end
    ...
    style RSK fill:#FF9800,color:#FFFFFF
...
graph LR
    subgraph "🏛️ Government Coalition Assessment"
        GS["✅ Strengths<br/>5 entries<br/>Dominant: Defense leadership + NATO integration"]
        GW["⚠️ Weaknesses<br/>4 entries<br/>Critical: Implementation capacity + oil dependency"]
        GO["🚀 Opportunities<br/>4 entries<br/>Top: Crisis validates preparedness agenda"]
        GT["🔴 Threats<br/>4 entries<br/>Top: Energy price crisis eroding support"]
    end
