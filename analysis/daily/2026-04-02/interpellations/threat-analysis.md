...
```mermaid
graph LR
    subgraph Threats["Democratic Function Threats"]
        T1["🔴 Defence Readiness<br/>Severity: HIGH"]:::high
        T2["🟡 Public Service Access<br/>Severity: MEDIUM"]:::medium
        T3["🟡 Ministerial Accountability<br/>Severity: MEDIUM"]:::medium
        T4["🟢 Diplomatic Credibility<br/>Severity: LOW"]:::low
    end
    subgraph Indicators["Evidence"]
        E1["frs 2025/26:425<br/>Trafikverket delays"]
        E2["frs 2025/26:424, 427<br/>Aviation + postal cuts"]
        E3["7 IPs vs Carlson<br/>Capacity strain"]
        E4["frs 2025/26:426<br/>Israel response pending"]
    end
    T1 --> E1
    T2 --> E2
    T3 --> E3
