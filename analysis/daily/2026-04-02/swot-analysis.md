...
```mermaid
graph TB
    subgraph "SWOT — Swedish Parliamentary Landscape 2026-04-02"
        subgraph S["🟢 STRENGTHS"]
            S1["High legislative output<br/>4 propositions Apr 1<br/>dok_id: HD03235, HD03214, HD03228, HD03216"]
            S2["Defense modernization coherence<br/>Cybersecurity + Military export + Civilian protection"]
            S3["Active parliamentary oversight<br/>6 questions from S, MP, C, Independent"]
        end
        subgraph W["🔴 WEAKNESSES"]
            W1["Committee report transparency gap<br/>JuU15 & FöU12 lack debate transcripts"]
            W2["Human rights exposure<br/>Israel (HD11680) + Syria (HD11683) questions"]
            W3["Environmental policy contradiction<br/>Mining vs conservation (HD11681)"]
        end
        subgraph O["🔵 OPPORTUNITIES"]
            O1["Nordic cybersecurity leadership<br/>HD03214 positions Sweden ahead"]
            O2["NATO interoperability<br/>HD03228 military export framework"]
            O3["Civilian preparedness<br/>FöU12 strengthens crisis readiness"]
        end
        subgraph T["🟠 THREATS"]
            T1["Deportation polarization<br/>HD03235 divisive public debate risk"]
            T2["Coalition tension<br/>Environment vs economy on Norra Kärr"]
