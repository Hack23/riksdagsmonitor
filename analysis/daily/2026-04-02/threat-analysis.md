...
```mermaid
graph TD
    ROOT["Political Threats<br/>2026-04-02"] --> POL["Policy Coherence"]
    ROOT --> DEM["Democratic Accountability"]
    ROOT --> EXT["External Relations"]
    ROOT --> ENV["Environmental Governance"]

    POL --> POL1["Deportation vs Human Rights<br/>Severity: 4/5"]
    POL --> POL2["Mining vs Conservation<br/>Severity: 3/5"]

    DEM --> DEM1["Committee transparency gap<br/>Severity: 2/5"]
    DEM --> DEM2["Opposition oversight effectiveness<br/>Severity: 2/5"]

    EXT --> EXT1["Israel death penalty stance<br/>Severity: 3/5"]
    EXT --> EXT2["Syria minorities response<br/>Severity: 3/5"]
    EXT --> EXT3["Stockholm Initiative follow-up<br/>Severity: 2/5"]
