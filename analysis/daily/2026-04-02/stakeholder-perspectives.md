...
```mermaid
graph TD
    CENTER["Parliamentary Activity<br/>2026-04-02"] --> CIT["👥 Citizens"]
    CENTER --> GOV["🏛️ Government Coalition"]
    CENTER --> OPP["⚔️ Opposition Bloc"]
    CENTER --> BIZ["💼 Business/Industry"]
    CENTER --> CIV["🌍 Civil Society"]
    CENTER --> INT["🇪🇺 International/EU"]
    CENTER --> JUD["⚖️ Judiciary/Constitutional"]
    CENTER --> MED["📰 Media/Public Opinion"]

    CIT --> CIT1["Civilian protection strengthened<br/>FöU12: Impact HIGH"]
    CIT --> CIT2["Criminal justice reform<br/>JuU15: Impact MEDIUM"]
    GOV --> GOV1["Legislative agenda advancing<br/>4 props: Impact HIGH"]
    GOV --> GOV2["Security narrative dominant<br/>Impact HIGH"]
    OPP --> OPP1["Foreign policy probing<br/>3 questions: Impact MEDIUM"]
    OPP --> OPP2["Environmental accountability<br/>2 questions: Impact MEDIUM"]
    BIZ --> BIZ1["Military export opportunities<br/>HD03228: Impact HIGH"]
    BIZ --> BIZ2["Mining sector uncertainty<br/>HD11681: Impact MEDIUM"]
    CIV --> CIV1["Human rights scrutiny<br/>HD11680, HD11683: Impact MEDIUM"]
    INT --> INT1["NATO interoperability<br/>HD03228: Impact HIGH"]
    INT --> INT2["Cybersecurity cooperation<br/>HD03214: Impact HIGH"]
    JUD --> JUD1["Deportation law changes<br/>HD03235: Impact HIGH"]
