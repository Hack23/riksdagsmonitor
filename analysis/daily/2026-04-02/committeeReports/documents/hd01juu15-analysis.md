...
```mermaid
graph LR
    A["HD01JuU15<br/>Kriminalvårdsfrågor"] --> B{Sensitivity}
    B -->|"🟢 PUBLIC"| E["Standard Parliamentary<br/>Committee Report"]

    A --> G{Domain}
    G --> H["Justice & Criminal Policy"]
...
```mermaid
graph TD
    subgraph "⚖️ JuU15 Risk Landscape"
        R1["R1: Tillkännagivande on<br/>Trygghetsberedningen<br/>L:2 × I:3 = 6"]
        R2["R2: Prison overcrowding<br/>policy gap<br/>L:3 × I:3 = 9"]
        R3["R3: Women inmates<br/>media attention<br/>L:2 × I:2 = 4"]
