...
```mermaid
graph TD
    GOV["🏛️ Government Coalition<br/>M, KD, L + SD"] --> DEF["🛡️ Defense Track"]
    GOV --> JUST["⚖️ Justice Track"]
    GOV --> MIG["🔐 Immigration Track"]
    
    DEF --> FOU12["FöU12<br/>Civilian Protection"]
    DEF --> P228["Prop 228<br/>Arms Export Reform"]
    DEF --> P214["Prop 214<br/>Cybersecurity Center"]
    
    JUST --> JUU15["JuU15<br/>Criminal Justice"]
    JUST --> P227["Prop 227<br/>Youth Crime Investigation"]
    
    MIG --> P235["Prop 235<br/>Criminal Deportation"]
