...
```mermaid
graph LR
    A["HD01JuU15<br/>Criminal Justice"] --> B{"Sensitivity"}
    B -->|"🟡 SENSITIVE"| D["Justice Policy /<br/>Public Safety"]
    
    A --> G{"Domain"}
    G --> H["Criminal Justice &<br/>Corrections"]
    
    A --> I{"Urgency"}
    I -->|"🔵 ELEVATED"| L["Monitoring —<br/>this week"]
