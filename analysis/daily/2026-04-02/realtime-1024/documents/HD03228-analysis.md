...
```mermaid
graph LR
    A["HD03228<br/>Arms Export Reform"] --> B{"Sensitivity"}
    B -->|"🔴 RESTRICTED"| C["National Security /<br/>International Obligations"]
    
    A --> G{"Domain"}
    G --> H["Defense Export &<br/>Foreign Policy"]
    
    A --> I{"Urgency"}
    I -->|"🟠 URGENT"| K["NATO alignment<br/>— weeks"]
    
    A --> P{"Temperature"}
    P -->|"🔴 HOT"| Q["Traditional neutrality<br/>vs. NATO reality"]
