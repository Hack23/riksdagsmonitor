...
```mermaid
graph LR
    A["HD03235<br/>Deportation Reform"] --> B{"Sensitivity"}
    B -->|"🔴 RESTRICTED"| C["Constitutional Rights /<br/>Migration-Criminal Nexus"]
    
    A --> G{"Domain"}
    G --> H["Immigration & Criminal Justice"]
    
    A --> I{"Urgency"}
    I -->|"🟠 URGENT"| K["Major legislative action<br/>— days to weeks"]
