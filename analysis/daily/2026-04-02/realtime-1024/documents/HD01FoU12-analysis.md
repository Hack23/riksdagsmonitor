...
graph LR
    ...
    B -->|"🟡 SENSITIVE"| D["National Security /<br/>Civil Defense"]
    
    A --> G{"Domain"}
    G --> H["Defense & Total Defense"]
    
    A --> I{"Urgency"}
    I -->|"🟠 URGENT"| K["Legislative response<br/>within weeks"]
    
    A --> P{"Temperature"}
    P -->|"🔴 HOT"| Q["Multi-party engagement<br/>cross-bloc support likely"]
...
```mermaid
quadrantChart
    title SWOT Quadrant — FöU12 Civilian Protection
    x-axis "Harmful" --> "Beneficial"
    y-axis "External" --> "Internal"
    quadrant-1 "Strengths"
    quadrant-2 "Weaknesses"
    quadrant-3 "Threats"
    quadrant-4 "Opportunities"
    "Cross-party consensus": [0.85, 0.8]
    "NATO alignment": [0.9, 0.7]
    "Municipal capacity gap": [0.2, 0.75]
    "Budget pressure": [0.15, 0.65]
    "Alliance expertise": [0.8, 0.3]
    "Public mandate": [0.75, 0.2]
    "Geopolitical escalation": [0.1, 0.25]
    "Coordination challenges": [0.25, 0.15]
```
