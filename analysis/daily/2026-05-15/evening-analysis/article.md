...
keywords: "HD11813, HD03262, HD11812, HD024184, HD10494, HD03267, KU34, CU31, KU, CU, SD, James Pether Sörling, Foreign Ministry, Monitor SD s, Common European Asylum System, Migration Agency s, Tenants Association s, Centre Party, Chechen Ichkeria, Confirm SD s, SHORT TERM, MEDIUM TERM, Await Lagrådet, Exekutivt Briefing"
date: 2026-05-15
subfolder: evening-analysis
slug: 2026-05-15-evening-analysis
source_folder: analysis/daily/2026-05-15/evening-analysis
generated_at: 2026-05-24T16:14:52.830Z
language: en
layout: article
---
## Executive Brief
...
graph TB
    A["🏛️ Tidökoalitionen<br/>M+SD+KD+L (194 mandaten)"]
    B["KU34: Abortskydd<br/>84% stöd (S+M+C+L+KD+V)"]
    C["KU34: Föreningsfrihet<br/>SD splittrat (riskerar supr.maj.)"]
    D["HD03262 PUT-avskaffande<br/>Oppositionen samlad nej"]
    E["HD024184: C opponerar<br/>prop. 2025/26:258"]
    F["Rysslands aggressionslagstiftning<br/>Geopolitisk acceleration (HD11813)"]
    ...
    style B fill:#1a4d1a,stroke:#00ff88,color:#e0e0e0
    style C fill:#4d1a1a,stroke:#ff006e,color:#e0e0e0
    style D fill:#4d1a1a,stroke:#ff006e,color:#e0e0e0
    style E fill:#2d2d00,stroke:#ffbe0b,color:#e0e0e0
    style F fill:#3d1a0a,stroke:#ff4400,color:#e0e0e0
```
...
graph LR
    KJ1["KJ-1 KU34 Abort<br/>HÖG 8/10"]
    KJ2["KJ-2 PUT Backlog<br/>HÖG 8/10"]
    KJ3["KJ-3 Ryssland Aggressionslagstiftning<br/>HÖG 7/10"]
    KJ7["KJ-7 JuU39 Psykologvåld<br/>HÖG 9/10"]
    KJ4["KJ-4 CU31 Valkonflik<br/>MEDEL 7/10"]
    KJ5["KJ-5 C väljarflykt<br/>MEDEL 6/10"]
    PIR1["PIR-1 SD röstning KU34"]
    PIR2["PIR-2 L röstning KU34"]
    PIR3["PIR-3 Lagrådet yttranden"]

    PIR1 --> KJ1
    PIR2 --> KJ1
    PIR3 --> KJ2
    KJ3 --> PIR5["PIR-5 Aurora 26"]

    style KJ1 fill:#1a4d1a,stroke:#00ff88,color:#e0e0e0
    style KJ2 fill:#4d2a00,stroke:#ff8c00,color:#e0e0e0
    style KJ3 fill:#4d1a1a,stroke:#ff006e,color:#e0e0e0
    style KJ7 fill:#1a4d1a,stroke:#00ff88,color:#e0e0e0
```
...
%%{init: {'theme': 'dark', 'themeVariables': {'primaryColor': '#1a1e3d'}}}%%
xychart-beta
    title "KU34 Mandat per röstningsposition"
    x-axis ["Abort-klausulen (Ja)", "Föreningsfrihet (Ja)", "Medborgarrevocation (Ja)", "Supermajoritetströskel"]
    y-axis "Antal mandat" 0 --> 350
    bar [291, 176, 180, 233]
```
...
%%{init: {'theme': 'dark'}}%%
timeline
    title Framåtindikatorer 2026
    section T+72h
        IND-1 : SD röstning KU34
        IND-2 : Svar Itjkerien
        IND-3 : Svar drönarkrig
    section T+7d
        IND-5 : KU34 pleniomröstning
        IND-7 : Dousa bistånd
    section T+30d
        IND-9 : Lagrådet PUT
        IND-10 : KU39 pleniomröstning
    section T+90d
        IND-13 : Riksbank ränta
        IND-15 : Aurora 26 slutrapport
    section T+365d
        IND-16 : Val 2026
        IND-17 : KU34 andra läsning
```
...
```mermaid
%%{init: {'theme': 'dark'}}%%
pie title "Valprognos september 2026 (SOM-baserad)"
    "S" : 31.5
    "SD" : 22.0
    "M" : 19.5
    "V" : 7.2
...
%%{init: {'theme': 'dark'}}%%
xychart-beta
    title "Sverige makroindikator IMF WEO Apr-2026"
    x-axis [2022, 2023, 2024, 2025f, 2026f]
    y-axis "Procent" 0 --> 12
    bar [10.9, 5.9, 2.2, 1.8, 1.8]
    line [2.9, -0.3, 0.5, 2.1, 2.3]
```
...
%%{init: {'theme': 'dark'}}%%
graph LR
    Riksdag["Riksdagens kommunikationskanaler"]
    
    TS["Tidöstrategi:<br/>Aborträtt + Säkerhet + Migration"]
    OS["Oppositionsstrategi:<br/>Hyra + Bistånd + Rättssäkerhet"]
    
    M1["SVT Debatt: KU34 abort (M)"]
    M2["DN Opinion: PUT-human. risk (S)"]
    M3["Expressen: Rysk aggression (SD)"]
    M4["Aftonbladet: Hyresgäster (S, V)"]
    ...
    style TS fill:#1a1e3d,stroke:#00d9ff,color:#e0e0e0
    style OS fill:#1a2d1a,stroke:#00ff88,color:#e0e0e0
```
...
%%{init: {'theme': 'dark'}}%%
gitGraph
    commit id: "2026-05-14 (HD10492, HD10493 interpellationer)"
    branch "2026-05-15"
    checkout "2026-05-15"
    commit id: "HD024184 C-motion KU"
    commit id: "HD10494 SD ip Itjkerien"
    commit id: "HD11812 SD fr drönarkrig"
    commit id: "HD11813 SD fr Ryssland aggression"
