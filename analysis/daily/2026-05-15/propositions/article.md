...
keywords: "Propositions, English, May 15, 2026 update, Riksdagsmonitor, Swedish Parliament, Riksdag, political intelligence, OSINT, Swedish politics, democratic transparency, Security Digital Identity Migration Reforms, Security, Digital, Identity, Migration, Reforms, Government, 2026, Bill, Package, Kristersson, tabled, three, interconnected"
date: 2026-05-15
subfolder: propositions
slug: 2026-05-15-propositions
source_folder: analysis/daily/2026-05-15/propositions
generated_at: 2026-05-20T20:11:10.029Z
language: en
layout: article
---
## Executive Brief
...
mindmap
  root((May 2026 Bill Package))
    Digital Identity
      HD03250 e-identification
        DIGG implementation
        EU eIDAS link
      HD03261 Skatteverket
        Population register controls
        GDPR risks
    Security
      HD03267 Security threats
        ...
        JuU scrutiny
    Migration EU Pact
      HD03262 PUT abolition
        349,000+ affected
        SfU scrutiny
      HD03264 Good-character
        Broader deportation grounds
...
| 📝 | [Executive Brief En](#rm-executive-brief-en) | supporting analytical lens with primary-source evidence and audit-traceable citations |
...
```mermaid
%%{init: {'theme': 'dark', 'themeVariables': {'primaryColor': '#00d9ff', 'secondaryColor': '#ff006e', 'tertiaryColor': '#0a0e27'}}}%%
flowchart TD
    A[Regeringen Kristersson] -->|lämnar| B[Propositionspaket maj 2026]
    B --> C[HD03250 e-legitimation]
    B --> D[HD03261 Skatteverket]
    B --> E[HD03267 Säkerhetshot]
    B --> F[HD03262 PUT-avskaffande]
    B --> G[HD03264 Vandelskrav]
    C -->|TU-beredning| H[Riksdagen]
    D -->|SkU-beredning| H
    E -->|JuU-beredning| H
    F -->|SfU-beredning| H
    G -->|SfU-beredning| H
    H -->|Votering vår 2026| I[Ny lagstiftning]
...
%%{init: {'theme': 'dark'}}%%
graph TB
    KJ1["KJ-1 Antagande<br/>Konfidensgrad: Hög"]
    KJ2["KJ-2 Migrationsverket backlog<br/>Konfidensgrad: Medelhög"]
    KJ3["KJ-3 e-legitimation IT-risk<br/>Konfidensgrad: Medelhög"]
    KJ4["KJ-4 Lagrådet EKMR<br/>Konfidensgrad: Medelhög"]
    KJ5["KJ-5 Valstrategi<br/>Konfidensgrad: Medelhög"]
    DATA[["Datakällor: riksdag.se\nStatskontoret\nLagrådet (väntande)"]]
    DATA --> KJ1 & KJ2 & KJ3 & KJ4 & KJ5
    style KJ1 fill:#0a0e27,stroke:#00d9ff
    style KJ2 fill:#0a0e27,stroke:#ffbe0b
    style KJ3 fill:#0a0e27,stroke:#ffbe0b
    style KJ4 fill:#0a0e27,stroke:#ffbe0b
    style KJ5 fill:#0a0e27,stroke:#00d9ff
```
...
%%{init: {'theme': 'dark'}}%%
graph LR
    M[Moderaterna] -->|stödjer| PAK[Propositionspaket]
    SD[Sverigedemokraterna] -->|stödjer| PAK
    KD[Kristdemokraterna] -->|stödjer| PAK
    L[Liberalerna] -->|villkorat stöd| PAK
    S[Socialdemokraterna] -->|motstånd| PAK
    V[Vänsterpartiet] -->|starkt motstånd| PAK
    MP[Miljöpartiet] -->|motstånd| PAK
    C[Centerpartiet] -->|delat| PAK
    FARR[FARR/Amnesty] -->|motstånd| PAK
    TE[Teknikföretagen] -->|oroade HD03262| PAK
    style M fill:#1a1e3d,stroke:#00d9ff
    style SD fill:#1a1e3d,stroke:#00d9ff
    style KD fill:#1a1e3d,stroke:#00d9ff
    style L fill:#1a1e3d,stroke:#ffbe0b
    style S fill:#1a1e3d,stroke:#ff006e
    style V fill:#1a1e3d,stroke:#ff006e
    style MP fill:#1a1e3d,stroke:#ff006e
...
%%{init: {'theme': 'dark'}}%%
xychart-beta
  title "Riksdagsmandat per Parti (349 totalt)"
  x-axis ["M", "SD", "KD", "L", "S", "V", "MP", "C"]
  y-axis "Antal mandat" 0 --> 120
...
%%{init: {'theme': 'dark'}}%%
xychart-beta
  title "Väljargrupper: Stöd för Propositionspaket"
  x-axis ["SD-kärna", "M-höger", "L-rättig.", "C-näring.", "S-kärna", "S-kosmo.", "V+MP", "Utrik."]
  y-axis "Stödindex (-100 till +100)" -100 --> 100
  bar [90, 65, -30, -60, -50, -85, -95, -90]
```
...
%%{init: {'theme': 'dark'}}%%
timeline
    title Framåtindikatorer 2026–2029
    2026-06 : FI-1 Lagrådet HD03267
            : FI-2 Lagrådet HD03262
            : FI-4 Tekniska yttranden
    2026-09 : FI-5 Riksdag votering HD03262
            : FI-6 Riksdag votering HD03267
            : FI-7 Riksdagsval 2026
            : FI-8 EU-kommissionen
    2027-01 : FI-10 Migrationsverket PUT-start
    2027-03 : FI-11 Arbetsgivarorganisationernas rapport
    2027-05 : FI-9 DIGG e-legitimation pilot
    2029-01 : FI-12 ECHR-prövning
            : FI-13 PUT-konverteringsstatistik
    2029-06 : FI-14 e-legitimation marknadspenetration
```
...
%%{init: {'theme': 'dark'}}%%
graph LR
    NOW[["2026-05-15\nProp.paket\nframlagt"]] --> A["Scenario A\n(55%)\nStark impl."]
    NOW --> B["Scenario B\n(25%)\nFörsenad"]
    NOW --> C["Scenario C\n(15%)\nKris/Blockad"]
    NOW --> D["Scenario D\n(5%)\nUtvidgad"]
    A --> A1["2026H2: Riksdagsantagande\n2027: PUT-konvertering\n2028: e-legitimation"]
    B --> B1["2027: Reviderat Riksdagsantagande\n2029: Försenad e-legitimation"]
    C --> C1["Extraval 2026\nOsäkert utfall"]
    D --> D1["Ny Tidö-2.0\n2027–2030 ytterligare skärpningar"]
    style A fill:#0a0e27,stroke:#00d9ff
    style B fill:#0a0e27,stroke:#ffbe0b
    style C fill:#0a0e27,stroke:#ff006e
...
%%{init: {'theme': 'dark'}}%%
graph LR
    subgraph Val2026["🗳️ Val September 2026"]
        VA["Valresultat A\nHöger vinner knappt\n55% sannolikhet"]
        VB["Valresultat B\nJämnt läge, förhandlingar\n30% sannolikhet"]
        VC["Valresultat C\nL under 4%, krisval\n15% sannolikhet"]
    end
    PROP[Propositionspaket Mai 2026] -->|"Migration valkampanj"| Val2026
    VA --> REG1["Tidö 2.0\nSD+M+KD regering"]
    VB --> REG2["Minoritetsregeringen\nom M söker C+S-stöd"]
    VC --> REG3["Extraval 2027\nStatsministern avgår"]
    style VA fill:#1a1e3d,stroke:#00d9ff
    style VB fill:#1a1e3d,stroke:#ffbe0b
    style VC fill:#1a1e3d,stroke:#ff006e
```
...
```mermaid
%%{init: {'theme': 'dark', 'themeVariables': {'primaryColor': '#00d9ff', 'secondaryColor': '#ff006e', 'tertiaryColor': '#ffbe0b'}}}%%
graph TB
    S1[✅ Koalitionskohesion HD03250 HD03262 HD03267] --> CENTER
    S2[✅ EU-konformitet] --> CENTER
    W1[⚠️ EKMR-risker HD03267] --> CENTER
    W2[⚠️ Migrationsverket kapacitetsbrister] --> CENTER
    O1[💡 Valstrategi 2026] --> CENTER
    O2[💡 Digital infrastruktur] --> CENTER
    T1[🚨 Rättsliga överklaganden HD03262] --> CENTER
    T2[🚨 Kompetensförsörjning] --> CENTER
    CENTER{{"Propositions-\npaket\nMaj 2026"}}
    style CENTER fill:#1a1e3d,stroke:#00d9ff
    style S1 fill:#1a1e3d,stroke:#00d9ff
    style S2 fill:#1a1e3d,stroke:#00d9ff
    style W1 fill:#1a1e3d,stroke:#ffbe0b
    style W2 fill:#1a1e3d,stroke:#ffbe0b
    style O1 fill:#1a1e3d,stroke:#00d9ff
    style O2 fill:#1a1e3d,stroke:#00d9ff
    style T1 fill:#1a1e3d,stroke:#ff006e
    style T2 fill:#1a1e3d,stroke:#ff006e
```
...
%%{init: {'theme': 'dark'}}%%
timeline
    title Historiska Paralleller — Nyckelmoment
    2015 : Migrationstoppen 163 000 asylsökande
    2016 : Tidsbegränsad asyllag (S+MP)
         : Prop. 2015/16:174 PUT-begränsning
    2018 : Danska ghetto-paketet
    2019 : SÄPO-lag utvidgning (S-regering)
    2021 : SOU 2021:62 e-legitimationsutredning
         : PUT-begränsning permanentad
    2022 : Tidöavtalet M+SD+KD+L
    2026 : Propositionspaket maj 2026
         : HD03262 HD03264 HD03267 HD03250 HD03261
```
...
%%{init: {'theme': 'dark'}}%%
graph LR
    GOV[Propositionspublicering\nRiksdag.se] --> MSM[Mainstreammedia\n24h]
    MSM --> SM[Social Media\n48–72h]
    SM --> INT[Internationell media\n72–96h]
    SM --> C1[Civilsamhälle\naktivering]
    SM --> C2[Opposition\nmobilisering]
    C1 --> DEM[Demonstrationer\n2–4 veckor]
    C2 --> PAR[Parlamentsdebatt\n4–6 veckor]
    INT --> EUP[EU-parlamentsdebatt\n4–8 veckor]
    style GOV fill:#0a0e27,stroke:#00d9ff
    style MSM fill:#1a1e3d,stroke:#ffbe0b
    style SM fill:#1a1e3d,stroke:#ffbe0b
    style INT fill:#1a1e3d,stroke:#00d9ff
    style DEM fill:#1a1e3d,stroke:#ff006e
```
...
%%{init: {'theme': 'dark'}}%%
graph LR
    H1["Hypotes 1\ne-legitimation fiasko\n30% sannolikhet"]
    H2["Hypotes 2\nHD03262 skadar\nSveriges image\n20% sannolikhet"]
    H3["Hypotes 3\nHD03267 mot aktivister\n15% sannolikhet"]
    IND1["Indikator:\nDIGG leverans-\nproblem Q3 2026"]
    IND2["Indikator:\nEU-kommissionens\nbrev till Sverige"]
    IND3["Indikator:\nSÄPO utvisning av\npolitisk aktivist"]
    H1 --> IND1
...
## Executive Brief Ar
<!-- source: executive-brief_ar.md :: https://github.com/Hack23/riksdagsmonitor/blob/main/analysis/daily/2026-05-15/propositions/executive-brief_ar.md -->
...
%%{init: {'theme': 'dark', 'themeVariables': {'primaryColor': '#1a1e3d', 'edgeLabelBackground': '#0a0e27', 'tertiaryColor': '#0a0e27'}}}%%
mindmap
  root((Maj 2026 Propositionspaket))
    Digital Identitet
      HD03250 e-legitimation
        DIGG implementation
        EU eIDAS-koppling
      HD03261 Skatteverket
        Folkbokföring kontrolls
        GDPR-risker
    Säkerhet
      HD03267 Säkerhetshot
        EKMR-risker
...
## Executive Brief He
<!-- source: executive-brief_he.md :: https://github.com/Hack23/riksdagsmonitor/blob/main/analysis/daily/2026-05-15/propositions/executive-brief_he.md -->
...
- [`executive-brief_ar.md`](https://github.com/Hack23/riksdagsmonitor/blob/main/analysis/daily/2026-05-15/propositions/executive-brief_ar.md)
- [`executive-brief_da.md`](https://github.com/Hack23/riksdagsmonitor/blob/main/analysis/daily/2026-05-15/propositions/executive-brief_da.md)
- [`executive-brief_de.md`](https://github.com/Hack23/riksdagsmonitor/blob/main/analysis/daily/2026-05-15/propositions/executive-brief_de.md)
- [`executive-brief_en.md`](https://github.com/Hack23/riksdagsmonitor/blob/main/analysis/daily/2026-05-15/propositions/executive-brief_en.md)
- [`executive-brief_es.md`](https://github.com/Hack23/riksdagsmonitor/blob/main/analysis/daily/2026-05-15/propositions/executive-brief_es.md)
- [`executive-brief_fi.md`](https://github.com/Hack23/riksdagsmonitor/blob/main/analysis/daily/2026-05-15/propositions/executive-brief_fi.md)
- [`executive-brief_fr.md`](https://github.com/Hack23/riksdagsmonitor/blob/main/analysis/daily/2026-05-15/propositions/executive-brief_fr.md)
- [`executive-brief_he.md`](https://github.com/Hack23/riksdagsmonitor/blob/main/analysis/daily/2026-05-15/propositions/executive-brief_he.md)
- [`executive-brief_ja.md`](https://github.com/Hack23/riksdagsmonitor/blob/main/analysis/daily/2026-05-15/propositions/executive-brief_ja.md)
- [`executive-brief_ko.md`](https://github.com/Hack23/riksdagsmonitor/blob/main/analysis/daily/2026-05-15/propositions/executive-brief_ko.md)
- [`executive-brief_nl.md`](https://github.com/Hack23/riksdagsmonitor/blob/main/analysis/daily/2026-05-15/propositions/executive-brief_nl.md)
- [`executive-brief_no.md`](https://github.com/Hack23/riksdagsmonitor/blob/main/analysis/daily/2026-05-15/propositions/executive-brief_no.md)
- [`executive-brief_sv.md`](https://github.com/Hack23/riksdagsmonitor/blob/main/analysis/daily/2026-05-15/propositions/executive-brief_sv.md)
- [`executive-brief_zh.md`](https://github.com/Hack23/riksdagsmonitor/blob/main/analysis/daily/2026-05-15/propositions/executive-brief_zh.md)
