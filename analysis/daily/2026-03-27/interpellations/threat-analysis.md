...
```mermaid
graph TD
    subgraph "🎭 Political Threat Analysis — 2026-03-27"
        T1["Spoofing<br/>(Misrepresentation)<br/>LOW"]
        T2["Tampering<br/>(Policy Manipulation)<br/>LOW"]
        T3["Repudiation<br/>(Accountability Denial)<br/>MEDIUM"]
        T4["Information Disclosure<br/>(Transparency Gaps)<br/>MEDIUM"]
