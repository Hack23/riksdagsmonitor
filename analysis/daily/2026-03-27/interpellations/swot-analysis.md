...
```mermaid
graph TD
    subgraph "SWOT Quadrant — 2026-03-27 Interpellations"
        direction TB
        subgraph "Strengths"
            GS1["Coalition majority<br/>stable (83/100)"]
            OS1["Coordinated 3-minister<br/>interpellation strategy"]
        end
        subgraph "Weaknesses"
            GW1["SEK 4.3B returned unused<br/>by Arbetsformedlingen"]
            GW2["Discrimination law<br/>reform delayed"]
            GW3["1-2 pct GDP lost<br/>integration failures"]
        end
        subgraph "Opportunities"
            GO1["Minister responses<br/>April 13-17"]
            OO1["Election 2026<br/>integration narrative"]
        end
        subgraph "Threats"
            GT1["Media narrative of<br/>government inaction"]
