...
```mermaid
graph TD
    subgraph "👥 Stakeholder Impact — 2026-03-27"
        GOV["🏛️ Government<br/>Impact: HIGH<br/>3 ministers questioned"]
        OPP["⚖️ Opposition<br/>Impact: HIGH<br/>Coordinated strategy"]
        CIT["👥 Citizens<br/>Impact: HIGH<br/>Rights, jobs, integration"]
        ECO["💰 Economy<br/>Impact: MEDIUM<br/>SEK 4.3B, GDP loss"]
