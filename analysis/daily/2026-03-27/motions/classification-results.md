...
```mermaid
graph LR
    subgraph "🏷️ Document Classification — 2026-03-27"
        direction TB
        A["4 Motions"] --> B["Migration Policy<br/>2 documents"]
        A --> C["Fiscal Policy<br/>1 document"]
        A --> D["Competition Policy<br/>1 document"]
    end
