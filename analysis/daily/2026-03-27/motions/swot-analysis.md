...
graph LR
    subgraph "💪 Strengths"
        GS1["Gov: 176-seat majority<br/>holds firm"]
        OS1["V: Broad-front<br/>3 motions, 3 domains"]
        OS2["S: Nuanced citizenship<br/>constructive modification"]
    end
    subgraph "⚠️ Weaknesses"
        GW1["Gov: Cross-party<br/>citizenship opposition"]
        OW1["S-V divergence<br/>prevents coordination"]
        OW2["96% denial rate<br/>limits legislative impact"]
    end
    subgraph "🌟 Opportunities"
        GO1["Gov: Exploit S-V split<br/>on citizenship"]
        OO1["Cash mandate<br/>broad voter appeal"]
        OO2["Banking oligopoly<br/>media traction"]
    end
    subgraph "🔴 Threats"
        GT1["Cash exclusion<br/>gains public traction"]
