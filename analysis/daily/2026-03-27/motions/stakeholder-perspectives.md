...
```mermaid
graph TD
    subgraph "👥 Stakeholder Impact — March 27 Motions"
        GOV["🏛️ Government<br/>Impact: LOW<br/>Agenda proceeds"]
        OPP["⚔️ Opposition<br/>Impact: MEDIUM<br/>Active but divided"]
        CIT["👤 Citizens<br/>Impact: MEDIUM<br/>Cash access, citizenship rights"]
        ECO["💰 Economic<br/>Impact: LOW-MEDIUM<br/>Competition, banking reform"]
        MED["📰 Media<br/>Impact: MEDIUM<br/>Citizenship debate newsworthy"]
