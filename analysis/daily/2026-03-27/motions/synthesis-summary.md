...
```mermaid
graph TD
    subgraph "📊 Daily Political Intelligence Dashboard — 2026-03-27"
        direction TB
        subgraph "🔒 Sensitivity"
            CLS["Sensitivity: 🟢 PUBLIC<br/>Standard parliamentary motions"]
        end
        subgraph "⚖️ Risk"
            RSK["Overall Risk: 🟡 MEDIUM<br/>Citizenship reform generates<br/>cross-party opposition alignment"]
        end
        subgraph "🎭 Threat"
            THR["Threat Level: 🟢 LOW<br/>No immediate democratic threat<br/>Normal legislative opposition"]
        end
        subgraph "📈 Significance"
            SIG["Average: 3.5/10<br/>Top: HD023993 (4/10)<br/>Cash payment expansion (V)"]
        end
    end
