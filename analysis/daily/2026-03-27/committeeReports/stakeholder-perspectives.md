...
```mermaid
graph TD
    subgraph "📄 5 Committee Reports"
        DOC["📅 2026-03-27<br/>5 Reports"]
    end

    subgraph "🏛️ Political Actors"
        GOV["🏛️ Government<br/>Impact: MEDIUM<br/>Policy consistency maintained"]
        OPP["⚖️ Opposition<br/>Impact: HIGH<br/>214+ rejected motions = campaign material"]
    end

    subgraph "👥 Society"
        CIT["👥 Citizens<br/>Impact: HIGH<br/>Housing, consumer, minority rights"]
        ECO["💰 Economic<br/>Impact: MEDIUM<br/>Housing market, consumer regulation"]
    end

    subgraph "🌍 External"
        INT["🌍 International<br/>Impact: MEDIUM<br/>EU policy, minority language obligations"]
        MED["📰 Media<br/>Impact: MEDIUM<br/>Housing crisis + Riksrevisionen angles"]
    end
