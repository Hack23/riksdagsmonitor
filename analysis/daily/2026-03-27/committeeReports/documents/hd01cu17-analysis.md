...
```mermaid
graph LR
    A["📄 HD01CU17<br/>Consumer Rights"] --> B{Sensitivity}
    B -->|"🟢 PUBLIC"| E["Standard Parliamentary<br/>Consumer Policy"]

    A --> G{Domain}
    G --> H["Consumer Affairs / Economy (CON)"]
