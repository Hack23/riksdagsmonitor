...
```mermaid
graph LR
    A["📄 HD01KrU10<br/>EU Cultural Compass"] --> B{Sensitivity}
    B -->|"🟢 PUBLIC"| E["Standard Parliamentary<br/>EU Scrutiny"]

    A --> G{Domain}
    G --> H["Culture / EU Affairs (CUL+EU)"]
...
```mermaid
graph TD
    subgraph "⚖️ Political Risk Matrix — HD01KrU10"
        R1["🟢 Coalition Stability<br/>L:1 × I:1 = 1"]
        R2["🟢 Policy Implementation<br/>L:1 × I:2 = 2"]
        R3["🟢 Budget / Fiscal<br/>L:1 × I:1 = 1"]
        R4["🟢 Electoral Impact<br/>L:1 × I:1 = 1"]
        R5["🟢 Democratic Process<br/>L:1 × I:1 = 1"]
        R6["🟡 External / International<br/>L:2 × I:2 = 4"]
    end
