...
```mermaid
graph LR
    A["📄 HD01KU31<br/>Minority Languages"] --> B{Sensitivity}
    B -->|"🟡 SENSITIVE"| D["Constitutional Rights<br/>International Obligations"]

    A --> G{Domain}
    G --> H["Human Rights / Culture (HR+CUL)"]
...
```mermaid
graph TD
    subgraph "⚖️ Political Risk Matrix — HD01KU31"
