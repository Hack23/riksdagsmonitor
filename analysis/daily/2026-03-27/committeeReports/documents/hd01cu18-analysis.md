...
```mermaid
graph LR
    A["📄 HD01CU18<br/>Housing Policy"] --> B{Sensitivity}
    B -->|"🟡 SENSITIVE"| D["High Public Salience<br/>Voter Impact"]

    A --> G{Domain}
    G --> H["Housing / Social Policy (HOU)"]
...
```mermaid
graph TD
    subgraph "⚖️ Political Risk Matrix — HD01CU18"
        R1["🟢 Coalition Stability<br/>L:2 × I:2 = 4"]
        R2["🟡 Policy Implementation<br/>L:3 × I:3 = 9"]
        R3["🟡 Budget / Fiscal<br/>L:3 × I:2 = 6"]
        R4["🟠 Electoral Impact<br/>L:4 × I:3 = 12"]
