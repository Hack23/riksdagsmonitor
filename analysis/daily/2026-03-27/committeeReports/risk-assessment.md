...
```mermaid
graph TD
    subgraph "⚖️ Aggregated Risk — 5 Committee Reports"
        R1["🟢 Coalition Stability<br/>Max: 4 (CU18)"]
        R2["🟡 Policy Implementation<br/>Max: 9 (KU31)"]
        R3["🟡 Budget / Fiscal<br/>Max: 6 (CU18)"]
        R4["🟠 Electoral Impact<br/>Max: 12 (CU18)"]
        R5["🟡 Democratic Process<br/>Max: 6 (KU31)"]
        R6["🟡 External/International<br/>Max: 6 (KU31)"]
    end
