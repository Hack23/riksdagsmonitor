...
keywords: "HD10480, HD11802, HD11803, HD11801, HD11800, HD01CU34, HD01UbU28, UbU28, CU34, UbU, CU, With Sweden, S s Niklas Karlsson, Finance Minister Svantesson, Education Minister Mohamsson, Foreign Minister Malmer Stenergard, IFS SDMX HTTP, IMF WEO, Growth Pact, Riksdagsmonitor, Swedish Parliament, Riksdag, political intelligence, OSINT"
date: 2026-05-08
subfolder: realtime-pulse
slug: 2026-05-08-realtime-pulse
source_folder: analysis/daily/2026-05-08/realtime-pulse
generated_at: 2026-05-24T17:19:40.030Z
language: en
layout: article
---
## Executive Brief
...
graph TD
    subgraph Coalition["Tidö Coalition"]
        M[Moderaterna] --> Gov[Government]
        KD[Kristdemokraterna] --> Gov
        L[Liberalerna] --> Gov
        SD[Sverigedemokraterna] -.->|passive support| Gov
    end
    ...
    Gov -->|UbU28 implements| Skolverket
    Gov -->|CU34 empowers| Kronofogden[Kronofogdemyndigheten]
    SD -->|HD11802 probe| L
    S -->|HD10480 accountability| Svantesson[Finance Min. Svantesson]
    S -->|HD11803 accountability| MMS[FM Malmer Stenergard]
    V -->|HD11801 pressure| Carlson[Infrastructure Min. Carlson]
    style M fill:#1f77b4,color:#fff
    style SD fill:#ffdd33,color:#333
    style S fill:#e74c3c,color:#fff
    style V fill:#c0392b,color:#fff
    style L fill:#3498db,color:#fff
    style KD fill:#2c7bb6,color:#fff
```
...
```mermaid
graph TD
    A[2026-05-08 Riksdag session] --> B{UbU28 vote outcome}
    B -->|Passes, unions accept| S1[Scenario 1: Smooth delivery]
    B -->|Passes, unions oppose| S2[Scenario 2: Education backlash]
    A --> C{HD11802 Mohamsson response}
    C -->|Civil-liberties restatement| D[SD dissatisfied but silent]
    C -->|Ambiguous/accommodating| E[SD escalates]
    E --> S3[Scenario 3: Coalition rupture]
...
```mermaid
graph LR
    subgraph Today["2026-05-08 realtime-pulse"]
        UbU28[HD01UbU28]
        CU34[HD01CU34]
        I480[HD10480]
        Q803[HD11803]
    end
    subgraph Prior["Prior cycles"]
        PIR9[PIR-RT-009: teacher shortage\n2026-05-07/realtime-pulse]
        PIR5[PIR-RT-005: Carlson accountability\n2026-05-07/realtime-pulse]
        Prop212[Prop 2025/26:212\npropositions/]
    end
    UbU28 -->|partially answers| PIR9
    CU34 -.->|implements| Prop212
    Q803 -.->|series continuation| PriorGaza[Prior Gaza questions]
    style PIR9 fill:#f39c12,color:#fff
    style PIR5 fill:#f39c12,color:#fff
    style Prop212 fill:#27ae60,color:#fff
```
