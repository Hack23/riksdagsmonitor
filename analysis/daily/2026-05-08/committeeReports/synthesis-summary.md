# Synthesis Summary — Committee Reports 2026-05-08
...
## Pass 2 Additions — Enhanced Cross-Cutting Analysis

### 5. The "July 1, 2026" Signal
Seven of eight bills share the identical effective date: 1 July 2026. This is a government choice (effective dates are set in the proposition and confirmed by committee). The convergence is deliberate: it maximises legislative delivery narrative during the 75-day campaign window (1 July to 13 September). It also means all bills require the same regulatory implementation timeline — creating institutional implementation load risk across Riksbanken, Polismyndigheten, Åklagarmyndigheten, and municipalities simultaneously.

### 6. The Framing Battle for JuU39
The contest over JuU39's scope (core psychological violence vs. economic violence vs. conversion therapy) reflects three distinct political-cultural coalitions within the opposition:
- **S+MP axis**: Wants broader domestic violence protection (class-inflected; economic violence disproportionately affects lower-income victims)
- **V axis**: Radical extension + LGBTQ rights integration
- **C axis**: Specifically LGBTQ conversion therapy (C's liberal tradition distinguishes it from SD)

This three-way opposition coalition will not hold coherently in campaign — each party will emphasise its specific reservation, diluting the unified "government didn't go far enough" message.
