...
|----------|---------------|--------------:|
| **Editorial lead selection** | [`significance-scoring.md`](significance-scoring.md) · DIW rank 1 = HD03100 | Immediate |
| **Coalition fiscal-credibility posture** | [`risk-assessment.md`](risk-assessment.md) §Fiscal Risk · [`scenario-analysis.md`](scenario-analysis.md) BEAR scenario | Before Riksrevisionen response on HD03241 (Q2 2026) |
| **ECHR / rights-NGO engagement posture** | [`threat-analysis.md`](threat-analysis.md) §Elevation of Privilege · [`comparative-international.md`](comparative-international.md) §Migration | Before HD01SfU22 enters force (target: June 2026) |
...
[README](README.md) · [Synthesis](synthesis-summary.md) · [Significance](significance-scoring.md) · [SWOT](swot-analysis.md) · [Risk](risk-assessment.md) · [Threat](threat-analysis.md) · [Stakeholders](stakeholder-perspectives.md) · [Scenarios](scenario-analysis.md) · [Comparative](comparative-international.md) · [Cross-References](cross-reference-map.md) · [Classification](classification-results.md)
