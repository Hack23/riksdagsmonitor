---
title: "Scenario Analysis — Post-2026 Mandate (12-leaf tree + 5 wildcards)"
date: 2026-05-13
language: en
...
horizon: cycle
methodology: structured scenario analysis (4 base × 3 coalition branches = 12 leaves) + black-swan wildcards
---

# Scenario Analysis — Post-2026 Swedish Governing Arrangement
...
- Coalition arithmetic: [`coalition-mathematics.md`](coalition-mathematics.md).
- Wildcard distribution: [`wildcards-blackswans.md`](wildcards-blackswans.md).
- Counterfactuals: [`devils-advocate.md`](devils-advocate.md).
- Forward indicators by horizon-band: [`cycle-trajectory.md`](cycle-trajectory.md).
