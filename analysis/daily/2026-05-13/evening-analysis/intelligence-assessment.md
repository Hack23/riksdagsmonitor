# 🔍 Intelligence Assessment — Evening Analysis, 2026-05-13

**Date:** 2026-05-13 | **Cycle:** 2025/26 | **Analyst:** Automated (AI-FIRST)
...
*Generated: 2026-05-13T18:12:00Z | Agent: news-evening-analysis | Pass: 1*

---

## Pass 2 Addendum — Deepened Assessment

### KJ-1 Enhancement: Migration Package Technical Detail

**Prop. 262 legal mechanism:** The legislation amends Utlänningslagen (2005:716) Chapter 5, §1. The current right to permanent residence after 4 years of continuous legal residence is replaced with a renewable 4-year permit system. Key provision: after 8 years of legal residence with successful integration (employment, language proficiency, conduct), a "long-term resident" status may be granted — not equivalent to permanent residence but providing enhanced protection against expulsion.

**Prop. 265 detention scope:** The expanded powers include three new detention triggers:
1. "Risk of absconding" with lower burden of proof (from "significant risk" to "assessed risk")
2. Extended detention pending appeal (currently limited; would expand)
3. Electronic supervision (ankle tags) as mandatory alternative before administrative detention

**Comparison to morning propositions (HD03267):** HD03267 (security detention, this morning's propositions analysis) covers post-sentence security detention of convicted criminals. Props 265 covers administrative migration detention — different legal regime, same ECHR Art. 5 scrutiny. Together, these two legislative tracks represent a systematic expansion of Swedish administrative detention powers in a single parliamentary session — unprecedented in scope.

### KJ-2 Enhancement: Military Cooperation

**Prop. 254 specific mechanism:** The law amends Lagen (2020:782) om operativt militärt samarbete. The MP motion (HD024176) specifically opposes the provision that would allow Swedish soldiers to operate under foreign tactical command **without prior Riksdag approval** for non-Article 5 operations. This is a significant sovereignty question: the current law requires government case-by-case decision; prop. 254 grants standing government authority.
