...
keywords: "HD024151, HD024150, HD024149, HD024148, HD024146, HD024142, HD024147, HD024127, prop. 2025/26:258, MP, SD, James Pether Sörling, Run ID, Jennie Nilsson, Tony Haddou, IMF WEO-, Riksdagsmonitor, Swedish Parliament, Riksdag, political intelligence, OSINT, Swedish politics, democratic transparency, Regeringen"
date: 2026-05-13
subfolder: motions
slug: 2026-05-13-motions
source_folder: analysis/daily/2026-05-13/motions
generated_at: 2026-05-24T14:02:59.587Z
language: en
layout: article
---
## Executive Brief
...
graph TD
    ...
    A[Opposition Motions Batch 2026-05-13]
    B[HD024151: Party Transparency - S vs Prop 258]
    C[HD024150+149: Migration - V vs Props 263+264]
    D[HD024148+146: Criminal Age - MP+C vs Prop 246]
    E[HD024141-147: Forestry - Multiple vs Prop 242]
    A --> B
    A --> C
    A --> D
    A --> E
...
```mermaid
graph LR
    style GOV fill:#ff006e,stroke:#0a0e27,color:#fff
    style S fill:#E8112D,stroke:#0a0e27,color:#fff
    style V fill:#EE2020,stroke:#0a0e27,color:#fff
    style MP fill:#83CF39,stroke:#0a0e27,color:#0a0e27
    style C fill:#009933,stroke:#0a0e27,color:#fff
    style KU fill:#00d9ff,stroke:#0a0e27,color:#0a0e27
    style SfU fill:#00d9ff,stroke:#0a0e27,color:#0a0e27
    style JuU fill:#00d9ff,stroke:#0a0e27,color:#0a0e27
    GOV[Tidö Coalition]
    S[S: HD024151 - Party transparency attack]
    V[V: HD024149+150 - Migration rejection]
    MP[MP: HD024147+131 - Forestry+Environment]
    C[C: HD024146+145 - Criminal age+Forestry]
    KU[KU: Prop 258]
    SfU[SfU: Props 263+264]
    JuU[JuU: Prop 246]
    GOV --> KU
    GOV --> SfU
    GOV --> JuU
...
```mermaid
xychart-beta
    title "DIW Significance Scores — Top 10 Motions 2026-05-13"
    x-axis ["HD024151", "HD024150", "HD024149", "HD024148", "HD024146", "HD024142", "HD024147", "HD024145", "HD024144", "HD024143"]
    y-axis "DIW Score" 0 --> 100
    bar [87, 72, 70, 68, 65, 63, 52, 50, 48, 46]
```
...
graph TD
    ...
    style MP fill:#83CF39,stroke:#0a0e27,color:#0a0e27
    style C fill:#009933,stroke:#0a0e27,color:#fff
    style LO fill:#ffbe0b,stroke:#0a0e27,color:#0a0e27
    style LAGR fill:#00d9ff,stroke:#0a0e27,color:#0a0e27
    GOV[Tidö Coalition]
    S[S — HD024151]
    V[V — HD024150/149]
    MP[MP — Environment+Justice]
    C[C — Pragmatic amendments]
    LO[LO/TCO — Trade unions: anti-prop 258]
    LAGR[Lagrådet — Constitutional gatekeeper]
    S -->|opposes| GOV
    V -->|opposes| GOV
    MP -->|opposes| GOV
    C -->|partially opposes| GOV
    LO -->|lobbies| S
    S -->|triggers review| LAGR
    LAGR -->|advisory opinion| GOV
```
...
```mermaid
graph LR
    style LI1 fill:#ffbe0b,stroke:#0a0e27,color:#0a0e27
    style LI2 fill:#ffbe0b,stroke:#0a0e27,color:#0a0e27
    style LI3 fill:#00d9ff,stroke:#0a0e27,color:#0a0e27
    style SA fill:#ff006e,stroke:#0a0e27,color:#fff
    style SB fill:#ff006e,stroke:#0a0e27,color:#fff
    style SC fill:#ff006e,stroke:#0a0e27,color:#fff
    LI1[SD endorses criminal age 13]
    LI2[Lagrådet advisory tone on prop 258]
    LI3[SfU vote timeline]
    SA[Scenario A: All pass]
    SB[Scenario B: Prop 258 modified]
    SC[Scenario C: Criminal age modified]
    LI1 -->|positive| SA
    LI1 -->|negative| SC
    LI2 -->|critical| SB
    LI2 -->|permissive| SA
...
```mermaid
flowchart TD
    P258["Prop. 258\nTransparency\nLag.ref.: HIGH"] --> KU["KU Committee\nJune 2026"]
    P263["Prop. 263\nDeportation\nMigrationsverket: BOTTLENECK"] --> SfU["SfU Committee\nJune 2026"]
    P264["Prop. 264\nDetention\nKriminalvården: BOTTLENECK"] --> SfU
    P246["Prop. 246\nAge 13\nUNCRC: RISK"] --> JuU["JuU Committee\nJune 2026"]
    KU --> Lagrådet["Lagrådet\nAdvisory\nJuly 2026?"]
    JuU --> Lagrådet
    SfU --> ECtHR["ECtHR Risk\n2027+"]
```
