...
generated_at: 2026-05-20T13:14:37.015Z
language: en
layout: article
---
## Executive Brief
...
```mermaid
timeline
    title Interpellation Policy Timelines
    section Utjämningssystem (HD10487)
        2022 : Riksdagen commissions review (unanimous)
        Summer 2024 : SOU delivered
        Autumn 2024 : Remiss genomförd
        2026-05-08 : S interpellation filed (HD10487)
        2026-05-29 : Sista svarsdatum
    section Klimatanpassning (HD10488)
        Spring 2025 : Inquiry "Bättre förutsättningar" presented
        2025-10-17 : Consultation closed
        2026-05-12 : MP interpellation filed (HD10488)
        2026-05-29 : Sista svarsdatum
```
...
```mermaid
xychart-beta
    title "DIW Significance Scores — 2026-05-13 Interpellations"
    x-axis ["HD10487\nUtjämningssystem", "HD10488\nKlimatanpassning"]
...
```mermaid
graph LR
    classDef high fill:#E91E63,color:white
    classDef medium fill:#FF9800,color:white
    classDef low fill:#4CAF50,color:white

    Slottner["Erik Slottner KD
(Civilminister)"]:::high
    Britz["Johan Britz L
(Akt. Klimatminister)"]:::medium
    Lindh["Eva Lindh S"]:::medium
    Luhr["Katarina Luhr MP"]:::low
    SKR["SKR
(Municipal federation)"]:::high
    NV["Naturvårdsverket"]:::medium
    KustKom["Coastal municipalities"]:::medium
    Media["Swedish media"]:::medium

    Lindh -->|interpellation HD10487| Slottner
    Luhr -->|interpellation HD10488| Britz
    SKR -->|lobbying| Slottner
    NV -->|technical advice| Britz
    KustKom -->|political pressure| Britz
    Media -->|amplification| Lindh
    Media -->|amplification| Luhr
```
...
pie title Scenario Probabilities
    "A: Legislative plans (25%)" : 25
    "B: Process promises (55%)" : 55
    "C: Partial action (15%)" : 15
    "D: Escalation (5%)" : 5
```
...
```mermaid
graph TB
    classDef strength fill:#4CAF50,color:white
    classDef weakness fill:#F44336,color:white
    classDef opportunity fill:#2196F3,color:white
    classDef threat fill:#FF9800,color:white

    S1["✅ Cross-party 2022 consensus on review (HD10487)"]:::strength
    S2["✅ Completed inquiry with 11 legislative proposals (HD10488)"]:::strength
    S3["✅ Remiss completed — government has the material"]:::strength
    W1["⚠️ Interpellations non-binding"]:::weakness
    W2["⚠️ Opposition lacks leverage"]:::weakness
    O1["🔵 Answers become election material"]:::opportunity
    O2["🔵 EU climate law gives external legitimacy"]:::opportunity
    T1["🔶 Government preemptive bill announcement"]:::threat
    T2["🔶 Issue crowded out by security agenda"]:::threat
