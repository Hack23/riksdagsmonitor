...
```mermaid
flowchart TD
    subgraph "6 Analysis Lenses"
        GOV["🏛️ Government<br/>Impact: Medium"]
        OPP["⚖️ Opposition<br/>Impact: Low-Medium"]
        CIT["👥 Citizen<br/>Impact: Low-Medium"]
        ECON["💰 Economic<br/>Impact: Low"]
        INTL["🌍 International<br/>Impact: Low"]
        MEDIA["📰 Media<br/>Impact: Low"]
    end
    
    subgraph "Documents"
        MJU30["MJU30 Climate"]
        KU38["KU38 Parliament"]
    end
