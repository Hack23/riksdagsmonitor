...
```mermaid
flowchart LR
    subgraph "Significance Scores"
        MJU30["MJU30<br/>Climate Targets<br/>🟡 5/10"]
        KU38["KU38<br/>Parliamentary Process<br/>🟡 5/10"]
    end
    
    subgraph "Coverage Level"
        STD["📰 Standard Coverage"]
    end
