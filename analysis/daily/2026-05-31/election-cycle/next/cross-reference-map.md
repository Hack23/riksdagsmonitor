...
**Anchor**: `next` · **Horizon**: [horizon:cycle]. Maps the 4-year forward forecast onto its shorter-horizon predecessors to prevent narrative drift, per the long-horizon cross-horizon citation rule.
