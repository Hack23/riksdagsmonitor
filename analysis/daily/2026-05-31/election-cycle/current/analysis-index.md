# Analysis Index — Tidö Mandate Cycle — Current
...
**Status**: all 31 core artifacts + 10 Family E + sidecar present. Two-pass AI-FIRST executed (see `methodology-reflection.md`).
