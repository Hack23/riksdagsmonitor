...
```mermaid
graph TD
    subgraph "Evening Intelligence Dashboard — Week 15, 2026"
        direction TB
        subgraph "Classification"
            CLS["HIGHLY SENSITIVE<br/>Migration + NATO + Criminal Justice<br/>Pre-election legislative offensive"]
        end
        subgraph "Risk Overview"
            RSK["OVERALL: MEDIUM<br/>Top Risk: ECHR HD03235 16/25<br/>Climate opposition MJU30 12/25<br/>SD Tido probing 12/25"]
        end
        subgraph "Threat Assessment"
            THR["MODERATE<br/>8 threat vectors identified<br/>ECHR + Climate + SD probing<br/>Cumulative load elevated"]
        end
        subgraph "Significance"
            SIG["9/10 peak HD03235<br/>Avg: 6.4/10 across 27 docs<br/>41 percent scored HIGH or above<br/>1.8x session weekly average"]
        end
    end

    subgraph "Editorial Decision"
        DEC{{"Saturday Weekly Wrap-Up"}}
        DEC -->|"Articles exist"| EXIST["weekly-review articles<br/>already generated 8 langs"]
...
```mermaid
graph LR
    subgraph "Week 15 Legislative Pipeline — April 4-10, 2026"
        direction LR
        subgraph "April 1-4: Foundation"
            A1["HD03235<br/>Deportation Reform<br/>9/10"]
            A2["HD03214<br/>Cybersecurity Centre<br/>8/10"]
            A3["HD03228<br/>Arms Export<br/>7/10"]
            A4["HD01FoU12<br/>Shelter Law<br/>8/10"]
        end
        subgraph "April 9: Triple Offensive"
            B1["HD03220<br/>NATO Finland<br/>8/10"]
            B2["HD03218<br/>Double Penalties<br/>8/10"]
            B3["HD03217<br/>Accountability<br/>7/10"]
        end
        subgraph "April 10: Migration Pipeline"
            C1["HD01SfU31<br/>Detention Reform<br/>8/10"]
            C2["HD01SfU32<br/>Deportation Enforce<br/>8/10"]
            C3["HD01SfU36<br/>Character Reqs<br/>8/10"]
        end
        A1 --> B2
        A2 --> B1
        B1 --> C1
