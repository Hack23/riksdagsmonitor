...
```mermaid
graph TD
    subgraph "8-Group Stakeholder Impact Analysis — Week 15, 2026"
        direction TB
        subgraph CIT["Citizens"]
            C1["Direct impact: migration enforcement<br/>affects foreign residents<br/>Healthcare denial affects all<br/>Gang crime measures popular"]
        end
        subgraph GOV["Government Coalition"]
            G1["M-KD-L + SD support<br/>Triple offensive executed<br/>9 propositions in 7 days<br/>96 percent motion denial"]
        end
        subgraph OPP["Opposition Bloc"]
            O1["S: strategic restraint<br/>MP: 18+ motions activism<br/>V: ECHR rights framework<br/>C: rural + aid coalition"]
        end
        subgraph BUS["Business/Industry"]
            B1["Arms export HD03228<br/>Species protection HD03230<br/>Renewable energy NU18<br/>Cyber centre HD03214"]
        end
        subgraph CIV["Civil Society"]
            CS1["ECHR concern HD03235<br/>Climate activism MJU30<br/>Healthcare advocacy<br/>Migration rights groups"]
        end
        subgraph INT["International/EU"]
            I1["NATO FM May 21-22<br/>ECHR Art.8 scrutiny<br/>EU NIS2/Fit-for-55<br/>UNHCR monitoring"]
        end
        subgraph JUD["Judiciary/Constitutional"]
            J1["ECHR proportionality test<br/>Deportation enforcement<br/>Official accountability<br/>Arms export oversight"]
        end
...
quadrantChart
    ...
    "Government Coalition": [0.95, 0.95]
    "Opposition Bloc": [0.88, 0.75]
    "International-EU": [0.65, 0.80]
    "Judiciary": [0.60, 0.70]
    "Business-Industry": [0.55, 0.60]
    "Citizens": [0.80, 0.40]
    "Civil Society": [0.75, 0.35]
    "Media": [0.85, 0.50]
```
