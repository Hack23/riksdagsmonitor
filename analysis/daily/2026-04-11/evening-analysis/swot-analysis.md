...
graph TD
    subgraph S["STRENGTHS"]
        ...
        S3["S3: 96 percent motion denial rate"]
        S4["S4: FoU12 shelter law<br/>first since Cold War"]
        S5["S5: Migration enforcement triple<br/>SfU31 / SfU32 / SfU36"]
        S6["S6: SD 99 percent voting cohesion"]
    end

    subgraph W["WEAKNESSES"]
        W1["W1: SD probing Tido<br/>HD10430 / HD10429"]
        W2["W2: UU6 security reservations<br/>NATO / nuclear / DCA"]
        W3["W3: Healthcare dual denial<br/>SoU16 + SoU17 = 348 motions"]
