---
title: "Opposition Motions Signal Coalition Fracture and Constitutional Crisis on Forestry and Youth Crime Bills"
description: "Eight opposition committee motions filed 2026-05-04 reveal a structurally significant dual challenge: five parties simultaneously oppose the government's flagship forestry deregulation (prop.…"
date: 2026-05-11
subfolder: motions
slug: 2026-05-11-motions
source_folder: analysis/daily/2026-05-11/motions
generated_at: 2026-05-11T07:51:52.646Z
language: en
layout: article
---
## Executive Brief
...
Eight committee motions from V, S, SD, C, and MP filed 2026-05-04 reveal two contested proposition clusters at a critical pre-election juncture. The analytically decisive signal is **Lagrådet's 12 March 2026 yttrande** confirming prop. 2025/26:246's criminal age-cut is unconstitutional — and the government's apparent intent to proceed regardless. Centerpartiet's dual defection (HD024145 + HD024146) is the most electorally significant event: C is explicitly seeking a policy differentiation space between the governing bloc and the traditional socialist opposition.

### Proposition Cluster 1: Forestry Deregulation (MJU)

Prop. 2025/26:242 "Ett tydligt regelverk för aktivt skogsbruk" would shorten the notification window before forest operations, raise the minimum threshold for required restoration plans, and loosen buffer zone requirements near wetlands. The deregulation is economically coherent in the short term (reduces administrative burden for ~350,000 Swedish forest owners) but the cumulative regulatory change since 2020 has attracted EU scrutiny.

**Opposition positions by party**:
- V: Full rejection. Biodiversity crisis documented. EU Habitats Directive Art. 6 risk identified. Demands stronger protection of high-value forests (26,000 ha/year being felled per Skogsstyrelsen 2026:07).
- SD: Principled support but practical qualification — demands exemption for small landowners (<50 ha) who cannot bear the same compliance cost as forest corporations.
- S: No rejection; demands comprehensive cumulative impact analysis of all regulatory changes since 2020 before implementation. Responsible governance framing.
- C: Supports direction; calls the proposition "insufficient." Key SOU 2025:93 production incentives deferred. C wants more deregulation, not less — this is a government-facing demand, not an opposition stance.
- MP: Full rejection. Same biodiversity concerns as V but framed through the 2030 biodiversity targets.

**Key cross-motion tension**: SD votes for the government while V/MP vote against — creating a centre-right + SD majority that could pass the forestry bill even without C (if C abstains on the insufficient-framing and votes "yes" to avoid defeating what they want more of).

### Proposition Cluster 2: Youth Criminal Justice (JuU)

Prop. 2025/26:246 "Skärpta regler för unga lagöverträdare" proposes three main changes: (a) lowering the age of criminal responsibility to 13 for serious offences, (b) new youth supervision orders with mandatory conditions, and (c) reduced "ungdomsrabatt" (youth discount on sentencing) for 15–17 year olds.

**Lagrådet finding (12 March 2026)**: The age-cut provision (lowering from 15 to 13) "inte kan anses förenligt med 2 kap. 8, 20 och 21 §§ regeringsformen" — i.e., violates constitutional proportionality requirements. This is the most significant finding from the motion cluster.

**Opposition positions**:
- V: Partially supports (youth supervision tightening), opposes age cut and reduced youth discount; cites brain research and Lagrådet.
- C: Opposes age cut on constitutional grounds explicitly citing Lagrådet. Also objects to reduced youth discount. Notes government "repeatedly ignores both Lagrådet and the constitution" — high political charge.
- MP: Opposes age cut (to 13 years for serious offences) and specific provisions on reduced sentencing discount.

**Government arithmetic**: JuU vote can likely pass with M+KD+L+SD votes (if SD maintains support). C votes against but cannot block. However, the Lagrådet negative yttrande creates legal vulnerability — if the Supreme Court or Constitutional Court later invalidates the provision, the political cost falls on the government.

### Cross-Cutting Intelligence

1. **C's strategic positioning**: Helena Lindahl (C, MJU, skogsbruk) wants *more* deregulation; Ulrika Liljeberg (C, JuU, ungdomsbrott) wants *constitutional compliance* — these are not contradictions, they are C's consistent "evidence-based liberalism" brand ahead of 2026 elections.

2. **SD's moderation signal**: Martin Kinnunen (SD, MJU) proposes a small-owner exemption — a technocratic concession that reads as SD's "responsible governance" positioning. SD is not blocking the government's core agenda.

3. **S's absence from JuU**: Notably, Socialdemokraterna filed no motion on prop. 2025/26:246. S likely intends to vote against the age-cut on the floor but has made a tactical choice not to file a formal committee motion — perhaps to avoid committing to an exact alternative age threshold.

4. **Election multiplier**: All 8 motions carry the 1.5× DIW multiplier (election September 2026). The forestry and youth crime debates will feature prominently in the campaign period.

### PIR Status Updates

| PIR ID | Status | Evidence |
|--------|--------|---------|
| PIR-LAGRÅDET-246 | **ANSWERED** | Lagrådet yttrande 12 March 2026 — RF 2 kap. 8, 20–21 §§ incompatible |
| PIR-EU-HABITATS-SE | **OPEN** | No Naturvårdsverket Art. 6 assessment published |
| PIR-COALITION-C-JuU | **ANSWERED** | HD024146 is C's formal parliamentary position; note this is committee motion, not public press statement |
| PIR-S-CRC-JOIN | **OPEN** | S filed no JuU motion; HD024144 is MJU forestry only |
...
| dok_id | Party | Topic | D | I | W | DIW_raw | Multiplier | DIW_adj | Tier |
|--------|-------|-------|---|---|---|---------|-----------|---------|------|
| HD024142 | V | Youth crime — full rejection + Lagrådet | 3 | 4 | 4 | 48 | 1.5 | **72** | T1 |
| HD024146 | C | Youth crime — constitutional + Lagrådet | 3 | 4 | 4 | 48 | 1.5 | **72** | T1 |
| HD024141 | V | Forestry — full rejection + EU law risk | 4 | 3 | 3 | 36 | 1.5 | **54** | T1 |
| HD024145 | C | Forestry — insufficient (wants more) | 3 | 3 | 3 | 27 | 1.5 | **40** | T2 |
| HD024144 | S | Forestry — cumulative impact demand | 3 | 3 | 3 | 27 | 1.5 | **40** | T2 |
| HD024148 | MP | Youth crime — age cut rejection | 2 | 3 | 3 | 18 | 1.5 | **27** | T2 |
| HD024143 | SD | Forestry — small-owner exemption | 2 | 2 | 3 | 12 | 1.5 | **18** | T3 |
| HD024147 | MP | Forestry — full rejection | 2 | 2 | 2 | 8 | 1.5 | **12** | T3 |

**Dimension key** (1–5 scale):
- **D (Duration)**: How long the policy effect persists: 5 = decades, 1 = weeks
- **I (Impact)**: Depth of policy change: 5 = fundamental rights, 1 = administrative
- **W (Width)**: Breadth of population affected: 5 = all citizens, 1 = narrow sector

### Tier Rationale

**T1 (DIW_adj ≥50)**:
- HD024142 (V, JuU): Lagrådet negative yttrande is a formal legal event; youth crime framing touches fundamental rights (RF 2 kap. 8). Election resonance very high — youth crime is a campaign wedge issue. Duration = constitutional standard (D=3 for current political cycle; children today 13 = potentially tried age 13 for years).
- HD024146 (C, JuU): Same legal foundation; C's explicit "systemic" framing of government overriding constitution elevates governance-legitimacy dimension. High Width (C speaks to constitutional order for all citizens, not just youth crime).
- HD024141 (V, MJU): EU Habitats Directive Art. 6 risk creates a multi-year legal exposure beyond the parliamentary vote. Duration = medium-long (D=4, EU infringement proceedings run 2–3 years). Forestry sector: all rural Sweden + biodiversity targets.

**T2 (DIW_adj 25–49)**:
- HD024145 (C, MJU): Important because C "wants more" — this is a signal about the post-election negotiating floor for forestry policy.
- HD024144 (S, MJU): Responsible governance framing; cumulative impact analysis demand could trigger a delay. Medium electoral impact.
- HD024148 (MP, JuU): Supports the age-cut rejection coalition but adds less new evidence than V or C.

**T3 (DIW_adj <25)**:
- HD024143 (SD, MJU): Supportive motion with one technical concession request; does not threaten passage.
- HD024147 (MP, MJU): Full rejection with limited evidential base beyond general principles.

### Article Coverage Priority

1. Lead story: Constitutional crisis framing — Lagrådet ignored, C warns of systemic pattern (HD024146 + HD024142)
2. Second story: Forestry EU law risk and biodiversity collapse (HD024141 + HD024145 + HD024144)
3. Third story: SD's moderation signal on forestry (HD024143) as election positioning
...
#### Governing Bloc (M+KD+L with SD support)
**Interests**: Pass both propositions before summer recess; maintain electoral narrative on law and order; avoid forestry EU entanglement.
**Position**: Proceed unamended. Government legal memo provides sufficient rebuttal to Lagrådet's RF concerns. Forestry bill is good for owners and the economy.

**Vulnerability**: The "ignoring the constitution" narrative from C; EU Habitats risk.

#### Centerpartiet
**Interests**: Differentiate electorally; maintain "responsible liberal" brand; secure better forestry policy and RF-compliant youth crime policy.
**Position on skogsbruk (HD024145)**: The proposition is a step in the right direction but insufficient. SOU 2025:93 production incentives must be implemented. C will likely vote "yes" on passage but with caveats.
**Position on JuU (HD024146)**: Cannot support age-cut as written — unconstitutional per Lagrådet. C will vote against the age-cut provision. Whether C proposes a formal amendment or merely votes against remains unclear.
**Electoral signalling**: C needs to occupy the "constitutionally serious" space vacated by KD's rightward shift. Both motions serve this purpose.

#### Socialdemokraterna
**Interests**: Position as the responsible, evidence-based alternative; delay forestry bill if possible; avoid appearing soft on crime.
**Position on skogsbruk (HD024144)**: Demand cumulative impact analysis — this is procedurally legitimate and delays are electorally neutral for S.
**Position on JuU**: Silent in committee motions; likely floor vote against. Tactical silence preserves S's flexibility on what alternative they'd offer.
**Electoral calculation**: Urban voters care about biodiversity; suburban voters care about crime. S must thread both.

#### Sverigedemokraterna
**Interests**: Maintain supply-and-confidence; signal responsible governance modifier on forestry; avoid being seen as blindly supporting failed policy.
**Position on skogsbruk (HD024143)**: Supportive but demands small-owner exemption (<50 ha). This is a genuine constituency concern for SD's rural landowner voters.
**Position on JuU**: No motion filed; no known opposition. SD's core constituency strongly supports tough youth crime measures.
**Strategic note**: SD's moderation on forestry (technical qualification) while backing youth crime toughening reflects their electoral coalition.

#### Vänsterpartiet
**Interests**: Full rejection, environmental protection, constitutional defence, social justice on criminal law.
**HD024141 perspective**: Biodiversity crisis framing; V sees the forestry bill as a catastrophic step toward irreversible habitat loss. Skogsstyrelsen 2026:07 data (26,000 ha/year) is central to V's evidence base.
**HD024142 perspective**: Lagrådet, brain development research, risk of criminalising children with social vulnerabilities. V's motion cites scientific consensus on adolescent brain development to argue 13-year-olds should not face criminal proceedings.
**Leverage**: Very limited — V is in opposition, can delay media narrative but cannot block passage.

#### Miljöpartiet
**Interests**: Environmental protection; EU nature law compliance; restorative justice.
**HD024147**: Full rejection of forestry bill, emphasising 2030 biodiversity targets and EU Habitats compatibility.
**HD024148**: Opposes age cut and specific reduced youth discount provisions; MP frames through UN children's rights lens.
**Leverage**: Limited; MP is not a supply-and-confidence actor. MP's EU political connections (Greens/EFA group) could amplify EU law risk.

#### Lagrådet
**Interests**: Constitutional rule of law; Lagrådet's advisory authority.
**Position**: Yttrande 12 March 2026 stated RF 2 kap. 8, 20–21 §§ incompatibility with age-cut provision.
**Significance**: Lagrådet is the only actor in this cluster whose position is legally binding in the sense that it creates political-constitutional accountability. If the government overrides Lagrådet, it must justify this explicitly in the legislative record — the justification then becomes the basis for any future court challenge.

#### Skogsstyrelsen
**Interests**: Regulatory mandate execution; data integrity.
**Role**: Skogsstyrelsen 2026:07 (cited by V in HD024141) provides the empirical foundation for the biodiversity risk argument. The agency is executing the existing supervisory mandate which the government is now proposing to weaken.
**Tension**: Skogsstyrelsen as a government agency cannot publicly oppose a government proposition, but its data publication is a form of institutional constraint.

#### EU Commission / DG Environment
**Interests**: Habitats Directive Art. 6 compliance; Nature Restoration Law implementation.
**Status**: No formal action yet. The Art. 6 compatibility risk noted in HD024141 would require a formal notification or complaint to trigger Commission interest.
**Potential role**: Could emerge as a slow-moving but high-impact player if prop. 242 passes and NGOs file a formal EU complaint.
...
| Party | Seats | Bloc |
|-------|-------|------|
| M (Moderaterna) | 68 | Tidö governing |
| KD (Kristdemokraterna) | 19 | Tidö governing |
| L (Liberalerna) | 16 | Tidö governing |
| SD (Sverigedemokraterna) | 73 | Supply and confidence |
| **Total Tidö+SD** | **176** | **Majority: 175 needed** |
| S (Socialdemokraterna) | 107 | Opposition |
| V (Vänsterpartiet) | 24 | Opposition |
| C (Centerpartiet) | 24 | Nominally opposition, issue-based |
| MP (Miljöpartiet) | 18 | Opposition |
| **Total opposition** | **173** | |
| **Riksdag total** | **349** | |

### Prop. 2025/26:242 (Forestry) Vote Arithmetic

| Party | Seats | Likely vote | Reason |
|-------|-------|-------------|--------|
| M | 68 | YES | Government proposition |
| KD | 19 | YES | Government proposition |
| L | 16 | YES | Government proposition |
| SD | 73 | YES* | Supply/confidence + HD024143 is supportive |
| C | 24 | YES (probably) | HD024145 "insufficient" but direction supported; abstaining would look like opposing |
| S | 107 | NO/ABS | HD024144 demands delay; without impact analysis, S votes no or abstains |
| V | 24 | NO | HD024141 explicit full rejection |
| MP | 18 | NO | HD024147 explicit full rejection |

**Expected outcome**: ~200 YES (M+KD+L+SD+C) vs ~149 NO (S+V+MP). **PASSES comfortably.**

*SD's HD024143 requests small-owner exemption but this is a "support with qualification" motion — SD will vote yes regardless unless government completely ignores the request.

### Prop. 2025/26:246 (Youth Crime) Vote Arithmetic
...
| KD | 19 | YES | Government proposition |
| L | 16 | YES | Government proposition |
| SD | 73 | YES | No opposing motion; supply/confidence intact |
| C | 24 | SPLIT | HD024146: against age-cut provision; may support other provisions |
| S | 107 | NO (likely) | No motion filed but party line opposes age-cut |
| V | 24 | NO | HD024142 explicit opposition to age-cut |
| MP | 18 | NO | HD024148 explicit opposition |

**If C splits: age-cut vote** ~176 (M+KD+L+SD) YES vs ~173 (S+V+MP+C split) NO. **Passes by 3 seats — razor thin.**  
**If C votes fully against**: ~152 YES vs ~197 NO. **FAILS.** (C would need to fully commit against all provisions for this).

**Most likely**: C votes against the specific age-cut provision (if it comes to a separate vote) but the bill likely passes as a whole if voted together. Swedish procedure often requires specific reservation (reservation) rather than an amendment forcing a separate vote on each provision.

### Post-2026 Election Coalition Scenarios

**If September 2026 election produces a new left-green majority** (S+V+MP+C):
- Forestry deregulation would likely be revisited/reversed by new government
- Youth crime age-cut provision repealed
- C in a left-green government would demand: significant climate/environment concessions, constitutional governance reform, better Lagrådet compliance rules

**If Tidö bloc retains government** (M+KD+L+SD+potential SD upgrade):
- Both propositions remain in force
- EU Habitats risk managed case-by-case
- Constitutional risk of youth crime bill remains unresolved

**Swing factor**: C's 24 seats are the decisive swing actor. HD024145+HD024146 demonstrate C is genuinely considering either coalition option depending on policy offers.

### HD024146 as Coalition Signal

C's "government pattern of ignoring Lagrådet" framing is not just policy commentary — it's a pre-negotiation list of conditions for any future C coalition partnership:
1. Future government must commit to respecting Lagrådet opinions
2. Future government must conduct proper RF compatibility reviews
3. Future government must not override constitutional advice without exceptional justification

This sets a higher bar for C's right-wing coalition participation than the Tidö coalition currently meets, while setting a lower bar than V/MP would require for governance. C is positioning for the centre.
...
### Prop. 2025/26:242 (Forestry Deregulation) — Implementation Assessment

#### Administrative feasibility
**Skogsstyrelsen capacity**: Reducing notification windows and assessment requirements REDUCES Skogsstyrelsen's administrative burden in the short term — implementation is administratively feasible and would likely reduce backlogs. Statskontoret's general capacity assessments (2024–2025) noted Skogsstyrelsen resource constraints; this reform would relieve some of that pressure.

**Compliance monitoring**: Reduced notification windows mean Skogsstyrelsen has less time to flag potential issues before operations begin. This creates a quality-of-oversight reduction that may not show up in efficiency metrics but represents a real governance cost.

**IT systems**: Sweden's Skogsbruksregistret (forestry registry) can accommodate the regulatory changes without major system overhaul. Implementation complexity: LOW.

**Timeline to full implementation**: 3–6 months post-enactment (SFS publication + administrative ordinance update). Feasible within the remaining parliamentary term.

#### Legal feasibility
**EU Habitats compatibility**: Feasible if restricted to non-Natura 2000 areas. However, the proposition does not contain an explicit Natura 2000 carve-out — legal uncertainty remains. The V/EU Habitats risk (PIR EU-HABITATS-SE) creates a post-enactment legal risk, not an implementation blocker.

**S's cumulative impact analysis demand**: If adopted, would delay implementation by 12–18 months. The forestry industry lobby will resist this delay.

**Conclusion**: Forestry bill is IMPLEMENTABLE but carries a medium-term EU law risk if Natura 2000 boundaries are not explicitly addressed.

---

### Prop. 2025/26:246 (Youth Criminal Justice) — Implementation Assessment

#### Administrative feasibility
**Kriminalvården capacity**: New supervision orders for 13–15 year olds will require new Kriminalvården (Prison and Probation Service) resources — specialised youth supervision officers, dedicated youth facilities, transition protocols from socialtjänst to criminal justice system. **This is the most significant implementation constraint.**

Kriminalvården's 2025 annual report indicates near-capacity adult detention; youth capacity expansion would require new resource allocation (estimated SEK 200–500 mn/year at scale). The proposition's financial note has not been publicly verified from this analysis — a significant gap.

**Socialtjänst transition**: Lowering the criminal responsibility age means children who previously received socialtjänst (social services) care would now enter the criminal justice system. The handover protocols between socialtjänst and criminal justice are not established for 13-year-olds. Implementation risk: MEDIUM-HIGH.

**Courts**: Tingsrätt (district courts) will need adapted juvenile court procedures. Sweden currently has no court procedures specifically designed for 13-year-old defendants. Implementation requires primary legislation AND secondary procedural rules — complex timeline.

#### Constitutional feasibility
**Critical blocker**: The Lagrådet yttrande (12 March 2026) identified RF 2 kap. 8, 20–21 §§ incompatibility with the age-cut provision. This creates a legal risk that could result in:
1. Constitutional challenge in HD or HFD within 12 months of enactment
2. A court refusing to apply the age-cut provision in a specific case on RF grounds
3. The Supreme Court certifying a constitutional question to the ad hoc review body (there is no formal Constitutional Court in Sweden; RF review is in principle possible via regular courts)

The implementation could proceed nominally but be legally fragile from day one.

#### V's partial support signal (HD024142)
V supports the tightened youth supervision orders. This suggests that stripping out the age-cut provision and passing just the supervision tightening + modified youth discount (as Scenario A) would be IMPLEMENTABLE with broader political support. This is the implementation-optimal path if the government prioritises policy durability.

**Conclusion**: Youth crime bill is IMPLEMENTABLE at scale but carries:
- HIGH constitutional risk (Lagrådet, RF 2 kap.)
- MEDIUM capacity risk (Kriminalvården, socialtjänst integration)
- MEDIUM international law risk (CRC Art. 40(3)(a))

The implementation-feasibility argument strengthens the case for an RF amendment before passage.
...
### Devil's Advocate: The Government Is Right on Youth Crime

#### Standard narrative being challenged:
"The government is wrong to proceed with age-cut to 13 given Lagrådet's negative yttrande."

#### Counter-argument:

1. **Lagrådet is advisory, not binding.** The Swedish constitution (RF 8 kap. 22 §) explicitly permits the government and parliament to proceed with legislation after a negative Lagrådet opinion if they present a clear justification. The Swedish Riksdag has overridden negative Lagrådet yttranden approximately 15–20 times in the past decade. This is a feature, not a bug, of Sweden's constitutional design — parliamentary supremacy is preserved.

2. **RF 2 kap. proportionality is genuinely contested.** Lagrådet's conclusion that the age-cut is disproportionate under RF 2 kap. 8 rests on a proportionality analysis that reasonable constitutional scholars disagree on. The government's legal memo (not yet public) may present a viable counter-analysis demonstrating that protecting potential victims of 13-year-old serious offenders is a proportionate goal. Several western European states with ECHR membership (UK, Netherlands, France) have lower MACRs without formal convention violations.

3. **Child brain development research is contested in the jurisprudence.** V cites "hjärnforskning" (brain research) but the direct legal relevance of neuroscience to criminal responsibility thresholds is disputed. Swedish courts have consistently applied the 15-year threshold as a social-political choice, not a scientific necessity. The CRC Art. 40(3)(a) requires a minimum age "not too low" — the UNCRC's "optimal standard" of 14–16 is a recommendation, not a treaty obligation with direct enforceability.

4. **Crime realities change.** Youth gang crime in Swedish suburbs has shifted to younger perpetrators. The government's proposition responds to documented police reports of 12–14 year olds leading serious criminal activities with impunity from the justice system. Prop. 246's narrow scope (serious offences only, not minor crime) may be constitutionally defensible as a proportionate targeted measure.

#### Implication for analysis:
The constitutional framing (led by C and V) is powerful politically but not legally inevitable. The government's legal team may have a defensible RF compatibility argument. Analysts should not assume the bill is legally doomed — it may be constitutionally borderline rather than clearly invalid.

---

### Devil's Advocate: Forestry Deregulation Serves a Legitimate Environmental Goal

#### Standard narrative being challenged:
"The forestry bill is environmentally destructive and risks EU law compliance."

#### Counter-argument:

1. **Clearer rules can improve actual compliance.** The current Swedish forestry notification system has been criticised by the government's own forest industry stakeholders as creating legal uncertainty that incentivises early clear-cutting before regulatory definitions change. A clearer, more predictable rule framework (even a lighter one) may reduce opportunistic pre-notification felling.

2. **EU Habitats Art. 6 does not apply uniformly to private forestry.** Art. 6 of the Habitats Directive applies to activities within Natura 2000 sites. The majority of the proposed deregulation covers private forestry outside designated Natura 2000 areas. The V/MP framing conflates two different legal frameworks (national biodiversity protection and EU Habitats law). A robust distinction in the MJU committee report would substantially address the legal risk.

3. **Skogsstyrelsen 2026:07 data may be misinterpreted.** The 26,000 ha/year "high-value forest felling" figure (cited in HD024141) comes from Skogsstyrelsen's own monitoring mandate. However, "high-value" in this context is Skogsstyrelsen's internal classification, not a legal Habitats Directive or Nature Restoration Law category. The overlap between Skogsstyrelsen high-value and legally protected Habitats sites may be considerably smaller than V's motion implies.

4. **SOU 2025:93 production incentives are an S/C demand that the government has partially accepted.** The proposition already implements several SOU 2025:93 recommendations. C's "insufficient" framing (HD024145) is a maximalist opening position in a negotiation, not a fundamental objection. C will likely vote yes on the proposition.

#### Implication for analysis:
The forestry bill's legal risk is real but more specifically contained to Natura 2000 boundary areas than the V/MP motions imply. Analysts should not assume EU infringement proceedings are likely — they require a formal complaint to an EU institution, which requires organised NGO coordination and documented Natura 2000 impact, neither of which has yet materialised.
...
| dok_id | Category | Priority | Confidence | Source | NTK |
|--------|----------|----------|------------|--------|-----|
| HD024141 | LAW/ENV/POLICY | HIGH | HIGH [B1] | Public parliamentary record | All |
| HD024142 | LAW/CRC/CONSTITUT | CRITICAL | HIGH [B1] | Public parliamentary record | All |
| HD024143 | LAW/ENV/POLICY | MEDIUM | HIGH [B1] | Public parliamentary record | All |
| HD024144 | LAW/ENV/POLICY | MEDIUM | HIGH [B1] | Public parliamentary record | All |
| HD024145 | LAW/ENV/POLICY | HIGH | HIGH [B1] | Public parliamentary record | All |
| HD024146 | LAW/CONSTITUT/RF | CRITICAL | HIGH [B1] | Public parliamentary record | All |
| HD024147 | LAW/ENV/POLICY | LOW-MED | HIGH [B1] | Public parliamentary record | All |
| HD024148 | LAW/CRC/CRIMINAL | MEDIUM | HIGH [B1] | Public parliamentary record | All |

**Source reliability**: B1 — independent public parliamentary record; official documents filed with riksdagen.se.

### Topic Classification

#### Primary topic clusters
1. **ENV-FOREST** (MJU, prop. 2025/26:242): HD024141, HD024143, HD024144, HD024145, HD024147
   - Subtopics: biodiversity, EU Habitats Directive, Skogsstyrelsen, deregulation, skogsägare, SOU 2025:93
2. **YOUTH-CRIMINAL** (JuU, prop. 2025/26:246): HD024142, HD024146, HD024148
   - Subtopics: RF 2 kap., Lagrådet, CRC Art. 40, ungdomsrabatt, brain development

#### Cross-cluster classification
- **CONSTITUT-LAGRADET**: HD024146 (primary), HD024142 (secondary) — Lagrådet negative yttrande pattern
- **COALITION-SIGNAL**: HD024145 + HD024146 (dual C defection, electoral positioning)
- **EU-LAW-RISK**: HD024141 (primary) — Habitats Directive Art. 6 compatibility
- **ELECTION-2026**: All 8 documents (proximity multiplier active)

### Information Gaps

| Gap | Category | Impact | PIR |
|-----|----------|--------|-----|
| No Naturvårdsverket Art. 6 opinion on forestry prop. | ENV | HIGH | EU-HABITATS-SE |
| No S motion on JuU prop. 246 | POLITICAL | MEDIUM | S-CRC-JOIN |
| No JuU prior voteringar found in last 4 riksmöten | DATA | LOW | none |
| No direct IMF live fetch available (degraded) | ECON | LOW | none |
