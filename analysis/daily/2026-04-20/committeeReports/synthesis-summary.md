...
<p align="center">
  <strong>Consolidated Political Intelligence from 6 Committee Reports</strong><br>
...
```mermaid
graph TD
    subgraph "📊 Committee Reports Intelligence Dashboard — 2026-04-20"
        direction TB
        subgraph "🔒 Constitutional Significance"
            CONST["⚖️ TWO VILANDE AMENDMENTS<br/>KU33: Police seizure secrecy<br/>KU32: Media accessibility<br/>Election 2026 determines fate<br/>Confidence: 🟦VERY HIGH"]
        end
        subgraph "🏠 Housing Market Reform"
            HOUSE["🏢 HOUSING TRIPTYCH<br/>CU27: Identity/anti-fraud (29 reservations)<br/>CU28: National condo register (1.7M units)<br/>~5M residents affected<br/>Confidence: 🟩HIGH"]
        end
        subgraph "👥 Social Welfare"
            SOC["🤝 GUARDIANSHIP REFORM<br/>CU22: God man/förvaltare overhaul<br/>Zero reservations — cross-party consensus<br/>~100K vulnerable adults protected<br/>Confidence: 🟩HIGH"]
        end
        subgraph "📋 Audit Response"
            AUD["📊 ESTATE AUDIT RESPONSE<br/>CU42: Riksrevisionen dödsbon report<br/>SOU investigation — no immediate legislation<br/>18+ months to potential reform<br/>Confidence: 🟩HIGH"]
        end
    end
    style CONST fill:#D32F2F,color:#fff
    style HOUSE fill:#FF9800,color:#fff
...
```mermaid
graph LR
    subgraph "🏠 Housing Reform Pipeline"
        CU27["HD01CU27<br/>Identity Requirements<br/>Anti-circumvention<br/>29 reservations"]
        CU28["HD01CU28<br/>National Registry<br/>1.7M condos<br/>3-4 year IT build"]
        EFFECT["Combined Effect:<br/>Layered fraud prevention<br/>AML compliance<br/>Market transparency"]
    end
    CU27 --> EFFECT
    CU28 --> EFFECT
    ...
    style EFFECT fill:#4CAF50,color:#FFFFFF
```
...
```mermaid
graph LR
    subgraph "📊 Aggregate SWOT — Committee Reports 2026-04-20"
        S["💪 STRENGTHS<br/>• Constitutional process integrity<br/>• Housing anti-fraud package (CU27+CU28)<br/>• Cross-party CU22 consensus<br/>• EU accessibility compliance (KU32)<br/>• Rule-of-law agenda coherence"]
        W["⚠️ WEAKNESSES<br/>• KU33 restricts offentlighetsprincipen<br/>• CU27 tenant protections insufficient<br/>• Two amendments election-contingent<br/>• Implementation complexity (IT)"]
        O["🎯 OPPORTUNITIES<br/>• 2026 election mandate on housing<br/>• Nordic housing transparency leader<br/>• EU AML/EAA full compliance<br/>• Constitutional clarity via election"]
        T["🚨 THREATS<br/>• Election reversal of KU33<br/>• IT implementation delays (CU28)<br/>• Housing crime adaptation<br/>• Press freedom index decline"]
    end
...
```mermaid
flowchart TD
    ELEC["🗳️ Sept 2026 Election<br/>Central node"]
    KU33["HD01KU33<br/>Vilande"]
    KU32["HD01KU32<br/>Vilande"]
    PASS["✅ Second reading PASSES<br/>(if Tidö wins)"]
    BLOCK["❌ Second reading BLOCKED<br/>(if S-bloc wins)"]
    RSF["📉 RSF index risk<br/>(if KU33 passes)"]
    EU["⚠️ EU infringement risk<br/>(if KU32 blocked)"]

    KU33 --> ELEC
    KU32 --> ELEC
    ELEC -->|Tidö wins| PASS
    ELEC -->|S-bloc wins| BLOCK
    PASS --> RSF
    BLOCK --> EU
    ...
    style BLOCK fill:#9E9E9E,color:#FFFFFF
    style RSF fill:#FFC107,color:#000000
