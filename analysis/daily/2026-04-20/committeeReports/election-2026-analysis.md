...
<p align="center">
  <strong>Electoral Implications of Vilande Constitutional Amendments</strong><br>
...
```mermaid
graph TD
    subgraph "🗳️ Election 2026 — Committee Reports Impact"
        ELEC["🗳️ General Election<br/>September 14, 2026"]
        
        TIDO["Scenario A: Tidö Coalition Wins<br/>M+KD+L+SD ≥ 175 seats<br/>Probability: ~45-50%"]
        LEFT["Scenario B: S-bloc Wins<br/>S+V+MP+C/other ≥ 175 seats<br/>Probability: ~50-55%"]
        
        KU33A["✅ KU33 2nd reading PASSES<br/>Police seizure secrecy becomes TF law<br/>Offentlighetsprincipen restricted"]
        KU33B["❌ KU33 2nd reading BLOCKED<br/>Offentlighetsprincipen preserved<br/>Opposition pledge fulfilled"]
        KU32A["✅ KU32 2nd reading PASSES<br/>Media accessibility enabled<br/>EU EAA compliance achieved"]
        KU32B["⚠️ KU32 status uncertain<br/>EU compliance pressure<br/>Likely passes regardless"]
    ...
    style ELEC fill:#2196F3,color:#fff
    style TIDO fill:#1565C0,color:#fff
    style LEFT fill:#D32F2F,color:#fff
    style KU33A fill:#FF9800,color:#fff
    style KU33B fill:#4CAF50,color:#fff
    style KU32A fill:#FF9800,color:#fff
    style KU32B fill:#FFC107,color:#333
```
...
```mermaid
flowchart TD
    A["🗳️ Election Result:<br/>Tidö ≥ 175 seats"]
    A --> B["New government formed<br/>by late Oct 2026"]
    B --> C["KU33 second reading<br/>scheduled Nov-Dec 2026"]
    B --> D["KU32 second reading<br/>scheduled Nov-Dec 2026"]
    C --> E["✅ KU33 PASSES<br/>Police seizure secrecy<br/>becomes TF law"]
    D --> F["✅ KU32 PASSES<br/>Media accessibility<br/>becomes TF/YGL law"]
    E --> G["⚠️ RSF press freedom<br/>index watch"]
    F --> H["✅ EU EAA compliance<br/>achieved"]
...
```mermaid
flowchart TD
    A["🗳️ Election Result:<br/>S-bloc ≥ 175 seats"]
    A --> B["New S-led government<br/>formed late Oct 2026"]
    B --> C["KU33 second reading<br/>NOT SCHEDULED"]
    B --> D["KU32 second reading<br/>likely proceeds (EU pressure)"]
    C --> E["❌ KU33 DIES<br/>Offentlighetsprincipen<br/>preserved"]
    D --> F["✅ KU32 PASSES<br/>(bipartisan support)"]
    B --> G["CU27 amendment bill<br/>for stronger tenant protections"]
    G --> H["New legislation<br/>2027"]
...
```mermaid
quadrantChart
    title Voter Salience × Electoral Impact — Committee Reports 2026-04-20
    x-axis Low Voter Salience --> High Voter Salience
    y-axis Low Electoral Impact --> High Electoral Impact
    
    quadrant-1 Campaign Battleground
    quadrant-2 Elite Politics
    quadrant-3 Background Noise
    quadrant-4 Popular but Settled
    
    "KU33 Press Freedom": [0.55, 0.95]
    "CU27 Housing": [0.85, 0.80]
    "CU28 Registry": [0.60, 0.45]
    "KU32 Accessibility": [0.35, 0.55]
    "CU22 Guardianship": [0.25, 0.20]
    "CU42 Estates": [0.15, 0.10]
```
...
```mermaid
timeline
    title Electoral Timeline — Committee Reports 2026
    section Pre-Campaign (Apr-Jun)
        April 17 : Committee reports adopted (vilande first readings)
        May-June : S announces KU33 reversal pledge
        June : Campaign manifestos released
    section Campaign (Jul-Sep)
        July 1 : CU27 identity requirements effective
        Aug : Constitutional debate peaks
        Sept 1-13 : Final campaign sprint
        Sept 14 : ELECTION DAY
    section Post-Election (Oct-Dec)
        Late Sept : Results certified
        Oct : Coalition negotiations
        Late Oct : New government formed
        Nov-Dec : Second reading votes (KU33/KU32)
```
