...
<p align="center">
  <strong>Strengths, Weaknesses, Opportunities, Threats + TOWS Matrix</strong><br>
...
```mermaid
mindmap
  root((Committee Reports<br/>2026-04-20<br/>SWOT Analysis))
    Strengths
      Constitutional process integrity
        Both vilande amendments follow RF 8:14
        Lagrådet reviewed
      Housing reform package
        CU27 anti-fraud
        CU28 national registry
      Cross-party consensus CU22
        Zero reservations
      ...
      EU compliance KU32
        ...
        Disability rights
      Rule-of-law agenda
        5/6 docs address crime/oversight
    Weaknesses
      KU33 press freedom restriction
        Offentlighetsprincipen since 1766
        16 reservations
        SJF/TU/Utgivarna opposed
      CU27 tenant protection gaps
        29 reservations highest
        Hyresgästföreningen concerns
      Election-contingent amendments
        KU33 KU32 vilande
        Maximum uncertainty
      Implementation complexity
        CU28 3-4 year IT build
        CU22 central authority setup
    Opportunities
      2026 election mandate
        Housing policy platform
        Constitutional clarity
      Nordic housing transparency leader
        CU28 benchmark
        AML compliance
      Anti-money laundering framework
        EU directive aligned
        Organised crime deterrent
      Accessibility leadership KU32
        EAA compliance
        Disability inclusion
      Election campaign clarity
        Voters choose constitutional direction
    Threats
      Election reversal KU33
        S-led coalition blocks
        Offentlighetsprincipen restored
      IT implementation delays
        CU28 budget overruns
        Government IT track record
      Housing crime adaptation
        Organised crime finds new routes
        Samordningsnummer loopholes
      Guardian volunteer shortage
        CU22 stricter requirements
        50K godmän affected
      Press freedom index decline
        RSF downgrade risk
        ECHR Article 10 scrutiny
```
...
```mermaid
graph TB
    subgraph "🔄 TOWS Strategic Matrix — Committee Reports 2026-04-20"
        subgraph "SO Strategies (Strengths + Opportunities)"
            SO1["SO1: Coalition leverages housing<br/>reforms (S2,S7) as election<br/>platform (O1,O3)"]
            SO2["SO2: Use CU22 consensus (S3)<br/>to demonstrate governance<br/>capacity (O5)"]
        end
        
        subgraph "WO Strategies (Weaknesses + Opportunities)"
            WO1["WO1: Opposition campaigns to<br/>strengthen CU27 (W2) post-<br/>election (O7)"]
            WO2["WO2: Election clarity (O5)<br/>resolves constitutional<br/>uncertainty (W3)"]
        end
        
        subgraph "ST Strategies (Strengths + Threats)"
            ST1["ST1: Rule-of-law coherence (S5)<br/>mitigates crime adaptation (T4)"]
            ST2["ST2: 6-domain breadth (S6)<br/>reduces single-issue<br/>electoral risk (T1)"]
        end
        
        subgraph "WT Strategies (Weaknesses + Threats)"
            WT1["WT1: KU33 vilande (W3) +<br/>election reversal (T1) =<br/>maximum constitutional<br/>uncertainty"]
            WT2["WT2: IT delays (T3) compound<br/>implementation complexity (W4)"]
        end
    end

    style SO1 fill:#4CAF50,color:#FFFFFF
    style SO2 fill:#4CAF50,color:#FFFFFF
    style WO1 fill:#2196F3,color:#FFFFFF
    style WO2 fill:#2196F3,color:#FFFFFF
    style ST1 fill:#FF9800,color:#FFFFFF
    style ST2 fill:#FF9800,color:#FFFFFF
    style WT1 fill:#D32F2F,color:#FFFFFF
    style WT2 fill:#D32F2F,color:#FFFFFF
```
