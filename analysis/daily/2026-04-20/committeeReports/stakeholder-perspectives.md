...
<p align="center">
  <strong>8-Group Stakeholder Assessment with Power/Interest Mapping</strong><br>
...
```mermaid
graph TB
    subgraph "📊 Stakeholder Impact Radar — Committee Reports 2026-04-20"
        direction TB
        
        CIT["👥 CITIZENS<br/>Impact: MIXED<br/>Housing reform +, Press freedom −"]
        GOV["🏛️ GOVERNMENT COALITION<br/>Impact: POSITIVE<br/>All 6 proposals adopted"]
        OPP["⚖️ OPPOSITION BLOC<br/>Impact: PARTIAL<br/>CU22 consensus, others contested"]
        BIZ["💼 BUSINESS/INDUSTRY<br/>Impact: MIXED<br/>Banks +, Real estate ±"]
        CSV["📢 CIVIL SOCIETY<br/>Impact: MIXED<br/>Disability +, Press freedom −"]
        INT["🌍 INTERNATIONAL/EU<br/>Impact: MIXED<br/>EU compliance, ECHR scrutiny"]
        JUD["🏛️ JUDICIARY<br/>Impact: TECHNICAL<br/>Process respected"]
        MED["📰 MEDIA<br/>Impact: DIVIDED<br/>KU33 restricts, KU32 enables"]
    end
    ...
    style CSV fill:#FFC107,color:#000000
...
```mermaid
graph LR
    subgraph "🔴 Oppose KU33 (Press Freedom Restriction)"
        A1["Media organisations<br/>SJF, TU, Utgivarna"]
        A2["Opposition parties<br/>S, V, MP, C"]
        A3["Civil liberties NGOs<br/>Press freedom advocates"]
        A4["International observers<br/>RSF, Council of Europe"]
    end
    
    subgraph "🟢 Support KU33 (Police Effectiveness)"
        B1["Government coalition<br/>M, KD, L, SD"]
        B2["Police/prosecution<br/>Polismyndigheten, Åklagarmyndigheten"]
        B3["KU committee majority"]
    end
    
    subgraph "🟡 Housing Reform Split (CU27)"
        C1["Government: Anti-fraud<br/>measures sufficient"]
        C2["Opposition: Tenant<br/>protections insufficient<br/>(29 reservations)"]
        C3["Banks: Support CU28<br/>register strongly"]
        C4["Hyresgästföreningen:<br/>Wants stronger rules"]
    end
    
    subgraph "🟢 Consensus (CU22)"
        D1["All parties support<br/>guardianship reform"]
        D2["Zero reservations"]
    end
    ...
    style C4 fill:#FFC107,color:#000000
