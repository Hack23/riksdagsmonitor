...
```mermaid
graph TD
    subgraph "Threat Categories — W14 2026"
        subgraph "External Threats"
            ET1["State-Sponsored<br/>Cyber Operations"]
            ET2["Migration Pressure<br/>Driving Policy"]
        end
        subgraph "Internal Threats"
            IT1["Correctional System<br/>Capacity Collapse"]
            IT2["Civil Defense<br/>Implementation Gap"]
        end
        subgraph "Political Threats"
            PT1["ECHR Legal<br/>Challenge"]
