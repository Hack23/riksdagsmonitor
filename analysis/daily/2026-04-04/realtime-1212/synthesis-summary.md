...
```mermaid
graph TD
    subgraph "📊 Weekly Political Intelligence Dashboard"
        direction TB
        subgraph "🔒 Classification"
            CL["Sensitivity: PUBLIC"]
        end
        subgraph "📈 Activity Level"
            AL["3 Propositions<br/>2 Committee Reports<br/>0 Votes Today"]
        end
        subgraph "⚠️ Risk Level"
            RL["MEDIUM<br/>Defense Package +<br/>Criminal Justice Reform"]
        end
        subgraph "🔍 Key Theme"
...
```mermaid
graph LR
    subgraph "Security Modernization Cluster"
        HD03214["HD03214<br/>Cybersecurity"] --- HD03228["HD03228<br/>War Materiel"]
        HD03228 --- FöU12["HD01FöU12<br/>Civilian Protection"]
        HD03214 --- FöU12
    end
