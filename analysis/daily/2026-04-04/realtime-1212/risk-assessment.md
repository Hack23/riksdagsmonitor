...
```mermaid
graph TD
    subgraph "Risk Matrix — L×I Scoring"
        subgraph "HIGH Risk Zone"
            R1["R1: Prison Overcrowding<br/>L:4 × I:4 = 16"]
            R4["R4: Cybersecurity Resourcing<br/>L:3 × I:4 = 12"]
        end
        subgraph "MEDIUM Risk Zone"
            R2["R2: ECHR Challenge HD03235<br/>L:3 × I:4 = 12"]
            R3["R3: Arms Export Ethics<br/>L:3 × I:3 = 9"]
            R5["R5: Municipal Civil Defense<br/>L:3 × I:3 = 9"]
        end
        subgraph "LOW Risk Zone"
