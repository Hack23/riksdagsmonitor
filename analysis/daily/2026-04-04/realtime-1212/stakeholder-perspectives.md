...
```mermaid
graph TD
    subgraph "Stakeholder Impact — Security & Justice Package"
        subgraph "HIGH Impact"
            C["Citizens<br/>Safety vs. Rights"]
            GC["Government Coalition<br/>Policy Delivery"]
            BI["Business/Industry<br/>Defense Exports"]
        end
        subgraph "MEDIUM Impact"
            OB["Opposition Bloc<br/>Rights Critique"]
            CS["Civil Society<br/>Human Rights"]
            JC["Judiciary<br/>ECHR Compliance"]
        end
        subgraph "LOW-MEDIUM Impact"
            IE["International/EU<br/>NATO Integration"]
            MP["Media/Opinion<br/>Security Framing"]
        end
    end
    style C fill:#0A66C2,stroke:#333,color:#fff
    style GC fill:#28a745,stroke:#333,color:#fff
    style BI fill:#28a745,stroke:#333,color:#fff
    style OB fill:#ffc107,stroke:#333,color:#000
    style CS fill:#dc3545,stroke:#333,color:#fff
    style JC fill:#ffc107,stroke:#333,color:#000
    style IE fill:#0A66C2,stroke:#333,color:#fff
    style MP fill:#fd7e14,stroke:#333,color:#fff
```
