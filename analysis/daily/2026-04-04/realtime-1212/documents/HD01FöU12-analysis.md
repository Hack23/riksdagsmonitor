...
```mermaid
graph TD
    subgraph "HD01FöU12 — Civilian Protection Framework"
        A["FöU12<br/>Civilian Protection"] --> B["Shelters &<br/>Evacuation"]
        A --> C["Municipal<br/>Preparedness"]
        A --> D["Total Defense<br/>Integration"]
        D --> E["HD03214<br/>Cybersecurity"]
        D --> F["HD03228<br/>War Materiel"]
    ...
    style E fill:#0A66C2,stroke:#424242,color:#FFFFFF
