...
```mermaid
graph TD
    subgraph "HD03228 — War Materiel Regulation"
        A["Prop 2025/26:228<br/>Modernized Arms Rules"] --> B["Foreign Ministry<br/>Benjamin Dousa, M"]
        A --> C["NATO<br/>Interoperability"]
        A --> D["Arms Export<br/>Controls"]
        C --> E["Allied Defense<br/>Industrial Cooperation"]
        D --> F["Saab, BAE Bofors<br/>Competitiveness"]
