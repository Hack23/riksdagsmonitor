...
```mermaid
graph TD
    subgraph "HD03235 — Deportation Rules Impact"
        A["Prop 2025/26:235<br/>Stricter Deportation"] --> B["Justice Ministry<br/>Johan Forssell, M"]
        A --> C["Tidö Agreement<br/>Fulfillment"]
        A --> D["Constitutional<br/>Review Risk"]
        B --> E["Coalition Unity<br/>M+KD+L+SD"]
        C --> F["SD Demand<br/>Satisfied"]
