...
```mermaid
graph TD
    subgraph "HD03214 — National Cybersecurity Center"
        A["Prop 2025/26:214<br/>Cybersecurity Center"] --> B["Defense Ministry<br/>Carl-Oskar Bohlin, M"]
        A --> C["EU NIS2<br/>Compliance"]
        A --> D["Inter-Agency<br/>Coordination"]
        B --> E["FRA"]
        B --> F["SÄPO"]
        D --> E
        D --> F
        A --> G["Nordic-Baltic<br/>Cooperation"]
        C --> H["Threat Intelligence<br/>Sharing Authority"]
    end
