...
```mermaid
graph TD
    subgraph "HD01JuU15 — Correctional System Pressures"
        A["JuU15<br/>Correctional Issues"] --> B["Prison Capacity<br/>110-120% Occupancy"]
        A --> C["Staff<br/>Recruitment"]
        A --> D["Rehabilitation<br/>Programs"]
        B --> E["New Construction<br/>2028-2030"]
        B --> F["Overcrowding<br/>Crisis"]
