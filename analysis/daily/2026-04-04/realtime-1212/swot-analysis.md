...
```mermaid
graph TD
    subgraph "SWOT Quadrant — Government Coalition W14"
        subgraph "✅ STRENGTHS"
            S1["S1: Coordinated<br/>Security Package"]
            S3["S3: Tidö Agreement<br/>Delivery"]
        end
        subgraph "⚠️ WEAKNESSES"
            W1["W1: Prison Capacity<br/>Crisis 110-120%"]
            W2["W2: ECHR Legal<br/>Risk"]
        end
        subgraph "🌟 OPPORTUNITIES"
            O1["O1: NATO Nordic-Baltic<br/>Cooperation"]
            O2["O2: Cross-Party<br/>Defense Consensus"]
        end
        subgraph "🔴 THREATS"
            T1["T1: Cyber Threat<br/>Escalation"]
            T3["T3: Correctional<br/>Capacity Collapse"]
        end
    end
    ...
    style O1 fill:#0A66C2,stroke:#333,color:#fff
    style O2 fill:#0A66C2,stroke:#333,color:#fff
