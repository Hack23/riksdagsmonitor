---
title: "Quantitative SWOT — Scored 1–5"
date: 2026-05-10
...
# Quantitative SWOT — Scored 1–5 (LH-5 blocking)

## Methodology

Each SWOT entry scored 1–5 on **importance** (cycle-level impact) and **certainty** (evidence and likelihood of materialising). Aggregate = sum across all S, W, O, T categories. See [`swot-analysis.md`](swot-analysis.md) for the qualitative narrative.
...
- Anchor scenarios in [`scenario-analysis.md`](scenario-analysis.md) weight A and B around S+T anchor items.
...
- See [`swot-analysis.md`](swot-analysis.md) §Sources.
