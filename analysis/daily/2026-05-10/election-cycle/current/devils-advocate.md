---
title: "Devil's Advocate — Counterfactuals and Disconfirming Cases"
date: 2026-05-10
...
# Devil's Advocate — Counterfactuals and Disconfirming Cases

## ACH-Lite Disconfirmation Frame

This analysis runs Analysis of Competing Hypotheses (ACH) lite on the central narrative of [`synthesis-summary.md`](synthesis-summary.md): "Tidö is the security-pivot mandate". Four counterfactuals are tested.
...
**Disconfirming evidence**: Fiscal discipline is path-dependent on the 1990s reform consensus, not on Tidö-specific decisions. Three of four scenarios in [`scenario-analysis.md`](scenario-analysis.md) preserve the ramverk regardless of bloc.
...
**Verdict**: Strong counterfactual. Re-frames the cycle narrative: Tidö produced a security framework whose **implementation responsibility transfers to the 2026–2030 government**. Updates conditional probability in [`intelligence-assessment.md`](intelligence-assessment.md) KJ-1 — successor government's implementation capacity is more determinative than reversal-risk.
...
**Verdict**: Partial disconfirmation succeeds. Keep the security-pivot synthesis but reinforce in [`election-2026-analysis.md`](election-2026-analysis.md) that **the electoral outcome may rotate on what is missing from the mandate, not what is present**.
...
- **Recency bias risk**: 2026-05-10 same-day pipeline weighting may over-represent Y4. Annualised distribution check in [`significance-scoring.md`](significance-scoring.md) shows Y4 = 45% of top-20 DIW (high but defensible).
...
These refinements are propagated to [`synthesis-summary.md`](synthesis-summary.md), [`intelligence-assessment.md`](intelligence-assessment.md), and [`election-2026-analysis.md`](election-2026-analysis.md) via Pass-2 edits.
