...
Per [`ext/cycle-rollover.md`](../../../../.github/prompts/ext/cycle-rollover.md), Riksdagsmonitor is **inside the ±30-day rollover window** (election anchor is 2026-09-13). Mandate-end consolidation patterns active. Cycle-archival of 2022-cycle PIRs scheduled for 2026-10-15 (T+32 from election). See [`cycle-trajectory.md`](cycle-trajectory.md) for full PIR carry-forward map.
