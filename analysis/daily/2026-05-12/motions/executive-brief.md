# Executive Brief — 2026-05-12

**Classification**: 🟢 PUBLIC
**Admiralty**: B2 (confirmed parliamentary source, probably true)
...
| Band | Assessment |
|------|-----------|
| T+72h | Motion text will circulate in Swedish civil society, legal, and immigration media |
| T+7d | SfU deliberations begin; government may issue written response to motion arguments |
| T+30d | Betänkande expected; committee vote (motions expected to fail) |
| T+90d | Props enacted if betänkande passes; agencies begin implementation |
