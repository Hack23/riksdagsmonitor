...
generated_at: 2026-05-30T12:15:03.300Z
language: en
layout: article
---
## What Happened
...
```mermaid
graph TD
    A[Government — M+KD+L+SD] -->|proposes| B[Prop. 2025/26:261 Skatteverket]
    A -->|proposes| C[Prop. 2025/26:267 LSU Security]
    D[MP Opposition] -->|counter-motions| B
    D -->|counter-motions| C
    E[Skatteverket] -->|implements| B
    F[Migrationsverket] -->|implements| C
    G[Civil Rights CSOs] -->|supports| D
    G -->|opposes| C
    H[Lagrådet] -->|criticized| C
    I[Riksdag committees SkU/JuU] -->|will decide| B
    I -->|will decide| C
    J[Homeless persons / vulnerable] -->|affected by| B
    K[Security-threat aliens / children] -->|affected by| C
    L[ECtHR / UN bodies] -->|long-term oversight| C
    style A fill:#1a3a6b,color:#fff
    style D fill:#006400,color:#fff
    style G fill:#8b4513,color:#fff
    style H fill:#4a148c,color:#fff
    style L fill:#880000,color:#fff
```
...
```mermaid
graph LR
    A[2026-05-27: Motions Filed] --> B{Committee vote ~June 2026}
    B -->|ALMOST CERTAIN — 85%| C[Both motions defeated]
    B -->|POSSIBLE — 10%| D[Partial concession — evaluation commitment]
    B -->|REMOTE — 5%| E[Government withdraws child-detention provisions]
    C --> F{Post-enactment 2026–2027}
    F -->|LIKELY — 60%| G[JO complaints filed on child detention]
    F -->|POSSIBLE — 30%| H[Statskontoret review of Skatteverket folkbokföring]
    F -->|POSSIBLE — 25%| I[ECHR petition on adult detention time-limit removal]
    D --> J[MP claims partial victory; uses in election campaign]
    E --> K[MP significant win; rare government retreat on security bill]
    G --> L{JO Decision 2027}
    L -->|LIKELY — 55%| M[JO critique confirms MP position; election retroactive vindication]
    L -->|POSSIBLE — 35%| N[JO finds no systemic violation but recommends safeguards]
```
...
```mermaid
quadrantChart
    title MP SWOT — Motions 2026-05-22
    ...
    quadrant-4 Threats
    Rights expertise: [0.8, 0.85]
    CSO alliances: [0.75, 0.75]
    Legal coherence: [0.85, 0.80]
    Policy niche: [0.78, 0.70]
    Small parliamentary size: [0.25, 0.80]
    No legislative leverage: [0.20, 0.75]
    Election threshold risk: [0.22, 0.78]
    2026 election opening: [0.75, 0.25]
    ECHR scrutiny opportunity: [0.80, 0.30]
    Government overreach narrative: [0.82, 0.20]
    Government majority: [0.18, 0.20]
    S also backing security measures: [0.15, 0.25]
```
...
```mermaid
gantt
    title Legislative Timeline — Propositions and Motions
    dateFormat YYYY-MM-DD
    section Prop 2025/26:261 (Skatteverket)
    Proposition filed         :done, 2026-05-01, 2026-05-15
    Motion HD024191 filed     :done, 2026-05-22, 2026-05-22
    SkU committee handling    :active, 2026-05-22, 2026-06-15
    Chamber vote expected     :2026-06-15, 2026-06-20
    section Prop 2025/26:267 (LSU Security)
    Proposition filed         :done, 2026-05-01, 2026-05-15
    Motion HD024192 filed     :done, 2026-05-22, 2026-05-22
    JuU committee handling    :active, 2026-05-22, 2026-06-15
    Chamber vote expected     :2026-06-15, 2026-06-20
    section Post-enactment
    Law entry into force      :2026-09-01, 2026-09-30
    Statskontoret monitoring  :2026-10-01, 2027-06-30
    Potential JO complaints   :2026-09-01, 2027-06-30
