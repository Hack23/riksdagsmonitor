...
slug: 2026-05-27-election-cycle/current
source_folder: analysis/daily/2026-05-27/election-cycle/current
generated_at: 2026-06-22T07:39:52.234Z
language: en
layout: article
---
## What Happened
...
1. **Social values mobilisation** (Riksdag document #03271 (HD03271) abortion bill) — KD's act of mandate-end values politics
...
```mermaid
xychart-beta
    title "Tidö Mandate DIW-Weighted Legislative Output by Semester"
    x-axis ["2022-H2", "2023-H1", "2023-H2", "2024-H1", "2024-H2", "2025-H1", "2025-H2", "2026-H1"]
    y-axis "DIW-weighted output" 0 --> 50
    bar [22, 31, 28, 45, 42, 38, 25, 18]
    line [22, 31, 28, 45, 42, 38, 25, 18]
```
...
```mermaid
quadrantChart
    title Risk Register — Swedish Election Cycle T-108
    ...
    quadrant-3 Accept
    quadrant-4 Control
    R1-AbortionBacklash: [0.82, 0.78]
    R2-SDCongress: [0.78, 0.62]
    R3-EconomicShock: [0.80, 0.58]
    R4-HungParliament: [0.75, 0.60]
    R5-MigrationLegal: [0.80, 0.35]
    R6-EdholmLeadership: [0.62, 0.78]
    R7-Cybersecurity: [0.95, 0.38]
```
...
```mermaid
graph LR
    style SD fill:#00529B,color:#fff
    style M fill:#52BDEC,color:#000
    style KD fill:#009933,color:#fff
    style L fill:#006AB3,color:#fff
    style S fill:#E8112d,color:#fff
    style V fill:#DA291C,color:#fff
    style MP fill:#83B340,color:#000
    style C fill:#009933,color:#fff

    Migration["Migration<br>Bills×5"]:::domain --> SD
    Migration --> M
    Migration --> KD
    Defence["Defence<br>NATO"]:::domain --> M
    Defence --> S
    Crime["Crime<br>Gang policy"]:::domain --> SD
    Crime --> M
    Abortion["Abortion<br>Bill"]:::domain --> KD
    Pension["Pension<br>Surplus"]:::domain --> S
    Pension --> M

    classDef domain fill:#333,color:#fff,stroke:#666
```
