...
generated_at: 2026-06-07T10:51:30.725Z
language: en
layout: article
---
## What Happened
...
graph LR
    ...
    subgraph Authorities
        SOCS[Socialstyrelsen]
        NV[Naturvårdsverket]
        IVO[IVO]
    end
    KL -->|HD10509 HD10510| JB
    NK -->|HD10511| ES
    SB -->|HD10512| CWG
    ROKS -->|pressure| CWG
    UNI -->|pressure| CWG
    ...
    SOCS -->|data| CWG
    IVO -->|oversight| CWG
    style JB fill:#f9a,stroke:#c33
    style CWG fill:#f9a,stroke:#c33
    style ES fill:#fca,stroke:#c63
```
...
```mermaid
graph TD
    A[Interpellation answers due 2026-06-05] --> B{Government response quality}
    B --> C[Scenario 1: Substantive engagement]
    B --> D[Scenario 2: Partial concession]
    B --> E[Scenario 3: Procedural deflection]
    B --> F[Scenario 4: Escalation by interpellants]
    C --> C1[Announce climate adaptation prop timeline]
    C --> C2[Regulatory relief for women's shelters]
    C --> C3[Acknowledge emission data + municipal support]
    D --> D1[Announce reviews but no commitments]
    D --> D2[Partial regulatory adjustments]
    E --> E1[Constitutional deflection on RF 1:2]
    E --> E2[Municipality blame on emissions]
    E --> E3[Procedural framing on shelters]
    F --> F1[MiU hearing request by MP]
    F --> F2[SoU referral by S]
    F --> F3[Media campaign by NGOs]
    style C fill:#ccffcc
    style E fill:#ffcccc
    style F fill:#ffcccc
    style D fill:#ffffcc
...
```mermaid
quadrantChart
    title SWOT — Tidöregeringen vs. Interpellation Pressure
    ...
    quadrant-4 Threats
    Majority in Riksdag: [0.2, 0.8]
    Fiscal space: [0.3, 0.7]
    Procedural control: [0.15, 0.85]
    Climate adaptation delay: [0.35, 0.25]
    Dual-role minister: [0.2, 0.15]
    Shelter licensing failure: [0.3, 0.2]
    Pre-election climate reframing: [0.7, 0.75]
    Agency capacity reform: [0.65, 0.7]
    Distributional messaging: [0.75, 0.65]
    MP-S coordination signal: [0.8, 0.25]
    EU emission compliance risk: [0.85, 0.2]
    Media amplification: [0.9, 0.3]
```
...
gantt
    ...
    section Climate (T-1, T-2)
    Interpellation answers due    :milestone, 2026-06-05, 0d
    MiU hearing possible          :2026-06-08, 7d
    Autumn session motions        :2026-09-01, 30d
    ESR review (EU)               :2027-01-01, 180d
    section Constitutional (T-3)
    Finance minister answer       :milestone, 2026-06-05, 0d
    KU potential review           :2026-09-01, 90d
    section Social (T-4)
    Minister answer due           :milestone, 2026-06-05, 0d
    IVO inspection cycle          :2026-07-01, 90d
    NCK/NGO campaign              :2026-06-10, 30d
```
