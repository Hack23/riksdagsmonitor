...
graph LR
    subgraph "Government Coalition"
        GOV["M, KD, L<br/>🟢 Delivery Record"]
        SD["SD<br/>🟢 Migration Wins"]
    end
    subgraph "Opposition"
        S_PARTY["S<br/>🔴 Infrastructure Critique"]
        V_PARTY["V<br/>🔴 Rights Defence"]
        MP_PARTY["MP<br/>🟡 Climate Leverage"]
    end
    subgraph "External"
        EU["EU/ECHR<br/>🟡 Legal Scrutiny"]
        NATO_S["NATO<br/>🟢 Integration"]
        CIVIL["Civil Society<br/>🔴 Welfare Concerns"]
        MEDIA["Media<br/>🟡 Accountability"]
    end
    GOV -->|"66 propositions"| SD
    SD -->|"supply-and-confidence"| GOV
    S_PARTY -->|"44 interpellations"| GOV
    V_PARTY -->|"rights scrutiny"| GOV
    EU -->|"ECHR review"| GOV
