...
```mermaid
graph TD
    subgraph "Political Risk Matrix — March/April 2026"
        direction TB
        subgraph "🔴 HIGH RISK"
            HR1["ECHR challenge to<br/>deportation law HD03235<br/>Likelihood: 70%<br/>Impact: SEVERE"]
            HR2["Detention framework<br/>human rights violation<br/>HD01SfU31<br/>Likelihood: 50%<br/>Impact: HIGH"]
        end
        subgraph "🟠 MEDIUM-HIGH RISK"
            MHR1["SD post-election<br/>escalation demands<br/>Likelihood: 60%<br/>Impact: HIGH"]
            MHR2["Legislative quality<br/>gaps from speed<br/>66 props in 30 days<br/>Likelihood: 40%<br/>Impact: MEDIUM"]
        end
        subgraph "🟡 MEDIUM RISK"
            MR1["Opposition infrastructure<br/>narrative gaining traction<br/>Likelihood: 55%<br/>Impact: MEDIUM"]
            MR2["Welfare reform<br/>social unrest<br/>Likelihood: 35%<br/>Impact: MEDIUM"]
        end
        subgraph "🟢 LOW RISK"
            LR1["Coalition breakup<br/>before election<br/>Likelihood: 10%<br/>Impact: SEVERE"]
