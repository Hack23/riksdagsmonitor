...
keywords: "HD024184, Prop. 2025/26:258, Decision-Grade BLUF, KU Motion, Malin Björk, Sole KU, Monitor KU, European Court, Human Rights, Social Democrats, Muharrem Demirok, VERY HIGH, Riksdagsmonitor, Swedish Parliament, Riksdag, political intelligence, OSINT, Swedish politics, democratic transparency, Regeringen, Motions, English"
date: 2026-05-20
subfolder: motions
slug: 2026-05-20-motions
source_folder: analysis/daily/2026-05-20/motions
generated_at: 2026-05-24T18:59:06.804Z
language: en
layout: article
---
## Executive Brief
...
```mermaid
%%{init: {'theme': 'dark', 'themeVariables': {'primaryColor': '#00d9ff', 'primaryTextColor': '#e0e0e0', 'primaryBorderColor': '#ff006e', 'lineColor': '#ffbe0b', 'secondaryColor': '#1a1e3d', 'tertiaryColor': '#0a0e27', 'background': '#0a0e27', 'mainBkg': '#1a1e3d', 'nodeBorder': '#00d9ff'}}}%%
graph TD
...
graph LR
    subgraph OPPOSE_LAB["Oppose labor org law"]
        C[Centerpartiet C]
    ...
    subgraph SUPPORT_LAB["Support full Prop. 258"]
        M[Moderaterna M]
        KD[Kristdemokraterna KD]
        L[Liberalerna L]
        SD[Sverigedemokraterna SD]
    end
    style OPPOSE_LAB fill:#330011,stroke:#ff006e
    style SUPPORT_LAB fill:#0a3322,stroke:#00d9ff
    classDef c fill:#1a1e3d,stroke:#00d9ff
    classDef opp fill:#2a0022,stroke:#ff006e
```
...
graph LR
    ...
    subgraph POST2026["Post-election coalition options"]
        B1[Center-right without SD: M+L+KD+C]
        B2[Broad center: S+C+L+MP]
        B3[Status quo: M+KD+L with SD support]
    end
    C1 -->|Maintains option| B1
    C1 -->|Opens option| B2
    C1 -->|Distances from| B3
    style C1 fill:#1a1e3d,stroke:#00d9ff
    style B2 fill:#0a3322,stroke:#00d9ff
    classDef scenario fill:#1a1e3d,stroke:#00d9ff
```
...
```mermaid
%%{init: {'theme': 'dark', 'themeVariables': {'primaryColor': '#00d9ff', 'primaryTextColor': '#e0e0e0', 'lineColor': '#ffbe0b', 'background': '#0a0e27', 'mainBkg': '#1a1e3d'}}}%%
pie title Voter attitude to labor org contributions law
...
%%{init: {'theme': 'dark', 'themeVariables': {'primaryColor': '#00d9ff', 'primaryTextColor': '#e0e0e0', 'lineColor': '#ffbe0b', 'background': '#0a0e27', 'mainBkg': '#1a1e3d'}}}%%
quadrantChart
    title SWOT — C Position on Labor Org Law
...
%%{init: {'theme': 'dark', 'themeVariables': {'primaryColor': '#00d9ff', 'primaryTextColor': '#e0e0e0', 'lineColor': '#ffbe0b', 'background': '#0a0e27', 'mainBkg': '#1a1e3d'}}}%%
quadrantChart
    title Implementation Feasibility vs. Effectiveness
    x-axis "Low Feasibility" --> "High Feasibility"
    y-axis "Low Effectiveness" --> "High Effectiveness"
    quadrant-1 High priority implementation
    quadrant-2 Risky but effective
    quadrant-3 Abandon
...
graph LR
    ...
    style ROOT fill:#1a1e3d,stroke:#00d9ff
    style D1 fill:#0a3322,stroke:#00d9ff
    style D2 fill:#330011,stroke:#ff006e
    style D3 fill:#2a1a00,stroke:#ffbe0b
    classDef domain fill:#1a1e3d,stroke:#00d9ff
```
