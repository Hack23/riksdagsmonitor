...
**Methodology**: ICD 203 analytic standards; Admiralty grading; WEP confidence language
...
*Confidence*: HIGH (A2 — reliable source, direct documentary evidence)  
...
*Confidence*: MODERATE (B2 — reliable analysis, incomplete evidence)  
...
*Confidence*: MODERATE (B3 — reasonable inference from pattern data)  
