...
graph TD
    subgraph "✅ Strengths"
        S1["S1: 4-proposition delivery<br/>capacity"]
        S2["S2: Defence bipartisan<br/>consensus"]
        S3["S3: Healthcare voter<br/>salience"]
        S4["S4: SD deportation<br/>commitment kept"]
    end
    subgraph "⚠️ Weaknesses"
        W1["W1: ECHR risk on<br/>deportation"]
        W2["W2: Physician shortage<br/>blocks reform"]
        W3["W3: FRA surveillance<br/>alienates L"]
    end
    subgraph "🌍 Opportunities"
        O1["O1: Pre-election<br/>competence narrative"]
        O2["O2: NATO defence<br/>standing"]
    end
    subgraph "🔴 Threats"
        T1["T1: V/MP human<br/>rights campaign"]
        T2["T2: Arms trade<br/>criticism"]
