...
graph TD
    subgraph "⚖️ Political Risk Landscape — Likelihood × Impact"
        R1["🔴 ECHR challenge on<br/>deportation (L3×I5=15)"]
        R2["🟡 Arms trade<br/>opposition campaign (L3×I4=12)"]
        R3["🟡 Healthcare<br/>implementation gap (L4×I3=12)"]
        R4["🟡 Privacy challenge<br/>on FRA expansion (L3×I3=9)"]
...
```mermaid
graph LR
    A["Deportation<br/>rules enacted"] --> B["ECHR<br/>complaint filed"]
    B --> C["Interim<br/>measures issued"]
    C --> D["Government faces<br/>compliance choice"]
