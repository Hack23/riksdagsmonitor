...
```mermaid
graph LR
    subgraph "1 April 2026 — Government Propositions"
        A["HD03214<br/>Cybersecurity Center<br/>→ FöU"] --> E["Committee<br/>Review"]
        B["HD03216<br/>Municipal Healthcare<br/>→ SoU"] --> E
        C["HD03228<br/>War Materiel<br/>→ UU"] --> E
        D["HD03235<br/>Criminal Deportation<br/>→ SfU"] --> E
        E --> F["Plenary<br/>Vote"]
        F --> G["Implementation"]
    end
