...
graph TD
    ...
    subgraph Risks["Identified Risks"]
        R1["🟠 R1: Welfare<br/>majority defeat<br/>L=3 × I=4 = 12"]
        R2["🟡 R2: Education<br/>package delay<br/>L=3 × I=3 = 9"]
        R3["🟡 R3: EU habitat<br/>compliance<br/>L=2 × I=4 = 8"]
...
timeline
    ...
    section Near-term (0–3 months)
        April 2026 : UbU committee hearings begin
                   : SoU welfare reform processing
    section Medium-term (3–6 months)
        June–Aug 2026 : Committee votes on education package
                      : Potential welfare reform floor vote
    section Long-term (6–12 months)
        Sept 2026 : New riksmöte 2026/27 begins
                  : Pre-election positioning intensifies
        Sept 2026 : Election 2026 campaign period
```
...
```mermaid
graph LR
    T["🔴 Trigger:<br/>C formally opposes<br/>welfare cap in SoU"]
    O1["🟠 1st Order:<br/>S+V+C+MP majority<br/>defeats prop. 201"]
    O2["🟡 2nd Order:<br/>Government forced<br/>to negotiate or<br/>withdraw welfare cap"]
    O3["🟢 Circuit Breaker:<br/>SD signals continued<br/>confidence support<br/>despite policy defeat"]
    T --> O1
    O1 --> O2
    O2 -.->|mitigated by| O3
