...
graph TD
    subgraph S["💪 Strengths"]
        GS1["Gov: SD alignment<br/>on welfare"]
        OS1["Opp: S unified<br/>education counter"]
    end
    subgraph W["⚠️ Weaknesses"]
        GW1["Gov: 19-motion<br/>education opposition"]
        GW2["Gov: 4-party<br/>welfare resistance"]
    end
    subgraph O["🌟 Opportunities"]
        GO1["Gov: SD tacit<br/>welfare support"]
        OO1["Opp: Cross-party<br/>welfare alliance"]
    end
    subgraph T["🔴 Threats"]
        GT1["Gov: Welfare<br/>majority risk"]
        OT1["Opp: SD-Gov<br/>welfare pact"]
    end
    OS1 -->|exploits| GW1
    OO1 -->|amplifies| GT1
    GS1 -->|mitigates| GT1
