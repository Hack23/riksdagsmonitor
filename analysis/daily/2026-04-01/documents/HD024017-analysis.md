...
```mermaid
graph LR
    A["HD024017<br/>S Motion vs Bidragstak"] --> B{Sensitivity}
    B -->|"🟢 PUBLIC"| E["Standard Opposition<br/>Motion"]
    
    A --> G{Domain}
    G --> H["Social Welfare<br/>& Budget Policy"]
    
    A --> I{Urgency}
    I -->|"🔵 ELEVATED"| L["SoU committee<br/>processing"]
    
    style A fill:#e83e3e,color:#FFFFFF
