...
```mermaid
graph LR
    A["HD03235<br/>Deportation Rules"] --> B{Sensitivity}
    B -->|"🟡 SENSITIVE"| D["Policy Delivery Risk<br/>Human rights implications"]
    
    A --> G{Domain}
    G --> H["Migration (MIG) +<br/>Justice (JUS)"]
...
```mermaid
quadrantChart
    title Political Impact - Deportation Reform HD03235
    ...
    "Tidö delivery strengthens SD alliance": [0.2, 0.8]
    "S internal division on migration": [0.8, 0.4]
    "Human rights legal challenges": [0.3, 0.2]
    "V/MP unite anti-deportation bloc": [0.7, 0.7]
```
