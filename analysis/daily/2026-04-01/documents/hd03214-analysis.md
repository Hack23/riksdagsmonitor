...
graph LR
    ...
    B -->|"🟡 SENSITIVE"| D["National Security<br/>Critical infrastructure"]
    
    A --> G{Domain}
    G --> H["Defence (DEF) +<br/>Digital Security (DIG)"]
    
    A --> I{Urgency}
    I -->|"🟠 URGENT"| K["Active cyber threat<br/>landscape requires response"]
...
```mermaid
quadrantChart
    title Political Impact - Cybersecurity Center HD03214
    ...
    "Bipartisan cyber defense consensus": [0.5, 0.85]
    "NATO cyber cooperation deepens": [0.2, 0.8]
    "Privacy concerns from FRA expansion": [0.6, 0.3]
    "Implementation cost overruns": [0.3, 0.2]
```
