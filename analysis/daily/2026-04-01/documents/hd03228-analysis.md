...
```mermaid
graph LR
    A["HD03228<br/>Arms Regulation"] --> B{Sensitivity}
    B -->|"🟡 SENSITIVE"| D["Defence Industrial Policy<br/>NATO integration"]
    
    A --> G{Domain}
    G --> H["Defence (DEF) +<br/>Foreign Affairs (FOR)"]
    
    A --> I{Urgency}
    I -->|"🟠 URGENT"| K["NATO commitments<br/>require timely action"]
...
```mermaid
quadrantChart
    title Political Impact - Arms Regulation HD03228
    ...
    "NATO integration deepens": [0.2, 0.85]
    "Defence industry growth": [0.3, 0.7]
    "V/MP opposition to arms exports": [0.75, 0.65]
    "Public debate on arms ethics": [0.4, 0.25]
```
