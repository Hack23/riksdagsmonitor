...
```mermaid
graph LR
    A["HD03216<br/>Healthcare Competence"] --> B{Sensitivity}
    B -->|"🟢 PUBLIC"| E["Standard Healthcare<br/>Policy Reform"]
    
    A --> G{Domain}
    G --> H["Healthcare (HEA)"]
    
    A --> I{Urgency}
    I -->|"🔵 ELEVATED"| L["Active reform agenda<br/>monitoring this week"]
...
```mermaid
quadrantChart
    title Political Impact - Healthcare Competence HD03216
    ...
    "Healthcare reform delivery": [0.25, 0.75]
    "Municipal implementation challenges": [0.3, 0.25]
    "S healthcare expertise advantage": [0.75, 0.7]
    "Funding gaps risk": [0.5, 0.2]
```
