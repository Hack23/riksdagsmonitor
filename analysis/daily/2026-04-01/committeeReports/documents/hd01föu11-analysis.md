...
```mermaid
flowchart LR
    A[Riksrevisionen Audit<br/>Maritime Environmental Rescue]:::audit --> B[Skr. 2025/26:121<br/>Government Communication]:::gov
    B --> C[FöU11<br/>Defence Committee Review]:::committee
    C --> D{Committee Decision}:::decision
    D --> E[Shelved<br/>No binding action]:::shelved
    E -.-> F[Budget Bill 2027?<br/>Potential allocation]:::future
    
    classDef audit fill:#4ecdc4,stroke:#424242,color:#000000
    classDef gov fill:#45b7d1,stroke:#424242,color:#000000
    classDef committee fill:#96ceb4,stroke:#424242,color:#000000
