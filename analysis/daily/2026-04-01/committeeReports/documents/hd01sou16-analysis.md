...
```mermaid
flowchart TD
    A[SoU16: Healthcare Organization<br/>84 motions rejected, 20 reservations]:::committee
    A --> B[S — Socialdemokraterna<br/>R4,R7,R8,R9,R11,R12,R13,R14,R18]:::sParty
    A --> C[V — Vänsterpartiet<br/>R1,R5,R12,R13,R18]:::vParty
    A --> D[C — Centerpartiet<br/>R2,R7,R16,R19]:::cParty
    A --> E[MP — Miljöpartiet<br/>R3,R6,R10,R12,R13,R15,R17,R18,R20]:::mpParty
