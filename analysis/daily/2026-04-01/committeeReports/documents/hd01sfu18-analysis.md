...
```mermaid
flowchart TD
    A[SfU18: Social Insurance<br/>39 Reservations — Highest 2025/26]:::committee
    
    A --> V[V — Vänsterpartiet<br/>Solo: R1,R17,R23,R28,R35,R38<br/>Joint: R4,R7,R10-13,R15-16,R20-21,R26,R30,R33,R37]:::vParty
    A --> C[C — Centerpartiet<br/>Solo: R2,R5,R8,R14,R24,R29,R36<br/>Joint: R15,R19,R20,R22,R32]:::cParty
    A --> MP[MP — Miljöpartiet<br/>Solo: R3,R18,R25,R27,R31,R39<br/>Joint: R4,R7,R10-13,R15-16,R19-22,R25-27,R30-34,R37]:::mpParty
    A --> S[S — Socialdemokraterna<br/>Solo: R6,R9,R11<br/>Joint: R26,R30,R34,R37]:::sParty
    
    V & MP --> VM[V+MP Bloc<br/>R4,R7,R10,R12,R13,R16,R21,R33]:::vmBloc
