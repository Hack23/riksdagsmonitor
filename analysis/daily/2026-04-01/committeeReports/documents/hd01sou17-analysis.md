...
```mermaid
flowchart LR
    A[Government Coalition<br/>M, SD, L, KD]:::coalition --> B{SoU17<br/>Healthcare Priorities}:::committee
    B --> C[M — Moderaterna<br/>Supports committee line]:::mParty
    B --> D[L — Liberalerna<br/>Supports committee line]:::lParty
    B --> E[SD — Sverigedemokraterna<br/>⚠️ R15 dissent]:::sdParty
    B --> F[KD — Kristdemokraterna<br/>⚠️ R15 dissent]:::kdParty
