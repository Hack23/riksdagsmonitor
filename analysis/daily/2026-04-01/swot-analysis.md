...
graph TD
    subgraph "💪 Strengths"
        S1["S1: Security package delivery<br/>HD03235 + HD03228 + HD03214"]
        S2["S2: 13+ chamber decisions<br/>Active legislative agenda"]
        S3["S3: Healthcare reform<br/>HD03216 + SoU cluster"]
    end
    subgraph "⚠️ Weaknesses"
        W1["W1: ECHR compliance risk<br/>HD03235"]
        W2["W2: L internal tensions<br/>Migration vs liberal values"]
    end
    subgraph "🚀 Opportunities"
        O1["O1: SD cooperation locked<br/>through budget cycle"]
        O2["O2: NATO leadership<br/>Nordic-Baltic region"]
    end
    subgraph "🔴 Threats"
        T1["T1: Opposition humanitarian<br/>framing of HD03235"]
        T2["T2: International scrutiny<br/>Arms exports HD03228"]
    end
...
```mermaid
quadrantChart
    title Coalition vs Opposition Political Landscape 2026-04-01
    x-axis Government Advantage --> Opposition Advantage
    y-axis Vulnerability --> Strength
    quadrant-1 Opposition Strengths
    quadrant-2 Government Strengths
    quadrant-3 Government Vulnerabilities
    quadrant-4 Opposition Vulnerabilities
    
    "Security package delivery": [0.2, 0.9]
    "NATO defense alignment": [0.25, 0.85]
    "Healthcare reform push": [0.3, 0.7]
    "ECHR legal risk": [0.35, 0.15]
    "L internal tensions": [0.3, 0.25]
    "SoU19 multi-party debate": [0.7, 0.6]
    "S migration ambiguity": [0.75, 0.2]
    "Motion rejection rate 96%": [0.8, 0.15]
```
