...
```mermaid
graph TD
    subgraph "5×5 Risk Matrix — Opposition Motions"
        R1["R1: Cross-bloc education vote<br/>L:2 × I:4 = 8"]
        R2["R2: Sida audit policy change<br/>L:3 × I:3 = 9"]
        R3["R3: Housing policy backlash<br/>L:2 × I:3 = 6"]
        R4["R4: Asylum debate escalation<br/>L:3 × I:2 = 6"]
