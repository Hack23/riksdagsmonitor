...
```mermaid
graph TD
    subgraph "📊 Opposition Motions Intelligence Dashboard — 2026-04-14"
        direction TB
        subgraph "🏛️ Party Activity"
            MP["MP: 14 motions"]
            V["V: 6 motions"]
            S["S: 6 motions"]
            C["C: 2 motions"]
        ...
        subgraph "🔴 Risk Assessment"
            COAL["Coalition Risk: LOW 4/100"]
            OPPO["Opposition Coordination: MEDIUM"]
