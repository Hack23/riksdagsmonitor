...
```mermaid
graph LR
    subgraph "Cross-Party Clusters"
        SIDA["Sida Audit<br/>C+V+MP"]
        YOUTH["Youth Justice<br/>V+MP"]
        EDU["Education<br/>S+MP"]
    end
    subgraph "Single-Party Clusters"
        HOUSE["Housing<br/>MP×5"]
        SOCIAL["Social Policy<br/>V×2"]
        CRIME["Criminal Justice<br/>MP×2"]
    end
    SIDA --- YOUTH
    EDU --- YOUTH
    style SIDA fill:#dc3545,color:#fff
    style YOUTH fill:#fd7e14,color:#fff
    style EDU fill:#ffc107,color:#000
    style HOUSE fill:#28a745,color:#fff
    style SOCIAL fill:#17a2b8,color:#fff
    style CRIME fill:#6f42c1,color:#fff
```
