...
```mermaid
graph TD
    subgraph "Political Threat Assessment — April 2026 Motions"
        DEM["Democratic Function: LOW"]
        POL["Policy Stability: MEDIUM"]
        COA["Coalition Integrity: LOW"]
        PUB["Public Trust: MEDIUM"]
