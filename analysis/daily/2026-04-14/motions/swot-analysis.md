...
graph LR
    subgraph "Government SWOT"
        GS["✅ S: Majority + Policy Initiative"]
        GW["⚠️ W: Multi-front + Sida Audit"]
        GO["🌟 O: Frame Opposition as Obstructionist"]
        GT["🔴 T: Cross-bloc Education + Asylum Debate"]
    end
    subgraph "Opposition SWOT"
        OS["✅ S: MP Dominance + Cross-party Aid"]
        OW["⚠️ W: C Passive + Reactive Posture"]
        OO["🌟 O: 2026 Election Positioning"]
        OT["🔴 T: Internal Fragmentation"]
    end
    GW --> OS
    GT --> OO
