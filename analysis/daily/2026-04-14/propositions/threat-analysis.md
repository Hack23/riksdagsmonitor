...
```mermaid
graph TD
    subgraph "Threat Assessment: Spring Fiscal Package"
        T1["⚠️ Fiscal Transparency<br/>Severity: MODERATE<br/>6 documents, complex cross-references"]
        T2["⚠️ Fast-Track Procedure<br/>Severity: LOW-MODERATE<br/>FiU48 expedited processing"]
        T3["📊 SD Influence Opacity<br/>Severity: LOW<br/>Pre-negotiation not disclosed"]
    end
    T1 --> |"Risk: Budget complexity obscures trade-offs"| D1["🏛️ Democratic Accountability"]
