...
```mermaid
graph LR
    subgraph "Risk Heat Map — Spring Fiscal Package"
        direction TB
        R1["🔴 SD Budget Leverage<br/>L:4 × I:4 = 16<br/>HIGH"] 
        R2["🟠 Unemployment Challenge<br/>L:5 × I:3 = 15<br/>MODERATE-HIGH"]
        R3["🟠 Energy Fiscal Exposure<br/>L:3 × I:4 = 12<br/>MODERATE"]
        R4["🟡 Opposition Counter-Budget<br/>L:4 × I:2 = 8<br/>MODERATE-LOW"]
