...
```mermaid
graph TD
    ROOT[Threat to Swedish Energy Security] --> A[Middle East Conflict Escalation]
    ROOT --> B[Severe Weather Events]
    A --> A1[Oil Supply Disruption]
    A --> A2[Gas Price Spike]
    A1 --> C[FiU48 Relief Insufficient]
    A2 --> C
    B --> B1[Extended Cold Period]
    B1 --> C
    C --> D[Government Credibility Damage]
