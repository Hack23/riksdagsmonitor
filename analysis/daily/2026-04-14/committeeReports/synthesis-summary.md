...
```mermaid
graph TD
    A[April 13 Committee Reports] --> B[FiU48: Emergency Budget]
    A --> C[UFöU3: NATO Finland]
    A --> D[KU44: Procedural]

    B --> E[Cost-of-Living Crisis Response]
    B --> F[Fuel Tax: -82 öre/l petrol]
    B --> G[El/Gas Price Support]

    C --> H[NATO eFP Deployment]
    C --> I[1,200 Troops Finland]
    C --> J[Nordic Defence Integration]
