...
> ⚠️ **No SWOT entries generated**: The automated data pipeline found 17 documents but could not extract SWOT contributions from metadata alone. Deep SWOT analysis requires AI-driven per-document analysis following `analysis/methodologies/political-swot-framework.md`.
...
1. No SWOT entries could be derived from document metadata alone — AI analysis required.
