...
```mermaid
graph TD
    subgraph "🏛️ Government Legislative Package"
        VB["Vårbudget Prop 100<br/>⭐10/10"] --> EB["Extra Budget Prop 236<br/>⭐9/10"]
        VB --> EL["Elsystemet Prop 240<br/>⭐7/10"]
        VB --> WP["Vindkraft Prop 239<br/>⭐5/10"]
        EL --> ENV["Miljöprövning Prop 238<br/>⭐5/10"]
        WP --> ENV
        POL["Polisutbildning Prop 237<br/>⭐6/10"] --> FRD["Bedrägerier Prop 233<br/>⭐4/10"]
        VIO["Våldsstrategi Skr 245<br/>⭐6/10"] --> POL
    end
    subgraph "📋 Committee Processing"
        FIU["FiU48: Fuel Tax Cuts<br/>⭐8/10<br/>Decision: Apr 22"] --> EB
        NATO["UFöU3: NATO Finland<br/>⭐7/10<br/>Decision: Jun 4"]
        ELIG["TU21: E-legitimation<br/>⭐5/10"]
        TACH["TU22: Tachograph<br/>⭐3/10"]
    end
    subgraph "🔴 Opposition Pressure"
        SINT["S: 10 interpellations<br/>7 ministers targeted"]
        VMOT["V: 6 motions filed"]
        MPMOT["MP: 14 motions filed"]
    end
