...
```mermaid
flowchart LR
    subgraph "S Strategy (8 interpellations)"
        S1["Infrastructure<br/>5 to Carlson KD"]
        S2["Foreign Policy<br/>1 to Malmer Stenergard M"]
        S3["Welfare<br/>1 to Slottner KD"]
        S4["Integration<br/>2 to Britz L + Svantesson M"]
    end
    subgraph "V Strategy (2 interpellations)"
        V1["Disability Rights<br/>Awad → 3 ministers"]
    end
    subgraph "Government Response Pressure"
        G1["🔴 Carlson KD: 5 pending"]
        G2["🟡 Svantesson M: 2 pending"]
        G3["🟡 Malmer Stenergard M: 1 pending"]
        G4["🟡 Slottner KD: 1 pending"]
    end
    S1 --> G1
    S2 --> G3
    S3 --> G4
