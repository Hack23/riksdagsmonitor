...
```mermaid
flowchart TD
    A["frs 2025/26:423<br/>Eva Lindh (S)"] -->|Demands| B["Min. Slottner (KD)<br/>Civil Affairs"]
    A -->|Evidence| C["Wealthy municipalities<br/>relocate vulnerable people<br/>to poorer municipalities"]
    C -->|Victims| D["Domestic violence survivors<br/>Addiction patients<br/>Mental health patients"]
    B -->|Context| E["S-government launched<br/>investigation<br/>Current govt cancelled it"]
    B --> F{Response Path}
