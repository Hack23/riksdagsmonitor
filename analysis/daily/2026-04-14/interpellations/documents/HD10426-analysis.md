...
```mermaid
flowchart TD
    A["frs 2025/26:426<br/>Muranovic (S)"] -->|3 Questions| B["FM Malmer Stenergard (M)"]
    B --> C["Q1: Condemn death penalty?"]
    B --> D["Q2: EU joint position?"]
    B --> E["Q3: Ensure relations<br/>don't legitimize?"]
    C -->|Response| F{Diplomatic Calculus}
