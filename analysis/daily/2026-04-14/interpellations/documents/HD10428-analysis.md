...
```mermaid
flowchart TD
    A["frs 2025/26:428<br/>Hultqvist (S)"] -->|Questions| B["Min. Carlson (KD)<br/>Infrastructure"]
    B -->|Deadline Apr 23| C{Response Options}
    C -->|Accept| D["🟢 Designate airport<br/>Budget commitment"]
    C -->|Deflect| E["🟡 Refer to Trafikverket<br/>Ongoing review"]
    C -->|Reject| F["🔴 Oppose designation<br/>Defense rhetoric gap"]
    D -->|Impact| G["S loses pressure point"]
