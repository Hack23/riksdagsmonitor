...
Classified **17** parliamentary documents by sensitivity, impact, urgency, and domain.
...
- **Type**: unknown
- **Significance**: 🟢 Low (1/10)
- **Domains**: education policy, justice policy
- **Confidence**: LOW (30%)
...
- **Type**: unknown
- **Significance**: 🟢 Low (1/10)
- **Domains**: fiscal policy, trade and industry policy
- **Confidence**: LOW (30%)
...
- **Type**: unknown
- **Significance**: 🟢 Low (1/10)
- **Domains**: trade and industry policy
- **Confidence**: LOW (30%)
...
- **Type**: unknown
- **Significance**: 🟢 Low (1/10)
- **Domains**: environmental and climate policy
- **Confidence**: LOW (30%)
...
- **Type**: unknown
- **Significance**: 🟢 Low (1/10)
- **Domains**: defence and security policy
- **Confidence**: HIGH (70%)

### Åtgärder mot manipulation och missbruk av färdskrivare
- **dok_id**: HD01TU22
- **Type**: unknown
- **Significance**: 🟢 Low (1/10)
- **Domains**: transport policy
- **Confidence**: HIGH (70%)
...
### Ökad stängning av statliga vägar på grund av tjälnedsättningar i Norr- och Västerbotten
- **dok_id**: HD11705
- **Type**: unknown
- **Significance**: 🟢 Low (1/10)
- **Domains**: transport policy
...
1. **Nya lagar om elsystemet** (dok_id: HD03240) — Significance: 1/10
2. **En betald polisutbildning** (dok_id: HD03237) — Significance: 1/10
3. **Vindkraft i kommuner** (dok_id: HD03239) — Significance: 1/10
4. **Förbättrade regler för svensk tonnagebeskattning** (dok_id: HD03243) — Significance: 1/10
5. **Frihet från våld, förtryck och utnyttjande – En nationell strategi mot mäns våld mot kvinnor, våld i nära relationer, utnyttjande i prostitution och människohandel samt hedersrelaterat våld och förtryck** (dok_id: HD03245) — Significance: 1/10
