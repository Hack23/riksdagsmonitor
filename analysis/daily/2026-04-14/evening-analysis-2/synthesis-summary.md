...
```mermaid
graph TD
    subgraph Government_Legislative_Package
        VB[Varproposition 100 10/10] --> EB[Extra Budget 236 9/10]
        VB --> AB[Andringsbudget 99 9/10]
        EL[Elsystemet 240 7/10] --> WP[Vindkraft 239 5/10]
        EL --> ENV[Miljoprovning 238 5/10]
        POL[Polisutbildning 237 6/10]
        FRD[Bedragerier 233 4/10]
        VIO[Valdsstrategi 245 6/10]
    end
    subgraph Committee_Processing
        FIU[FiU48 Fuel Tax 8/10 Apr22] --> EB
        NATO[UFoU3 NATO 7/10 Jun4]
        ELIG[TU21 E-legitimation 5/10]
    end
    subgraph Opposition_Accountability
        BRITZ[Britz L answers 4 Ips]
        REDAR[Redar S Integration Push]
        LUHR[Luhr MP Climate Challenge]
    end
