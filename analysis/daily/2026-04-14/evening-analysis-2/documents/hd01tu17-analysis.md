# Document Analysis: Nya regler mot bedrägerier och annat vilseledande genom elektroniska kommunikationstjänster
...
- Policy domain: transport policy (HIGH confidence)
...
1. Policy domain: transport policy (HIGH confidence)
