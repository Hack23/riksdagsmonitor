...
```mermaid
graph TD
    subgraph Democratic_Accountability_Threats
        T1[Ministerial capacity L dual-hatting]
        T2[Legislative quality rush 8 props/day]
        T3[Emergency measures transparency]
    end
    subgraph Coalition_Stability_Threats
        T4[SD climate policy friction]
        T5[KD healthcare vulnerability]
        T6[L burnout risk]
    end
    subgraph Electoral_Threats
        T7[Integration data weaponization]
        T8[Climate credibility gap]
