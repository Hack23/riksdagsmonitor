...
```mermaid
graph TD
    subgraph Risk_Classification
        R1[Integration Election Liability<br/>L4 x I4 = 16 CRITICAL]
        R2[Coalition L Dual-Hatting<br/>L3 x I4 = 12 HIGH]
        R3[Healthcare Disparities<br/>L4 x I3 = 12 HIGH]
        R4[Climate Credibility Gap<br/>L3 x I4 = 12 HIGH]
        R5[Legislative Quality Rush<br/>L3 x I3 = 9 MODERATE]
        R6[Fiscal Sustainability<br/>L2 x I4 = 8 MODERATE]
    end
    R1 -->|triggers| R2
    R4 -->|amplifies| R2
    R3 -->|compounds| R1
