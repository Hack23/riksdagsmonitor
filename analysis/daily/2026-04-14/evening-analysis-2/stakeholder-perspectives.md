...
graph LR
    subgraph Positive_Impact
        CIT[Citizens: Fuel relief]
        BIZ[Business: Regulatory clarity]
        INT[International: NATO commitment]
    end
    subgraph Mixed_Impact
        GOV[Government: Delivery vs accountability]
        OPP[Opposition: Strong attacks but no alternative]
        MED[Media: Rich material but overload]
    end
    subgraph Negative_Impact
        CIV[Civil Society: Social dumping gap]
        JUD[Judiciary: Quality concerns]
    end

    style CIT fill:#2ed573,color:#FFFFFF
    style BIZ fill:#2ed573,color:#FFFFFF
    style INT fill:#2ed573,color:#FFFFFF
    style GOV fill:#FF9800,color:#FFFFFF
    style OPP fill:#FF9800,color:#FFFFFF
    style MED fill:#FF9800,color:#FFFFFF
    style CIV fill:#ff4757,color:#FFFFFF
    style JUD fill:#ff4757,color:#FFFFFF
```
