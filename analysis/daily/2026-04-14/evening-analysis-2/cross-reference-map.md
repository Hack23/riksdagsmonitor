...
```mermaid
graph LR
    subgraph Fiscal_Cluster
        P100[Prop 100 Varproposition] --- P99[Prop 99 Varandringsbudget]
        P100 --- P236[Prop 236 Extra budget]
        P236 --- FIU48[FiU48 Fuel tax committee]
        P100 --- S98[Skr 98 Skatteutgifter]
        P100 --- S101[Skr 101 Arsredovisning]
        P100 --- S241[Skr 241 Riksrevisionen]
    end
    subgraph Energy_Cluster
        P240[Prop 240 Elsystemet] --- P239[Prop 239 Vindkraft]
        P240 --- P238[Prop 238 Miljoprovning]
        P238 --- NU18[NU18 Fornybartdirektivet]
    end
    subgraph Security_Cluster
        P237[Prop 237 Polisutbildning] --- P233[Prop 233 Bedragerier]
        S245[Skr 245 Valdsstrategi] --- P237
        P220[Prop 220 NATO Finland] --- UFOU3[UFoU3 NATO committee]
    end
    subgraph Accountability_Cluster
        IP421[Ip 421 Integration Svantesson] --- IP422[Ip 422 Integration Britz]
        IP404[Ip 404 Klimatpolitiska radet] --- P238
        IP369[Ip 369 Forlossningsvarden] --- S245
