...
```mermaid
graph TD
    A["Prop 2025/26:237<br/>Betald polisutbildning"] -->|"Addresses"| B["Police Shortage"]
    A -->|"Implements"| C["Tidö Agreement<br/>Security Priority"]
    A -->|"Signed by"| D["PM Kristersson +<br/>Strömmer (M)"]
    B -->|"Root cause"| E["Financial barrier<br/>for applicants"]
