...
```mermaid
graph TD
    A["Prop 2025/26:240<br/>Elsystemet"] -->|"Implements"| B["EU Energy Directives"]
    A -->|"Clarifies"| C["Systemansvar<br/>(System Responsibility)"]
    A -->|"Modernizes"| D["Electricity Market<br/>Regulation"]
