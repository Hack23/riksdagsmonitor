...
graph TD
    subgraph "HIGH Impact"
        R1["Energy price volatility<br/>undermining reform support"]
        R2["Municipal wind power<br/>resistance despite incentives"]
    end
    subgraph "MEDIUM Impact"
        R3["Legislative rush quality<br/>concerns in committees"]
        R4["Opposition 'rubber stamp'<br/>narrative"]
        R5["Integration policy<br/>interpellation pressure"]
    end
    subgraph "LOW Impact"
