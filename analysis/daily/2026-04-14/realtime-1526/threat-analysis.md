...
graph LR
    subgraph "Threat Actors"
        ...
        MUN["Municipal Governments"]
        EU["EU Regulatory<br/>Compliance Pressure"]
    end
    subgraph "Attack Vectors"
        V1["Legislative quality<br/>critique"]
        V2["Wind power<br/>local resistance"]
        V3["Directive deadline<br/>pressure"]
        V4["Integration policy<br/>effectiveness"]
    end
    subgraph "Targets"
        T1["Government<br/>credibility"]
        T2["Energy transition<br/>program"]
        T3["Coalition<br/>cohesion"]
    end
    OPP --> V1 --> T1
    OPP --> V4 --> T3
    MUN --> V2 --> T2
