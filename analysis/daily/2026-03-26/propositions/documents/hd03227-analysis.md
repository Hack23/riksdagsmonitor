...
```mermaid
graph LR
    A["Prop. 2025/26:227<br/>HD03227"] --> B{Sensitivity}
    B -->|"🟡 SENSITIVE"| D["Policy Delivery Risk<br/>Children's Rights Balance"]
    
    A --> G{Domain}
    G --> H["JUS<br/>Justice Policy<br/>Youth Crime Investigation"]
    
    A --> I{Urgency}
    I -->|"🔵 ELEVATED"| L["Active monitoring<br/>— high political salience"]
