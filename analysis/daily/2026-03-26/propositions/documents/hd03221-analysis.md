...
```mermaid
graph LR
    A["Prop. 2025/26:221<br/>HD03221"] --> B{Sensitivity}
    B -->|"🟢 PUBLIC"| E["Standard Parliamentary<br/>Regulatory Reform"]
    
    A --> G{Domain}
    G --> H["ECO/HEA<br/>Hospitality Deregulation<br/>+ Alcohol Policy"]
    
    A --> I{Urgency}
    I -->|"⚪ ROUTINE"| M["Standard legislative<br/>processing via SoU"]
