...
source_folder: analysis/daily/2026-05-26/committee-reports
generated_at: 2026-05-29T19:05:09.999Z
language: en
layout: article
---
## What Happened
...
**Political significance**: VERY HIGH. Opposition motions (including Riksdag document #024114 (HD024114), S/MP critical of lack of proportionality evidence) indicate contested terrain. A sentencing system overhaul affects every level of prosecution and judiciary.
...
```mermaid
graph TD
    A[Tidö Bloc M+SD+KD+L] -->|Strong support| B[JuU47 + JuU48 + UU19 + UU24]
    C[SD] -->|Strong support + punitive floor preference| B
    D[S] -->|Support + rights amendments| B
    E[V] -->|Reservations on NATO; oppose intelligence/surveillance| B
    F[MP] -->|Reservation on gender inclusion; oppose broad powers| B
    G[C] -->|Support + oversight requirements| B
    H[L] -->|Support + civil liberties conditions| B
...
```mermaid
graph LR
    JuU47[JuU47\nOnlinerekrytering] -->|Same legislative cluster| JuU48[JuU48\nPåföljdssystem]
    JuU47 -->|Gang crime continuity| Prop218[Prop 2025/26:218\nDubbla straff]
    JuU48 -->|Sentencing alignment| Prop218

    UU19[UU19\nNato 2025] -->|NATO membership follow-on| UU24[UU24\nCivil underrättelsetjänst]
    UU19 -->|Parliamentary basis| NATOAccession[Prop 2022/23:74\nNATO accession]

    JuU48 -->|Same Aug 13 decision day| UU24
    JuU47 -->|Justice legislative cluster June 17| Vo617[Votering 2026-06-17]
    UU24 -->|Intelligence architecture| UU19

    style JuU47 fill:#c0392b,color:#fff
    style JuU48 fill:#c0392b,color:#fff
    style UU19 fill:#2980b9,color:#fff
    style UU24 fill:#2980b9,color:#fff
    style Prop218 fill:#7f8c8d,color:#fff
    style NATOAccession fill:#7f8c8d,color:#fff
```
