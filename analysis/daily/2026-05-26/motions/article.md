...
date: 2026-05-26
subfolder: motions
slug: 2026-05-26-motions
source_folder: analysis/daily/2026-05-26/motions
generated_at: 2026-05-29T10:25:39.877Z
language: en
layout: article
---
## What Happened
...
```mermaid
graph TD
    A[2 MP motions filed\n2026-05-22] --> B[JuU: HD024192\nChildren's detention\nSecurity threats]
    A --> C[SkU: HD024191\nSkatteverket data\npowers + GDPR]
    B --> D{Lagrådet\nyttrande?}
    D -->|ECHR concerns raised| E[Proposition amended\nor withdrawn - Even/E]
    D -->|No concerns / silent| F[Proposition passed\nMP motion voted down - Likely/L]
    C --> G[Skatteverket gets\nexpanded powers\nLikely/L]
    style A fill:#1a1e3d,stroke:#00d9ff,color:#e0e0e0
    style D fill:#ff006e,stroke:#cc0000,color:#fff
    style E fill:#ffa500,stroke:#cc7700,color:#fff
    style F fill:#4ecdc4,stroke:#2b8a85,color:#fff
```
...
```mermaid
graph LR
    A[Prop 2025/26:267\nSecurity threats] -->|opposed by MP| B[HD024192\nChildren's detention]
    C[Prop 2025/26:261\nSkatteverket powers] -->|opposed by MP| D[HD024191\nData protection]
    B --> E[JuU committee\nvote pending]
    D --> F[SkU committee\nvote pending]
    E --> G[Likely majority\napproval of props]
    F --> G
    ...
    style G fill:#4ecdc4,stroke:#2b8a85,color:#fff
```
...
```mermaid
xychart-beta
    title "DIW Significance Scores — Motions 2026-05-26"
    x-axis [HD024192, HD024191]
    y-axis "DIW Score" 0 --> 5
    bar [4.0, 3.0]
```
...
```mermaid
graph LR
    A[MP motion HD024192] -->|informs| B[Lagrådet]
    A -->|pressures| C[JuU Committee]
    B -->|may block| D[Prop. 2025/26:267]
    C -->|votes on| D
    E[Rädda Barnen] -->|supports| A
    F[ECtHR] -->|ultimate arbiter| D
    G[S-party JuU members] -->|key swing| C
    C -->|if amended| H[Government accepts]
    C -->|if voted down| I[Motion rejected\nProposition passes]
    style A fill:#ff006e,stroke:#cc0000,color:#fff
    style B fill:#00d9ff,stroke:#007aaa,color:#000
    style F fill:#ffa500,stroke:#cc7700,color:#fff
    style G fill:#ffbe0b,stroke:#cc9900,color:#000
```
...
```mermaid
graph TD
    A[Both motions filed\nHD024192 + HD024191\n2026-05-22] --> B{Lagrådet on\nprop 267?}
    B -->|Raises ECHR concerns| C[Scenario 1\n25%]
    B -->|Silent / no concerns| D{JuU/SkU vote}
    D -->|Government wins both| E[Scenario 2\n50%]
    D -->|Partial S/C support| F[Scenario 3\n15%]
    D -->|Both props withdrawn| G[Scenario 4\n10%]
    style C fill:#ffa500,stroke:#cc7700
    style E fill:#4ecdc4,stroke:#2b8a85
    style F fill:#ffbe0b,stroke:#cc9900
    style G fill:#ff006e,stroke:#cc0000,color:#fff
```
...
quadrantChart
    ...
    quadrant-2 "Monitor — may escalate"
...
```mermaid
quadrantChart
    title "MP Motion Strategic Positioning"
    x-axis Low Political Leverage --> High Political Leverage
    y-axis Low Legal Strength --> High Legal Strength
    quadrant-1 "High leverage + High legal: Win zone"
    quadrant-2 "Low leverage + High legal: Moral victory"
    quadrant-3 "Low leverage + Low legal: Symbolic"
    quadrant-4 "High leverage + Low legal: Political"
    HD024192: [0.25, 0.85]
    HD024191: [0.20, 0.60]
```
...
```mermaid
graph LR
    P1[Prop. 2025/26:267\nSecurity threats] --> M1[HD024192\nMP opposition]
    P2[Prop. 2025/26:261\nSkatteverket powers] --> M2[HD024191\nMP opposition]
    M1 --> JuU[JuU Committee\nvote pending]
    M2 --> SkU[SkU Committee\nvote pending]
    JuU --> L1[Lagrådet yttrande?]
    L1 -->|yes, ECHR concern| A1[Amendment required]
    L1 -->|no| B1[Original text to\nRiksdagen floor]
    SkU --> L2[IMY proportionality?]
    L2 -->|yes, GDPR concern| A2[Amendment required]
    L2 -->|no| B2[Original text to\nRiksdagen floor]
    style P1 fill:#1a1e3d,stroke:#00d9ff,color:#e0e0e0
    style P2 fill:#1a1e3d,stroke:#00d9ff,color:#e0e0e0
    style M1 fill:#ff006e,stroke:#cc0000,color:#fff
    style M2 fill:#ff6b6b,stroke:#cc0000,color:#fff
```
