# Intelligence Assessment: Opposition Motions 2026-05-06

**Author**: James Pether Sörling | **Date**: 2026-05-06
**Classification**: PUBLIC | **Standard**: ICD 203 Key Judgments format
...
## Pass 2 — KJ Refinements (2026-05-06)

**KJ-2 confidence upgrade**: C dual defection assessment upgraded from MODERATE [B2] to MODERATE-HIGH [B1] based on historical Januariöverenskommelsen parallel (historical-parallels.md Parallel 3). The structural replication of 2017-2019 behaviour is now the dominant explanatory hypothesis.

**KJ-5 confidence maintained at LOW [D2]**: S's silence on prop. 2025/26:246 is deliberate — the absence of a JuU motion filing as of 2026-05-06 is itself informative. S had the same deadline as other parties. The probability of S joining the opposition coalition drops from 15% to 12% given continued silence past the initial filing window.

**KJ-3 calibration note**: The 35% probability for Lagrådet concern is above the 15-20% historical base rate, justified by (a) novel CRC argument, (b) Barnombudsmannen statutory mandate to submit, (c) OECD outlier status of the age threshold. If Barnombudsmannen submits a formal CRC brief to Lagrådet (expected based on statutory mandate), the probability rises to 40-45%.

**KJ-7 precision**: The conditioned risk "if post-passage challenges materialise before Sept 2026" has a low probability of materialising before the election — Lagrådet findings come weeks after committee processing, and EU reports operate on annual cycles. More precisely: the electoral liability materialises in the 2026 CAMPAIGN as a forward-looking risk argument ("they ignored Lagrådet / EU warnings"), not as a materialised fact.
