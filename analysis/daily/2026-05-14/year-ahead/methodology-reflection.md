# Methodology Reflection — Year-Ahead 2026-05-14
...
- Documents: `analysis/daily/2026-05-14/documents/` (15 JSON) + `full-text/` (5 MD)
...
- Reproducibility command: `npx tsx scripts/download-parliamentary-data.ts --date 2026-05-14 --limit 30 --auto-full-text-top-n 5`
