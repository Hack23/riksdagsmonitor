# Scenario Analysis — Year-Ahead 2026-05-14 → 2027-05-14

**Methodology**: 4 base scenarios spanning the post-election political-economic configuration; 5 wildcards in `wildcards-blackswans.md`; 3 coalition-formation branches per base scenario where applicable. Year-ahead × tier-C requires this expanded structure.
