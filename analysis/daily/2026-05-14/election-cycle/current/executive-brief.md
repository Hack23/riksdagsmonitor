...
**Classification**: PUBLIC | **Workflow**: news-election-cycle | **Cycle**: 2022-09-11 → 2026-09-13 (T-123 to mandate end)
...
**T-123 to election (2026-09-13)** · refreshed against 2026-05-13 sibling analyses ([propositions](../../propositions/), [motions](../../motions/), [committeeReports](../../committeeReports/), [interpellations](../../interpellations/), [month-ahead](../../month-ahead/)) and predecessor [2026-05-11 election-cycle](../../../2026-05-11/election-cycle/current/).
...
- [`synthesis-summary.md`](synthesis-summary.md) — full lead-story decision and DIW Top-10
- [`intelligence-assessment.md`](intelligence-assessment.md) — ICD 203 BLUF + WEP per finding
- [`scenario-analysis.md`](scenario-analysis.md) — 12-leaf scenario tree + 5 wildcards
- [`cycle-trajectory.md`](cycle-trajectory.md) — multi-year SCB + IMF + Riksdag throughput trend (24th artifact)
- [`risk-assessment.md`](risk-assessment.md) — top risks with mitigation
- [`forward-indicators.md`](forward-indicators.md) — ≥15 dated indicators across quarter/year/cycle/election bands
