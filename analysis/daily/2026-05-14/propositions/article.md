...
keywords: "HD03250, HD03261, HD03267, James Pether Sörling, Tax Agency, Justice Minister Gunnar Strömmer, IMF WEO Apr-, Special Advocate, Abu Qatada, ECtHR Rule, Riksdagsmonitor, Swedish Parliament, Riksdag, political intelligence, OSINT, Swedish politics, democratic transparency, Regeringen, Propositions, English"
date: 2026-05-14
subfolder: propositions
slug: 2026-05-14-propositions
source_folder: analysis/daily/2026-05-14/propositions
generated_at: 2026-05-24T14:02:59.675Z
language: en
layout: article
---
## Executive Brief
...
```mermaid
graph TD
    subgraph Digital["Digital Sovereignty"]
        HD03250["HD03250<br>Statlig e-legitimation<br>(Finansdep/TU)"]
        HD03261["HD03261<br>Skatteverket folkbokföring<br>(Finansdep/SkU)"]
    end
    subgraph Security["National Security"]
        HD03267["HD03267<br>Säkerhetshot utlänningar<br>(Justisdep/JuU)"]
    end
    subgraph Narrative["Pre-election narrative"]
        GOV["Competent governance<br>Digital + Secure Sweden"]
    end
    HD03250 --> GOV
    HD03261 --> GOV
    HD03267 --> GOV
    style HD03250 fill:#1a1e3d,stroke:#00d9ff,color:#e0e0e0
    style HD03261 fill:#1a1e3d,stroke:#00d9ff,color:#e0e0e0
    style HD03267 fill:#1a1e3d,stroke:#ff006e,color:#e0e0e0
...
```mermaid
graph TD
    GOV["Tidö Government<br>Proposer"] --> |HD03267| JuU["JuU Committee<br>Vote"]
    GOV --> |HD03250| TU["TU Committee<br>Vote"]
    GOV --> |HD03261| SkU["SkU Committee<br>Vote"]
    SAPO["SÄPO<br>Supporting"] --> GOV
    LR["Lagrådet<br>Advisory"] --> |Critical yttrande risk| JuU
    S["S<br>May amend"] --> JuU
    V["V/MP<br>Opposed"] --> JuU
    NGO["NGOs<br>Opposed"] --> |ECtHR referral| ECtHR["ECtHR<br>Final arbitre"]
    style GOV fill:#0a0e27,stroke:#ffbe0b,color:#ffbe0b
    style HD03267 fill:#1a1e3d,stroke:#ff006e,color:#e0e0e0
    style ECtHR fill:#1a1e3d,stroke:#ff006e,color:#e0e0e0
```
...
```mermaid
pie title Riksdag Vote Projection — HD03267 (Most Contested)
    "Tidö FOR (certain)" : 200
    "S FOR (if unamended)" : 107
    "S AGAINST (if amended rejected)" : 107
    "V AGAINST" : 24
    "MP AGAINST" : 18
```
...
```mermaid
graph TD
    START["Package submitted<br>May 2026"] --> Q1{"Lagrådet<br>yttrande?"}
    Q1 -->|Favourable / minor amendments| S1["Scenario A<br>Smooth passage"]
    Q1 -->|Critical on HD03267| Q2{"Government<br>response?"}
    Q2 -->|Amend bill| S2["Scenario B<br>Amended passage"]
    Q2 -->|Override critical opinion| S3["Scenario C<br>Contested passage"]
    Q1 -->|Blocked / delay| S4["Scenario D<br>Post-election"]
    style S1 fill:#1a1e3d,stroke:#00d9ff,color:#e0e0e0
    style S2 fill:#1a1e3d,stroke:#ffbe0b,color:#e0e0e0
    style S3 fill:#1a1e3d,stroke:#ff006e,color:#e0e0e0
    style S4 fill:#0a0e27,stroke:#ff006e,color:#ff006e
```
...
```mermaid
xychart-beta
    title "Proposition Electoral Impact by Party (0=Harm, 5=Neutral, 10=Benefit)"
    x-axis ["M", "KD", "L", "C", "SD", "S", "V", "MP"]
    y-axis "Electoral impact" 0 --> 10
    bar [6, 8, 5, 5, 9, 4, 2, 3]
    line [6, 8, 5, 5, 9, 4, 2, 3]
```
...
```mermaid
xychart-beta
    title "Risk Assessment — Propositions May 2026"
    x-axis ["Constitutional", "Judicial", "Impl. delay", "Internat.", "Electoral", "Economic"]
...
```mermaid
quadrantChart
    title SWOT — Tidö Government Propositions (May 2026)
    ...
    HD03267 Security: [0.75, 0.75]
    HD03250 e-ID: [0.65, 0.65]
    HD03261 Skatteverket: [0.60, 0.80]
```
...
```mermaid
quadrantChart
    title Implementation Feasibility vs. Political Risk
    x-axis "Low Political Risk" --> "High Political Risk"
    y-axis "Low Feasibility" --> "High Feasibility"
    quadrant-1 Deliver carefully
    quadrant-2 Priority implementation
    quadrant-3 Monitor closely
    quadrant-4 Proceed with safeguards
    HD03261: [0.2, 0.85]
    HD03250: [0.35, 0.65]
    HD03267: [0.75, 0.55]
```
...
## Executive Brief Ar
<!-- source: executive-brief_ar.md :: https://github.com/Hack23/riksdagsmonitor/blob/main/analysis/daily/2026-05-14/propositions/executive-brief_ar.md -->
...
## Executive Brief Da
<!-- source: executive-brief_da.md :: https://github.com/Hack23/riksdagsmonitor/blob/main/analysis/daily/2026-05-14/propositions/executive-brief_da.md -->
...
## Executive Brief De
<!-- source: executive-brief_de.md :: https://github.com/Hack23/riksdagsmonitor/blob/main/analysis/daily/2026-05-14/propositions/executive-brief_de.md -->
...
## Executive Brief Es
<!-- source: executive-brief_es.md :: https://github.com/Hack23/riksdagsmonitor/blob/main/analysis/daily/2026-05-14/propositions/executive-brief_es.md -->
...
## Executive Brief Fi
<!-- source: executive-brief_fi.md :: https://github.com/Hack23/riksdagsmonitor/blob/main/analysis/daily/2026-05-14/propositions/executive-brief_fi.md -->
...
## Executive Brief Fr
<!-- source: executive-brief_fr.md :: https://github.com/Hack23/riksdagsmonitor/blob/main/analysis/daily/2026-05-14/propositions/executive-brief_fr.md -->
...
## Executive Brief He
<!-- source: executive-brief_he.md :: https://github.com/Hack23/riksdagsmonitor/blob/main/analysis/daily/2026-05-14/propositions/executive-brief_he.md -->
...
## Executive Brief Ja
<!-- source: executive-brief_ja.md :: https://github.com/Hack23/riksdagsmonitor/blob/main/analysis/daily/2026-05-14/propositions/executive-brief_ja.md -->
...
## Executive Brief Ko
<!-- source: executive-brief_ko.md :: https://github.com/Hack23/riksdagsmonitor/blob/main/analysis/daily/2026-05-14/propositions/executive-brief_ko.md -->
...
## Executive Brief Nl
<!-- source: executive-brief_nl.md :: https://github.com/Hack23/riksdagsmonitor/blob/main/analysis/daily/2026-05-14/propositions/executive-brief_nl.md -->
...
## Executive Brief No
<!-- source: executive-brief_no.md :: https://github.com/Hack23/riksdagsmonitor/blob/main/analysis/daily/2026-05-14/propositions/executive-brief_no.md -->
...
## Executive Brief Sv
<!-- source: executive-brief_sv.md :: https://github.com/Hack23/riksdagsmonitor/blob/main/analysis/daily/2026-05-14/propositions/executive-brief_sv.md -->
...
## Executive Brief Zh
<!-- source: executive-brief_zh.md :: https://github.com/Hack23/riksdagsmonitor/blob/main/analysis/daily/2026-05-14/propositions/executive-brief_zh.md -->
...
- [`executive-brief_ar.md`](https://github.com/Hack23/riksdagsmonitor/blob/main/analysis/daily/2026-05-14/propositions/executive-brief_ar.md)
- [`executive-brief_da.md`](https://github.com/Hack23/riksdagsmonitor/blob/main/analysis/daily/2026-05-14/propositions/executive-brief_da.md)
- [`executive-brief_de.md`](https://github.com/Hack23/riksdagsmonitor/blob/main/analysis/daily/2026-05-14/propositions/executive-brief_de.md)
- [`executive-brief_es.md`](https://github.com/Hack23/riksdagsmonitor/blob/main/analysis/daily/2026-05-14/propositions/executive-brief_es.md)
- [`executive-brief_fi.md`](https://github.com/Hack23/riksdagsmonitor/blob/main/analysis/daily/2026-05-14/propositions/executive-brief_fi.md)
- [`executive-brief_fr.md`](https://github.com/Hack23/riksdagsmonitor/blob/main/analysis/daily/2026-05-14/propositions/executive-brief_fr.md)
- [`executive-brief_he.md`](https://github.com/Hack23/riksdagsmonitor/blob/main/analysis/daily/2026-05-14/propositions/executive-brief_he.md)
- [`executive-brief_ja.md`](https://github.com/Hack23/riksdagsmonitor/blob/main/analysis/daily/2026-05-14/propositions/executive-brief_ja.md)
- [`executive-brief_ko.md`](https://github.com/Hack23/riksdagsmonitor/blob/main/analysis/daily/2026-05-14/propositions/executive-brief_ko.md)
- [`executive-brief_nl.md`](https://github.com/Hack23/riksdagsmonitor/blob/main/analysis/daily/2026-05-14/propositions/executive-brief_nl.md)
- [`executive-brief_no.md`](https://github.com/Hack23/riksdagsmonitor/blob/main/analysis/daily/2026-05-14/propositions/executive-brief_no.md)
- [`executive-brief_sv.md`](https://github.com/Hack23/riksdagsmonitor/blob/main/analysis/daily/2026-05-14/propositions/executive-brief_sv.md)
- [`executive-brief_zh.md`](https://github.com/Hack23/riksdagsmonitor/blob/main/analysis/daily/2026-05-14/propositions/executive-brief_zh.md)
