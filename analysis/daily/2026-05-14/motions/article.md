...
keywords: "HD024160, HD024162, HD024153, prop. 2025/26:262, SD, Sweden s Riksdag, CRC Art, AMR Pact, Riksdagsmonitor, Swedish Parliament, Riksdag, political intelligence, OSINT, Swedish politics, democratic transparency, Regeringen, Motions, English"
date: 2026-05-14
subfolder: motions
slug: 2026-05-14-motions
source_folder: analysis/daily/2026-05-14/motions
generated_at: 2026-05-24T17:19:40.333Z
language: en
layout: article
---
## Executive Brief
...
```mermaid
quadrantChart
    title Migration Opposition Motions: Significance vs Political Impact
    x-axis Low Impact --> High Impact
    y-axis Low Significance --> High Significance
    quadrant-1 Critical Battleground
    quadrant-2 High Significance
    quadrant-3 Monitor
    quadrant-4 Strategic Positioning
    HD024153: [0.9, 0.87]
    HD024160: [0.85, 0.83]
    HD024168: [0.7, 0.79]
    HD024162: [0.65, 0.75]
...
```mermaid
xychart-beta
    title "DIW Significance by Document"
    x-axis ["HD024153","HD024160","HD024168","HD024162","HD024157","HD024152","HD024167","HD024169","HD024159","HD024161"]
    y-axis "DIW Score" 0 --> 10
    bar [8.7, 8.3, 7.9, 7.5, 7.4, 7.1, 7.0, 6.8, 6.5, 6.3]
```
...
```mermaid
graph LR
    style Lagrádet fill:#00d9ff,color:#000
    style Kristersson fill:#52be80,color:#000
    style S fill:#e8112d,color:#fff
    style C fill:#009933,color:#fff
    style V fill:#DA291C,color:#fff
    style Migrationsverket fill:#ffbe0b,color:#000

    Lagrádet["Lagrådet\n(Constitutional check)"] -->|"CRC/ECHR critique"| Kristersson["Kristersson Govt\n(Prop 262–265)"]
    S["S Opposition\n(HD024153, 152)"] -->|"Electoral challenge"| Kristersson
    C["C Opposition\n(HD024157–161)"] -->|"Rights safeguards"| Kristersson
    V["V Opposition\n(HD024167–169)"] -->|"Total rejection"| Kristersson
    Kristersson -->|"Mandate expansion"| Migrationsverket["Migrationsverket\n(Implementation risk)"]
    Lagrádet -->|"Provides authority to"| C
    UNHCR["UNHCR/Amnesty/\nRädda Barnen"] -->|"Media pressure"| S
    UNHCR -->|"Media pressure"| C
```
...
```mermaid
pie title Migration Package Scenarios (May-September 2026)
    "Scenario 1: Minor amendment accepted (45%)" : 45
    "Scenario 2: Full passage unchanged (30%)" : 30
    "Scenario 3: Prop 265 returned for revision (15%)" : 15
    "Scenario 4: Coalition disruption, delayed (10%)" : 10
```
...
```mermaid
xychart-beta
    title "Party Polling % (approximate April 2026)"
    x-axis ["S", "M", "SD", "C", "V", "KD", "MP", "L"]
    y-axis "Polling %" 0 --> 40
    bar [33, 19, 21, 8.5, 7, 5, 5, 4.5]
```
...
graph TD
    ...
    A["ECHR violation: child detention without safeguards (L×I=15)"]
    B["Migrationsverket capacity failure (L×I=16)"]
    C["S election mobilisation on migration (L×I=16)"]
    D["International HRO criticism (L×I=12)"]
    A --> |"If HD024160 ignored"| D
    B --> |"Implementation lag"| D
    C --> |"Election year"| E["Coalition pressure to restrict debate"]
    D --> |"Media amplification"| C
```
