...
```mermaid
graph TD
    subgraph Impact5["Impact 5 - Critical"]
        R5_cell["R5 ECHR\nL:2 I:5\nScore:10"]
    end
    subgraph Impact4["Impact 4 - Major"]
        R1_cell["R1 Constitutional\nL:4 I:4\nScore:16"]
        R2_cell["R2 eID Delays\nL:3 I:4\nScore:12"]
    end
    subgraph Impact3["Impact 3 - Moderate"]
        R3_cell["R3 Telecom\nL:3 I:3\nScore:9"]
        R4_cell["R4 Polarization\nL:4 I:3\nScore:12"]
    end
