...
```mermaid
quadrantChart
    title Political Risk Landscape — Evening 2026-04-16
    ...
    quadrant-3 Accept
    quadrant-4 Mitigate
    CRC Backlash on Prop 246: [0.8, 0.75]
    Opposition Coordination Hardening: [0.65, 0.8]
    Climate Credibility Erosion: [0.7, 0.6]
    Youth Justice Polarization: [0.75, 0.55]
    SD-Government Strain: [0.55, 0.5]
    Forestry Environmental Protest: [0.45, 0.35]
    Digital Governance Overreach: [0.3, 0.25]
    Ukraine Commitment Escalation: [0.4, 0.2]
```
...
```mermaid
flowchart TD
    A["Prop 246 tabled<br/>Youth crime reform<br/>🔴 TRIGGER"] --> B["JuU committee hearings<br/>Expert testimony on CRC<br/>🟡 WEEKS 1-2"]
    B --> C["BRIS + Rädda Barnen<br/>public campaign<br/>🟠 WEEKS 2-4"]
    C --> D{Media amplification?}
    D -->|Yes| E["International CRC scrutiny<br/>UN Committee statement<br/>🔴 MONTHS 1-3"]
    D -->|No| F["Contained domestic debate<br/>🟢 MANAGEABLE"]
    E --> G["Opposition exploits in<br/>Election 2026 campaign<br/>🔴 CRITICAL"]
...
```mermaid
graph LR
    R1["R1: CRC Backlash<br/>L×I=16"] --> R4["R4: Youth Justice<br/>Polarization<br/>L×I=12"]
    R3["R3: Climate<br/>Erosion<br/>L×I=12"] --> R6["R6: Forestry<br/>Protest<br/>L×I=6"]
    R2["R2: Opposition<br/>Coordination<br/>L×I=12"] --> R1
    R2 --> R3
