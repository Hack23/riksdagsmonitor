...
```mermaid
graph LR
    DOC["📄 Evening Analysis<br/>24 documents"] --> SENS{Sensitivity}
    SENS -->|"🟡 SENSITIVE"| SEN["Careful Framing<br/>Youth justice + CRC"]
    
    DOC --> URG{Urgency}
    URG -->|"🟠 URGENT"| URGE["48h Window<br/>Press conference today"]
