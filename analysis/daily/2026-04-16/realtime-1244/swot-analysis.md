...
```mermaid
quadrantChart
    title SWOT Strategic Position — Criminal Justice (Post-JuU15 Vote 145-142)
    ...
    quadrant-3 "Monitor"
    quadrant-4 "Build"
    "Legislative majority S1: 145 Ja": [0.85, 0.75]
    "SD discipline S2: 59/59": [0.9, 0.65]
    "Election framing O1": [0.7, 0.9]
    "S vulnerability O3: 88/88 Nej": [0.65, 0.8]
    "UN CRC conflict T1": [0.3, 0.15]
    "SiS capacity W3: 90%+": [0.15, 0.4]
    "M absences W1: 19.7%": [0.25, 0.55]
    "No budget W5": [0.1, 0.35]
    "Recidivism evidence T4": [0.4, 0.2]
    "C isolated O4: 18/18 Nej": [0.55, 0.75]
```
