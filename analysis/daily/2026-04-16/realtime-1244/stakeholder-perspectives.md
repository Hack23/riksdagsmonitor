...
```mermaid
graph TB
    subgraph "🟢 PROPONENTS (145 Ja)"
        GOV["🏛️ Government (M+KD+L)<br/>82 Ja / 0 Nej / 19 Absent"]
        SD_S["🔵 SD (Support)<br/>59 Ja / 0 Nej / 11 Absent"]
        IND_J["⚪ Independent (Ja)<br/>4 Ja"]
        POLICE["👮 Law Enforcement<br/>Strong Support"]
    end
    
    subgraph "🔴 OPPONENTS (142 Nej)"
        S_P["🔴 S (Opposition)<br/>0 Ja / 88 Nej / 18 Absent"]
        V_P["🟣 V (Opposition)<br/>0 Ja / 18 Nej / 4 Absent"]
        C_P["🟢 C (Opposition)<br/>0 Ja / 18 Nej / 6 Absent"]
        MP_P["🌿 MP (Opposition)<br/>0 Ja / 15 Nej / 3 Absent"]
        IND_N["⚪ Independent (Nej)<br/>3 Nej"]
        CHILDREN["👶 Children's Rights<br/>Strong Opposition"]
    end
    
    GOV -->|"82 Ja"| PROP246["📜 Prop. 246<br/>Criminal Age 15→13"]
    SD_S -->|"59 Ja"| PROP246
    S_P -->|"88 Nej"| PROP246
...
```mermaid
quadrantChart
    title Stakeholder Power-Interest Grid — Prop. 246
    ...
    "Government M+KD+L (82 Ja)": [0.95, 0.95]
    "SD (59 Ja)": [0.90, 0.85]
    "S (88 Nej)": [0.85, 0.80]
    "V (18 Nej)": [0.80, 0.40]
    "C (18 Nej)": [0.65, 0.35]
    "MP (15 Nej)": [0.70, 0.25]
    "Police/Prosecution": [0.75, 0.55]
    "Children's Rights Orgs": [0.90, 0.30]
    "UN CRC Committee": [0.50, 0.20]
    "Municipalities (SKR)": [0.60, 0.45]
```
