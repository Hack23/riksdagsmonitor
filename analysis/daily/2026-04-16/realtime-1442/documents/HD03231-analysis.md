...
```mermaid
graph LR
    A["Prop 2025/26:231<br/>Ukraine Tribunal"] --> B{"Sensitivity"}
    B -->|"🟡 SENSITIVE"| D["International Security Policy"]
    A --> G{"Domain"}
    G --> H["Foreign Affairs / International Law"]
    A --> I{"Urgency"}
    I -->|"🟠 URGENT"| K["Formal response — weeks"]
