...
```mermaid
graph LR
    A["Prop 2025/26:232<br/>Damages Commission"] --> B{"Sensitivity"}
    B -->|"🟡 SENSITIVE"| D["International Compensation Law"]
    A --> G{"Domain"}
    G --> H["Foreign Affairs / Civil Law"]
    A --> I{"Urgency"}
    I -->|"🟠 URGENT"| K["Legislation required — weeks"]
