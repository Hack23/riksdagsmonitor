...
graph LR
    subgraph "Government Propositions"
        P229["prop. 229<br/>Mottagandelag"]
        P222["prop. 222<br/>Brottsofferersättning"]
        P215["prop. 215<br/>Bosättning"]
        P216["prop. 216<br/>Kommunal hälso-sjukvård"]
        P223["prop. 223<br/>Konsumentkreditlag"]
        P236["prop. 236<br/>Extra ändringsbudget"]
    end
    subgraph "Opposition Responses"
        S["S (5 motions)"]
        MP["MP (3 motions)"]
        V["V (2 motions)"]
        C["C (2 motions)"]
    ...
    C -->|mot.4089| P229
    C -->|mot.4088| P223
    style S fill:#EF5350,color:#FFFFFF
