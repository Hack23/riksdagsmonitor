...
```mermaid
graph TD
    S_THREAT["S Threat Vector:<br/>Fiscal & welfare dominance<br/>5 motions, senior politicians"]
    MP_THREAT["MP Threat Vector:<br/>Full rejection strategy<br/>3 motions, maximalist positions"]
    V_THREAT["V Threat Vector:<br/>Constitutional challenges<br/>2 motions, proportionality arguments"]
    C_THREAT["C Threat Vector:<br/>Centrist alternatives<br/>2 motions, market-oriented"]
    GOV["Government Agenda"]
    S_THREAT -->|"Highest threat"| GOV
    MP_THREAT -->|"Medium threat"| GOV
    V_THREAT -->|"Targeted threat"| GOV
    C_THREAT -->|"Low threat"| GOV
    style S_THREAT fill:#EF5350,color:#FFFFFF
