...
```mermaid
pie title Opposition Motions by Party (2026-04-15)
...
```mermaid
graph TD
    subgraph "Prop. 229: Mottagandelag (Asylum)"
        M4080["mot. 4080 (S)"]
        M4087["mot. 4087 (MP)"]
        M4089["mot. 4089 (C)"]
    end
    subgraph "Prop. 222: Brottsofferersättning"
        M4078["mot. 4078 (S)"]
        M4085["mot. 4085 (MP)"]
        M4084["mot. 4084 (V)"]
    end
    subgraph "Prop. 215: Bosättning"
        M4079["mot. 4079 (S)"]
        M4086["mot. 4086 (MP)"]
    end
    subgraph "Prop. 216: Hälso-sjukvård"
        M4081["mot. 4081 (S)"]
        M4083["mot. 4083 (V)"]
    end
    M4082["mot. 4082 (S) — Extra Budget"]
    M4088["mot. 4088 (C) — Konsumentkredit"]
    M4080 -.->|"Both oppose privatisation"| M4087
