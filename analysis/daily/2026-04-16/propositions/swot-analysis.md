...
> ⚠️ **No SWOT entries generated**: The automated data pipeline found 8 documents but could not extract SWOT contributions from metadata alone. Deep SWOT analysis requires AI-driven per-document analysis following `analysis/methodologies/political-swot-framework.md`.
