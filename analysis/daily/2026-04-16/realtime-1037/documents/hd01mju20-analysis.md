...
```mermaid
graph LR
    A["HD01MJU20<br/>MJU20"] --> B{"Sensitivity"}
    B -->|"🟡 SENSITIVE"| D["Government Performance Criticism"]
    A --> G{"Domain"}
...
```mermaid
quadrantChart
    title Political Impact — Climate Audit
    ...
    "Agrees with problems": [0.3, 0.4]
    "RR criticism as weapon": [0.8, 0.8]
    "Shelving strategy risk": [0.3, 0.2]
    "S separate opinion": [0.65, 0.5]
```
