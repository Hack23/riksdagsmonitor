...
```mermaid
graph LR
    A["HD01SkU23<br/>SkU23"] --> B{"Sensitivity"}
...
```mermaid
quadrantChart
    title Political Impact — EV Tax Exemption
    ...
    "Green transition signal": [0.3, 0.8]
    "V reservation - not enough": [0.7, 0.7]
    "Employer cost concern": [0.3, 0.3]
    "Limited to workplace only": [0.6, 0.5]
```
