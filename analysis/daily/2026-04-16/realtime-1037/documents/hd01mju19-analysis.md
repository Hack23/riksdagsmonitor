...
```mermaid
graph LR
    A["HD01MJU19<br/>MJU19"] --> B{"Sensitivity"}
    B -->|"🟢 PUBLIC"| E["Standard Parliamentary"]
    A --> G{"Domain"}
    G --> H["Environment + EU Compliance + Circular Economy"]
    A --> I{"Urgency"}
...
```mermaid
quadrantChart
    title Political Impact — Waste Reform
    ...
    "EU compliance achieved": [0.2, 0.8]
    "9 reservations - weak spots": [0.8, 0.7]
    "Municipal exemption criticism": [0.4, 0.3]
    "Fragmented opposition": [0.7, 0.3]
```
