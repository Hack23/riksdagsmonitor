...
```mermaid
graph TD
    subgraph "Risk Matrix — Likelihood x Impact"
        R1["🟡 Climate Governance<br/>L:Medium × I:High = 5/10"]
        R2["🟡 Environmental Opposition<br/>L:Medium × I:Medium = 4/10"]
        R3["🟢 EU Forestry Tension<br/>L:Low × I:High = 3/10"]
