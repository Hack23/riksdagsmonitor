...
```mermaid
graph TD
    subgraph "Environmental Policy Cluster"
        MJU19["🟢 MJU19<br/>Waste Reform<br/>9 reservations"]
        MJU20["🟡 MJU20<br/>Climate Audit<br/>RR criticism"]
        PROP242["🔵 Prop 242<br/>Forestry Regulation<br/>Industry vs. nature"]
    end
    subgraph "Fiscal/Green Transition"
        SKU23["🟢 SkU23<br/>EV Tax Exemption<br/>Cross-party support"]
    end
    subgraph "Digital Government"
        PROP244["🔵 Prop 244<br/>Interoperability<br/>Data sharing"]
    end
