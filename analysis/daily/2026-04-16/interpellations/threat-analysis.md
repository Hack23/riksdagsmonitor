...
```mermaid
flowchart LR
    A["Interpellation Filed"] --> B["Minister Must Respond
(4-week statutory deadline)"]
    B --> C{"Response Quality"}
    C -->|"Substantive"| D["Accountability Satisfied"]:::green
    C -->|"Evasive"| E["Media Scrutiny
Follow-up Questions"]:::yellow
