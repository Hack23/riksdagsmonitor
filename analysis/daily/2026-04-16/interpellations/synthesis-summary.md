...
```mermaid
flowchart TD
    S["S (Social Democrats)"]:::red
    SD["SD (Sweden Democrats)"]:::yellow
    C["C (Centre Party)"]:::green

    S -->|"Healthcare investment<br/>frs 2025/26:432"| Lann["Lann (KD)<br/>Healthcare"]:::blue
    S -->|"Tax system legitimacy<br/>frs 2025/26:433"| Svantesson["Svantesson (M)<br/>Finance"]:::blue
    S -->|"Housing crisis<br/>frs 2025/26:434"| Carlson["Carlson (KD)<br/>Infrastructure"]:::blue
    SD -->|"Free speech limits<br/>frs 2025/26:429"| Strömmer["Strömmer (M)<br/>Justice"]:::orange
