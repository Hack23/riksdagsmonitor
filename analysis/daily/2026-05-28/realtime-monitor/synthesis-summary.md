...
```mermaid
graph TD
    Budget["🏦 Fiscal/Security Cluster\nHD03275 Extra Budget\nHD03277 Utbetalningsmyndigheten"]:::fiscal
    Crime["⚖️ Crime/Justice Cluster\nHD03276 Online Recruitment\nHD01JuU35 Prison Abroad\nHD11848 Taxi Fraud\nHD11847 School Profit"]:::crime
    ...
    style Budget fill:#ff006e,stroke:#ff006e,color:#fff
    style Crime fill:#ffbe0b,stroke:#ffbe0b,color:#000
...
**Source diversity**: 23 documents from 7 MCP tools (2 new betänkanden discovered in improvement run at 14:21Z/14:34Z). Economic context: IMF WEO Apr-2026 (pre-warmed, vintage 1 month). Admiralty Code: A-2 for TU committee documents (full text retrieved); B2 for primary-source confirmed facts; C3 for analytical judgments.
