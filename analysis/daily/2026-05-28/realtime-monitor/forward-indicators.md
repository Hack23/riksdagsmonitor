# Forward Indicators — 28 May 2026 Riksdag Pulse
...
**Confidence**: HIGH — SD communications infrastructure is active; this question will be addressed publicly
...
**Confidence**: HIGH — Lagrådet referral is required by law for criminal code amendments
...
**Confidence**: HIGH — betänkande is registered, publication is imminent
...
**Confidence**: MEDIUM — depends on government communication speed
...
**Confidence**: HIGH — Polisförbundet has been publicly calling for this legislation
...
**Confidence**: MEDIUM (IMF July update is scheduled; content uncertain)
...
**Confidence**: HIGH — responses are legally required
...
**Confidence**: HIGH (polling release is scheduled)
