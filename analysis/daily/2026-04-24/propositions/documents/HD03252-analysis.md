...
- See [executive-brief.md](../executive-brief.md) §"HD03252" row.
- See [significance-scoring.md](../significance-scoring.md) for DIW methodology.
- See [risk-assessment.md](../risk-assessment.md) for integrated risk register touching HD03252.
- See [implementation-feasibility.md](../implementation-feasibility.md) for HD03252 delivery-risk lenses.
- See [forward-indicators.md](../forward-indicators.md) for dated indicators tied to HD03252.
