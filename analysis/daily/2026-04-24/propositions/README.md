# Propositions Analysis — 2026-04-24

**Effective coverage date**: 2026-04-23 (lookback from 2026-04-24)
**Riksmöte**: 2025/26
**Workflow**: `news-propositions`
**Analysis mode**: Run 1 (Analysis-only; articles follow in Run 2)
**Author byline**: James Pether Sörling
**Tier depth**: Standard (compressed for ~28-min MCP idle budget; 1:1 per-document coverage maintained)

## Documents covered (4)

| # | dok_id | Type | Ministry | Signed |
|---|--------|------|----------|--------|
| 1 | [HD03104](https://data.riksdagen.se/dokument/HD03104.html) — Skr. 2025/26:104 | Skrivelse (Written Communication) | Finansdepartementet | 2026-04-23 |
| 2 | [HD03252](https://data.riksdagen.se/dokument/HD03252.html) — Prop. 2025/26:252 | Proposition (Government Bill) | Justitiedepartementet | 2026-04-23 |
| 3 | [HD03253](https://data.riksdagen.se/dokument/HD03253.html) — Prop. 2025/26:253 | Proposition (Government Bill) | Finansdepartementet | 2026-04-23 |
| 4 | [HD03256](https://data.riksdagen.se/dokument/HD03256.html) — Prop. 2025/26:256 | Proposition (Government Bill) | Landsbygds- och infrastrukturdepartementet | 2026-04-23 |

## Artifact index (Families A+B+C+D + per-document)
...
The 23 April 2026 proposition bundle signals a **dual-track government agenda**: (1) **financial-stability institutionalisation** via the EU Banking Package (Prop. 2025/26:253) and the debt-management reporting cycle (Skr. 2025/26:104); (2) **Tidö-era criminal-justice operationalisation** via benefit restrictions for detainees (Prop. 2025/26:252) and tachograph-manipulation enforcement (Prop. 2025/26:256). The highest-weight item is Prop. 2025/26:253 (DIW 3.8 — systemic banking-regulation impact on 4 systemically-important banks).

## Confidence

**MEDIUM** overall — full text retrieved from Riksdagen API for all 4 documents; no committee votes yet (referral phase). Key judgments rest on published remiss bodies and government motivation text (Admiralty B2).
