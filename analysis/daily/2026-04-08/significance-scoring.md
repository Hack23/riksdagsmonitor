...
```mermaid
graph LR
    subgraph "Significance Assessment"
        HD["📄 HD03114<br/>Skr. 2025/26:114<br/>Strategic Export Control"]
        SC["📊 Score: 6/10<br/>Level: MEDIUM"]
        F1["🎖️ First post-NATO<br/>annual report"]
        F2["🏛️ UU committee<br/>oversight trigger"]
        F3["🌍 International<br/>transparency signal"]
    end
    HD --> SC
    SC --> F1
    SC --> F2
