...
```mermaid
flowchart TD
    A[20 Committee Reports] --> B{Policy Domain}
    B --> C[Defence & Security<br/>FöU12, FöU11, UU6]
    B --> D[Justice & Law<br/>JuU15, JuU16]
    B --> E[Climate & Environment<br/>MJU30, MJU18]
    B --> F[Healthcare & Social<br/>SoU16, SoU17, SoU19, SoU37, SfU18]
    B --> G[Economy & Housing<br/>CU18, CU17, NU17]
    B --> H[Governance & Culture<br/>KU38, KU31, KrU10, AU11, AU12]
    
    C --> I[Chamber Debate<br/>Pending]
    D --> I
    E --> I
    F --> I
    G --> I
