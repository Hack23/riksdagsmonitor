...
```mermaid
flowchart LR
    A[Threat Vectors] --> B[Legislative<br/>Responsiveness]
    A --> C[EU Sovereignty<br/>Tension]
    A --> D[Security-Liberty<br/>Balance]
    
    B --> B1[461 Motions<br/>Rejected]
    B --> B2[Broad Policy<br/>Areas Affected]
    
    C --> C1[SoU37<br/>Subsidiarity]
    C --> C2[MJU30<br/>Climate Targets]
