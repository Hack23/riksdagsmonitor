...
```mermaid
graph TD
    A["HD01NU18: Renewable Energy Permits"] --> B["Policy Domain: Energy & Climate"]
    A --> C["Legislative Type: Committee Report"]
    A --> D["EU Implementation: Directive 2018/2001"]
    B --> E["Wind Power Permits"]
    B --> F["Solar Energy Permits"]
    B --> G["Grid Connection"]
