...
```mermaid
graph TD
    A["HD11692: Emergency Police"] --> B["Policy Domain: Internal Security"]
    A --> C["Policy Domain: Total Defense"]
    A --> D["Reference: SOU 2025:57"]
    B --> E["Gang Crime Threat"]
    C --> F["Höjd Beredskap Capacity"]
