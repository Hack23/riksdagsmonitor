...
```mermaid
graph TD
    A["HD03230: Species Protection Compensation"] --> B["Policy Domain: Environment"]
    A --> C["Policy Domain: Property Rights"]
    A --> D["Legislative Type: Government Bill"]
    B --> E["Artskyddsförordningen"]
    C --> F["Landownership Rights"]
