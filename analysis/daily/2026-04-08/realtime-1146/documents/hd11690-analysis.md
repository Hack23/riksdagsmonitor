...
```mermaid
graph TD
    A["HD11690: Private Defense Actors"] --> B["Policy Domain: Defense & Security"]
    A --> C["International Context: Ukraine War"]
    A --> D["NATO Membership Context"]
    B --> E["Private Sector Defense Role"]
    C --> F["Drone Defense Innovation"]
    D --> G["Capability Gap Assessment"]
    E --> H["Question to Defense Minister"]
