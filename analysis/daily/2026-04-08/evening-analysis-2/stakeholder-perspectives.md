...
```mermaid
graph TD
    subgraph "Stakeholder Impact — 2026-04-08"
        CIT["Citizens<br/>Impact: MODERATE<br/>Healthcare + energy"]
        GOV["Government Coalition<br/>Impact: POSITIVE<br/>Legislative momentum"]
        OPP["Opposition Bloc<br/>Impact: MODERATE<br/>Accountability leverage"]
        BIZ["Business/Industry<br/>Impact: POSITIVE<br/>Permit streamlining"]
        CIV["Civil Society<br/>Impact: LOW-MODERATE<br/>Transparency demands"]
        INT["International/EU<br/>Impact: POSITIVE<br/>NATO + EU compliance"]
        JUD["Judiciary/Constitutional<br/>Impact: LOW<br/>No acute issues"]
        MED["Media/Public Opinion<br/>Impact: MODERATE<br/>Budget + audit narratives"]
    end
