...
```mermaid
graph TD
    subgraph "Parliamentary Activity — 2026-04-08"
        A["Committee Reports: 1<br/>NU18 Renewables Directive"] --> D["Legislative Pipeline"]
        B["Gov Propositions: 2<br/>HD03219 Dental Care<br/>HD03230 Species Protection"] --> D
        C["Written Questions: 8<br/>Defense, Healthcare,<br/>Environment, Democracy"] --> E["Accountability Signals"]
        F["Motions: 3<br/>HD024070-72 Sida<br/>Humanitarian Aid"] --> D
    end

    subgraph "Government Activity — 2026-04-07/08"
        G["Spring Budget 2026<br/>Presented Apr 7"] --> H["Fiscal Policy Signal"]
        I["NATO FM Meeting<br/>Sweden hosting May 21-22"] --> J["Security Alignment"]
        K["Healthcare Investment<br/>in Budget Amendment"] --> H
    end

    D --> L["Significance: MODERATE"]
    E --> L
    H --> L
    J --> L
