...
graph TD
    subgraph "STRENGTHS"
        S1["EU Directive Transposition<br/>NU18 Renewables Permits<br/>dok_id: HD01NU18"]
        S2["Spring Budget 2026<br/>Healthcare + STEM Investment"]
        S3["NATO Integration<br/>FM Meeting Host May 21-22"]
    end

    subgraph "WEAKNESSES"
        W1["Riksrevisionen: Dental Care<br/>dok_id: HD03219<br/>Implementation gaps"]
        W2["Riksrevisionen: Sida Aid<br/>dok_id: HD024070-72<br/>3 opposition motions"]
        W3["Defense Readiness<br/>dok_id: HD11690, HD11692<br/>Capability questions"]
    end

    subgraph "OPPORTUNITIES"
        O1["Green Transition<br/>Permit streamlining<br/>Investment unlock"]
        O2["Healthcare Reform<br/>Budget + audit pressure"]
        O3["STEM Workforce<br/>Government initiative"]
    end

    subgraph "THREATS"
        T1["Opposition Accountability<br/>Sida motions HD024070-72"]
        T2["Species Protection<br/>HD03230 landowner tensions"]
        T3["Democracy Transparency<br/>HD11693 Lobby register"]
    end
