...
```mermaid
graph LR
    subgraph "Scoring Dimensions (0-10)"
        D1["Legislative Impact<br/>Score: 6/10"]
        D2["Political Significance<br/>Score: 5/10"]
        D3["Public Interest<br/>Score: 6/10"]
        D4["Policy Innovation<br/>Score: 5/10"]
        D5["Democratic Accountability<br/>Score: 7/10"]
    end

    D1 --> CS["Composite: 5.8/10"]
    D2 --> CS
    D3 --> CS
    D4 --> CS
    D5 --> CS
