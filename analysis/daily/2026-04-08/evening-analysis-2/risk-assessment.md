...
```mermaid
graph TD
    subgraph "5×5 Risk Matrix — Likelihood (L) × Impact (I)"
        R1["R1: Policy Implementation<br/>L=3 × I=3 = 9<br/>Riksrevisionen gaps"]
        R2["R2: Electoral Risk<br/>L=3 × I=4 = 12<br/>Species protection backlash"]
        R3["R3: Coalition Stability<br/>L=2 × I=2 = 4<br/>Government cohesion"]
        R4["R4: Security/Defense<br/>L=2 × I=4 = 8<br/>NATO transition gaps"]
        R5["R5: Democratic Process<br/>L=2 × I=3 = 6<br/>Transparency demands"]
