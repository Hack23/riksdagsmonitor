...
```mermaid
graph TD
    A["Riksrevisionen<br/>Dental Care Audit"] --> B["Findings: Implementation<br/>gaps in tandvårdsstöd"]
    B --> C["Government Skrivelse<br/>Skr. 2025/26:219"]
    C --> D["SoU Committee<br/>Review"]
