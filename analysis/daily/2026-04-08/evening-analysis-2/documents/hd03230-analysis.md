...
```mermaid
graph TD
    A["EU Habitats Directive<br/>Species Protection"] --> B["Swedish artskydd<br/>regulations"]
    B --> C["Landowner restrictions<br/>on property use"]
    C --> D["Prop. 2025/26:230<br/>Compensation framework"]
    D --> E["Government: Balance<br/>conservation + rights"]
