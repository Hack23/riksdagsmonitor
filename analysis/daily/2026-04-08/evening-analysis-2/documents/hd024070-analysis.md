...
```mermaid
graph LR
    A["Riksrevisionen<br/>Sida Audit"] --> B["Skr. 2025/26:226<br/>Government Response"]
    B --> C["HD024070<br/>Motion 1"]
    B --> D["HD024071<br/>Motion 2"]
    B --> E["HD024072<br/>Motion 3"]
    C --> F["UU Committee<br/>Review"]
    D --> F
    E --> F
