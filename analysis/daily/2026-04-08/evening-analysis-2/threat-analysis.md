...
graph TD
    subgraph "Democratic Function Threats"
        T1["Legislative Integrity<br/>Severity: 2/5"]
        T2["Accountability Gap<br/>Severity: 3/5"]
        T3["Policy Coherence<br/>Severity: 2/5"]
        T4["Institutional Trust<br/>Severity: 2/5"]
        T5["Electoral Process<br/>Severity: 2/5"]
        T6["Security Governance<br/>Severity: 2/5"]
    end

    T1 --> |"HD01NU18 EU transposition<br/>compliance risk"| D1["EU regulatory alignment"]
    T2 --> |"HD03219 + HD024070-72<br/>Riksrevisionen findings"| D2["Audit-driven accountability"]
    T3 --> |"HD03230 conservation vs<br/>property rights tension"| D3["Policy contradiction"]
    T4 --> |"HD11693 lobby register<br/>HD11694 public trust"| D4["Transparency deficit"]
