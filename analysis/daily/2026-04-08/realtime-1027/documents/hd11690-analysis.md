...
```mermaid
graph LR
    A["HD11690<br/>Fr 2025/26:690"] --> B{"Sensitivity"}
    B -->|"🟡 SENSITIVE"| D["Defence Policy<br/>Private Sector Role"]
    
    A --> G{"Domain"}
    G --> H["Defence & Security<br/>Industrial Policy"]
    
    A --> I{"Urgency"}
    I -->|"🔵 ELEVATED"| L["Active policy debate<br/>NATO context"]
