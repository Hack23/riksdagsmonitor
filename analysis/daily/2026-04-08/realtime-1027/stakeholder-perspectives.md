...
```mermaid
graph TB
    subgraph "Government Coalition"
        M["M - Moderaterna<br/>Defence, Justice, Foreign"]
        KD["KD - Kristdemokraterna<br/>Healthcare"]
        L["L - Liberalerna<br/>Education, Climate"]
    end
    
    subgraph "Support Party"
        SD["SD - Sverigedemokraterna<br/>5 questions today"]
    end
    
    subgraph "Opposition"
        S["S - Socialdemokraterna<br/>Healthcare scrutiny"]
        V["V - Vänsterpartiet<br/>Climate equity"]
        C["C - Centerpartiet<br/>Aid oversight"]
    end
    
    SD -->|"Defence pressure ×3"| M
    SD -->|"Security vetting"| L
    SD -->|"Transparency"| M
    S -->|"Healthcare"| KD
    V -->|"EV premium"| L
    C -->|"Sida audit"| M
    
    style M fill:#1a6bc4,stroke:#424242,color:#FFFFFF
    style KD fill:#005ea1,stroke:#424242,color:#FFFFFF
    style L fill:#006ab3,stroke:#424242,color:#FFFFFF
    style SD fill:#dddd00,stroke:#424242,color:#000000
