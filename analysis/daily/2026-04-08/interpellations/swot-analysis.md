...
graph TD
    subgraph "🔍 Stakeholder Impact Matrix"
        CIT["👥 Citizens<br/>HIGH impact on rights"]
        GOV["🏛️ Government Coalition<br/>MEDIUM-HIGH internal tension"]
        OPP["⚔️ Opposition<br/>MEDIUM opportunity"]
        BIZ["💼 Business<br/>LOW impact"]
        CIV["🌐 Civil Society<br/>HIGH engagement trigger"]
        INT["🌍 International<br/>MEDIUM reputation risk"]
