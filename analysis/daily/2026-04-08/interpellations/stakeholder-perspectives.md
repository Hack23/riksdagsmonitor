...
```mermaid
graph TD
    subgraph SD_Strategy["SD Strategy"]
        A[SD Files Interpellations] --> B[Targets KD Minister Forssmed]
        A --> C[Targets M Minister Strömmer]
    end
    subgraph Coalition_Impact["Coalition Dynamics"]
        B --> D[Mosque Governance HD10430]
        C --> E[Assembly Rights HD10429]
        D --> F{Coalition Tension}
        E --> F
    end
    subgraph Stakeholder_Effects["Stakeholder Impact"]
        F --> G[Government: Internal pressure]
        F --> H[Opposition: Opportunity to exploit]
