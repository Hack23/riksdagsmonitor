...
```mermaid
graph TD
    subgraph "🔍 SD Interpellation Strategy — 2026-04-07"
        A["SD files 2 interpellations"] --> B["HD10430: Hate speech in mosques"]
        A --> C["HD10429: Freedom of expression vs Prop 133"]
        B --> D["Target: Social Minister Forssmed (KD)"]
        C --> E["Target: Justice Minister Strömmer (M)"]
        D --> F["Response due: 2026-04-24"]
        E --> G["Response due: 2026-04-27"]
