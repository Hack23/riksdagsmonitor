...
```mermaid
graph TD
    subgraph "HD10430 Accountability Chain"
        A["Expressen exposé:<br/>Imam hate speech"] --> B["SD's Jomshof<br/>files ip 2025/26:430"]
        B --> C["Social Minister<br/>Forssmed (KD)"]
        C --> D{"Response by<br/>2026-04-24?"}
