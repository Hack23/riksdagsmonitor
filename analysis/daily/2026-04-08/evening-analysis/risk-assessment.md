...
```mermaid
graph TD
    subgraph "Risk Heat Map — L×I Scoring"
        R1["Renewable Permit Delay<br/>L:3 × I:4 = 12"]
        R2["Landowner Backlash<br/>L:3 × I:3 = 9"]
        R3["Dental Care Reform Resistance<br/>L:2 × I:3 = 6"]
        R4["Coalition Humanitarian Aid Tension<br/>L:2 × I:2 = 4"]
