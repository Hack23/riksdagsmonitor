...
```mermaid
graph LR
    subgraph "2026-04-08 Parliamentary Activity"
        A[Committee Reports: 1] --> B[Key: NU18 Renewable Energy]
        C[Propositions: 2] --> D[Species Protection Prop 230]
        C --> E[Dental Care Audit Skr 219]
        F[Motions: 3] --> G[Sida Humanitarian Aid x3]
