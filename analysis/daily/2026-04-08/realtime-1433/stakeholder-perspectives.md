...
graph TD
    subgraph "👥 Stakeholder Impact — 2026-04-08"
        GOV["🏛️ Government (M, KD, L)<br/>Impact: MEDIUM<br/>Direction: Mixed<br/>Delivering on energy/environment<br/>but facing SD defense pressure"]
        SD["🗳️ SD (Support Party)<br/>Impact: MEDIUM<br/>Direction: Active<br/>6 written questions today<br/>3 targeting defense"]
        OPP["⚖️ Opposition (S, V, MP)<br/>Impact: LOW<br/>Direction: Probing<br/>Healthcare (S) + EV equity (V)"]
        PUB["🏘️ Public<br/>Impact: MEDIUM<br/>Direction: Neutral<br/>Dental care audit + species compensation"]
        BIZ["🏭 Business/Landowners<br/>Impact: MEDIUM<br/>Direction: Positive<br/>Species protection compensation"]
        INT["🌍 International<br/>Impact: MEDIUM<br/>Direction: Positive<br/>EU compliance + NATO hosting"]
    end
