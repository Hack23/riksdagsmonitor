...
```mermaid
graph TD
    subgraph "💪 Government Strengths"
        S1["S1: EU Compliance<br/>Delivering renewable energy<br/>permitting reform (NU18)<br/>🟢 Evidence: HD01NU18"]
        S2["S2: Property Rights<br/>Species protection<br/>compensation (Prop 230)<br/>🟢 Evidence: HD03230"]
...
```mermaid
graph TD
    subgraph "⚠️ Government Weaknesses"
        W1["W1: Defense-Environment Conflict<br/>Environmental permits blocking<br/>military operations<br/>🟠 Evidence: HD11689"]
        W2["W2: Preparedness Gap<br/>Reserve police force<br/>not established despite SOU<br/>🟡 Evidence: HD11692"]
...
graph TD
    subgraph "🔴 Political Threats"
        T1["T1: SD Defense Pressure<br/>Coordinated 3-question cluster<br/>challenges coalition partner M<br/>🟠 Evidence: HD11690,89,92"]
        T2["T2: Opposition Healthcare<br/>S probing healthcare quality<br/>register vulnerabilities<br/>🟡 Evidence: HD11687"]
...
```mermaid
graph LR
    subgraph "TOWS Matrix"
        SO["SO (Maxi-Maxi)<br/>Use EU compliance strength (S1)<br/>+ NATO hosting (O2) to<br/>demonstrate international credibility"]
        WO["WO (Mini-Maxi)<br/>Resolve defense-environment<br/>conflict (W1) before<br/>NATO hosting (O2)"]
        ST["ST (Maxi-Mini)<br/>Leverage transparency initiative (S3)<br/>to counter SD pressure (T1)<br/>on defense accountability"]
