...
graph TD
    subgraph "📊 Daily Political Intelligence Dashboard"
        ...
        subgraph "⚖️ Risk"
            RSK["Overall Risk<br/>MEDIUM<br/>Top: Defense readiness vs environmental permits"]
        end
        subgraph "🎭 Threat"
            THR["Threat Level<br/>MODERATE<br/>Top Category: AC — Accountability"]
        end
        subgraph "📈 Significance"
            SIG["Top Significance<br/>5.5/10<br/>Monitor"]
        end
    end

    subgraph "🎯 Editorial Decision"
        DEC{Article Decision}
        DEC -->|"Medium significance"| MON["📋 Analysis Only"]
    end
...
graph LR
    subgraph "🏛️ Government Coalition Assessment"
        GS["✅ Strengths<br/>3 entries<br/>Dominant: Policy delivery on energy and species protection"]
        GW["⚠️ Weaknesses<br/>3 entries<br/>Critical: Defense readiness gaps exposed by SD"]
        GO["🚀 Opportunities<br/>2 entries<br/>Top: Lobby transparency legislation"]
        GT["🔴 Threats<br/>3 entries<br/>Top: SD defense pressure on coalition partner"]
    end
