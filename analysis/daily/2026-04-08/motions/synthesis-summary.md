...
```mermaid
pie title Opposition Motion Activity by Party (Recent Period)
    "MP (Miljöpartiet)" : 11
    "S (Socialdemokraterna)" : 8
    "C (Centerpartiet)" : 8
    "V (Vänsterpartiet)" : 1
    "SD (Sverigedemokraterna)" : 1
```
...
```mermaid
graph TD
    subgraph "Coordinated Opposition Fronts"
        A["Education Reform<br/>S + C + MP aligned"] --> E["3 parties challenging<br/>grading system"]
        B["Cash Payment<br/>S + C + MP aligned"] --> F["3 parties demanding<br/>broader cash rights"]
        C["Hunting Legislation<br/>MP + V aligned"] --> G["Environmental bloc<br/>opposing prop. 2025/26:211"]
