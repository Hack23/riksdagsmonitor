...
```mermaid
graph LR
    A["mot. 2025/26:4070"] --> B{"Sensitivity"}
    B -->|"🟡 SENSITIVE"| D["Policy Delivery Risk"]
    
    A --> G{"Domain"}
    G --> H["Foreign Affairs & International Development"]
...
```mermaid
quadrantChart
    title Political Risk Matrix — mot. 2025/26:4070
    ...
    quadrant-3 Accept
    quadrant-4 Mitigate
    "Aid policy reversal": [0.35, 0.70]
    "Coalition tension on UNRWA": [0.55, 0.60]
    "Embassy reopening demand": [0.25, 0.45]
    "Ukraine fund adoption": [0.40, 0.55]
```
