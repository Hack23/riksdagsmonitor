...
graph TD
    subgraph "Democratic Function Threat Categories"
        A["Legislative Effectiveness"] --> A1["Coordinated opposition<br/>may slow reform pace"]
        B["Accountability & Oversight"] --> B1["Riksrevisionen findings<br/>demand formal response"]
        C["Rule of Law"] --> C1["Prison abroad proposal<br/>raises rights concerns"]
