...
```mermaid
graph TD
    subgraph "Stakeholder Impact — Skr. 2025/26:114"
        direction LR
        GOV["🏛️ Government<br/>Impact: HIGH<br/>Demonstrates responsible<br/>NATO member stewardship"]
        OPP["⚔️ Opposition<br/>Impact: MEDIUM<br/>Scrutiny opportunity<br/>on export destinations"]
        COM["📋 UU Committee<br/>Impact: HIGH<br/>Primary oversight body<br/>for export control"]
        IND["🏭 Defence Industry<br/>Impact: MEDIUM<br/>Market access and<br/>regulatory clarity"]
