...
```mermaid
graph TD
    subgraph "Daily Political Intelligence Dashboard — 2026-04-08"
        direction TB
        subgraph "Document Overview"
            D1["📄 Skr. 2025/26:114<br/>Strategic Export Control 2025<br/>dok_id: HD03114"]
        end
        subgraph "Classification"
            C1["🔒 Sensitivity: PUBLIC"]
            C2["🏷️ Domain: Defence & Security"]
            C3["⚡ Urgency: ROUTINE"]
        end
        subgraph "Risk Assessment"
            R1["🟢 Coalition Risk: LOW (4/100)"]
            R2["🟡 Scrutiny Risk: MEDIUM"]
            R3["🟢 Overall: LOW"]
        end
        subgraph "Significance"
            S1["📊 Score: 6/10 MEDIUM"]
            S2["🎯 First post-NATO export report"]
        end
        D1 --> C1
        D1 --> C2
        C2 --> R1
