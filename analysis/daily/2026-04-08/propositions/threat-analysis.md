...
```mermaid
graph TD
    subgraph "Threat Analysis — Strategic Export Control"
        direction TB
        T1["🟡 Democratic Oversight<br/>Severity: MEDIUM"] --> T1a["Skrivelse limits<br/>parliamentary response"]
        T2["🟢 Policy Capture<br/>Severity: LOW"] --> T2a["Defence industry lobbying<br/>within normal parameters"]
