...
generated_at: 2026-06-11T08:12:02.231Z
language: en
layout: article
---
## What Happened
...
1. **Justice Minister Strömmer (M)**: Must operationalise "eradicate gang crime in 4 years" before Riksdag document #10458 (HD10458) answer-date 2026-05-19 — or face credibility damage going into election campaign
...
```mermaid
graph TD
    A[S: Criminal Economy\nHD10458 + HD10451] -->|352 GSEK ESO figure| B[Government accountability gap\npre-election]
    C[SD: Institutional Reform\nHD10459] -->|Intra-coalition pressure| D[Tidökooalitionen\ninternal tension]
    E[S: ESA Space Decline\nHD10461] -->|Rank 17 of 23| F[Competitiveness narrative]
    B --> G[2026 Election Battleground]
    D --> G
    F --> G
...
```mermaid
mindmap
  root(Swedish Security & Governance 2026)
    Criminal Economy
      352 GSEK / 5.5% GDP
      23000 linked companies
      Gang violence / explosions
    Institutional Reform
      Agency activism dispute
      Utnämningsmakt demand
      Intra-coalition SD/KD friction
    Industrial Competitiveness
      ESA rank 17 of 23
      100 MSEK vs requested higher
      Nordic peers surpassing Sweden
    Electoral Positioning
      S building crime narrative
      SD pressure within coalition
      2026 election battleground
      
    style root fill:#003087,color:#fff
```
...
```mermaid
graph LR
    HD10458["HD10458\nGang crime pledge\nCarvalho (S)→Strömmer (M)"] 
    HD10451["HD10451\n352 GSEK criminal economy\nNylund Watz (S)→Strömmer (M)"]
    HD10461["HD10461\nESA rank 17/23\nWiking (S)→Edholm (L)"]
    HD10459["HD10459\nAgency activism\nFransson (SD)→Slottner (KD)"]
    HD10460["HD10460\nSFV heritage\nLundberg (SD)→Brandberg (L)"]
    ESO["ESO Report\n352 GSEK / 23,000 companies"]
    RiR["RiR 2025:30\nSFV bidragsfastigheter"]
    
    HD10458 -->|"Same minister target\n(Strömmer)"| HD10451
    HD10458 -->|"Both cite ESO data"| ESO
    HD10451 -->|"Cites same ESO report"| ESO
    HD10460 -->|"Based on audit findings"| RiR
    HD10458 -->|"Same party (S)\ncoordinated campaign"| HD10461
    HD10459 -->|"Both SD\naccountability"| HD10460
    
    style HD10458 fill:#E60026,color:#fff
    style HD10451 fill:#E60026,color:#fff
    style HD10461 fill:#E60026,color:#fff
    style HD10459 fill:#DDDD00,color:#000
    style HD10460 fill:#DDDD00,color:#000
    style ESO fill:#003087,color:#fff
    style RiR fill:#003087,color:#fff
```
