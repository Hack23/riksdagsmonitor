...
```mermaid
graph TD
    subgraph "Stakeholder Impact Radar"
        PROP["3 Propositions<br/>HD03214, HD03228, HD03235"]
        CIT["🏘️ Citizens<br/>MEDIUM Impact"]
        GOV["🏛️ Government<br/>HIGH Impact"]
        OPP["🗳️ Opposition<br/>MEDIUM Impact"]
        BIZ["🏭 Business<br/>HIGH Impact"]
        CIV["🤝 Civil Society<br/>MEDIUM Impact"]
        INT["🌍 International<br/>HIGH Impact"]
    end
    PROP --> CIT
    PROP --> GOV
    PROP --> OPP
