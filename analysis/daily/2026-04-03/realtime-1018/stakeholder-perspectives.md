...
```mermaid
graph TD
    subgraph "👥 Stakeholder Impact Map — Defense & Criminal Justice Package"
        CIT["👤 Citizens<br/>Impact: HIGH"]
        GOV["🏛️ Government<br/>Coalition<br/>Impact: HIGH"]
        OPP["⚔️ Opposition<br/>Impact: MEDIUM"]
        BUS["💼 Business/<br/>Industry<br/>Impact: HIGH"]
        CIV["🤝 Civil<br/>Society<br/>Impact: MEDIUM"]
        INT["🌍 International<br/>/ EU<br/>Impact: HIGH"]
        JUD["⚖️ Judiciary<br/>Impact: MEDIUM"]
        MED["📰 Media<br/>Impact: HIGH"]
    end
    ...
    style CIT fill:#7b2d8e,color:#fff
