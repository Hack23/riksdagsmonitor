...
```mermaid
graph LR
    A["HD03228<br/>War Materials"] --> B{Sensitivity}
    B -->|"🟡 SENSITIVE"| D["Defense Industry:<br/>Export control reform"]

    A --> G{Domain}
    G --> H["Defense & Trade<br/>DEF-TRD"]

    A --> I{Urgency}
    I -->|"🔵 ELEVATED"| L["Active legislative<br/>processing"]
