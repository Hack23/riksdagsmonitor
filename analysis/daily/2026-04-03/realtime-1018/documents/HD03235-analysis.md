...
graph LR
    ...
    B -->|"🟡 SENSITIVE"| D["Policy Delivery Risk:<br/>Tidö Agreement compliance"]

    A --> G{Domain}
    G --> H["Criminal Justice / Migration<br/>CRI-MIG cross-domain"]

    A --> I{Urgency}
    I -->|"🟠 URGENT"| K["Committee referral<br/>expected within weeks"]
