...
graph LR
    ...
    B -->|"🟡 SENSITIVE"| D["National Security:<br/>Critical infrastructure protection"]

    A --> G{Domain}
    G --> H["Defense & Security<br/>DEF-CYB"]

    A --> I{Urgency}
    I -->|"🔵 ELEVATED"| L["Monitoring — active<br/>legislative processing"]
