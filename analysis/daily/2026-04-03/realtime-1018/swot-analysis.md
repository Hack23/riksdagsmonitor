...
```mermaid
graph TD
    subgraph "📊 Political SWOT Landscape — 2026-04-03"
        direction TB
        subgraph "✅ Strengths (Internal Positive)"
            S1N["💪 S1: Defense modernization<br/>package coherence"]
            S2N["💪 S2: Tidö Agreement<br/>criminal justice delivery"]
        end
        subgraph "⚠️ Weaknesses (Internal Negative)"
            W1N["⚡ W1: Implementation<br/>capacity strain"]
            W2N["⚡ W2: Prison<br/>overcrowding crisis"]
        end
        subgraph "🚀 Opportunities (External Positive)"
            O1N["🌟 O1: NATO framework<br/>for cooperation"]
            O2N["🌟 O2: Public defense<br/>spending support"]
        end
        subgraph "🔴 Threats (External Negative)"
            T1N["☁️ T1: EU legal<br/>challenge risk"]
            T2N["☁️ T2: 'No capacity'<br/>opposition narrative"]
        end
    end
