...
```mermaid
flowchart TD
    A["Political Threat<br/>Landscape Q2 2026"] --> B["Democratic<br/>Accountability"]
    A --> C["Policy<br/>Implementation"]
    A --> D["International<br/>Legal Risk"]
    
    B --> B1["Arms export oversight<br/>Transparency gaps"]
    B --> B2["Criminal justice<br/>Proportionality debate"]
    
    C --> C1["Multi-reform overload<br/>5+ major reforms"]
    C --> C2["Municipal capacity<br/>Civil defense gaps"]
