...
```mermaid
flowchart LR
    A["Government<br/>Coalition<br/>M+KD+L"] --> B["HIGH Impact<br/>Reform delivery"]
    C["SD<br/>Support Party"] --> D["HIGH Impact<br/>Crime/migration win"]
    E["S<br/>Main Opposition"] --> F["MEDIUM Impact<br/>Difficult positioning"]
    G["V + MP<br/>Left Opposition"] --> H["HIGH Impact<br/>Anti-arms narrative"]
    I["Defense Industry<br/>Saab, BAE, SISU"] --> J["HIGH Impact<br/>SEK 8.7B revenue"]
    K["Citizens"] --> L["MEDIUM Impact<br/>Security + fiscal cost"]
    ...
    style I fill:#616161,stroke:#424242,color:#FFFFFF
    style K fill:#00d9ff,stroke:#424242,color:#000000
    style M fill:#ff6600,stroke:#424242,color:#FFFFFF
    style O fill:#7B1FA2,stroke:#424242,color:#FFFFFF
```
