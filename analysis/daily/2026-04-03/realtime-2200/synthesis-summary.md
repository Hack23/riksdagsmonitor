...
```mermaid
mindmap
  root((Swedish Defense<br/>& Security Surge<br/>April 2026))
    Defense Procurement
      GUTE II Contract<br/>SEK 8.7B
      Saab + BAE Systems
      Counter-drone focus
      Anti-UAV capability
    Legislative Reform
      Prop 228: War Material
      Prop 214: Cybersecurity
      FöU12: Civilian Protection
    Criminal Justice
      Prop 235: Deportation
      JuU15: Prison Reform
      HD03213: Honor Violence
    International
      NATO Norfolk Visit
      Pentagon Meetings
...
```mermaid
flowchart TD
    A["Defense Spending Surge<br/>SEK 8.7B+ GUTE II"] --> B["Budget Pressure<br/>L×I: 12"]
    A --> C["Industrial Capacity<br/>L×I: 9"]
    D["Criminal Justice Reform<br/>HD03235 + JuU15"] --> E["ECHR Challenge<br/>L×I: 12"]
    D --> F["Political Polarization<br/>L×I: 9"]
    B --> G["Pre-Election<br/>Budget Debate"]
    E --> G
    F --> G
