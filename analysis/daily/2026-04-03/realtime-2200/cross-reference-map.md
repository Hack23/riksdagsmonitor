...
```mermaid
flowchart TD
    A["GUTE-II<br/>SEK 8.7B Air Defense"] ---|"Procurement enables"| B["HD03228<br/>War Material Reform"]
    A ---|"Defense cluster"| C["HD03214<br/>Cybersecurity Center"]
    A ---|"Total defense"| D["HD01FöU12<br/>Civilian Protection"]
    B ---|"Export framework"| C
