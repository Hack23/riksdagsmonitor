...
```mermaid
flowchart TD
    A["FöU12: Civilian<br/>Protection Report"] --> B["Shelter Capacity<br/>Expansion"]
    A --> C["Evacuation<br/>Planning Reform"]
    A --> D["Civilian Resilience<br/>Programs"]
    B --> E["Municipal<br/>Implementation"]
    C --> F["Total Defense<br/>Integration"]
    D --> F
    E --> G{"Funding<br/>Adequate?"}
