...
```mermaid
flowchart LR
    A["Prop 235<br/>Stricter Deportation"] --> B["Lowered Crime<br/>Thresholds"]
    A --> C["Expanded Mandatory<br/>Removal Categories"]
    B --> D["More Deportation<br/>Orders Issued"]
    C --> D
    D --> E{"Return Agreements<br/>in Place?"}
    E -->|"Yes"| F["Effective<br/>Enforcement"]
