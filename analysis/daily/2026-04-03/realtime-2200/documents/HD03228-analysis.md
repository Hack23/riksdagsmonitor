...
```mermaid
flowchart LR
    A["Prop 228<br/>War Material Reform"] --> B["Relaxed Export Rules"]
    A --> C["Modernized Manufacturing"]
    B --> D["NATO Allied Exports<br/>Facilitated"]
    B --> E["Human Rights<br/>Safeguards Maintained?"]
    C --> F["GUTE II Production<br/>Enabled"]
    D --> G["Defense Industry<br/>Revenue Growth"]
    E -->|"L pressure"| H["Coalition Tension"]
    E -->|"V/MP attack"| I["Parliamentary Debate"]
    ...
    style I fill:#ff006e,stroke:#333,color:#000
```
