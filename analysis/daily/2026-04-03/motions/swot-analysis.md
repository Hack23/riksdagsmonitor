...
```mermaid
quadrantChart
    title Government Coalition Position
    x-axis "Vulnerability" --> "Resilience"
    y-axis "Short-term" --> "Long-term"
    quadrant-1 "Opportunities"
    quadrant-2 "Strengths"
    quadrant-3 "Threats"
    quadrant-4 "Weaknesses"
    "Broad reform agenda": [0.8, 0.7]
    "Coalition discipline 88%": [0.7, 0.8]
    "Education policy scope": [0.4, 0.6]
    "Housing market divide": [0.3, 0.4]
    "Multi-front opposition": [0.3, 0.3]
    "Welfare sanctions controversy": [0.2, 0.5]
```
...
flowchart TB
    subgraph Internal["Internal Factors"]
        S["💪 Strengths<br/>• Cross-party education alignment<br/>• MP activity volume (40%)<br/>• Coalition voting discipline"]
        W["⚠️ Weaknesses<br/>• V isolated on justice<br/>• S alone on housing<br/>• Fragmented committee spread"]
    end
    subgraph External["External Factors"]
        O["🌟 Opportunities<br/>• Rural 4-party convergence<br/>• Education reform pushback<br/>• Welfare state defense unity"]
        T["🔴 Threats<br/>• Reactive-only positioning<br/>• 11-committee dilution<br/>• Government sets all agendas"]
    end
    S ---|"Leverage"| O
    W ---|"Address"| T
    S ---|"Defend"| T
