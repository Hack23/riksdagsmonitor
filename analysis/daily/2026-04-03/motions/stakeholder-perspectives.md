...
```mermaid
flowchart LR
    subgraph Stakeholders["8 Stakeholder Groups"]
        CIT["👥 Citizens<br/>Impact: HIGH"]
        GOV["🏛️ Government Coalition<br/>Impact: MEDIUM"]
        OPP["⚔️ Opposition Bloc<br/>Impact: HIGH"]
        BIZ["💼 Business/Industry<br/>Impact: LOW"]
        CIV["🤝 Civil Society<br/>Impact: MEDIUM"]
        INT["🌐 International/EU<br/>Impact: LOW"]
