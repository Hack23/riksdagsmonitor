...
```mermaid
flowchart TB
    subgraph Threats["Political Threat Assessment"]
        NI["Narrative Integrity<br/>Severity: 2/5"]
        LI["Legislative Integrity<br/>Severity: 3/5"]
        AC["Accountability<br/>Severity: 2/5"]
        TR["Transparency<br/>Severity: 3/5"]
