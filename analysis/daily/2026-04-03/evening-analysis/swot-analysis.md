...
graph TB
    subgraph "Government SWOT"
        GS["🟢 S: Defense investment<br/>Cybersecurity<br/>Law & order"]
        GW["🔴 W: Constitutional tension<br/>Policy overload<br/>Fiscal strain"]
        GO["🔵 O: EU leadership<br/>Pre-election narrative<br/>Cross-party defense"]
        GT["🟡 T: Immigration polarization<br/>Arms export ethics<br/>Energy market failure"]
    end
    subgraph "Opposition SWOT"
        OS["🟢 S: Active motions<br/>Education equity"]
        OW["🔴 W: No defense counter<br/>Fragmented response"]
