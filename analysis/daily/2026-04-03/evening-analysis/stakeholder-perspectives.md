...
```mermaid
graph TB
    CENTER[April 3 2026<br/>Policy Developments] --> CIT[👥 Citizens]
    CENTER --> GOV[🏛️ Government Coalition]
    CENTER --> OPP[⚔️ Opposition Bloc]
    CENTER --> BIZ[💼 Business/Industry]
    CENTER --> CIV[🏘️ Civil Society]
    CENTER --> INT[🌍 International/EU]
    CENTER --> JUD[⚖️ Judiciary/Constitutional]
    CENTER --> MED[📰 Media/Public Opinion]
    CIT -->|"Mixed impact"| CIT1[Electricity subsidy<br/>positive]
    CIT -->|"Divisive"| CIT2[Deportation debate]
    GOV -->|"Strong"| GOV1[Defense narrative<br/>dominance]
    OPP -->|"Reactive"| OPP1[Motion filing<br/>education focus]
    BIZ -->|"Positive"| BIZ1[Arms export<br/>regulation reform]
