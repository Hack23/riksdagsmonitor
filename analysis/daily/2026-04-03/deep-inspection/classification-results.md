...
```mermaid
graph LR
    A["HD03214<br/>Proposition"] --> B{"Sensitivity"}
    B -->|"🟡 SENSITIVE"| C["Defense & Cybersecurity<br/>National security implications"]
    
    A --> D{"Domain"}
    D --> E["Defense & Cybersecurity<br/>Primary: National defense<br/>Secondary: Digital infrastructure"]
    
    A --> F{"Urgency"}
    F -->|"🟠 URGENT"| G["Legislative action required<br/>FöU committee referral pending"]
