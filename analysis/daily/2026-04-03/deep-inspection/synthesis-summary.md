...
```mermaid
graph TD
    subgraph "📊 Deep Inspection Intelligence Dashboard — 2026-04-03"
        direction TB
        subgraph "🔒 Sensitivity"
            SEN["🟡 SENSITIVE<br/>Defense & Cybersecurity"]
        end
        subgraph "⚖️ Risk Level"
            RSK["🟢 LOW<br/>Coalition score: 4/100"]
        end
        subgraph "🎭 Threat Level"
            THR["🟡 MEDIUM<br/>Implementation complexity"]
        end
        subgraph "📈 Significance"
            SIG["🟠 HIGH<br/>Score: 7/10"]
        end
        subgraph "👥 Stakeholder Impact"
            STK["🟠 HIGH<br/>Defense industry + NATO"]
        end
    end
