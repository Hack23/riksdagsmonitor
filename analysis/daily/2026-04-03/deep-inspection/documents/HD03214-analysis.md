...
```mermaid
flowchart TD
    A["Prop 214<br/>Cybersecurity Center"] --> B["Expanded Authority"]
    A --> C["Threat Intelligence<br/>Sharing Framework"]
    B --> D["Inter-agency<br/>Coordination<br/>FRA + MSB + SÄPO"]
    C --> E["NATO Cyber<br/>Defense Integration"]
    D --> F{"Implementation<br/>Challenges?"}
