...
```mermaid
quadrantChart
    title Political Risk Matrix — Cybersecurity Center Reform
    ...
    quadrant-3 "Accept"
    quadrant-4 "Mitigate"
    "R3: Underfunding": [0.6, 0.8]
    "R1: Agency turf wars": [0.6, 0.6]
    "R2: Privacy backlash": [0.4, 0.6]
    "R4: Threat outpaces law": [0.7, 0.7]
    "R5: NATO misalignment": [0.2, 0.5]
```
...
```mermaid
graph LR
    subgraph "Risk Evolution — Cybersecurity Center Reform"
        R3_NOW["R3: Underfunding<br/>L×I = 12 ↑"] --> R3_NEXT["Budget debate<br/>Q4 2026"]
        R4_NOW["R4: Threat pace<br/>L×I = 12 ↑"] --> R4_NEXT["NATO review<br/>2026"]
