...
```mermaid
graph TD
    subgraph "🎭 Political Threat Taxonomy — Cybersecurity Center Reform"
        A["HD03214<br/>Cybersecurity Center"] --> B["Democratic Process"]
        A --> C["Policy Execution"]
        A --> D["Public Trust"]
        A --> E["Institutional Integrity"]
        A --> F["Coalition Stability"]
        A --> G["External Influence"]
        
        B --> B1["Privacy vs. Security balance<br/>Severity: 2/5"]
        C --> C1["Inter-agency coordination<br/>Severity: 3/5"]
        C --> C2["Underfunding risk<br/>Severity: 3/5"]
        D --> D1["Surveillance overreach perception<br/>Severity: 2/5"]
        E --> E1["Agency mandate overlap<br/>Severity: 2/5"]
        F --> F1["V/MP privacy objections<br/>Severity: 1/5"]
