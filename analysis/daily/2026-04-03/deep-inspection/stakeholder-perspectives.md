...
```mermaid
graph TD
    subgraph "👥 Stakeholder Impact — Cybersecurity Center Reform"
        direction TB
        A["HD03214<br/>Cybersecurity Center"] --> C["🟢 Citizens<br/>MEDIUM Impact"]
        A --> G["🟢 Government Coalition<br/>MEDIUM Impact"]
        A --> O["🟢 Opposition<br/>LOW Impact"]
        A --> B["🟠 Business/Industry<br/>HIGH Impact"]
        A --> I["🟠 International/NATO<br/>HIGH Impact"]
