...
graph TB
    subgraph "STRENGTHS 💪"
        S1["S1: 8.7B SEK GUTE II<br/>NATO credibility"]
        S2["S2: Defense Triad<br/>Strategic coherence"]
        S3["S3: Tidö Delivery<br/>SD support maintained"]
    end
    
    subgraph "WEAKNESSES ⚠️"
        W1["W1: 6.3B uncommitted<br/>Execution risk"]
        W2["W2: 2027-28 delivery<br/>Capability gap"]
        W3["W3: L tension<br/>Migration policy"]
    end
    
    subgraph "OPPORTUNITIES 🚀"
        O1["O1: NATO positioning<br/>Alliance credibility"]
        O2["O2: Bipartisan cyber<br/>Easy passage"]
        O3["O3: Industry jobs<br/>Saab/BAE contracts"]
    end
    
    subgraph "THREATS 🔴"
        T1["T1: Social spending<br/>Opposition framing"]
        T2["T2: Geopolitical<br/>escalation risk"]
