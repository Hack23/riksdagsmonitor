...
```mermaid
graph TB
    subgraph "Defense & Security"
        D1["🛡️ GUTE II Deal<br/>SENSITIVE / URGENT<br/>Defense Procurement"]
        D2["🏗️ FöU12<br/>SENSITIVE / URGENT<br/>Civil Defense"]
        D3["💻 Prop 214<br/>SENSITIVE / URGENT<br/>Cybersecurity"]
    end
    
    subgraph "Criminal Justice"
        C1["⚖️ Prop 235<br/>SENSITIVE / URGENT<br/>Migration-Crime Nexus"]
        C2["🏛️ JuU15<br/>PUBLIC / ELEVATED<br/>Correctional Services"]
    end
    
    subgraph "Social Policy"
        S1["💡 Elstöd DS<br/>PUBLIC / ROUTINE<br/>Consumer Support"]
