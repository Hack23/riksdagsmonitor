...
graph TD
    subgraph "External Threats"
        ET1["🔴 Geopolitical Escalation<br/>Drone warfare evolution"]
        ET2["🟡 Cyber Attacks<br/>State-sponsored threats"]
        ET3["🟡 NATO Expectations<br/>Alliance commitment demands"]
    end
    
    subgraph "Internal Political Threats"
        IT1["🟡 Coalition Fragmentation<br/>L party on migration"]
        IT2["🟢 Opposition Framing<br/>Defense vs. social spending"]
        IT3["🟡 Implementation Failure<br/>Announced vs. delivered"]
    end
    
    subgraph "Institutional Threats"
        IN1["🟡 Constitutional Challenge<br/>Prop 235 ECHR risk"]
        IN2["🟡 Capacity Constraints<br/>Prison/cyber workforce"]
    end
