...
```mermaid
graph TB
    subgraph "Strongly Positive"
        A["🏭 Defense Industry<br/>Saab, BAE Bofors<br/>SISU, Nammo"]
        B["🇸🇪 Government Coalition<br/>M, KD, L + SD<br/>Policy delivery"]
        C["🌐 NATO/International<br/>Alliance credibility<br/>burden sharing"]
    end
    
    subgraph "Positive"
        D["👥 Citizens<br/>Enhanced security<br/>Infrastructure protection"]
        E["💻 Tech Industry<br/>Cybersecurity demand<br/>Public-private partnerships"]
    end
    
    subgraph "Mixed/Contested"
        F["⚖️ Opposition Bloc<br/>S: partial support<br/>V/MP: oppose spending"]
        G["🏛️ Judiciary<br/>Constitutional scrutiny<br/>ECHR compliance"]
        H["📰 Media<br/>High-interest stories<br/>Polarizing narratives"]
    end
