...
```mermaid
graph LR
    A["Prop 235<br/>Deportation Rules"] --> B{"Sensitivity"}
    B -->|"🟡 SENSITIVE"| D["Migration / Criminal Justice<br/>Tidö Agreement Implementation"]
    
    A --> G{"Domain"}
    G --> H["Migration Policy /<br/>Criminal Justice"]
    
    A --> I{"Urgency"}
    I -->|"🟠 URGENT"| K["Tidö Agreement delivery<br/>Pre-election commitment"]
...
```mermaid
graph TD
    R1["R1: Constitutional Challenge<br/>L:2 × I:5 = 10"] --> M1["Lagrådet review<br/>ECHR compliance check"]
    R2["R2: Coalition Tension<br/>L:3 × I:3 = 9"] --> M2["Tidö Agreement<br/>renegotiation clauses"]
    R3["R3: Implementation Gap<br/>L:3 × I:3 = 9"] --> M3["Migrationsverket capacity<br/>assessment"]
