...
```mermaid
graph LR
    A["Prop 214<br/>Cybersecurity Center"] --> B{"Sensitivity"}
    B -->|"🟡 SENSITIVE"| D["National Security /<br/>Critical Infrastructure"]
    
    A --> G{"Domain"}
    G --> H["Cybersecurity /<br/>Digital Defense"]
...
```mermaid
graph TD
    R1["R1: Talent Shortage<br/>L:4 × I:4 = 16"] --> M1["University partnerships<br/>cyber talent pipeline"]
