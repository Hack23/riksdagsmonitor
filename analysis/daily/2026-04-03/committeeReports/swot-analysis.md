...
```mermaid
graph TD
    subgraph "💼 SWOT Quadrant — Government Coalition"
        subgraph "✅ Strengths"
            GS1["Civil defence legislation<br/>passes committee"]
            GS2["Committee majority<br/>holds on JuU15"]
        end
        subgraph "❌ Weaknesses"
            GW1["Implementation<br/>feasibility questioned"]
            GW2["Accessibility gap<br/>flagged by 3 parties"]
        end
        subgraph "🔄 Opportunities"
            GO1["NATO interoperability<br/>narrative"]
            GO2["Election cycle<br/>security positioning"]
        end
        subgraph "⚠️ Threats"
            GT1["Municipal failure<br/>on shelter deadline"]
            GT2["Prison overcrowding<br/>narrative risk"]
        end
    end
