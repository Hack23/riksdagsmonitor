---
title: "Mandato Tidö, T-118: El cumplimiento energético de la UE se cierra mientras el pivote de seguridad aguanta"
date: 2026-05-18
language: es
...
# Mandato Tidö, T-118: El cumplimiento energético de la UE se cierra mientras el pivote de seguridad aguanta
...
**T-118 hasta las elecciones (2026-09-13)** · actualizado con análisis hermanos del 2026-05-18 ([proposiciones](../../propositions/), [mociones](../../motions/), [informes de comisión](../../committeeReports/), [interpelaciones](../../interpellations/), [mes por venir](../../month-ahead/)) y predecesor [ciclo electoral 2026-05-11](../../../2026-05-11/election-cycle/current/).
...
- [`synthesis-summary.md`](synthesis-summary.md) — decisión completa de historia principal y DIW Top-10
- [`intelligence-assessment.md`](intelligence-assessment.md) — BLUF ICD 203 + WEP por hallazgo
- [`scenario-analysis.md`](scenario-analysis.md) — árbol de escenarios de 12 hojas + 5 escenarios comodín
- [`cycle-trajectory.md`](cycle-trajectory.md) — tendencia de rendimiento plurianual SCB + IMF + Riksdag (24.° artefacto)
- [`risk-assessment.md`](risk-assessment.md) — principales riesgos con medidas de mitigación
- [`forward-indicators.md`](forward-indicators.md) — ≥15 indicadores con fecha a través de bandas trimestrales/anuales/de ciclo/electorales
