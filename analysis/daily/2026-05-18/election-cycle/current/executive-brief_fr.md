---
title: "Mandat Tidö, T-118 : La conformité énergétique européenne se referme tandis que le pivot sécuritaire tient"
date: 2026-05-18
language: fr
...
# Mandat Tidö, T-118 : La conformité énergétique européenne se referme tandis que le pivot sécuritaire tient

**Classification** : PUBLIC | **Processus** : news-election-cycle | **Cycle** : 2022-09-11 → 2026-09-13 (T-118 jusqu'à la fin du mandat)
...
**T-118 jusqu'aux élections (2026-09-13)** · mis à jour par les analyses sœurs du 2026-05-18 ([propositions](../../propositions/), [motions](../../motions/), [rapports de commission](../../committeeReports/), [interpellations](../../interpellations/), [mois à venir](../../month-ahead/)) et le prédécesseur [cycle électoral 2026-05-11](../../../2026-05-11/election-cycle/current/).
...
- [`synthesis-summary.md`](synthesis-summary.md) — décision complète d'histoire principale et DIW Top-10
- [`intelligence-assessment.md`](intelligence-assessment.md) — BLUF ICD 203 + WEP par résultat
- [`scenario-analysis.md`](scenario-analysis.md) — arbre de scénarios à 12 feuilles + 5 scénarios jokers
- [`cycle-trajectory.md`](cycle-trajectory.md) — tendance de débit pluriannuelle SCB + IMF + Riksdag (24e artefact)
- [`risk-assessment.md`](risk-assessment.md) — principaux risques avec mesures d'atténuation
- [`forward-indicators.md`](forward-indicators.md) — ≥15 indicateurs datés sur les bandes trimestriel/annuel/cycle/électoral
