...
generated_at: 2026-05-27T14:53:01.315Z
language: en
layout: article
---
## Executive Brief
...
```mermaid
graph TD
    subgraph "Security State Cluster (FöU18 + HD03267 + JuU32 + JuU34)"
        SIGINT["FöU18: SIGINT Modernisation<br/>DIW 8.9 / L3<br/>NATO interoperability, ECHR tension"]
        SEC["HD03267: Security Threats<br/>DIW 8.2 / L2+<br/>Deportation powers, Lagrådet referred"]
        PG["JuU32: Public Gathering<br/>DIW 7.0 / L2<br/>Police discretion, event security"]
        NC["JuU34: Nordic Criminal Enforcement<br/>DIW 6.5 / L2<br/>Cross-border enforcement"]
    end

    subgraph "Digital Identity Cluster"
        EID["HD03250: State e-ID<br/>DIW 7.5 / L2<br/>BankID competition"]
        SKV["HD03261: Skatteverket Powers<br/>DIW 7.0 / L2<br/>Population registry, personal data"]
    end

    subgraph "Financial Regulation Cluster (FiU)"
        MTF["CU35: MTF Platform Rules<br/>DIW 7.2 / L2<br/>EU securities alignment"]
        OTC["FiU38: OTC Derivatives<br/>DIW 7.0 / L2<br/>EMIR alignment"]
        CRISIS["FiU37: Financial Crisis Mgmt<br/>DIW 7.5 / L2<br/>New EU crisis function"]
        PROP["FiU31: State Property<br/>DIW 5.5 / L1<br/>Riksrevisionen audit"]
    end

    subgraph "Criminal Justice"
        PV["JuU39: Psychological Violence<br/>DIW 7.8 / L2+<br/>New criminal offence"]
        WELFARE["FiU43: Welfare Fraud Prevention<br/>DIW 5.8 / L2<br/>Municipal capability"]
    end

    subgraph "Opposition Accountability"
        ILO["HD10475: ILO Accountability<br/>S interpellation"]
        GAZA["HD10476/78: Gaza Humanitarian<br/>MP interpellations"]
        POST["HD10477: Postnord Rural<br/>SD interpellation"]
        MIN["HD10479: Minority Policy<br/>S interpellation"]
    end
```
...
```mermaid
graph LR
    GOV["Tidö Government"] -- "implements" --> SIGINT["FöU18 SIGINT"]
    GOV -- "proposes" --> SKV["HD03261 Skatteverket"]
    GOV -- "proposes" --> EID["HD03250 e-ID"]
    GOV -- "proposes" --> SEC["HD03267 Security"]
    
    BANKID["BankID Consortium"] -- "opposes" --> EID
    IMY["IMY"] -- "scrutinises" --> SKV
    UNHCR["UNHCR"] -- "concerns about" --> SEC
    SAPO["SÄPO"] -- "supports" --> SEC
    
    S["S opposition"] -- "challenges" --> GOV
    MP["MP opposition"] -- "challenges" --> GOV
    V["V opposition"] -- "challenges" --> GOV
    
    SD["SD (coalition)"] -- "internal tension" --> GOV
```
