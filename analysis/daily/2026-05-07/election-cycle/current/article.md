...
generated_at: 2026-05-24T18:59:05.722Z
language: en
layout: article
---
## Executive Brief
...
graph TD
    A["🗳️ Election 2026-09-13<br/>T-129 days"] --> B["Tidö 175 seats<br/>M+KD+L+SD"]
...
timeline
    ...
    2026-09 : Election T-129d → LIKELY Tidö re-election
...
%%{init: {'theme': 'dark', 'themeVariables': {'primaryColor': '#00d9ff', 'background': '#0a0e27'}}}%%
graph TD
    T["Tidö Coalition T-129d"] --> T1["Parliamentary threats"]
    T["Tidö Coalition T-129d"] --> T2["Electoral threats"]
    T["Tidö Coalition T-129d"] --> T3["External threats"]
