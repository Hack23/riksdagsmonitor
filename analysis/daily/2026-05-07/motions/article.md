...
keywords: "prop. 2025/26:242, prop. 2025/26:246, MJU, JuU, SD, MP, UN Convention, If Lagrådet, World Bank, Does SD s, CRC Art, Riksdagsmonitor, Swedish Parliament, Riksdag, political intelligence, OSINT, Swedish politics, democratic transparency, Regeringen, Motions, English"
date: 2026-05-07
subfolder: motions
slug: 2026-05-07-motions
source_folder: analysis/daily/2026-05-07/motions
generated_at: 2026-05-24T17:19:39.932Z
language: en
layout: article
---
## Executive Brief
...
graph LR
    ...
    A["Prop. 242\nSkogsbruk"] --> B["MJU: 5 opposition motions\nV+SD+S+C+MP"]
    A --> C["Intra-coalition tension\nSD amendments vs M/KD"]
    D["Prop. 246\nKriminalålder"] --> E["JuU: 3 opposition motions\nV+C+MP — CRC challenge"]
    E --> F["Lagrådet pending\nPIR LAGRÅDET-246"]
...
```mermaid
quadrantChart
    title Opposition Motion Strategic Positioning 2026-05-07
    x-axis "Rejection scope" --> "Amendment scope"
    y-axis "Constitutional challenge" --> "Policy challenge"
    quadrant-1 "Amendment + Policy"
    quadrant-2 "Rejection + Constitutional"
    quadrant-3 "Rejection + Policy"
    quadrant-4 "Amendment + Policy"
    HD024141-V: [0.1, 0.6]
    HD024142-V: [0.15, 0.8]
    HD024143-SD: [0.85, 0.2]
    HD024144-S: [0.75, 0.35]
    HD024145-C-forest: [0.7, 0.3]
    HD024146-C-crim: [0.1, 0.9]
    HD024147-MP: [0.05, 0.5]
...
```mermaid
xychart-beta
    title "Significance Scoring: 2026-05-07 Motions (DIW)"
    x-axis ["HD024146-C", "HD024142-V", "HD024148-MP", "HD024144-S", "HD024143-SD", "HD024141-V", "HD024147-MP", "HD024145-C"]
    y-axis "DIW Score" 0 --> 10
    bar [9.3, 8.3, 8.3, 7.7, 7.3, 7.3, 7.0, 6.7]
```
...
```mermaid
graph LR
    style GOVT fill:#0a0e27,color:#00d9ff,stroke:#00d9ff
    style LR fill:#1a1e3d,color:#00d9ff
    style LAG fill:#1a1e3d,color:#ff006e
    style EU fill:#1a1e3d,color:#ffbe0b

    GOVT[TidöPakten Government\n165 seats]
    LAG[Lagrådet\nConstitutional Review]
    EU[EU Commission\nDG ENV Monitoring]
    S[S Party\nCritical swing voter]
    SD[SD\nCoalition fracture signal]
    BRA[BRÅ\nEvidence gap]

    GOVT -->|Prop. 242| EU
    GOVT -->|Prop. 246| LAG
    LAG -->|Yttrande triggers| S
    S -->|Declaration triggers| GOVT
    SD -->|HD024143 filed against| GOVT
    EU -->|Infringement risk for| GOVT
    BRA -->|Research gap exploited by| Opposition
```
...
```mermaid
timeline
    title Key Decision Points — 2026-05-07 to 2026-06-22
    2026-05-14 : S Party Statement\n(PIR S-CRC-JOIN)\nWatch for declaration
    2026-05-20 : MJU Committee Hearing\nSD yrkanden accommodated?\nPivot to S1 or S3
    2026-06-05 : Lagrådet Yttrande Due\n(PIR LAGRÅDET-246)\nPivot to S2 or S1
    2026-06-15 : Committee Reports Published\nFinal scenario crystallises
    2026-06-22 : Chamber Votes\nOutcome confirmed
```
...
quadrantChart
    ...
    quadrant-2 "Monitor — Low likelihood but high impact"
    quadrant-3 "Watch — Low but manageable"
    quadrant-4 "Manage — High likelihood, lower impact"
    R1-Constitutional: [0.55, 0.95]
    R3-Electoral: [0.75, 0.6]
    R5-S-Position: [0.6, 0.95]
    R2-SD-Dissent: [0.45, 0.7]
    R4-EU-Habitats: [0.35, 0.7]
```
...
graph TD
    style A fill:#0a0e27,color:#00d9ff,stroke:#00d9ff
    style B fill:#1a1e3d,color:#00d9ff,stroke:#00d9ff
    style C fill:#1a1e3d,color:#ff006e,stroke:#ff006e
    style D fill:#1a1e3d,color:#ffbe0b,stroke:#ffbe0b
    A["Opposition SWOT\n2026-05-07 Motions"]
    A --> B["Strengths:\n5-party forestry coalition\nCRC constitutional grounding\nSD internal split\nLagrådet ace"]
    A --> C["Threats:\n165-seat govt majority\nCrime poll dynamics\nSD potential accommodation"]
    A --> D["Key Uncertainty:\nS position on prop. 246\nLagrådet yttrande timing"]
```
...
```mermaid
flowchart LR
    style PROP242 fill:#0a0e27,color:#00d9ff,stroke:#00d9ff
    style PROP246 fill:#0a0e27,color:#ff006e,stroke:#ff006e
    style MJU fill:#1a1e3d,color:#00d9ff
    style JUU fill:#1a1e3d,color:#ff006e

    PROP242["Prop. 2025/26:242\nForestry (Skogsvårdslagen)\nFiled 2026-04-16"]
    MJU["MJU Committee\n5 opposition motions\nHD024141, 143, 144, 145, 147"]
    PROP242 --> MJU

    PROP246["Prop. 2025/26:246\nCriminal Age (13 yrs)\nFiled 2026-04-16"]
    JUU["JuU Committee\n3 opposition motions\nHD024142, 146, 148"]
    PROP246 --> JUU

    MJU -->|"Committee report\n~2026-06-15"| VOTE_A["Chamber vote\nProp. 242 + MJU motions\n~2026-06-22"]
    JUU -->|"Committee report\n~2026-06-15 (pending Lagrådet)"| VOTE_B["Chamber vote\nProp. 246 + JuU motions\n~2026-06-22"]
```
