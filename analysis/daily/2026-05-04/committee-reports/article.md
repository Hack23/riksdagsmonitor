...
generated_at: 2026-05-24T14:02:58.896Z
language: en
layout: article
---
## Executive Brief
...
%%{init: {"theme": "dark"}}%%
timeline
    title April–June 2026 Legislative Calendar
    section April 2026
        April 29 : HD01NU19 approved (NU committee)
        April 29 : HD01SfU28 voted (SfU)
        April 29 : HD01JuU9 approved (JuU)
    section June 2026
        June 6 : SfU28 citizenship law enters force
        June 17 : NU19 nuclear licensing law enters force
        July 1 : JuU9 court process reform enters force
    section September 2026
        Sept 13 : General election (estimated)
```
...
graph LR
    A[Tidö Coalition<br>M+SD+KD+L] -->|"Prop 2025/26:171<br>Nuclear licensing"| B[NU Committee<br>HD01NU19]
    A -->|"Prop 2025/26:175<br>Citizenship tightening"| C[SfU Committee<br>HD01SfU28]
    A -->|"Prop 2025/26:155<br>Court reform"| D[JuU Committee<br>HD01JuU9]
    B -->|"Reservation 1+2"| E[S+V+C+MP<br>Opposition bloc]
    C -->|"10 res. V + 4 res. MP"| F[V+MP<br>Hard opposition]
    C -->|"S/C voted Ja"| G[S+C<br>Cross-party support]
    D -->|"1 reservation V"| F

    style A fill:#1a3a5c,stroke:#00d9ff
    style B fill:#2a1a5c,stroke:#ff006e
    style C fill:#2a1a5c,stroke:#ff006e
    style D fill:#1a3a2c,stroke:#00d9ff
    style E fill:#3a2a1a,stroke:#ffbe0b
    style F fill:#3a1a1a,stroke:#ff006e
...
%%{init: {"theme": "dark"}}%%
graph LR
    A[SfU28 Vote] --> B{Voted Ja}
    A --> C{Reservations/Nei}
    B --> D[M - Margareta Cederfelt]
    B --> E[SD - Julia Kronlid]
    B --> F[KD - implicit support]
    B --> G[L - implicit support]
    B --> H[S - Kenneth G Forslund<br>Anders Ygeman]
    B --> I[C - Kerstin Lundgren]
    C --> J[V - 10 reservations<br>Gudrun Nordborg]
    C --> K[MP - 4 reservations]

    style D fill:#1e4d8c,stroke:#1e4d8c
    style E fill:#f6c90e,stroke:#f6c90e,color:#000
    style G fill:#00b4ff,stroke:#00b4ff
    style H fill:#e8112d,stroke:#e8112d
    style I fill:#009966,stroke:#009966
    style J fill:#aa2233,stroke:#aa2233
    style K fill:#53a33f,stroke:#53a33f
```
...
```mermaid
%%{init: {"theme": "dark", "themeVariables": {"primaryColor": "#00d9ff"}}}%%
pie title Riksdag 2022 — Current Composition
    "S (107)" : 107
    "SD (73)" : 73
    "M (68)" : 68
    "V (24)" : 24
...
%%{init: {"theme": "dark"}}%%
xychart-beta
    title "Voter Segment Benefit (Positive = Winning Votes)"
    x-axis ["Energy<br>Cost", "Immigrants<br>Applicants", "Urban<br>Liberal", "Law&Order<br>Middle", "Defence/<br>Security"]
    y-axis "Net Segment Benefit Score -5 to +5" -5 --> 5
    bar [3, -4, -1, 3, 4]
```
...
pie title Scenario Probability Distribution
    "Scenario 1: Tidö Continuation (35%)" : 35
    "Scenario 2: Centre-Left Rotation (40%)" : 40
    "Scenario 3: Hung Parliament (25%)" : 25
```
...
%%{init: {"theme": "dark"}}%%
xychart-beta
    title "Projected 2026 Seat Ranges — Key Parties"
    x-axis ["SD", "M", "S", "C", "V", "KD", "L", "MP"]
    y-axis "Seats" 0 --> 120
    bar [74, 67, 112, 21, 28, 17, 14, 14]
```
...
quadrantChart
    ...
    quadrant-3 Monitor
    quadrant-4 Watch
    R-01 Constitutional Challenge: [0.40, 0.95]
    R-02 Implementation Failure: [0.60, 0.80]
    R-03 Election Reversal: [0.45, 0.82]
    R-04 Oversight Gap: [0.25, 0.78]
    R-05 EU Challenge: [0.30, 0.75]
    R-07 CER Gaps: [0.35, 0.70]
    R-06 Fair Trial: [0.20, 0.55]
```
...
%%{init: {"theme": "dark", "themeVariables": {"primaryColor": "#00d9ff", "edgeLabelBackground": "#1a1e3d"}}}%%
quadrantChart
    title SWOT — April 2026 Committee Cycle
...
%%{init: {"theme": "dark"}}%%
graph TD
    A[April 2026 Committee Decisions] --> B{Legal Threats}
    A --> C{Political Threats}
    A --> D{Operational Threats}
    A --> E{International Threats}
    
    B --> B1[T-1A: NU19 Constitutional Challenge<br>P=40%]
    B --> B2[T-1B: SfU28 ECHR Art.8<br>P=45%]
    C --> C1[T-2A: Election Reversal NU19<br>P=45%]
    C --> C2[T-2B: SfU28 Liability<br>P=40%]
    D --> D1[T-3A: Migrationsverket Capacity<br>P=60%]
    D --> D2[T-3B: Nuclear SSM Gap<br>P=35%]
    E --> E1[T-4A: EU State Aid<br>P=25%]
    
    style B1 fill:#ff006e,stroke:#ff006e
    style B2 fill:#ff8c00,stroke:#ff8c00
    style C1 fill:#ff006e,stroke:#ff006e
    style D1 fill:#ff006e,stroke:#ff006e
    style E1 fill:#2a3a4a,stroke:#00d9ff
```
...
%%{init: {"theme": "dark"}}%%
xychart-beta
    title "Implementation Feasibility Score (1=Low, 10=High)"
    x-axis ["NU19 Law<br>Enters Force", "NU19 First<br>Reactor", "SfU28 Core", "SfU28 Lang<br>Test", "JuU9", "FöU14", "FöU20"]
    y-axis "Feasibility Score" 0 --> 10
    bar [9.5, 4.0, 7.5, 4.5, 9.2, 8.0, 6.5]
```
...
%%{init: {"theme": "dark"}}%%
graph TD
    A[NU19 Nuclear Law] --> B[SvD, Expressen<br>Frame A: Energy security]
    A --> C[DN, SR, SVT<br>Frame B+C: Nuanced review]
    A --> D[Social media, Klimatnyheterna<br>Frame B: Environmental threat]
    
    E[SfU28 Citizenship] --> F[SD media, Samhällsnytt<br>Frame A: Integration success]
    E --> G[DN, Aftonbladet, SVT<br>Frame B+D: Pragmatic + implementation]
    E --> H[Arena Idé, Expo, V/MP channels<br>Frame C: Civil society critique]
    
    style A fill:#ff006e,stroke:#ff006e
    style E fill:#ff8c00,stroke:#ff8c00
    style B fill:#1a3a5c,stroke:#00d9ff
    style F fill:#4a1a1a,stroke:#f6c90e
```
...
%%{init: {"theme": "dark"}}%%
graph TD
    A[HD01NU19<br>NU — Nuclear Licensing] -->|"Energy sovereignty<br>narrative"| B[Election 2026<br>Campaign Issues]
    C[HD01SfU28<br>SfU — Citizenship] -->|"Integration<br>narrative"| B
    D[HD01JuU9<br>JuU — Court Reform] -->|"Law & order<br>narrative"| B
    E[HD01FöU14<br>FöU — Military Coop] -->|"National security<br>narrative"| B
    F[HD01FöU20<br>FöU — Critical Infra] -->|"Resilience<br>narrative"| B
    G[HD01KU36<br>KU — Oversight] -->|"Democratic<br>oversight"| H[Parliamentary<br>Accountability]
    
    A -->|"Requires SSM<br>implementation"| I[State Agency<br>Readiness]
    C -->|"Requires Migrationsverket<br>capacity"| I
    E -->|"Requires Försvarsmakten<br>agreements"| I
    F -->|"Requires MSB<br>supervision"| I

    style A fill:#ff006e,stroke:#ff006e
    style C fill:#ff8c00,stroke:#ff8c00
    style B fill:#1a3a5c,stroke:#00d9ff
```
