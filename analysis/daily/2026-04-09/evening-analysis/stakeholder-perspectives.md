...
```mermaid
graph TD
    subgraph "Stakeholder Impact — April 9 Legislative Package"
        CIT["👤 Citizens<br/>Impact: HIGH<br/>Crime + Accountability"]
        GOV["🏛️ Government Coalition<br/>Impact: HIGH<br/>Legislative momentum"]
        OPP["⚔️ Opposition Bloc<br/>Impact: MEDIUM<br/>Fragmented response"]
        BIZ["💼 Business/Industry<br/>Impact: MEDIUM<br/>Regulatory predictability"]
        CIV["🏥 Civil Society<br/>Impact: HIGH<br/>Proportionality concerns"]
        INT["🌍 International/EU<br/>Impact: HIGH<br/>NATO + rule of law"]
