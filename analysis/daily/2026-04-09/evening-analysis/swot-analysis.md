...
graph TD
    subgraph "STRENGTHS 🟢"
        S1["Coordinated 3-proposition launch<br/>HD03220 + HD03218 + HD03217"]
        S2["NATO integration maturity<br/>First forward deployment prop"]
        S3["PM Kristersson personal authorship<br/>signals priority"]
    end
    subgraph "WEAKNESSES 🟠"
        W1["Opposition filing separate motions<br/>V: HD024073, MP: HD024074"]
        W2["6 committee reports overwhelm<br/>scrutiny capacity"]
        W3["Criminal reform proportionality<br/>untested doubled penalties"]
    end
    subgraph "OPPORTUNITIES 🔵"
        O1["Bipartisan defense consensus<br/>S likely supports HD03220"]
        O2["Civil servant accountability<br/>popular demand fulfilled"]
        O3["Security committee report UU6<br/>reinforces NATO narrative"]
    end
    subgraph "THREATS 🔴"
        T1["Constitutional proportionality<br/>challenge on HD03218"]
