...
```mermaid
graph TD
    subgraph "Legislative Activity — 2026-04-09"
        A["🏛️ Government Propositions<br/>3 major bills"] --> B["⚖️ Justice & Security<br/>HD03218 + HD03217"]
        A --> C["🛡️ NATO/Defense<br/>HD03220"]
        D["📋 Committee Reports<br/>6 reports published"] --> E["🔒 Security Policy<br/>UU6"]
        D --> F["🚶 Migration<br/>SfU16"]
        D --> G["🚂 Transport<br/>TU15"]
        D --> H["🪖 Defense Personnel<br/>FöU8"]
        D --> I["🔬 Research Ethics<br/>UbU31"]
        D --> J["🏘️ Rural Dev<br/>CU23"]
        K["📝 Opposition Motions<br/>2 motions"] --> L["V + MP vs Youth Crime Bill<br/>HD024073 + HD024074"]
    end
