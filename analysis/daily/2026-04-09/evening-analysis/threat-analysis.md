...
graph TD
    subgraph "Democratic Function Threats"
        T1["Legislative Overload<br/>Severity: 3/5"]
        T2["Proportionality Erosion<br/>Severity: 4/5"]
        T3["Executive Overreach<br/>Severity: 2/5"]
        T4["Alliance Commitment Creep<br/>Severity: 3/5"]
        T5["Opposition Fragmentation<br/>Severity: 3/5"]
        T6["Electoral Instrumentalization<br/>Severity: 2/5"]
    end
    T1 --> T5
    T2 --> T3
    T4 --> T1
