# Document Analysis: Undantag från kravet på etikgodkännande för viss forskning och regleringen av tillsyn i etikprövningslagen
...
- Policy domain: education policy (HIGH confidence)
...
1. Policy domain: education policy (HIGH confidence)
