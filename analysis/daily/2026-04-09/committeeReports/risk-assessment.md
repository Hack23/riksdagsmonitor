...
graph TD
    subgraph "⚖️ Political Risk Matrix — Likelihood × Impact"
        R1["🔴 Climate Policy Stalemate<br/>L:4 × I:4 = 16"]
        R2["🔴 NATO Integration Backlash<br/>L:3 × I:5 = 15"]
        R3["🟠 Energy Transition Delay<br/>L:3 × I:4 = 12"]
        R4["🟡 Civil Protection Implementation<br/>L:2 × I:4 = 8"]
        R5["🟡 Opposition Fragmentation<br/>L:3 × I:3 = 9"]
...
```mermaid
graph LR
    R1["Climate Stalemate<br/>(MJU30)"] --> R3["Energy Delay<br/>(NU18)"]
    R2["NATO Backlash<br/>(UU6)"] --> R5["Opposition Split"]
    R3 --> R1
