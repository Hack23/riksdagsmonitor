...
```mermaid
graph TD
    subgraph "Defence Cluster"
        FOU12["FöU12<br/>Shelter Law"] --> FOU11["FöU11<br/>Maritime Rescue"]
        FOU12 --> UU6["UU6<br/>Security Policy"]
    end
    
    subgraph "Energy-Climate Cluster"
        NU18["NU18<br/>Renewable Permits"] --> MJU30["MJU30<br/>Climate Targets"]
        NU18 --> NU17["NU17<br/>Electricity Market"]
    end
    
    subgraph "Social Cluster"
        SOU16["SoU16<br/>Healthcare Org"] --> SOU17["SoU17<br/>Healthcare Priorities"]
        SFU18["SfU18<br/>Social Insurance"]
        SOU37["SoU37<br/>EU GMO/Organ"]
    end
    
    subgraph "Rights Cluster"
        AU11["AU11<br/>Equality"] --> AU12["AU12<br/>Working Environment"]
        JUU15["JuU15<br/>Criminal Justice"] --> JUU16["JuU16<br/>Police"]
    end
