...
graph TD
    subgraph "🔴 Democratic Function Threats"
        T1["Legislative Gridlock<br/>Severity: MEDIUM"]
        T2["Coalition Fragility<br/>Severity: LOW"]
        T3["Representation Gap<br/>Severity: MEDIUM"]
        T4["Accountability Deficit<br/>Severity: LOW"]
    end
    
    T1 --> E1["346+ motions rejected<br/>CU18+CU17+NU17"]
    T2 --> E2["SD special statement on AU11<br/>signals policy independence"]
