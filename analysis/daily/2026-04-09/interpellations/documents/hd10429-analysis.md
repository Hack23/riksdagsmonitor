...
```mermaid
graph LR
    A["HD10429<br/>Freedom of Speech<br/>vs Prop 2025/26:133"] --> B{Sensitivity}
    B -->|"🔴 RESTRICTED"| C["Constitutional Rights<br/>Government Legislation"]
    
    A --> G{Domain}
    G --> H["Constitutional Law &<br/>Civil Liberties"]
