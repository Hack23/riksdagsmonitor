...
graph TD
    subgraph "HIGH IMPACT"
        CIT["👥 Citizens<br/>Fundamental rights affected"]
        GOV["🏛️ Government Coalition<br/>SD-M/KD tension"]
        JUD["⚖️ Judiciary<br/>Constitutional implications"]
        MED["📰 Media<br/>High-salience topics"]
    end
    subgraph "MEDIUM IMPACT"
        OPP["🔴 Opposition<br/>Strategic opportunity"]
        INT["🌍 International/EU<br/>Free speech reputation"]
        CIV["🏘️ Civil Society<br/>Religious freedom debate"]
    end
    subgraph "LOW IMPACT"
