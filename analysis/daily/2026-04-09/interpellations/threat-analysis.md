...
```mermaid
graph TD
    ROOT["🔴 Political Threats<br/>SD Interpellations April 2026"] --> T1["⚖️ Fundamental Rights<br/>Erosion Risk"]
    ROOT --> T2["🏛️ Coalition Stability<br/>Threat"]
    ROOT --> T3["🌍 International<br/>Reputation Risk"]
    
    T1 --> T1A["Prop 133 enables<br/>'violent veto'<br/>frs 429"]
    T1 --> T1B["Police discretion<br/>expands without<br/>clear limits"]
    
    T2 --> T2A["SD defection on<br/>government legislation<br/>frs 429"]
    T2 --> T2B["Pre-election<br/>positioning weakens<br/>coalition unity"]
    ...
    style T2A fill:#1a1e3d,color:#e0e0e0
    style T2B fill:#1a1e3d,color:#e0e0e0
    style T3A fill:#1a1e3d,color:#e0e0e0
    style T3B fill:#1a1e3d,color:#e0e0e0
```
