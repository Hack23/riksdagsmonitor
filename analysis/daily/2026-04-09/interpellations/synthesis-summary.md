...
```mermaid
graph TD
    SD["🟡 SD<br/>Coalition Support Party"] -->|"frs 429"| M["🔵 Justice Minister<br/>Gunnar Strömmer (M)"]
    SD -->|"frs 430"| KD["🟣 Social Minister<br/>Jakob Forssmed (KD)"]
    
    M --- P133["Proposition 2025/26:133<br/>Public Gatherings Security"]
    KD --- MOSQUE["Mosque Oversight<br/>Kristianstad Cases"]
    
    P133 --> RIGHTS["🔴 Constitutional Rights<br/>Freedom of Speech/Assembly"]
    MOSQUE --> RIGHTS
