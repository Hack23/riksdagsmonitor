...
quadrantChart
    ...
    quadrant-4 Threats
    Migration agenda delivery: [0.25, 0.75]
    Defense consensus: [0.3, 0.7]
    Regulatory streamlining: [0.2, 0.6]
    Election migration issue: [0.7, 0.8]
    Defense employment: [0.65, 0.65]
    L voter tension: [0.3, 0.35]
    Recruitment shortfall: [0.25, 0.25]
    Rail underinvestment: [0.2, 0.4]
    ECHR compliance: [0.75, 0.3]
    NATO force gaps: [0.8, 0.2]
    SD power influence: [0.6, 0.25]
```
