...
```mermaid
graph TD
    subgraph Dashboard 2026-04-09 Realtime 1029
        D1[Documents Analyzed: 5]
        D2[Max Significance: 5.5 out of 10]
        D3[Risk Level: MEDIUM]
        D4[Breaking Threshold: NOT MET]
        D5[New Committee Reports: 4]
    end
    D1 --> D2
    D2 --> D3
    D3 --> D4
...
```mermaid
graph LR
    subgraph Coalition Balance Assessment
        GOV[Government Position: STABLE]
        OPP[Opposition Position: LIMITED LEVERAGE]
        RISK[Overall Risk: MEDIUM]
    end
    GOV --> RISK
    OPP --> RISK
