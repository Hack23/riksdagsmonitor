...
```mermaid
quadrantChart
    title Political Risk Assessment 2026-04-09
    ...
    "Electoral credibility (HD03218)": [0.6, 0.8]
    "Prison capacity strain": [0.7, 0.6]
    "NATO cost escalation": [0.5, 0.5]
    "Baltic security escalation": [0.6, 0.7]
    "SD coalition tension (NATO)": [0.3, 0.4]
    "Lagrådet proportionality": [0.5, 0.5]
    "Civil servant union backlash": [0.4, 0.3]
    "Chilling effect on officials": [0.3, 0.4]
```
...
```mermaid
graph TD
    A["HD03218: Doubled Penalties"] --> B["Increased Prison Population"]
    B --> C["Prison Capacity Crisis"]
    C --> D["Implementation Failure"]
    D --> E["Electoral Credibility Gap"]
    E --> F["2026 Election Vulnerability"]

    A2["HD03220: NATO eFP Deployment"] --> B2["Defence Budget Pressure"]
