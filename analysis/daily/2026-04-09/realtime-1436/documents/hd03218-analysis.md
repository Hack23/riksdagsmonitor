...
```mermaid
graph LR
    A["📄 HD03218"] --> B{Sensitivity}
    B -->|"🟡 SENSITIVE"| D["Criminal justice reform"]

    A --> G{Domain}
    G --> H["Justice & Criminal Law (JUS)"]
...
graph LR
    ...
    NI --> NI1["Moderate — populist framing of 'double penalties' may oversimplify"]
