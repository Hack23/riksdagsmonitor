...
```mermaid
graph TB
    subgraph "📊 Daily Intelligence Dashboard — 2026-04-09"
        direction TB
        SIG["🔴 Significance: MEDIUM-HIGH<br/>Score: 7.0/10"]
        RISK["🟡 Overall Risk: MEDIUM<br/>Aggregate: 5.2/25"]
        CONF["🟢 Confidence: HIGH<br/>11 documents analysed"]
    end

    subgraph "📋 Document Breakdown"
        PROP["📜 Propositions: 3<br/>HD03220, HD03218, HD03217"]
        MOT["📝 Motions: 2<br/>HD024073 (V), HD024074 (MP)"]
        BET["📂 Committee Reports: 5<br/>SfU16, TU15, UbU31, FöU8, CU23"]
        FRA["❓ Written Questions: 1<br/>HD11695"]
    end
