...
```mermaid
graph TB
    subgraph "🎭 Political Threat Taxonomy — 2026-04-09"
        NI["🎭 Narrative Integrity<br/>Score: 2/5"]
        LI["📝 Legislative Integrity<br/>Score: 2/5"]
        AC["🚫 Accountability<br/>Score: 1/5"]
        TR["🔇 Transparency<br/>Score: 2/5"]
        DP["⛔ Democratic Process<br/>Score: 1/5"]
        PB["👑 Power Balance<br/>Score: 2/5"]
    end
