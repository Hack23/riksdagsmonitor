...
```mermaid
graph LR
    A["Prop. 2025/26:230"] --> B{"Sensitivity"}
...
```mermaid
quadrantChart
    title Risk Matrix — Prop. 2025/26:230
    ...
    "Opposition attacks": [0.75, 0.55]
    "Fiscal uncertainty": [0.55, 0.55]
    "EU compliance": [0.35, 0.75]
    "MJU delays": [0.55, 0.35]
    "Rural expectations": [0.35, 0.35]
```
