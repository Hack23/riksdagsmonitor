...
```mermaid
graph TD
    A["Threat Analysis<br/>2026-04-09 Propositions"] --> B["Democratic<br/>Function Threats"]
    A --> C["Policy<br/>Delivery Threats"]
    A --> D["Governance<br/>Quality Threats"]
    B --> B1["None identified<br/>🟢 No democratic risks"]
