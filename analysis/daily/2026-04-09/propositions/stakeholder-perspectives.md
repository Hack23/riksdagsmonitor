...
```mermaid
graph TD
    A["Prop. 2025/26:230<br/>Species Protection<br/>Compensation"] --> B["🏛️ Government<br/>Coalition"]
    A --> C["⚖️ Opposition<br/>Parties"]
    A --> D["🏡 Property<br/>Owners"]
    A --> E["🌿 Environmental<br/>NGOs"]
    A --> F["🏘️ Municipalities"]
    A --> G["⚖️ Courts"]
    B --> B1["✅ POSITIVE<br/>Delivers property<br/>rights agenda"]
    C --> C1["❌ NEGATIVE (MP/V)<br/>Weakens env.<br/>protection"]
    C --> C2["⚠️ CAUTIOUS (S)<br/>May support with<br/>fiscal caveats"]
    D --> D1["✅ STRONGLY POSITIVE<br/>Statutory right to<br/>compensation"]
