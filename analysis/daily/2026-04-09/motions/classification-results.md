...
```mermaid
%%{init: {'theme': 'base', 'themeVariables': {'primaryColor': '#1a1e3d', 'primaryTextColor': '#e0e0e0', 'lineColor': '#00d9ff'}}}%%
flowchart LR
    subgraph Domain["Domain: EU & Foreign Affairs"]
        A["HD024070 — C<br/>Sensitivity: MEDIUM<br/>Significance: 5/10"]
        B["HD024071 — V<br/>Sensitivity: MEDIUM<br/>Significance: 6/10"]
        C["HD024072 — MP<br/>Sensitivity: MEDIUM<br/>Significance: 5/10"]
    end
    subgraph Urgency["Urgency: STANDARD"]
        D["UU Committee Review<br/>Expected: Spring 2026"]
    end
    A --> D
    B --> D
    C --> D
