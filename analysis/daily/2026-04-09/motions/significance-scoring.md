...
xychart-beta
    title "Motion Significance Scores — 2026-04-09"
    x-axis ["V (mot. 4071)", "C (mot. 4070)", "MP (mot. 4072)"]
...
%%{init: {'theme': 'base', 'themeVariables': {'primaryColor': '#1a1e3d', 'primaryTextColor': '#e0e0e0', 'lineColor': '#00d9ff'}}}%%
flowchart TD
    A["Riksrevisionen Audit<br/>Sida Humanitarian Aid"] --> B["Skr. 2025/26:226<br/>Government Communication"]
    B --> C["V — mot. 2025/26:4071<br/>Score: 6/10"]
    B --> D["C — mot. 2025/26:4070<br/>Score: 5/10"]
    B --> E["MP — mot. 2025/26:4072<br/>Score: 5/10"]
